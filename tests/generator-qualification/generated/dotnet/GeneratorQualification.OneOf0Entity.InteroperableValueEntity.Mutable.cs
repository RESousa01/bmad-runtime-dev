    ...
    public readonly partial struct OneOf0Entity
    {
        ...
        public readonly partial struct InteroperableValueEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(InteroperableValueEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InteroperableValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InteroperableValueEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InteroperableValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InteroperableValueEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InteroperableValueEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InteroperableValueEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(InteroperableValueEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<InteroperableValueEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InteroperableValueEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InteroperableValueEntity>();
                }
                finally
                {
