...
public readonly partial struct GeneratorQualification
    ...
    : IJsonElement<GeneratorQualification>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GeneratorQualification"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GeneratorQualification(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GeneratorQualification DefaultInstance { get; }
    ...
    public static explicit operator Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity(GeneratorQualification value)
    {
        return Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator GeneratorQualification(Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity(GeneratorQualification value)
    {
        return Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in GeneratorQualification left, in GeneratorQualification right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GeneratorQualification left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GeneratorQualification instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GeneratorQualification(JsonElement instance)
    {
        return GeneratorQualification.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratorQualification From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GeneratorQualification? result)
    {
        return JsonElementHelpers.TryParseValue<GeneratorQualification>(ref reader, out result);
    }
...
#if NET
    static GeneratorQualification IJsonElement<GeneratorQualification>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GeneratorQualification: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GeneratorQualification Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GeneratorQualification Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GeneratorQualification>(_idx);
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsOneOf0Entity(out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity result)
    {
        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.From(this);
            return true;
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsOneOf1Entity(out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity result)
    {
        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Sapphirus.GeneratorQualification.Generated.GeneratorQualification, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchOneOf0Entity(Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.From(this), context);
        }

        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchOneOf1Entity(Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Sapphirus.GeneratorQualification.Generated.GeneratorQualification, TResult> defaultMatch)
    {
        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchOneOf0Entity(Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf0Entity.From(this));
        }

        if (Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchOneOf1Entity(Sapphirus.GeneratorQualification.Generated.GeneratorQualification.OneOf1Entity.From(this));
        }
