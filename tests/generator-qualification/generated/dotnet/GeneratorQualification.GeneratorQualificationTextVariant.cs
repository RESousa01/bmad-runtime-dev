...
public readonly partial struct GeneratorQualification
{
    ...
    public readonly partial struct GeneratorQualificationTextVariant
        ...
        : IJsonElement<GeneratorQualificationTextVariant>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratorQualificationTextVariant"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GeneratorQualificationTextVariant(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GeneratorQualificationTextVariant DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.KindEntity Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.KindEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.JsonString Text
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TextUtf8, out Sapphirus.GeneratorQualification.Generated.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GeneratorQualificationTextVariant left, in GeneratorQualificationTextVariant right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GeneratorQualificationTextVariant left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GeneratorQualificationTextVariant instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GeneratorQualificationTextVariant(JsonElement instance)
        {
            return GeneratorQualificationTextVariant.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationTextVariant From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationTextVariant ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationTextVariant>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationTextVariant ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationTextVariant>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationTextVariant ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationTextVariant>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static GeneratorQualificationTextVariant ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationTextVariant>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GeneratorQualificationTextVariant? result)
        {
            return JsonElementHelpers.TryParseValue<GeneratorQualificationTextVariant>(ref reader, out result);
        }
...
#if NET
        static GeneratorQualificationTextVariant IJsonElement<GeneratorQualificationTextVariant>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GeneratorQualificationTextVariant: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationTextVariant Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationTextVariant Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GeneratorQualificationTextVariant>(_idx);
            }
