    ...
    public readonly partial struct OneOf0Entity
    {
            ...
            : IJsonElement<SignedValueEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/oneOf/0/properties/signedValue"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/oneOf/0/properties/signedValue";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/oneOf/0/properties/signedValue"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    {
                        JsonSchemaEvaluation.MatchLessThanOrEquals(isNegative, integral, fractional, exponent, false, "2147483647"u8, ""u8, 0, "2147483647", "maximum"u8, ref context);
                        if (!context.HasCollector && !context.IsMatch)
                        {
                            return;
                        }

                        JsonSchemaEvaluation.MatchGreaterThanOrEquals(isNegative, integral, fractional, exponent, true, "2147483648"u8, ""u8, 0, "-2147483648", "minimum"u8, ref context);
                    }
                }
