...
public readonly partial struct GeneratorQualification
{
        ...
        : IJsonElement<GeneratorQualificationNode>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNextPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("next"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNextNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("next"u8, buffer, out written);

            private const int RequiredOffsetForNext = 0;
            private const uint RequiredBitForNext = 0b00000000000000000000000000000001;
            ...
            private const uint RequiredBitMask0 =
                RequiredBitForNext | RequiredBitForValue;
            private static readonly JsonSchemaPathProvider NextSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/next"u8, buffer, out written);
            ...
            private static void MatchNext(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationNode.NextEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.NextUtf8,
                        evaluationPath: NextSchemaEvaluationPath);

                Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationNode.NextEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForNext] |= RequiredBitForNext;
            }
            ...
            private static void MatchValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                Sapphirus.GeneratorQualification.Generated.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Sapphirus.GeneratorQualification.Generated.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.GeneratorQualification.Generated.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.NextUtf8, MatchNext),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/GeneratorQualificationNode"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/GeneratorQualificationNode";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/GeneratorQualificationNode"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNextPresent, "next"u8, "required"u8);
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForNext] & RequiredBitForNext) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyNextNotPresent, "next"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNextPresent, "next"u8, "required"u8);
