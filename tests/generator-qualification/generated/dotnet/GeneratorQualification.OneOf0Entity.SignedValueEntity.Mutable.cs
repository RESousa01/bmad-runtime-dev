    ...
    public readonly partial struct OneOf0Entity
    {
        ...
        public readonly partial struct SignedValueEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SignedValueEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SignedValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SignedValueEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SignedValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SignedValueEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SignedValueEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SignedValueEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SignedValueEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SignedValueEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SignedValueEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SignedValueEntity>();
                }
                finally
                {
