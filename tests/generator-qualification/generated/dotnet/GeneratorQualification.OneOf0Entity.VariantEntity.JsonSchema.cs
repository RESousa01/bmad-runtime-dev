    ...
    public readonly partial struct OneOf0Entity
    {
            ...
            : IJsonElement<VariantEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/oneOf/0/properties/variant"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/oneOf/0/properties/variant";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/oneOf/0/properties/variant"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                        ...
                        if (parentDocument.GetJsonTokenType(parentIndex) == JsonTokenType.StartObject)
                        {
                            if (parentDocument.TryGetNamedPropertyValue(parentIndex, "kind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                            {
                                if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                                {
                                    ...
                                    if (discriminatorValue.Span.SequenceEqual("text"u8))
                                    {
                                        oneOfDiscriminatorBranch = 0;
                                    }
                                    else if (discriminatorValue.Span.SequenceEqual("count"u8))
                                    {
                        ...
                        switch (oneOfDiscriminatorBranch)
                        {
                            case 0:
                            {
                                JsonSchemaContext discriminatorContext0 =
                                    Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                            ...
                            case 1:
                            {
                                JsonSchemaContext discriminatorContext1 =
                                    Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationTextVariant.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                    ...
                    JsonSchemaContext oneOfContext1 =
                        Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                    Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
