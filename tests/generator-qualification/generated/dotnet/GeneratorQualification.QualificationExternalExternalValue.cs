...
public readonly partial struct GeneratorQualification
{
    ...
    public readonly partial struct QualificationExternalExternalValue
        ...
        : IJsonElement<QualificationExternalExternalValue>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualificationExternalExternalValue"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal QualificationExternalExternalValue(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static QualificationExternalExternalValue DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.GeneratorQualification.QualificationExternalExternalValue.CodeEntity Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.QualificationExternalExternalValue.CodeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in QualificationExternalExternalValue left, in QualificationExternalExternalValue right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in QualificationExternalExternalValue left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(QualificationExternalExternalValue instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QualificationExternalExternalValue(JsonElement instance)
        {
            return QualificationExternalExternalValue.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualificationExternalExternalValue From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualificationExternalExternalValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualificationExternalExternalValue>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualificationExternalExternalValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualificationExternalExternalValue>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualificationExternalExternalValue ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualificationExternalExternalValue>(json, options);
        }
        ...
        /// </exception>
        public static QualificationExternalExternalValue ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<QualificationExternalExternalValue>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out QualificationExternalExternalValue? result)
        {
            return JsonElementHelpers.TryParseValue<QualificationExternalExternalValue>(ref reader, out result);
        }
...
#if NET
        static QualificationExternalExternalValue IJsonElement<QualificationExternalExternalValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"QualificationExternalExternalValue: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public QualificationExternalExternalValue Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public QualificationExternalExternalValue Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<QualificationExternalExternalValue>(_idx);
            }
