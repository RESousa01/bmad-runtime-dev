...
public readonly partial struct GeneratorQualification
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratorQualificationCountVariant"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GeneratorQualificationCountVariant(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GeneratorQualificationCountVariant DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.JsonInteger Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Sapphirus.GeneratorQualification.Generated.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.KindEntity Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationCountVariant.KindEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GeneratorQualificationCountVariant left, in GeneratorQualificationCountVariant right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GeneratorQualificationCountVariant left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GeneratorQualificationCountVariant instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GeneratorQualificationCountVariant(JsonElement instance)
        {
            return GeneratorQualificationCountVariant.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationCountVariant From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationCountVariant ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationCountVariant>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationCountVariant ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationCountVariant>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationCountVariant ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationCountVariant>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static GeneratorQualificationCountVariant ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<GeneratorQualificationCountVariant>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GeneratorQualificationCountVariant? result)
        {
            return JsonElementHelpers.TryParseValue<GeneratorQualificationCountVariant>(ref reader, out result);
        }
...
#if NET
        static GeneratorQualificationCountVariant IJsonElement<GeneratorQualificationCountVariant>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GeneratorQualificationCountVariant: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationCountVariant Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationCountVariant Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GeneratorQualificationCountVariant>(_idx);
            }
