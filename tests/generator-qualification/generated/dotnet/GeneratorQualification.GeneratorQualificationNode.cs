...
public readonly partial struct GeneratorQualification
{
    ...
    public readonly partial struct GeneratorQualificationNode
        ...
        : IJsonElement<GeneratorQualificationNode>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratorQualificationNode"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GeneratorQualificationNode(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GeneratorQualificationNode DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationNode.NextEntity Next
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextUtf8, out Sapphirus.GeneratorQualification.Generated.GeneratorQualification.GeneratorQualificationNode.NextEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.GeneratorQualification.Generated.JsonString Value
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Sapphirus.GeneratorQualification.Generated.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GeneratorQualificationNode left, in GeneratorQualificationNode right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GeneratorQualificationNode left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GeneratorQualificationNode instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GeneratorQualificationNode(JsonElement instance)
        {
            return GeneratorQualificationNode.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationNode From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationNode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeneratorQualificationNode>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationNode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeneratorQualificationNode>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeneratorQualificationNode ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeneratorQualificationNode>(json, options);
        }
        ...
        /// </exception>
        public static GeneratorQualificationNode ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GeneratorQualificationNode>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GeneratorQualificationNode? result)
        {
            return JsonElementHelpers.TryParseValue<GeneratorQualificationNode>(ref reader, out result);
        }
...
#if NET
        static GeneratorQualificationNode IJsonElement<GeneratorQualificationNode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GeneratorQualificationNode: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationNode Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GeneratorQualificationNode Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GeneratorQualificationNode>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Next"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Next"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Next => [0x65, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x65, 0x78, 0x74, 0x22];
