    ...
    public readonly partial struct OneOf0Entity
    {
        ...
        public readonly partial struct UnsignedValueEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UnsignedValueEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UnsignedValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UnsignedValueEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UnsignedValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UnsignedValueEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UnsignedValueEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UnsignedValueEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UnsignedValueEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UnsignedValueEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UnsignedValueEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UnsignedValueEntity>();
                }
                finally
                {
