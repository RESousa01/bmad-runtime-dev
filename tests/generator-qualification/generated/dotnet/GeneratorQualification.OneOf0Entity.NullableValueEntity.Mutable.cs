    ...
    public readonly partial struct OneOf0Entity
    {
        ...
        public readonly partial struct NullableValueEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NullableValueEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NullableValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NullableValueEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NullableValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NullableValueEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NullableValueEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NullableValueEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NullableValueEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NullableValueEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NullableValueEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NullableValueEntity>();
                }
                finally
                {
