    ...
    public readonly partial struct OneOf1Entity
    {
        ...
        public readonly partial struct OptionalValueEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionalValueEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionalValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionalValueEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionalValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalValueEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalValueEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionalValueEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OptionalValueEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OptionalValueEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OptionalValueEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalValueEntity>();
                }
                finally
                {
