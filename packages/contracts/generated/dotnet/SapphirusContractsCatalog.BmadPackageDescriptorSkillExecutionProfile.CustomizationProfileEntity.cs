...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct CustomizationProfileEntity
#if NET8_0_OR_GREATER
            : IJsonElement<CustomizationProfileEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CustomizationProfileEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CustomizationProfileEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CustomizationProfileEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CustomizationProfileEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CustomizationProfileEntity left, in CustomizationProfileEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CustomizationProfileEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CustomizationProfileEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomizationProfileEntity(JsonElement instance)
            {
                return CustomizationProfileEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomizationProfileEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomizationProfileEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomizationProfileEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomizationProfileEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomizationProfileEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomizationProfileEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomizationProfileEntity>(json, options);
            }
            ...
            /// </exception>
            public static CustomizationProfileEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CustomizationProfileEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CustomizationProfileEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CustomizationProfileEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CustomizationProfileEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CustomizationProfileEntity IJsonElement<CustomizationProfileEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomizationProfileEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CustomizationProfileEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CustomizationProfileEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CustomizationProfileEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CustomizationProfileEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CustomizationProfileEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CustomizationProfileEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CustomizationProfileEntity>(_idx);
                }
            ...
            /// <param name="matchMethodSkillToml">Match 2nd item.</param>
            /// <param name="matchMethodAgentToml">Match 3rd item.</param>
            /// <param name="matchBuilderAgentToml">Match 4th item.</param>
            /// <param name="matchBuilderWorkflowToml">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNone,
                Func<TContext, TResult> matchMethodSkillToml,
                Func<TContext, TResult> matchMethodAgentToml,
                Func<TContext, TResult> matchBuilderAgentToml,
                Func<TContext, TResult> matchBuilderWorkflowToml,
...
#endif
            {
                ...
                {
                    return matchMethodSkillToml(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchMethodAgentToml(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchBuilderAgentToml(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchBuilderWorkflowToml(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchMethodSkillToml,
                Func<TResult> matchMethodAgentToml,
                Func<TResult> matchBuilderAgentToml,
                Func<TResult> matchBuilderWorkflowToml,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchMethodSkillToml();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchMethodAgentToml();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchBuilderAgentToml();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchBuilderWorkflowToml();
                }
