...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshotCapabilityStatus
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FilesystemCapabilitySnapshotCapabilityStatus instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FilesystemCapabilitySnapshotCapabilityStatus(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FilesystemCapabilitySnapshotCapabilityStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FilesystemCapabilitySnapshotCapabilityStatus Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FilesystemCapabilitySnapshotCapabilityStatus Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FilesystemCapabilitySnapshotCapabilityStatus>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FilesystemCapabilitySnapshotCapabilityStatus instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FilesystemCapabilitySnapshotCapabilityStatus, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FilesystemCapabilitySnapshotCapabilityStatus> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FilesystemCapabilitySnapshotCapabilityStatus>();
            }
            finally
            {
