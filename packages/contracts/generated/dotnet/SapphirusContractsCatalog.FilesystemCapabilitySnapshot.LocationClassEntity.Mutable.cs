    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct LocationClassEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LocationClassEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LocationClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LocationClassEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LocationClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LocationClassEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LocationClassEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LocationClassEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LocationClassEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LocationClassEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LocationClassEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocationClassEntity>();
                }
                finally
                {
