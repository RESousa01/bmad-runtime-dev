        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct SubjectIdEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SubjectIdEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SubjectIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SubjectIdEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SubjectIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SubjectIdEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SubjectIdEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SubjectIdEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SubjectIdEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SubjectIdEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SubjectIdEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SubjectIdEntity>();
                    }
                    finally
                    {
