        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct OutputLocationEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OutputLocationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OutputLocationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OutputLocationEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OutputLocationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OutputLocationEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OutputLocationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OutputLocationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OutputLocationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OutputLocationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OutputLocationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OutputLocationEntity>();
                    }
                    finally
                    {
