    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct RuntimeUseEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RuntimeUseEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RuntimeUseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RuntimeUseEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RuntimeUseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RuntimeUseEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RuntimeUseEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RuntimeUseEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RuntimeUseEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RuntimeUseEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RuntimeUseEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RuntimeUseEntity>();
                }
                finally
                {
