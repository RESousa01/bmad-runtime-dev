    ...
    public readonly partial struct ModelContextConsentInstallationProof
    {
        ...
        public readonly partial struct ProofTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProofTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProofTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProofTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProofTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProofTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProofTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProofTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProofTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProofTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProofTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProofTypeEntity>();
                }
                finally
                {
