...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalogInstalledSkillRecord
    {
        ...
        public readonly partial struct CapabilityKeysArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CapabilityKeysArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CapabilityKeysArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CapabilityKeysArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CapabilityKeysArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CapabilityKeysArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="CapabilityKeysArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CapabilityKeysArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CapabilityKeysArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CapabilityKeysArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CapabilityKeysArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CapabilityKeysArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CapabilityKeysArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogInstalledSkillRecord.CapabilityKeysArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CapabilityKeysArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogInstalledSkillRecord.CapabilityKeysArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<CapabilityKeysArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CapabilityKeysArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CapabilityKeysArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CapabilityKeysArray> Create<TContext>(
