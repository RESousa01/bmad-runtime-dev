    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct UpstreamLocatorEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UpstreamLocatorEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UpstreamLocatorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UpstreamLocatorEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UpstreamLocatorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UpstreamLocatorEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UpstreamLocatorEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UpstreamLocatorEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UpstreamLocatorEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UpstreamLocatorEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UpstreamLocatorEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UpstreamLocatorEntity>();
                }
                finally
                {
