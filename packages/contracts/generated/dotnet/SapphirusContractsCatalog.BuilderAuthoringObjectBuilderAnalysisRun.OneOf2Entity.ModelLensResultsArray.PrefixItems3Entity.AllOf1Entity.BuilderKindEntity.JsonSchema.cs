                    ...
                    public readonly partial struct AllOf1Entity
                    {
                            ...
                            : IJsonElement<BuilderKindEntity>
                        {
                            ...
                            private static class Constants
                            {
                                ...
                                /// </summary>
                                public static readonly byte[] Const = "workflow"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>const</c> keyword.
                                /// </summary>
                                public static readonly BuilderKindEntity ConstJson = ParsedJsonDocument<BuilderKindEntity>.StringConstant([.."\"workflow\""u8]);
                            }
                            ...
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/3/allOf/1/properties/builderKind"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/3/allOf/1/properties/builderKind";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/3/allOf/1/properties/builderKind"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "workflow"u8, "workflow", "const"u8, ref context);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeyword(false, "workflow", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                                    }
                                }
