...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadDistributionProfile
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadPackageDescriptorBmadDistributionProfile instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadPackageDescriptorBmadDistributionProfile"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadPackageDescriptorBmadDistributionProfile(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadPackageDescriptorBmadDistributionProfile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadDistributionProfile Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadDistributionProfile Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadPackageDescriptorBmadDistributionProfile>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadPackageDescriptorBmadDistributionProfile instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadPackageDescriptorBmadDistributionProfile, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadPackageDescriptorBmadDistributionProfile> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadPackageDescriptorBmadDistributionProfile>();
            }
            finally
            {
