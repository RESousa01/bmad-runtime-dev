            ...
            public readonly partial struct DeferredEntity
            {
                ...
                public readonly partial struct RevisitConditionEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RevisitConditionEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RevisitConditionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RevisitConditionEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RevisitConditionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RevisitConditionEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RevisitConditionEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RevisitConditionEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RevisitConditionEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RevisitConditionEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RevisitConditionEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RevisitConditionEntity>();
                        }
                        finally
                        {
