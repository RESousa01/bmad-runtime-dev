        ...
        public readonly partial struct MergeSemanticsEntity
        {
            ...
            public readonly partial struct TableRuleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TableRuleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TableRuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TableRuleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TableRuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TableRuleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TableRuleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TableRuleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TableRuleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TableRuleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TableRuleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TableRuleEntity>();
                    }
                    finally
                    {
