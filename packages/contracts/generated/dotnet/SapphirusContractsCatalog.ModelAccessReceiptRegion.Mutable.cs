...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessReceiptRegion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelAccessReceiptRegion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelAccessReceiptRegion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelAccessReceiptRegion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelAccessReceiptRegion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptRegion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptRegion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelAccessReceiptRegion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelAccessReceiptRegion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelAccessReceiptRegion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelAccessReceiptRegion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelAccessReceiptRegion>();
            }
            finally
            {
