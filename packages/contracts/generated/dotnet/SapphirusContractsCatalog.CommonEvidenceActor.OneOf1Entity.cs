...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonEvidenceActor
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity ActorKind
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActorKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity ServiceId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceIdUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="ActorKind"/>.
                /// </summary>
                public const string ActorKind = "actorKind";

                /// <summary>
                /// Gets the JSON property name for <see cref="ServiceId"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="ActorKind"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ActorKindUtf8 => "actorKind"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="ServiceId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ServiceIdUtf8 => "serviceId"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ActorKind"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ActorKind => "actorKind"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ServiceId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ServiceId => "serviceId"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="ActorKind"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ActorKind => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x63, 0x74, 0x6F, 0x72, 0x4B, 0x69, 0x6E, 0x64, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="ServiceId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ServiceId => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22];
            }
        }
    }
}
