        ...
        public readonly partial struct EnvelopeEntity
        {
                ...
                : IJsonElement<DeliveryModelEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "web_managed"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly DeliveryModelEntity ConstJson = ParsedJsonDocument<DeliveryModelEntity>.StringConstant([.."\"web_managed\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DurableObjectWebManagedObject/properties/envelope/properties/deliveryModel"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/DurableObjectWebManagedObject/properties/envelope/properties/deliveryModel";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DurableObjectWebManagedObject/properties/envelope/properties/deliveryModel"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "web_managed"u8, "web_managed", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "web_managed", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
