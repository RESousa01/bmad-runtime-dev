    ...
    public readonly partial struct BuilderAuthoringObjectBuilderProposedFileSet
    {
        ...
        public readonly partial struct LimitProfileEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LimitProfileEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LimitProfileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LimitProfileEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LimitProfileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LimitProfileEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LimitProfileEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LimitProfileEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LimitProfileEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LimitProfileEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LimitProfileEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LimitProfileEntity>();
                }
                finally
                {
