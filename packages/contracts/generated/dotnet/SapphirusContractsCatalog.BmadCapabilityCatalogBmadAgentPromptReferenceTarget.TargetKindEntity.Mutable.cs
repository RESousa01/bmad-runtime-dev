    ...
    public readonly partial struct BmadCapabilityCatalogBmadAgentPromptReferenceTarget
    {
        ...
        public readonly partial struct TargetKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TargetKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TargetKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TargetKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TargetKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TargetKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TargetKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TargetKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TargetKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TargetKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TargetKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TargetKindEntity>();
                }
                finally
                {
