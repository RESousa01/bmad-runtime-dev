    ...
    public readonly partial struct ModelAccessRequest
    {
        ...
        public readonly partial struct ModelRoleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ModelRoleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ModelRoleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ModelRoleEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ModelRoleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ModelRoleEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ModelRoleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ModelRoleEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ModelRoleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ModelRoleEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ModelRoleEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ModelRoleEntity>();
                }
                finally
                {
