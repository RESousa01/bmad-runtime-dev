    ...
    public readonly partial struct MethodHelpProposal
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForProposalKind = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForProposalKind | RequiredBitForReasonCode;
                ...
                private static void MatchProposalKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf1Entity.ProposalKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf1Entity.ProposalKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchReasonCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf1Entity.ReasonCodeEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf1Entity.ReasonCodeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodHelpProposal/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodHelpProposal/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodHelpProposal/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyProposalKindPresent, "proposalKind"u8, "required"u8);
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyProposalKindNotPresent, "proposalKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyProposalKindPresent, "proposalKind"u8, "required"u8);
