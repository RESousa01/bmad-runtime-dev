...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationDisposition
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct BlockingFindingIdsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(BlockingFindingIdsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BlockingFindingIdsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BlockingFindingIdsArray(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new BlockingFindingIdsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BlockingFindingIdsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// <summary>
                    /// Gets a <see cref="BlockingFindingIdsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="BlockingFindingIdsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlockingFindingIdsArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<BlockingFindingIdsArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="BlockingFindingIdsArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlockingFindingIdsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BlockingFindingIdsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.BlockingFindingIdsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(BlockingFindingIdsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.BlockingFindingIdsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<BlockingFindingIdsArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<BlockingFindingIdsArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BlockingFindingIdsArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<BlockingFindingIdsArray> Create<TContext>(
