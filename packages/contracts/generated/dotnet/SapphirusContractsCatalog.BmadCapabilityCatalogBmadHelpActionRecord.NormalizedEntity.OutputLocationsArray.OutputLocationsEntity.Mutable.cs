            ...
            public readonly partial struct OutputLocationsArray
            {
                ...
                public readonly partial struct OutputLocationsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(OutputLocationsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="OutputLocationsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator OutputLocationsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"OutputLocationsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly OutputLocationsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly OutputLocationsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<OutputLocationsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(OutputLocationsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<OutputLocationsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<OutputLocationsEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<OutputLocationsEntity>();
                        }
                        finally
                        {
