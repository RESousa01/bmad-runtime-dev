...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BuilderAuthoringObjectBuilderAnalysisRun
    {
        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct ModelLensesNotPerformedReasonEntity
#if NET8_0_OR_GREATER
                : IJsonElement<ModelLensesNotPerformedReasonEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ModelLensesNotPerformedReasonEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ModelLensesNotPerformedReasonEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ModelLensesNotPerformedReasonEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ModelLensesNotPerformedReasonEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ModelLensesNotPerformedReasonEntity left, in ModelLensesNotPerformedReasonEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ModelLensesNotPerformedReasonEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ModelLensesNotPerformedReasonEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ModelLensesNotPerformedReasonEntity(JsonElement instance)
                {
                    return ModelLensesNotPerformedReasonEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ModelLensesNotPerformedReasonEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ModelLensesNotPerformedReasonEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ModelLensesNotPerformedReasonEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ModelLensesNotPerformedReasonEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ModelLensesNotPerformedReasonEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ModelLensesNotPerformedReasonEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ModelLensesNotPerformedReasonEntity>(json, options);
                }
                ...
                /// </exception>
                public static ModelLensesNotPerformedReasonEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ModelLensesNotPerformedReasonEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ModelLensesNotPerformedReasonEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ModelLensesNotPerformedReasonEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ModelLensesNotPerformedReasonEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ModelLensesNotPerformedReasonEntity IJsonElement<ModelLensesNotPerformedReasonEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ModelLensesNotPerformedReasonEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ModelLensesNotPerformedReasonEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ModelLensesNotPerformedReasonEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ModelLensesNotPerformedReasonEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ModelLensesNotPerformedReasonEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ModelLensesNotPerformedReasonEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ModelLensesNotPerformedReasonEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ModelLensesNotPerformedReasonEntity>(_idx);
                    }
                ...
                /// <param name="matchNotRequested">Match 1st item.</param>
                /// <param name="matchConsentAbsent">Match 2nd item.</param>
                /// <param name="matchConnectivityAbsent">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchNotRequested,
                    Func<TContext, TResult> matchConsentAbsent,
                    Func<TContext, TResult> matchConnectivityAbsent,
...
#endif
                {
                    ...
                    {
                        return matchNotRequested(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchConsentAbsent(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchConnectivityAbsent(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchNotRequested,
                    Func<TResult> matchConsentAbsent,
                    Func<TResult> matchConnectivityAbsent,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchNotRequested();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchConsentAbsent();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchConnectivityAbsent();
                    }
