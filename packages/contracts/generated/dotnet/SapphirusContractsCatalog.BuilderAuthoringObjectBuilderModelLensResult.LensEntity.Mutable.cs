    ...
    public readonly partial struct BuilderAuthoringObjectBuilderModelLensResult
    {
        ...
        public readonly partial struct LensEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LensEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LensEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LensEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LensEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LensEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LensEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LensEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LensEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LensEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LensEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LensEntity>();
                }
                finally
                {
