    ...
    public readonly partial struct CommonDesktopLocalStoreAuthorityRef
    {
            ...
            : IJsonElement<AuthorityKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "desktop_local_store"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly AuthorityKindEntity ConstJson = ParsedJsonDocument<AuthorityKindEntity>.StringConstant([.."\"desktop_local_store\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonDesktopLocalStoreAuthorityRef/properties/authorityKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonDesktopLocalStoreAuthorityRef/properties/authorityKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonDesktopLocalStoreAuthorityRef/properties/authorityKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "desktop_local_store"u8, "desktop_local_store", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "desktop_local_store", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
