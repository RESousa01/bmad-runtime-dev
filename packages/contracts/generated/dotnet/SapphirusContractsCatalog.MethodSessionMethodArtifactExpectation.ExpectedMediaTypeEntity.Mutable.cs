    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct ExpectedMediaTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpectedMediaTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpectedMediaTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpectedMediaTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpectedMediaTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectedMediaTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectedMediaTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpectedMediaTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpectedMediaTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpectedMediaTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpectedMediaTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpectedMediaTypeEntity>();
                }
                finally
                {
