...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessReceiptCanonicalSchemaId
#if NET8_0_OR_GREATER
        : IJsonElement<ModelAccessReceiptCanonicalSchemaId>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelAccessReceiptCanonicalSchemaId"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModelAccessReceiptCanonicalSchemaId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModelAccessReceiptCanonicalSchemaId DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ModelAccessReceiptCanonicalSchemaId value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ModelAccessReceiptCanonicalSchemaId left, in ModelAccessReceiptCanonicalSchemaId right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModelAccessReceiptCanonicalSchemaId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ModelAccessReceiptCanonicalSchemaId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModelAccessReceiptCanonicalSchemaId(JsonElement instance)
        {
            return ModelAccessReceiptCanonicalSchemaId.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptCanonicalSchemaId From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptCanonicalSchemaId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptCanonicalSchemaId>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptCanonicalSchemaId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptCanonicalSchemaId>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptCanonicalSchemaId ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptCanonicalSchemaId>(json, options);
        }
        ...
        /// </exception>
        public static ModelAccessReceiptCanonicalSchemaId ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptCanonicalSchemaId>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModelAccessReceiptCanonicalSchemaId? result)
        {
            return JsonElementHelpers.TryParseValue<ModelAccessReceiptCanonicalSchemaId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ModelAccessReceiptCanonicalSchemaId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ModelAccessReceiptCanonicalSchemaId IJsonElement<ModelAccessReceiptCanonicalSchemaId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModelAccessReceiptCanonicalSchemaId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ModelAccessReceiptCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ModelAccessReceiptCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ModelAccessReceiptCanonicalSchemaId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ModelAccessReceiptCanonicalSchemaId>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ModelAccessReceiptCanonicalSchemaId"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ModelAccessReceiptCanonicalSchemaId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModelAccessReceiptCanonicalSchemaId>(_idx);
            }
