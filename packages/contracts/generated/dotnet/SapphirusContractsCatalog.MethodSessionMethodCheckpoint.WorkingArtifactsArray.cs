...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionMethodCheckpoint
    {
        ...
        public readonly partial struct WorkingArtifactsArray
            ...
            : IJsonElement<WorkingArtifactsArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WorkingArtifactsArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WorkingArtifactsArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WorkingArtifactsArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in WorkingArtifactsArray left, in WorkingArtifactsArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WorkingArtifactsArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(WorkingArtifactsArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WorkingArtifactsArray(JsonElement instance)
            {
                return WorkingArtifactsArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WorkingArtifactsArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WorkingArtifactsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WorkingArtifactsArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WorkingArtifactsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WorkingArtifactsArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WorkingArtifactsArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WorkingArtifactsArray>(json, options);
            }
            ...
            /// </exception>
            public static WorkingArtifactsArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WorkingArtifactsArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WorkingArtifactsArray? result)
            {
                return JsonElementHelpers.TryParseValue<WorkingArtifactsArray>(ref reader, out result);
            }
...
#if NET
            static WorkingArtifactsArray IJsonElement<WorkingArtifactsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WorkingArtifactsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public WorkingArtifactsArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public WorkingArtifactsArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WorkingArtifactsArray>(_idx);
                }
