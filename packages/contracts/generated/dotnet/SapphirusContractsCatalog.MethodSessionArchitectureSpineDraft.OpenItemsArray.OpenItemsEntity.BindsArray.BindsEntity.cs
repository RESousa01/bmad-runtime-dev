        ...
        public readonly partial struct OpenItemsArray
        {
            ...
            public readonly partial struct OpenItemsEntity
            {
                ...
                public readonly partial struct BindsArray
                {
                    ...
                    public readonly partial struct BindsEntity
#if NET8_0_OR_GREATER
                        : IJsonElement<BindsEntity>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="BindsEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal BindsEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static BindsEntity DefaultInstance { get; }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static explicit operator string(BindsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                        ...
                        /// </returns>
                        public static bool operator ==(in BindsEntity left, in BindsEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in BindsEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(BindsEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator BindsEntity(JsonElement instance)
                        {
                            return BindsEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static BindsEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static BindsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<BindsEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static BindsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<BindsEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static BindsEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<BindsEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static BindsEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<BindsEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out BindsEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<BindsEntity>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new BindsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static BindsEntity IJsonElement<BindsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"BindsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="BindsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="BindsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public BindsEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<BindsEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="BindsEntity"/> that lives for the lifetime of its
