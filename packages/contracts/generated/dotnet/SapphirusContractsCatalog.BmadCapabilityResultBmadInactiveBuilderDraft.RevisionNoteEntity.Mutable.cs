    ...
    public readonly partial struct BmadCapabilityResultBmadInactiveBuilderDraft
    {
        ...
        public readonly partial struct RevisionNoteEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RevisionNoteEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RevisionNoteEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RevisionNoteEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RevisionNoteEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RevisionNoteEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RevisionNoteEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RevisionNoteEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RevisionNoteEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RevisionNoteEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RevisionNoteEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RevisionNoteEntity>();
                }
                finally
                {
