    ...
    public readonly partial struct CommonAzureControlPlaneAuthorityRef
    {
        ...
        public readonly partial struct AuthorityKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AuthorityKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AuthorityKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AuthorityKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AuthorityKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorityKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorityKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AuthorityKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AuthorityKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AuthorityKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AuthorityKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AuthorityKindEntity>();
                }
                finally
                {
