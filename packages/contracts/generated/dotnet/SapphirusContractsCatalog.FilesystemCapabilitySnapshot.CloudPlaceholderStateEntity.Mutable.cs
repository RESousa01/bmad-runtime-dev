    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct CloudPlaceholderStateEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CloudPlaceholderStateEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CloudPlaceholderStateEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CloudPlaceholderStateEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CloudPlaceholderStateEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CloudPlaceholderStateEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CloudPlaceholderStateEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CloudPlaceholderStateEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CloudPlaceholderStateEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CloudPlaceholderStateEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CloudPlaceholderStateEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CloudPlaceholderStateEntity>();
                }
                finally
                {
