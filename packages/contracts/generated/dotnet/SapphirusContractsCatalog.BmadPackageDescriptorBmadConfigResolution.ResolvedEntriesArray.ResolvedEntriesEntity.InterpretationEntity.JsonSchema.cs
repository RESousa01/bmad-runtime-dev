            ...
            public readonly partial struct ResolvedEntriesEntity
            {
                    ...
                    : IJsonElement<InterpretationEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Enum1 = "known_untrusted"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly InterpretationEntity EnumJson1 = ParsedJsonDocument<InterpretationEntity>.StringConstant([.."\"known_untrusted\""u8]);
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly byte[] Enum2 = "unknown_untrusted"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly InterpretationEntity EnumJson2 = ParsedJsonDocument<InterpretationEntity>.StringConstant([.."\"unknown_untrusted\""u8]);
                    }
                    ...
                    {
                        /// <summary>
                        /// Gets the string "known_untrusted"
                        /// as a <see cref="InterpretationEntity"/>.
                        /// </summary>
                        public static InterpretationEntity KnownUntrusted { get; } = Constants.EnumJson1;
                        /// <summary>
                        /// Gets the string "known_untrusted"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> KnownUntrustedUtf8 => Constants.Enum1;

                        /// <summary>
                        /// Gets the string "unknown_untrusted"
                        /// as a <see cref="InterpretationEntity"/>.
                        /// </summary>
                        public static InterpretationEntity UnknownUntrusted { get; } = Constants.EnumJson2;
                        /// <summary>
                        /// Gets the string "unknown_untrusted"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> UnknownUntrustedUtf8 => Constants.Enum2;
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigResolution/properties/resolvedEntries/items/properties/interpretation"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigResolution/properties/resolvedEntries/items/properties/interpretation";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigResolution/properties/resolvedEntries/items/properties/interpretation"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                if (unescapedUtf8JsonString.Span.SequenceEqual("known_untrusted"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }

                                if (unescapedUtf8JsonString.Span.SequenceEqual("unknown_untrusted"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }
                            }
