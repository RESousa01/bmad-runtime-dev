    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
            ...
            : IJsonElement<AvailabilityEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AvailabilityEntity EnumJson1 = ParsedJsonDocument<AvailabilityEntity>.StringConstant([.."\"available\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "unavailable"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AvailabilityEntity EnumJson2 = ParsedJsonDocument<AvailabilityEntity>.StringConstant([.."\"unavailable\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "ambiguous"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AvailabilityEntity EnumJson3 = ParsedJsonDocument<AvailabilityEntity>.StringConstant([.."\"ambiguous\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// </summary>
                public static AvailabilityEntity Available { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "available"
                ...
                /// <summary>
                /// Gets the string "unavailable"
                /// as a <see cref="AvailabilityEntity"/>.
                /// </summary>
                public static AvailabilityEntity Unavailable { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "unavailable"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> UnavailableUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "ambiguous"
                /// as a <see cref="AvailabilityEntity"/>.
                /// </summary>
                public static AvailabilityEntity Ambiguous { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "ambiguous"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> AmbiguousUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDependency/properties/availability"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDependency/properties/availability";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDependency/properties/availability"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("unavailable"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("ambiguous"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
