...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<FilesystemCapabilitySnapshotCapabilityStatus>
    {
        ...
        private static class Constants
        {
            ...
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly FilesystemCapabilitySnapshotCapabilityStatus EnumJson1 = ParsedJsonDocument<FilesystemCapabilitySnapshotCapabilityStatus>.StringConstant([.."\"verified\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "unsupported"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly FilesystemCapabilitySnapshotCapabilityStatus EnumJson2 = ParsedJsonDocument<FilesystemCapabilitySnapshotCapabilityStatus>.StringConstant([.."\"unsupported\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum3 = "unknown"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly FilesystemCapabilitySnapshotCapabilityStatus EnumJson3 = ParsedJsonDocument<FilesystemCapabilitySnapshotCapabilityStatus>.StringConstant([.."\"unknown\""u8]);
        }
        ...
        public static class EnumValues
        {
            ...
            /// as a <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/>.
            /// </summary>
            public static FilesystemCapabilitySnapshotCapabilityStatus Verified { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "verified"
            ...
            /// <summary>
            /// Gets the string "unsupported"
            /// as a <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/>.
            /// </summary>
            public static FilesystemCapabilitySnapshotCapabilityStatus Unsupported { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "unsupported"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> UnsupportedUtf8 => Constants.Enum2;

            /// <summary>
            /// Gets the string "unknown"
            /// as a <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/>.
            /// </summary>
            public static FilesystemCapabilitySnapshotCapabilityStatus Unknown { get; } = Constants.EnumJson3;
            /// <summary>
            /// Gets the string "unknown"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> UnknownUtf8 => Constants.Enum3;
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/FilesystemCapabilitySnapshotCapabilityStatus"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/FilesystemCapabilitySnapshotCapabilityStatus";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/FilesystemCapabilitySnapshotCapabilityStatus"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("unsupported"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("unknown"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
                }
