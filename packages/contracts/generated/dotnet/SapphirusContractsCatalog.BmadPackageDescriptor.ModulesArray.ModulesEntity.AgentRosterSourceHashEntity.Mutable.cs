            ...
            public readonly partial struct ModulesEntity
            {
                ...
                public readonly partial struct AgentRosterSourceHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AgentRosterSourceHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AgentRosterSourceHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AgentRosterSourceHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AgentRosterSourceHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AgentRosterSourceHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AgentRosterSourceHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AgentRosterSourceHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ModulesArray.ModulesEntity.AgentRosterSourceHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ModulesArray.ModulesEntity.AgentRosterSourceHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AgentRosterSourceHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<AgentRosterSourceHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AgentRosterSourceHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AgentRosterSourceHashEntity>();
                        }
                        finally
                        {
