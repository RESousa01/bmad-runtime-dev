...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityRunBmadClosureCapabilityId
#if NET8_0_OR_GREATER
        : IJsonElement<BmadCapabilityRunBmadClosureCapabilityId>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadCapabilityRunBmadClosureCapabilityId"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadCapabilityRunBmadClosureCapabilityId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadCapabilityRunBmadClosureCapabilityId DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadCapabilityRunBmadClosureCapabilityId value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadCapabilityRunBmadClosureCapabilityId left, in BmadCapabilityRunBmadClosureCapabilityId right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadCapabilityRunBmadClosureCapabilityId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadCapabilityRunBmadClosureCapabilityId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadCapabilityRunBmadClosureCapabilityId(JsonElement instance)
        {
            return BmadCapabilityRunBmadClosureCapabilityId.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityRunBmadClosureCapabilityId From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityRunBmadClosureCapabilityId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityRunBmadClosureCapabilityId>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityRunBmadClosureCapabilityId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityRunBmadClosureCapabilityId>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityRunBmadClosureCapabilityId ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityRunBmadClosureCapabilityId>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BmadCapabilityRunBmadClosureCapabilityId ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityRunBmadClosureCapabilityId>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadCapabilityRunBmadClosureCapabilityId? result)
        {
            return JsonElementHelpers.TryParseValue<BmadCapabilityRunBmadClosureCapabilityId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadCapabilityRunBmadClosureCapabilityId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadCapabilityRunBmadClosureCapabilityId IJsonElement<BmadCapabilityRunBmadClosureCapabilityId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadCapabilityRunBmadClosureCapabilityId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadCapabilityRunBmadClosureCapabilityId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadCapabilityRunBmadClosureCapabilityId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityRunBmadClosureCapabilityId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadCapabilityRunBmadClosureCapabilityId>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadCapabilityRunBmadClosureCapabilityId"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityRunBmadClosureCapabilityId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadCapabilityRunBmadClosureCapabilityId>(_idx);
            }
