                    ...
                    public readonly partial struct LensResultsEntity
                    {
                            ...
                            : IJsonElement<LensEntity>
                        {
                            ...
                            private static class Constants
                            {
                                ...
                                /// </summary>
                                public static readonly byte[] Enum1 = "good_spine"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>enum</c> keyword.
                                /// </summary>
                                public static readonly LensEntity EnumJson1 = ParsedJsonDocument<LensEntity>.StringConstant([.."\"good_spine\""u8]);
                                /// <summary>
                                /// A constant for the <c>enum</c> keyword.
                                /// </summary>
                                public static readonly byte[] Enum2 = "current_technology_evidence"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>enum</c> keyword.
                                /// </summary>
                                public static readonly LensEntity EnumJson2 = ParsedJsonDocument<LensEntity>.StringConstant([.."\"current_technology_evidence\""u8]);
                                /// <summary>
                                /// A constant for the <c>enum</c> keyword.
                                /// </summary>
                                public static readonly byte[] Enum3 = "cross_unit_divergence"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>enum</c> keyword.
                                /// </summary>
                                public static readonly LensEntity EnumJson3 = ParsedJsonDocument<LensEntity>.StringConstant([.."\"cross_unit_divergence\""u8]);
                            }
                            ...
                            {
                                /// <summary>
                                /// Gets the string "good_spine"
                                /// as a <see cref="LensEntity"/>.
                                /// </summary>
                                public static LensEntity GoodSpine { get; } = Constants.EnumJson1;
                                /// <summary>
                                /// Gets the string "good_spine"
                                /// as a UTF8 byte array.
                                /// </summary>
                                public static ReadOnlySpan<byte> GoodSpineUtf8 => Constants.Enum1;

                                /// <summary>
                                /// Gets the string "current_technology_evidence"
                                /// as a <see cref="LensEntity"/>.
                                /// </summary>
                                public static LensEntity CurrentTechnologyEvidence { get; } = Constants.EnumJson2;
                                /// <summary>
                                /// Gets the string "current_technology_evidence"
                                /// as a UTF8 byte array.
                                /// </summary>
                                public static ReadOnlySpan<byte> CurrentTechnologyEvidenceUtf8 => Constants.Enum2;

                                /// <summary>
                                /// Gets the string "cross_unit_divergence"
                                /// as a <see cref="LensEntity"/>.
                                /// </summary>
                                public static LensEntity CrossUnitDivergence { get; } = Constants.EnumJson3;
                                /// <summary>
                                /// Gets the string "cross_unit_divergence"
                                /// as a UTF8 byte array.
                                /// </summary>
                                public static ReadOnlySpan<byte> CrossUnitDivergenceUtf8 => Constants.Enum3;
                            }
                            ...
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/0/properties/lensResults/items/properties/lens"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/0/properties/lensResults/items/properties/lens";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/0/properties/lensResults/items/properties/lens"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        if (unescapedUtf8JsonString.Span.SequenceEqual("good_spine"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("current_technology_evidence"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("cross_unit_divergence"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }
                                    }
