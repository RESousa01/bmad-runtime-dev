        ...
        public readonly partial struct SignatureEntity
        {
            ...
            public readonly partial struct SignatureEntity2
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SignatureEntity2 instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SignatureEntity2"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SignatureEntity2(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SignatureEntity2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SignatureEntity2 Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SignatureEntity2 Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SignatureEntity2>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SignatureEntity2 instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SignatureEntity2, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SignatureEntity2> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SignatureEntity2>();
                    }
                    finally
                    {
