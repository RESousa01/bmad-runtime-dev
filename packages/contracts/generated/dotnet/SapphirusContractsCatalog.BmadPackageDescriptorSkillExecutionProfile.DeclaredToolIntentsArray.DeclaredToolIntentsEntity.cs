    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct DeclaredToolIntentsArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DeclaredToolIntentsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DeclaredToolIntentsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DeclaredToolIntentsEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(DeclaredToolIntentsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in DeclaredToolIntentsEntity left, in DeclaredToolIntentsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DeclaredToolIntentsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DeclaredToolIntentsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeclaredToolIntentsEntity(JsonElement instance)
                {
                    return DeclaredToolIntentsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredToolIntentsEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredToolIntentsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DeclaredToolIntentsEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredToolIntentsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DeclaredToolIntentsEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredToolIntentsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DeclaredToolIntentsEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static DeclaredToolIntentsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DeclaredToolIntentsEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DeclaredToolIntentsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<DeclaredToolIntentsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DeclaredToolIntentsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DeclaredToolIntentsEntity IJsonElement<DeclaredToolIntentsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeclaredToolIntentsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DeclaredToolIntentsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DeclaredToolIntentsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DeclaredToolIntentsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DeclaredToolIntentsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DeclaredToolIntentsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DeclaredToolIntentsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DeclaredToolIntentsEntity>(_idx);
                    }
                ...
                /// <param name="matchFileRead">Match 1st item.</param>
                /// <param name="matchFileWrite">Match 2nd item.</param>
                /// <param name="matchProcess">Match 3rd item.</param>
                /// <param name="matchWeb">Match 4th item.</param>
                /// <param name="matchSubagent">Match 5th item.</param>
                /// <param name="matchBrowser">Match 6th item.</param>
                /// <param name="matchExternalHandoff">Match 7th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchFileRead,
                    Func<TContext, TResult> matchFileWrite,
                    Func<TContext, TResult> matchProcess,
                    Func<TContext, TResult> matchWeb,
                    Func<TContext, TResult> matchSubagent,
                    Func<TContext, TResult> matchBrowser,
                    Func<TContext, TResult> matchExternalHandoff,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchFileRead,
                    Func<TResult> matchFileWrite,
                    Func<TResult> matchProcess,
                    Func<TResult> matchWeb,
                    Func<TResult> matchSubagent,
                    Func<TResult> matchBrowser,
                    Func<TResult> matchExternalHandoff,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchFileRead();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchFileWrite();
                    }
