    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct PreviousEventHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PreviousEventHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PreviousEventHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PreviousEventHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PreviousEventHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PreviousEventHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PreviousEventHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PreviousEventHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.PreviousEventHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.PreviousEventHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PreviousEventHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PreviousEventHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PreviousEventHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PreviousEventHashEntity>();
                }
                finally
                {
