...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DesktopPolicyRegion
#if NET8_0_OR_GREATER
        : IJsonElement<DesktopPolicyRegion>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DesktopPolicyRegion"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DesktopPolicyRegion(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DesktopPolicyRegion DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(DesktopPolicyRegion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DesktopPolicyRegion left, in DesktopPolicyRegion right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DesktopPolicyRegion left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DesktopPolicyRegion instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DesktopPolicyRegion(JsonElement instance)
        {
            return DesktopPolicyRegion.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyRegion From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyRegion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DesktopPolicyRegion>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyRegion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DesktopPolicyRegion>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyRegion ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DesktopPolicyRegion>(json, options);
        }
        ...
        /// </exception>
        public static DesktopPolicyRegion ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DesktopPolicyRegion>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DesktopPolicyRegion? result)
        {
            return JsonElementHelpers.TryParseValue<DesktopPolicyRegion>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DesktopPolicyRegion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DesktopPolicyRegion IJsonElement<DesktopPolicyRegion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DesktopPolicyRegion: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DesktopPolicyRegion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DesktopPolicyRegion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DesktopPolicyRegion Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DesktopPolicyRegion>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DesktopPolicyRegion"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DesktopPolicyRegion Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DesktopPolicyRegion>(_idx);
            }
