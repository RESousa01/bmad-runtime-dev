    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
            ...
            : IJsonElement<ArtifactKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "architecture_spine_draft"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly ArtifactKindEntity ConstJson = ParsedJsonDocument<ArtifactKindEntity>.StringConstant([.."\"architecture_spine_draft\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureSpineDraft/properties/artifactKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodSessionArchitectureSpineDraft/properties/artifactKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureSpineDraft/properties/artifactKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "architecture_spine_draft"u8, "architecture_spine_draft", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "architecture_spine_draft", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
