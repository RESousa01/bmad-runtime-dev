                    ...
                    public readonly partial struct AllOf1Entity
                    {
                            ...
                            : IJsonElement<LensEntity>
                        {
                            ...
                            private static class Constants
                            {
                                ...
                                /// </summary>
                                public static readonly byte[] Const = "architecture"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>const</c> keyword.
                                /// </summary>
                                public static readonly LensEntity ConstJson = ParsedJsonDocument<LensEntity>.StringConstant([.."\"architecture\""u8]);
                            }
                            ...
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/1/allOf/1/properties/lens"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/1/allOf/1/properties/lens";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/1/allOf/1/properties/lens"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "architecture"u8, "architecture", "const"u8, ref context);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeyword(false, "architecture", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                                    }
                                }
