            ...
            public readonly partial struct OneOf1Entity
            {
                    ...
                    : IJsonElement<ModelReviewKindEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Const = "unavailable"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>const</c> keyword.
                        /// </summary>
                        public static readonly ModelReviewKindEntity ConstJson = ParsedJsonDocument<ModelReviewKindEntity>.StringConstant([.."\"unavailable\""u8]);
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/1/properties/modelReviewKind"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/1/properties/modelReviewKind";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview/oneOf/1/properties/modelReviewKind"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "unavailable"u8, "unavailable", "const"u8, ref context);
                            }
                            else
                            {
                                context.EvaluatedKeyword(false, "unavailable", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                            }
                        }
