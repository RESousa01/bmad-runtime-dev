...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibilityVersionRange
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PackageCompatibilityVersionRange instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PackageCompatibilityVersionRange"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PackageCompatibilityVersionRange(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PackageCompatibilityVersionRange.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PackageCompatibilityVersionRange Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PackageCompatibilityVersionRange Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PackageCompatibilityVersionRange>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PackageCompatibilityVersionRange instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PackageCompatibilityVersionRange, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PackageCompatibilityVersionRange> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PackageCompatibilityVersionRange>();
            }
            finally
            {
