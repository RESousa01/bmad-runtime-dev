...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonMutableInputBinding
        : IJsonElement<CommonMutableInputBinding>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInputIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("inputId"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInputIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("inputId"u8, buffer, out written);

            private const int RequiredOffsetForInputId = 0;
            private const uint RequiredBitForInputId = 0b00000000000000000000000000000010;
            ...
            private const uint RequiredBitForInputKind = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForContentHash | RequiredBitForInputId | RequiredBitForInputKind;
            ...
            private static readonly JsonSchemaPathProvider InputIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/inputId"u8, buffer, out written);
            ...
            private static void MatchInputId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonMutableInputBinding.InputIdEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.InputIdUtf8,
                        evaluationPath: InputIdSchemaEvaluationPath);

                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonMutableInputBinding.InputIdEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForInputId] |= RequiredBitForInputId;
            }
            ...
            private static void MatchInputKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonMutableInputBinding.InputKindEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonMutableInputBinding.InputKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.InputIdUtf8, MatchInputId),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonMutableInputBinding"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/CommonMutableInputBinding";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonMutableInputBinding"u8;
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyInputIdPresent, "inputId"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyInputKindPresent, "inputKind"u8, "required"u8);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForInputId] & RequiredBitForInputId) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyInputIdNotPresent, "inputId"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyInputIdPresent, "inputId"u8, "required"u8);
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyInputKindNotPresent, "inputKind"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyInputKindPresent, "inputKind"u8, "required"u8);
