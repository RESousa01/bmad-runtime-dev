...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<CommonMutableInputBinding>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchInputId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
