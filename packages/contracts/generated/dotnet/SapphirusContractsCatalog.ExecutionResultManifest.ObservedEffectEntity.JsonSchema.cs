...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct ObservedEffectEntity
            : IJsonElement<ObservedEffectEntity>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyObservedKindPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("observedKind"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyObservedKindNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("observedKind"u8, buffer, out written);

                private const int RequiredOffsetForObservedKind = 0;
                private const uint RequiredBitForObservedKind = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitForPatchHash = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForObservedKind | RequiredBitForPatchHash;
                private static readonly JsonSchemaPathProvider ObservedKindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/observedKind"u8, buffer, out written);
                ...
                private static void MatchObservedKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ObservedKindUtf8,
                            evaluationPath: ObservedKindSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForObservedKind] |= RequiredBitForObservedKind;
                }
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.ObservedKindUtf8, MatchObservedKind),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ExecutionResultManifest/properties/observedEffect"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ExecutionResultManifest/properties/observedEffect";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ExecutionResultManifest/properties/observedEffect"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyObservedKindPresent, "observedKind"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPatchHashPresent, "patchHash"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForObservedKind] & RequiredBitForObservedKind) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyObservedKindNotPresent, "observedKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyObservedKindPresent, "observedKind"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPatchHashNotPresent, "patchHash"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPatchHashPresent, "patchHash"u8, "required"u8);
