    ...
    public readonly partial struct DesktopDeviceRegistration
    {
        ...
        public readonly partial struct TenantPolicyVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TenantPolicyVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TenantPolicyVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TenantPolicyVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TenantPolicyVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TenantPolicyVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TenantPolicyVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TenantPolicyVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TenantPolicyVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TenantPolicyVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TenantPolicyVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TenantPolicyVersionEntity>();
                }
                finally
                {
