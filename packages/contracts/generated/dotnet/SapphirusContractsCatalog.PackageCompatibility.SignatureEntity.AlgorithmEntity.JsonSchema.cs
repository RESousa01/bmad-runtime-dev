        ...
        public readonly partial struct SignatureEntity
        {
                ...
                : IJsonElement<AlgorithmEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "ed25519"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly AlgorithmEntity EnumJson1 = ParsedJsonDocument<AlgorithmEntity>.StringConstant([.."\"ed25519\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "ecdsa-p256-sha256"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly AlgorithmEntity EnumJson2 = ParsedJsonDocument<AlgorithmEntity>.StringConstant([.."\"ecdsa-p256-sha256\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "ed25519"
                    /// as a <see cref="AlgorithmEntity"/>.
                    /// </summary>
                    public static AlgorithmEntity Ed25519 { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "ed25519"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Ed25519Utf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "ecdsa-p256-sha256"
                    /// as a <see cref="AlgorithmEntity"/>.
                    /// </summary>
                    public static AlgorithmEntity EcdsaP256Sha256 { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "ecdsa-p256-sha256"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> EcdsaP256Sha256Utf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/PackageCompatibility/properties/signature/properties/algorithm"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/PackageCompatibility/properties/signature/properties/algorithm";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/PackageCompatibility/properties/signature/properties/algorithm"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("ed25519"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("ecdsa-p256-sha256"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
