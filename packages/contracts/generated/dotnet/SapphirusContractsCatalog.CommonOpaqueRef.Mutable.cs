...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonOpaqueRef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonOpaqueRef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonOpaqueRef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonOpaqueRef(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonOpaqueRef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonOpaqueRef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonOpaqueRef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonOpaqueRef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonOpaqueRef instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonOpaqueRef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonOpaqueRef> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonOpaqueRef>();
            }
            finally
            {
