    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct PackageManifestSchemaVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PackageManifestSchemaVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PackageManifestSchemaVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PackageManifestSchemaVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PackageManifestSchemaVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PackageManifestSchemaVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PackageManifestSchemaVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PackageManifestSchemaVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PackageManifestSchemaVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PackageManifestSchemaVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PackageManifestSchemaVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PackageManifestSchemaVersionEntity>();
                }
                finally
                {
