        ...
        public readonly partial struct LimitsEntity
        {
            ...
            public readonly partial struct MaxOutputBytesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxOutputBytesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxOutputBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxOutputBytesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxOutputBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxOutputBytesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxOutputBytesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxOutputBytesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxOutputBytesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxOutputBytesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxOutputBytesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxOutputBytesEntity>();
                    }
                    finally
                    {
