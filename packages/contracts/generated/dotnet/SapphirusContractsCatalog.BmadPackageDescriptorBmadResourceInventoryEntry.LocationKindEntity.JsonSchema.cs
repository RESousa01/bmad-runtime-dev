    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
            ...
            : IJsonElement<LocationKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "source_tree"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly LocationKindEntity EnumJson1 = ParsedJsonDocument<LocationKindEntity>.StringConstant([.."\"source_tree\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "final_install"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly LocationKindEntity EnumJson2 = ParsedJsonDocument<LocationKindEntity>.StringConstant([.."\"final_install\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "managed_projection"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly LocationKindEntity EnumJson3 = ParsedJsonDocument<LocationKindEntity>.StringConstant([.."\"managed_projection\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "source_tree"
                /// as a <see cref="LocationKindEntity"/>.
                /// </summary>
                public static LocationKindEntity SourceTree { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "source_tree"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SourceTreeUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "final_install"
                /// as a <see cref="LocationKindEntity"/>.
                /// </summary>
                public static LocationKindEntity FinalInstall { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "final_install"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FinalInstallUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "managed_projection"
                /// as a <see cref="LocationKindEntity"/>.
                /// </summary>
                public static LocationKindEntity ManagedProjection { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "managed_projection"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ManagedProjectionUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadResourceInventoryEntry/properties/locationKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadResourceInventoryEntry/properties/locationKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadResourceInventoryEntry/properties/locationKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("source_tree"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("final_install"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("managed_projection"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
