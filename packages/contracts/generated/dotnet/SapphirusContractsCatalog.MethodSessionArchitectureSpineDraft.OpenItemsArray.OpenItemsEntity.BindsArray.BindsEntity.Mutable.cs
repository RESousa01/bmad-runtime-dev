                ...
                public readonly partial struct BindsArray
                {
                    ...
                    public readonly partial struct BindsEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(BindsEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="BindsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator BindsEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"BindsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly BindsEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly BindsEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<BindsEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(BindsEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<BindsEntity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<BindsEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<BindsEntity>();
                            }
                            finally
                            {
