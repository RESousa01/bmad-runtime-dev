...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadPackageDescriptorBmadConfigLayer>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigLayer"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigLayer";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigLayer"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (!context.HasCollector)
                {
                    ...
                    {
                        if (parentDocument.TryGetNamedPropertyValue(parentIndex, "graphKind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                        {
                            if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                            {
                                ...
                                if (discriminatorValue.Span.SequenceEqual("method_central_toml"u8))
                                {
                                    oneOfDiscriminatorBranch = 0;
                                }
                                else if (discriminatorValue.Span.SequenceEqual("skill_customization_toml"u8))
                                {
                                    oneOfDiscriminatorBranch = 1;
                                }
                                else if (discriminatorValue.Span.SequenceEqual("compatibility_yaml"u8))
                                {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                        ...
                        case 2:
                        {
                            JsonSchemaContext discriminatorContext2 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                ...
                JsonSchemaContext oneOfContext0 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                ...
                JsonSchemaContext oneOfContext2 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
