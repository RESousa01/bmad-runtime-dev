        ...
        public readonly partial struct CompletionEvidenceArray
        {
            ...
            public readonly partial struct CompletionEvidenceEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(CompletionEvidenceEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CompletionEvidenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CompletionEvidenceEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CompletionEvidenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CompletionEvidenceEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CompletionEvidenceEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CompletionEvidenceEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(CompletionEvidenceEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<CompletionEvidenceEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<CompletionEvidenceEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CompletionEvidenceEntity>();
                    }
                    finally
                    {
