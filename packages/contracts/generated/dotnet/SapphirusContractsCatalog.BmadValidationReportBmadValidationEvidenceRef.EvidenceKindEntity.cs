...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationEvidenceRef
    {
        ...
        public readonly partial struct EvidenceKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EvidenceKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EvidenceKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EvidenceKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EvidenceKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(EvidenceKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in EvidenceKindEntity left, in EvidenceKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EvidenceKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EvidenceKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EvidenceKindEntity(JsonElement instance)
            {
                return EvidenceKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EvidenceKindEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EvidenceKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EvidenceKindEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EvidenceKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EvidenceKindEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EvidenceKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EvidenceKindEntity>(json, options);
            }
            ...
            /// </exception>
            public static EvidenceKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EvidenceKindEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EvidenceKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EvidenceKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EvidenceKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EvidenceKindEntity IJsonElement<EvidenceKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EvidenceKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EvidenceKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EvidenceKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EvidenceKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EvidenceKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EvidenceKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EvidenceKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EvidenceKindEntity>(_idx);
                }
            ...
            /// <param name="matchSourceMember">Match 1st item.</param>
            /// <param name="matchSchemaValidation">Match 2nd item.</param>
            /// <param name="matchStaticAnalysis">Match 3rd item.</param>
            /// <param name="matchDependencyCheck">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSourceMember,
                Func<TContext, TResult> matchSchemaValidation,
                Func<TContext, TResult> matchStaticAnalysis,
                Func<TContext, TResult> matchDependencyCheck,
...
#endif
            {
                ...
                {
                    return matchSourceMember(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSchemaValidation(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchStaticAnalysis(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchDependencyCheck(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSourceMember,
                Func<TResult> matchSchemaValidation,
                Func<TResult> matchStaticAnalysis,
                Func<TResult> matchDependencyCheck,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSourceMember();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSchemaValidation();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchStaticAnalysis();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchDependencyCheck();
                }
