...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionArchitectureReviewResult
    {
        ...
        public readonly partial struct ReviewDispositionEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ReviewDispositionEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ReviewDispositionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ReviewDispositionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ReviewDispositionEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ReviewDispositionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ReviewDispositionEntity left, in ReviewDispositionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ReviewDispositionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ReviewDispositionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReviewDispositionEntity(JsonElement instance)
            {
                return ReviewDispositionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReviewDispositionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReviewDispositionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReviewDispositionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReviewDispositionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReviewDispositionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReviewDispositionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReviewDispositionEntity>(json, options);
            }
            ...
            /// </exception>
            public static ReviewDispositionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ReviewDispositionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ReviewDispositionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ReviewDispositionEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ReviewDispositionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ReviewDispositionEntity IJsonElement<ReviewDispositionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReviewDispositionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ReviewDispositionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ReviewDispositionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ReviewDispositionEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ReviewDispositionEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ReviewDispositionEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ReviewDispositionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ReviewDispositionEntity>(_idx);
                }
            ...
            /// <param name="matchNoFindings">Match 1st item.</param>
            /// <param name="matchFindingsPresent">Match 2nd item.</param>
            /// <param name="matchModelReviewUnavailable">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNoFindings,
                Func<TContext, TResult> matchFindingsPresent,
                Func<TContext, TResult> matchModelReviewUnavailable,
...
#endif
            {
                ...
                {
                    return matchNoFindings(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFindingsPresent(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchModelReviewUnavailable(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchNoFindings,
                Func<TResult> matchFindingsPresent,
                Func<TResult> matchModelReviewUnavailable,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchNoFindings();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFindingsPresent();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchModelReviewUnavailable();
                }
