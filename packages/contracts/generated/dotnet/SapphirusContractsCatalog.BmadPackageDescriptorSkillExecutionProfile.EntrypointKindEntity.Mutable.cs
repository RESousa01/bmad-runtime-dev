    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct EntrypointKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EntrypointKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EntrypointKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EntrypointKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EntrypointKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EntrypointKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EntrypointKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EntrypointKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EntrypointKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EntrypointKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EntrypointKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EntrypointKindEntity>();
                }
                finally
                {
