...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptor
    {
        ...
        public readonly partial struct ValidationReportHashesArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ValidationReportHashesArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ValidationReportHashesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ValidationReportHashesArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ValidationReportHashesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ValidationReportHashesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="ValidationReportHashesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ValidationReportHashesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationReportHashesArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ValidationReportHashesArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ValidationReportHashesArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationReportHashesArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ValidationReportHashesArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ValidationReportHashesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ValidationReportHashesArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ValidationReportHashesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ValidationReportHashesArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ValidationReportHashesArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ValidationReportHashesArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ValidationReportHashesArray> Create<TContext>(
