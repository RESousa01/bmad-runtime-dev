    ...
    public readonly partial struct BmadValidationReportBmadValidationDisposition
    {
            ...
            : IJsonElement<OneOf2Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchDispositionKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                private static void MatchMissingDependencyIds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
