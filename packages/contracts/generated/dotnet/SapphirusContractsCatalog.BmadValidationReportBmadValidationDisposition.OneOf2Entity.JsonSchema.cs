...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationDisposition
    {
            ...
            : IJsonElement<OneOf2Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDispositionKindPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("dispositionKind"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDispositionKindNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("dispositionKind"u8, buffer, out written);

                private const int RequiredOffsetForDispositionKind = 0;
                private const uint RequiredBitForDispositionKind = 0b00000000000000000000000000000001;

                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMissingDependencyIdsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("missingDependencyIds"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMissingDependencyIdsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("missingDependencyIds"u8, buffer, out written);

                private const int RequiredOffsetForMissingDependencyIds = 0;
                private const uint RequiredBitForMissingDependencyIds = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForDispositionKind | RequiredBitForMissingDependencyIds;
                private static readonly JsonSchemaPathProvider DispositionKindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/dispositionKind"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider MissingDependencyIdsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/missingDependencyIds"u8, buffer, out written);

                private static void MatchDispositionKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.DispositionKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.DispositionKindUtf8,
                            evaluationPath: DispositionKindSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.DispositionKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForDispositionKind] |= RequiredBitForDispositionKind;
                }

                private static void MatchMissingDependencyIds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.MissingDependencyIdsArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.MissingDependencyIdsUtf8,
                            evaluationPath: MissingDependencyIdsSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.MissingDependencyIdsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    requiredBitBuffer[RequiredOffsetForMissingDependencyIds] |= RequiredBitForMissingDependencyIds;
                }
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.DispositionKindUtf8, MatchDispositionKind),
                        (static () => JsonPropertyNames.MissingDependencyIdsUtf8, MatchMissingDependencyIds),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDispositionKindPresent, "dispositionKind"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMissingDependencyIdsPresent, "missingDependencyIds"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDispositionKind] & RequiredBitForDispositionKind) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDispositionKindNotPresent, "dispositionKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDispositionKindPresent, "dispositionKind"u8, "required"u8);
                            ...
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForMissingDependencyIds] & RequiredBitForMissingDependencyIds) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyMissingDependencyIdsNotPresent, "missingDependencyIds"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMissingDependencyIdsPresent, "missingDependencyIds"u8, "required"u8);
