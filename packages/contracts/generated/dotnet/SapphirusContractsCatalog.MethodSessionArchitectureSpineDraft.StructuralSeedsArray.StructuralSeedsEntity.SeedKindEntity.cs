    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct StructuralSeedsArray
        {
            ...
            public readonly partial struct StructuralSeedsEntity
            {
                ...
                public readonly partial struct SeedKindEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<SeedKindEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="SeedKindEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal SeedKindEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static SeedKindEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(SeedKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in SeedKindEntity left, in SeedKindEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in SeedKindEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(SeedKindEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SeedKindEntity(JsonElement instance)
                    {
                        return SeedKindEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SeedKindEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SeedKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SeedKindEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SeedKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SeedKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SeedKindEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SeedKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static SeedKindEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<SeedKindEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out SeedKindEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<SeedKindEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SeedKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static SeedKindEntity IJsonElement<SeedKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SeedKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SeedKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SeedKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public SeedKindEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SeedKindEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SeedKindEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public SeedKindEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<SeedKindEntity>(_idx);
                        }
                    ...
                    /// <param name="matchMermaid">Match 1st item.</param>
                    /// <param name="matchTextTree">Match 2nd item.</param>
                    /// <param name="matchStructuredNote">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchMermaid,
                        Func<TContext, TResult> matchTextTree,
                        Func<TContext, TResult> matchStructuredNote,
...
#endif
                    {
                        ...
                        {
                            return matchMermaid(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchTextTree(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchStructuredNote(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchMermaid,
                        Func<TResult> matchTextTree,
                        Func<TResult> matchStructuredNote,
                        Func<TResult> defaultMatch)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchTextTree();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchStructuredNote();
                        }
