...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonRelativeWorkspacePath
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonRelativeWorkspacePath instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonRelativeWorkspacePath"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonRelativeWorkspacePath(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonRelativeWorkspacePath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonRelativeWorkspacePath Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonRelativeWorkspacePath Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonRelativeWorkspacePath>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonRelativeWorkspacePath instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonRelativeWorkspacePath, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonRelativeWorkspacePath> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonRelativeWorkspacePath>();
            }
            finally
            {
