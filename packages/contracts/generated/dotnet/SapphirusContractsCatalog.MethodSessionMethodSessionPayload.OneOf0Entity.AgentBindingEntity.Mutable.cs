        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct AgentBindingEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AgentBindingEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AgentBindingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AgentBindingEntity(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.Mutable BindingKind
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetBindingKind(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AgentBindingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AgentBindingEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AgentBindingEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AgentBindingEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(AgentBindingEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AgentBindingEntity"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder)
                    {
                        builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.BindingKind, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.ConstInstance);
                    }
                ...
                {
                    return workspace.CreateBuilder<AgentBindingEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AgentBindingEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AgentBindingEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AgentBindingEntity> Create<TContext>(
