...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReport
    {
        ...
        public readonly partial struct SubjectKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SubjectKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SubjectKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SubjectKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SubjectKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SubjectKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SubjectKindEntity left, in SubjectKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SubjectKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SubjectKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SubjectKindEntity(JsonElement instance)
            {
                return SubjectKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SubjectKindEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SubjectKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SubjectKindEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SubjectKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SubjectKindEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SubjectKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SubjectKindEntity>(json, options);
            }
            ...
            /// </exception>
            public static SubjectKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SubjectKindEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SubjectKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SubjectKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SubjectKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SubjectKindEntity IJsonElement<SubjectKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SubjectKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SubjectKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SubjectKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SubjectKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SubjectKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SubjectKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SubjectKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SubjectKindEntity>(_idx);
                }
            ...
            /// <param name="matchSourceSkill">Match 1st item.</param>
            /// <param name="matchInstalledWorkspace">Match 2nd item.</param>
            /// <param name="matchBuilderDraftRevision">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSourceSkill,
                Func<TContext, TResult> matchInstalledWorkspace,
                Func<TContext, TResult> matchBuilderDraftRevision,
...
#endif
            {
                ...
                {
                    return matchSourceSkill(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchInstalledWorkspace(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBuilderDraftRevision(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSourceSkill,
                Func<TResult> matchInstalledWorkspace,
                Func<TResult> matchBuilderDraftRevision,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSourceSkill();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchInstalledWorkspace();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBuilderDraftRevision();
                }
