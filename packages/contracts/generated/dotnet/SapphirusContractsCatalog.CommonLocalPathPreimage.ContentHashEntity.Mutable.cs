    ...
    public readonly partial struct CommonLocalPathPreimage
    {
        ...
        public readonly partial struct ContentHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ContentHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ContentHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.ContentHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.ContentHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ContentHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ContentHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ContentHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentHashEntity>();
                }
                finally
                {
