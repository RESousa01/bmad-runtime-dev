...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DurableObjectWindowsLocalObject
        ...
        : IJsonElement<DurableObjectWindowsLocalObject>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DurableObjectWindowsLocalObject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DurableObjectWindowsLocalObject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DurableObjectWindowsLocalObject DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectWindowsLocalObject.EnvelopeEntity Envelope
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvelopeUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectWindowsLocalObject.EnvelopeEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectCandidatePointer Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectCandidatePointer value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DurableObjectWindowsLocalObject left, in DurableObjectWindowsLocalObject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DurableObjectWindowsLocalObject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DurableObjectWindowsLocalObject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DurableObjectWindowsLocalObject(JsonElement instance)
        {
            return DurableObjectWindowsLocalObject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWindowsLocalObject From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWindowsLocalObject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWindowsLocalObject>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWindowsLocalObject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWindowsLocalObject>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWindowsLocalObject ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWindowsLocalObject>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DurableObjectWindowsLocalObject ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWindowsLocalObject>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DurableObjectWindowsLocalObject? result)
        {
            return JsonElementHelpers.TryParseValue<DurableObjectWindowsLocalObject>(ref reader, out result);
        }
...
#if NET
        static DurableObjectWindowsLocalObject IJsonElement<DurableObjectWindowsLocalObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DurableObjectWindowsLocalObject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DurableObjectWindowsLocalObject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DurableObjectWindowsLocalObject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DurableObjectWindowsLocalObject>(_idx);
            }
