    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigLayer
    {
        ...
        public readonly partial struct OneOf2Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EntriesArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EntriesArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EntriesArray DefaultInstance { get; }
                ...
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.EntriesArray.EntriesEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.EntriesArray.EntriesEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.EntriesArray.EntriesEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf2Entity.EntriesArray.EntriesEntity>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in EntriesArray left, in EntriesArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EntriesArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(EntriesArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EntriesArray(JsonElement instance)
                {
                    return EntriesArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EntriesArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EntriesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EntriesArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EntriesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EntriesArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EntriesArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EntriesArray>(json, options);
                }
                ...
                /// </exception>
                public static EntriesArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EntriesArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EntriesArray? result)
                {
                    return JsonElementHelpers.TryParseValue<EntriesArray>(ref reader, out result);
                }
...
#if NET
                static EntriesArray IJsonElement<EntriesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EntriesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
