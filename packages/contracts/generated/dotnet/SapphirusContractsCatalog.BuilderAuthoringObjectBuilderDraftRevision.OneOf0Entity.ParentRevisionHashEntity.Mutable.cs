        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct ParentRevisionHashEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ParentRevisionHashEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ParentRevisionHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ParentRevisionHashEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ParentRevisionHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ParentRevisionHashEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ParentRevisionHashEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ParentRevisionHashEntity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.ParentRevisionHashEntity.Mutable, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.ParentRevisionHashEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                        {
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ParentRevisionHashEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ParentRevisionHashEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ParentRevisionHashEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ParentRevisionHashEntity>();
                    }
                    finally
                    {
