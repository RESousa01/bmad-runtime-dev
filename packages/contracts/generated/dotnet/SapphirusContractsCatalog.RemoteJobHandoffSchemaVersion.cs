...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffSchemaVersion
#if NET8_0_OR_GREATER
        : IJsonElement<RemoteJobHandoffSchemaVersion>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteJobHandoffSchemaVersion"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RemoteJobHandoffSchemaVersion(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RemoteJobHandoffSchemaVersion DefaultInstance { get; }

        /// <summary>
        /// Gets the const instance.
        /// </summary>
        public static RemoteJobHandoffSchemaVersion ConstInstance => Constants.ConstJson;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(RemoteJobHandoffSchemaVersion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffSchemaVersion left, in RemoteJobHandoffSchemaVersion right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffSchemaVersion left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RemoteJobHandoffSchemaVersion instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RemoteJobHandoffSchemaVersion(JsonElement instance)
        {
            return RemoteJobHandoffSchemaVersion.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffSchemaVersion From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffSchemaVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RemoteJobHandoffSchemaVersion>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffSchemaVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RemoteJobHandoffSchemaVersion>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffSchemaVersion ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RemoteJobHandoffSchemaVersion>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static RemoteJobHandoffSchemaVersion ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RemoteJobHandoffSchemaVersion>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RemoteJobHandoffSchemaVersion? result)
        {
            return JsonElementHelpers.TryParseValue<RemoteJobHandoffSchemaVersion>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RemoteJobHandoffSchemaVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RemoteJobHandoffSchemaVersion IJsonElement<RemoteJobHandoffSchemaVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RemoteJobHandoffSchemaVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RemoteJobHandoffSchemaVersion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RemoteJobHandoffSchemaVersion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffSchemaVersion Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RemoteJobHandoffSchemaVersion>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RemoteJobHandoffSchemaVersion"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffSchemaVersion Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RemoteJobHandoffSchemaVersion>(_idx);
            }
