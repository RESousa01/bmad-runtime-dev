...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct OutputArtifactsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OutputArtifactsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputArtifactsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputArtifactsArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OutputArtifactsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputArtifactsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="OutputArtifactsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OutputArtifactsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OutputArtifactsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OutputArtifactsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OutputArtifactsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OutputArtifactsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputArtifactsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.OutputArtifactsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OutputArtifactsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.OutputArtifactsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OutputArtifactsArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputArtifactsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputArtifactsArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OutputArtifactsArray> Create<TContext>(
