    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct SourceIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SourceIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SourceIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SourceIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SourceIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SourceIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SourceIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SourceIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SourceIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SourceIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SourceIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SourceIdEntity>();
                }
                finally
                {
