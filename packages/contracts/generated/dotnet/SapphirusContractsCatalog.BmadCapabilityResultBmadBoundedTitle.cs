...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResultBmadBoundedTitle
#if NET8_0_OR_GREATER
        : IJsonElement<BmadCapabilityResultBmadBoundedTitle>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadCapabilityResultBmadBoundedTitle"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadCapabilityResultBmadBoundedTitle(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadCapabilityResultBmadBoundedTitle DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadCapabilityResultBmadBoundedTitle value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadCapabilityResultBmadBoundedTitle left, in BmadCapabilityResultBmadBoundedTitle right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadCapabilityResultBmadBoundedTitle left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadCapabilityResultBmadBoundedTitle instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadCapabilityResultBmadBoundedTitle(JsonElement instance)
        {
            return BmadCapabilityResultBmadBoundedTitle.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedTitle From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedTitle ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedTitle>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedTitle ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedTitle>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedTitle ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedTitle>(json, options);
        }
        ...
        /// </exception>
        public static BmadCapabilityResultBmadBoundedTitle ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedTitle>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadCapabilityResultBmadBoundedTitle? result)
        {
            return JsonElementHelpers.TryParseValue<BmadCapabilityResultBmadBoundedTitle>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadCapabilityResultBmadBoundedTitle(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadCapabilityResultBmadBoundedTitle IJsonElement<BmadCapabilityResultBmadBoundedTitle>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadCapabilityResultBmadBoundedTitle: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadCapabilityResultBmadBoundedTitle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadCapabilityResultBmadBoundedTitle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityResultBmadBoundedTitle Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadCapabilityResultBmadBoundedTitle>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadCapabilityResultBmadBoundedTitle"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityResultBmadBoundedTitle Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadCapabilityResultBmadBoundedTitle>(_idx);
            }
