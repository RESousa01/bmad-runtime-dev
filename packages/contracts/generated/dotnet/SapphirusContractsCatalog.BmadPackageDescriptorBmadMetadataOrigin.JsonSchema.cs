...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadPackageDescriptorBmadMetadataOrigin>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "source"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly BmadPackageDescriptorBmadMetadataOrigin EnumJson1 = ParsedJsonDocument<BmadPackageDescriptorBmadMetadataOrigin>.StringConstant([.."\"source\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "synthesized"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly BmadPackageDescriptorBmadMetadataOrigin EnumJson2 = ParsedJsonDocument<BmadPackageDescriptorBmadMetadataOrigin>.StringConstant([.."\"synthesized\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum3 = "installed_projection"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly BmadPackageDescriptorBmadMetadataOrigin EnumJson3 = ParsedJsonDocument<BmadPackageDescriptorBmadMetadataOrigin>.StringConstant([.."\"installed_projection\""u8]);
        }
        ...
        public static class EnumValues
        {
            ...
            /// as a <see cref="BmadPackageDescriptorBmadMetadataOrigin"/>.
            /// </summary>
            public static BmadPackageDescriptorBmadMetadataOrigin Source { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "source"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> SourceUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "synthesized"
            /// as a <see cref="BmadPackageDescriptorBmadMetadataOrigin"/>.
            /// </summary>
            public static BmadPackageDescriptorBmadMetadataOrigin Synthesized { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "synthesized"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> SynthesizedUtf8 => Constants.Enum2;

            /// <summary>
            /// Gets the string "installed_projection"
            /// as a <see cref="BmadPackageDescriptorBmadMetadataOrigin"/>.
            /// </summary>
            public static BmadPackageDescriptorBmadMetadataOrigin InstalledProjection { get; } = Constants.EnumJson3;
            /// <summary>
            /// Gets the string "installed_projection"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> InstalledProjectionUtf8 => Constants.Enum3;
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadMetadataOrigin"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadMetadataOrigin";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadMetadataOrigin"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("source"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("synthesized"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("installed_projection"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
                }
