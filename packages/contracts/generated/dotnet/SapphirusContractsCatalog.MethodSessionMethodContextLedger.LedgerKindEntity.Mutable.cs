    ...
    public readonly partial struct MethodSessionMethodContextLedger
    {
        ...
        public readonly partial struct LedgerKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LedgerKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LedgerKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LedgerKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LedgerKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LedgerKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LedgerKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LedgerKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LedgerKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LedgerKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LedgerKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LedgerKindEntity>();
                }
                finally
                {
