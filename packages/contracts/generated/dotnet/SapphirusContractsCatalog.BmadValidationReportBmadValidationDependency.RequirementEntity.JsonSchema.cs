    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
            ...
            : IJsonElement<RequirementEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "required"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RequirementEntity EnumJson1 = ParsedJsonDocument<RequirementEntity>.StringConstant([.."\"required\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "optional"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RequirementEntity EnumJson2 = ParsedJsonDocument<RequirementEntity>.StringConstant([.."\"optional\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "required"
                /// as a <see cref="RequirementEntity"/>.
                /// </summary>
                public static RequirementEntity Required { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "required"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> RequiredUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "optional"
                /// as a <see cref="RequirementEntity"/>.
                /// </summary>
                public static RequirementEntity Optional { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "optional"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> OptionalUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDependency/properties/requirement"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDependency/properties/requirement";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDependency/properties/requirement"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("required"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("optional"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
