    ...
    public readonly partial struct MethodSessionMethodModelBinding
    {
        ...
        public readonly partial struct ModelIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ModelIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ModelIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ModelIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ModelIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ModelIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ModelIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ModelIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ModelIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ModelIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ModelIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ModelIdEntity>();
                }
                finally
                {
