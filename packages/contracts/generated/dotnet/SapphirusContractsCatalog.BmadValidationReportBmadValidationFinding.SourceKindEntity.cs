...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationFinding
    {
        ...
        public readonly partial struct SourceKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SourceKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SourceKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SourceKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SourceKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SourceKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SourceKindEntity left, in SourceKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SourceKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SourceKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SourceKindEntity(JsonElement instance)
            {
                return SourceKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceKindEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceKindEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceKindEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceKindEntity>(json, options);
            }
            ...
            /// </exception>
            public static SourceKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SourceKindEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SourceKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SourceKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SourceKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SourceKindEntity IJsonElement<SourceKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SourceKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SourceKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SourceKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SourceKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SourceKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SourceKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SourceKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SourceKindEntity>(_idx);
                }
            ...
            /// <param name="matchUpstreamMethod">Match 1st item.</param>
            /// <param name="matchUpstreamBuilder">Match 2nd item.</param>
            /// <param name="matchSapphirus">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchUpstreamMethod,
                Func<TContext, TResult> matchUpstreamBuilder,
                Func<TContext, TResult> matchSapphirus,
...
#endif
            {
                ...
                {
                    return matchUpstreamMethod(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUpstreamBuilder(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchSapphirus(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchUpstreamMethod,
                Func<TResult> matchUpstreamBuilder,
                Func<TResult> matchSapphirus,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchUpstreamMethod();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUpstreamBuilder();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchSapphirus();
                }
