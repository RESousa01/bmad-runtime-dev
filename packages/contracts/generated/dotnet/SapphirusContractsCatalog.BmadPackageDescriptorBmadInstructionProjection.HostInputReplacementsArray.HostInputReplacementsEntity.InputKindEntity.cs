        ...
        public readonly partial struct HostInputReplacementsArray
        {
            ...
            public readonly partial struct HostInputReplacementsEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="InputKindEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal InputKindEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static InputKindEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(InputKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in InputKindEntity left, in InputKindEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in InputKindEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(InputKindEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator InputKindEntity(JsonElement instance)
                    {
                        return InputKindEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InputKindEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InputKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InputKindEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InputKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InputKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InputKindEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InputKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static InputKindEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<InputKindEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out InputKindEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<InputKindEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new InputKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static InputKindEntity IJsonElement<InputKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"InputKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="InputKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="InputKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public InputKindEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<InputKindEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="InputKindEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public InputKindEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<InputKindEntity>(_idx);
                        }
                    ...
                    /// <param name="matchBoundedResourceSet">Match 1st item.</param>
                    /// <param name="matchResolvedConfig">Match 2nd item.</param>
                    /// <param name="matchWorkspaceSnapshot">Match 3rd item.</param>
                    /// <param name="matchArtifactInventory">Match 4th item.</param>
                    /// <param name="matchCatalogSnapshot">Match 5th item.</param>
                    /// <param name="matchUnavailableFact">Match 6th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchBoundedResourceSet,
                        Func<TContext, TResult> matchResolvedConfig,
                        Func<TContext, TResult> matchWorkspaceSnapshot,
                        Func<TContext, TResult> matchArtifactInventory,
                        Func<TContext, TResult> matchCatalogSnapshot,
                        Func<TContext, TResult> matchUnavailableFact,
...
#endif
                    {
                        ...
                        {
                            return matchBoundedResourceSet(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchResolvedConfig(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchWorkspaceSnapshot(context);
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchArtifactInventory(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchCatalogSnapshot(context);
                        }

                        if (this.ValueEquals(Constants.Enum6))
                        {
                            return matchUnavailableFact(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchBoundedResourceSet,
                        Func<TResult> matchResolvedConfig,
                        Func<TResult> matchWorkspaceSnapshot,
                        Func<TResult> matchArtifactInventory,
                        Func<TResult> matchCatalogSnapshot,
                        Func<TResult> matchUnavailableFact,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchBoundedResourceSet();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchResolvedConfig();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchWorkspaceSnapshot();
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchArtifactInventory();
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchCatalogSnapshot();
                        }

                        if (this.ValueEquals(Constants.Enum6))
                        {
                            return matchUnavailableFact();
                        }
