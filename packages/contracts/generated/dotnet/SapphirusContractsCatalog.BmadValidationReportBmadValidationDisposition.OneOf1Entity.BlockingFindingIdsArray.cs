    ...
    public readonly partial struct BmadValidationReportBmadValidationDisposition
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct BlockingFindingIdsArray
                ...
                : IJsonElement<BlockingFindingIdsArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BlockingFindingIdsArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BlockingFindingIdsArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BlockingFindingIdsArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in BlockingFindingIdsArray left, in BlockingFindingIdsArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BlockingFindingIdsArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(BlockingFindingIdsArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BlockingFindingIdsArray(JsonElement instance)
                {
                    return BlockingFindingIdsArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlockingFindingIdsArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlockingFindingIdsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlockingFindingIdsArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlockingFindingIdsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlockingFindingIdsArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlockingFindingIdsArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlockingFindingIdsArray>(json, options);
                }
                ...
                /// </exception>
                public static BlockingFindingIdsArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BlockingFindingIdsArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BlockingFindingIdsArray? result)
                {
                    return JsonElementHelpers.TryParseValue<BlockingFindingIdsArray>(ref reader, out result);
                }
...
#if NET
                static BlockingFindingIdsArray IJsonElement<BlockingFindingIdsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BlockingFindingIdsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public BlockingFindingIdsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public BlockingFindingIdsArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BlockingFindingIdsArray>(_idx);
                    }
