    ...
    public readonly partial struct DesktopDeviceRegistration
    {
        ...
        public readonly partial struct ClientReleaseEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClientReleaseEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClientReleaseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClientReleaseEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClientReleaseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClientReleaseEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClientReleaseEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClientReleaseEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClientReleaseEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClientReleaseEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClientReleaseEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClientReleaseEntity>();
                }
                finally
                {
