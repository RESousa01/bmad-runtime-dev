...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct ConformanceBundleEntity
        {
            ...
            public readonly partial struct MinimumConformanceLevelEntity
#if NET8_0_OR_GREATER
                : IJsonElement<MinimumConformanceLevelEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="MinimumConformanceLevelEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal MinimumConformanceLevelEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static MinimumConformanceLevelEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(MinimumConformanceLevelEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in MinimumConformanceLevelEntity left, in MinimumConformanceLevelEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in MinimumConformanceLevelEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(MinimumConformanceLevelEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumConformanceLevelEntity(JsonElement instance)
                {
                    return MinimumConformanceLevelEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MinimumConformanceLevelEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MinimumConformanceLevelEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<MinimumConformanceLevelEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MinimumConformanceLevelEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<MinimumConformanceLevelEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MinimumConformanceLevelEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<MinimumConformanceLevelEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static MinimumConformanceLevelEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<MinimumConformanceLevelEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out MinimumConformanceLevelEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<MinimumConformanceLevelEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MinimumConformanceLevelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static MinimumConformanceLevelEntity IJsonElement<MinimumConformanceLevelEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumConformanceLevelEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MinimumConformanceLevelEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MinimumConformanceLevelEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public MinimumConformanceLevelEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MinimumConformanceLevelEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MinimumConformanceLevelEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public MinimumConformanceLevelEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<MinimumConformanceLevelEntity>(_idx);
                    }
                ...
                /// <param name="matchSchema">Match 1st item.</param>
                /// <param name="matchSemantic">Match 2nd item.</param>
                /// <param name="matchExecutionRehearsal">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchSchema,
                    Func<TContext, TResult> matchSemantic,
                    Func<TContext, TResult> matchExecutionRehearsal,
...
#endif
                {
                    ...
                    {
                        return matchSchema(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchSemantic(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchExecutionRehearsal(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchSchema,
                    Func<TResult> matchSemantic,
                    Func<TResult> matchExecutionRehearsal,
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchExecutionRehearsal();
                    }
