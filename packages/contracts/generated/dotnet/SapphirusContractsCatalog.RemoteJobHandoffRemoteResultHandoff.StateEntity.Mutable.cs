    ...
    public readonly partial struct RemoteJobHandoffRemoteResultHandoff
    {
        ...
        public readonly partial struct StateEntity
        {
...
#endif
            {
                ...
                /// <param name="matchResultAvailable">Match 1st item.</param>
                /// <param name="matchResultVerified">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchResultAvailable,
                    Func<TContext, TResult> matchResultVerified,
...
#endif
                {
                    ...
                    {
                        return matchResultAvailable(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchResultVerified(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchResultAvailable,
                    Func<TResult> matchResultVerified,
