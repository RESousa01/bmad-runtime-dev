    ...
    public readonly partial struct MethodSessionBmadContextDecisionConsumption
    {
        ...
        public readonly partial struct IdempotencyKeyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IdempotencyKeyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IdempotencyKeyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IdempotencyKeyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IdempotencyKeyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IdempotencyKeyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IdempotencyKeyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IdempotencyKeyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IdempotencyKeyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IdempotencyKeyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IdempotencyKeyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IdempotencyKeyEntity>();
                }
                finally
                {
