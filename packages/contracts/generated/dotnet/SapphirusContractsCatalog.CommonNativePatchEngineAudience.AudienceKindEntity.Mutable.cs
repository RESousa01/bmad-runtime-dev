    ...
    public readonly partial struct CommonNativePatchEngineAudience
    {
        ...
        public readonly partial struct AudienceKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AudienceKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AudienceKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AudienceKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AudienceKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AudienceKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AudienceKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AudienceKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AudienceKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AudienceKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AudienceKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AudienceKindEntity>();
                }
                finally
                {
