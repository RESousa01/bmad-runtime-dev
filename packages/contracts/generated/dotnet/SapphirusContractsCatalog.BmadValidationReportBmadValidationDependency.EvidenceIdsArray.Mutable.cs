...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
        ...
        public readonly partial struct EvidenceIdsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EvidenceIdsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EvidenceIdsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EvidenceIdsArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EvidenceIdsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EvidenceIdsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="EvidenceIdsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EvidenceIdsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceIdsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EvidenceIdsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EvidenceIdsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceIdsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EvidenceIdsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDependency.EvidenceIdsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(EvidenceIdsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDependency.EvidenceIdsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<EvidenceIdsArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EvidenceIdsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EvidenceIdsArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EvidenceIdsArray> Create<TContext>(
