        ...
        public readonly partial struct LimitsEntity
        {
                ...
                : IJsonElement<MaxProcessCountEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly NormalizedJsonNumber Const = new(false, [..""u8], [..""u8], 0);
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly MaxProcessCountEntity ConstJson = ParsedJsonDocument<MaxProcessCountEntity>.NumberConstant([.."0"u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CandidateAction/properties/limits/properties/maxProcessCount"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/CandidateAction/properties/limits/properties/maxProcessCount";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CandidateAction/properties/limits/properties/maxProcessCount"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.Number)
                        {
                            ...
                            JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, ""u8, ""u8, 0, "0", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "0", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                        }
                    }
