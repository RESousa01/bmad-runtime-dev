        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct DraftEffectEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DraftEffectEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DraftEffectEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DraftEffectEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DraftEffectEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DraftEffectEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DraftEffectEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DraftEffectEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DraftEffectEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DraftEffectEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DraftEffectEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DraftEffectEntity>();
                    }
                    finally
                    {
