    ...
    public readonly partial struct ModelAccessReceiptSupportPlaneProof
    {
        ...
        public readonly partial struct AudienceEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AudienceEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AudienceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AudienceEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AudienceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AudienceEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AudienceEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AudienceEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AudienceEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AudienceEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AudienceEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AudienceEntity>();
                }
                finally
                {
