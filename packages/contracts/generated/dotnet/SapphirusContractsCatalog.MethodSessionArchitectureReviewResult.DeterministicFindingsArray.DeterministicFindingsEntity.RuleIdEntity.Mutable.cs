            ...
            public readonly partial struct DeterministicFindingsEntity
            {
                ...
                public readonly partial struct RuleIdEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RuleIdEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RuleIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RuleIdEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RuleIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuleIdEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuleIdEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RuleIdEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RuleIdEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RuleIdEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RuleIdEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RuleIdEntity>();
                        }
                        finally
                        {
