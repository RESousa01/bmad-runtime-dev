                    ...
                    public readonly partial struct LensResultsEntity
                    {
                        ...
                        public readonly partial struct FindingsArray
                        {
                            ...
                            public readonly partial struct FindingsEntity
                            {
                                ...
                                public readonly partial struct DispositionEntity
#if NET8_0_OR_GREATER
                                    : IJsonElement<DispositionEntity>,
                                      IFormattable,
                                      ISpanFormattable,
...
#endif
                                {
                                    ...
                                    /// <summary>
                                    /// Initializes a new instance of the <see cref="DispositionEntity"/> struct.
                                    /// </summary>
                                    /// <param name="value">The value from which to construct the instance.</param>
                                    internal DispositionEntity(IJsonDocument parent, int idx)
                                    {
                                        Debug.Assert(idx >= 0);
                                        _parent = parent;
                                        _idx = idx;
                                    ...
                                    /// </summary>
                                    public static DispositionEntity DefaultInstance { get; }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static explicit operator string(DispositionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                    ...
                                    /// </returns>
                                    public static bool operator ==(in DispositionEntity left, in DispositionEntity right)
                                    {
                                    ...
                                    /// <c>True</c> if the values are equal.
                                    /// </returns>
                                    public static bool operator ==(in DispositionEntity left, in JsonElement right)
                                    {
                                        return left.Equals(right);
                                    }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator JsonElement(DispositionEntity instance)
                                    {
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator DispositionEntity(JsonElement instance)
                                    {
                                        return DispositionEntity.From(instance);
                                    }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static DispositionEntity From<T>(in T instance)
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static DispositionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<DispositionEntity>(utf8Json, options);
                                    }
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static DispositionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<DispositionEntity>(json, options);
                                    }
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static DispositionEntity ParseValue(string json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<DispositionEntity>(json, options);
                                    }
                                    ...
                                    /// </exception>
                                    public static DispositionEntity ParseValue(ref Utf8JsonReader reader)
                                    {
                                        return JsonElementHelpers.ParseValue<DispositionEntity>(ref reader);
                                    }
                                    ...
                                    ///   A value could not be read from the reader.
                                    /// </exception>
                                    public static bool TryParseValue(ref Utf8JsonReader reader, out DispositionEntity? result)
                                    {
                                        return JsonElementHelpers.TryParseValue<DispositionEntity>(ref reader, out result);
                                    }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new DispositionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                    static DispositionEntity IJsonElement<DispositionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"DispositionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// <summary>
                                    /// Gets a <see cref="DispositionEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </summary>
                                    /// <returns>
                                    /// A <see cref="DispositionEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </returns>
                                    /// <remarks>
                                    /// <para>
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public DispositionEntity Clone()
                                    {
                                        CheckValidInstance();
                                        return _parent.CloneElement<DispositionEntity>(_idx);
                                    }
                                    ...
                                    /// </summary>
                                    /// <returns>
                                    /// An immutable <see cref="DispositionEntity"/> that lives for the lifetime of its
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public DispositionEntity Freeze()
                                    {
                                        CheckValidInstance();
                                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                        {
                                            return mutable.FreezeElement<DispositionEntity>(_idx);
                                        }
                                    ...
                                    /// <param name="matchOpen">Match 1st item.</param>
                                    /// <param name="matchResolved">Match 2nd item.</param>
                                    /// <param name="matchRetainedOpenQuestion">Match 3rd item.</param>
                                    /// <param name="defaultMatch">Match any other value.</param>
                                    /// <returns>An instance of the value returned by the match function.</returns>
                                    public TResult Match<TContext, TResult>(
                                        in TContext context,
                                        Func<TContext, TResult> matchOpen,
                                        Func<TContext, TResult> matchResolved,
                                        Func<TContext, TResult> matchRetainedOpenQuestion,
...
#endif
                                    {
                                        ...
                                        {
                                            return matchOpen(context);
                                        }

                                        if (this.ValueEquals(Constants.Enum2))
                                        {
                                            return matchResolved(context);
                                        }

                                        if (this.ValueEquals(Constants.Enum3))
                                        {
                                            return matchRetainedOpenQuestion(context);
                                        }
                                    ...
                                    public TResult Match<TResult>(
                                        Func<TResult> matchOpen,
                                        Func<TResult> matchResolved,
                                        Func<TResult> matchRetainedOpenQuestion,
                                        Func<TResult> defaultMatch)
                                    {
                                        ...
                                        if (this.ValueEquals(Constants.Enum3))
                                        {
                                            return matchRetainedOpenQuestion();
                                        }
