    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct ArtifactKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ArtifactKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ArtifactKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArtifactKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArtifactKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ArtifactKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ArtifactKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArtifactKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ArtifactKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ArtifactKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ArtifactKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArtifactKindEntity>();
                }
                finally
                {
