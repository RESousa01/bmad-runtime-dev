...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadCapabilityCatalogBmadHelpActionGraph>
    {
        public static partial class JsonSchema
        {
            ...
            private const uint RequiredBitForGraphHash = 0b00000000000000000000000000000010;
            ...
            private const uint RequiredBitMask0 =
                RequiredBitForActions | RequiredBitForGraphHash | RequiredBitForPackageVersionId;
            ...
            private static void MatchActions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadHelpActionGraph.ActionsArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadHelpActionGraph.ActionsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityCatalogBmadHelpActionGraph"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadCapabilityCatalogBmadHelpActionGraph";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityCatalogBmadHelpActionGraph"u8;
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyGraphHashPresent, "graphHash"u8, "required"u8);
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyGraphHashNotPresent, "graphHash"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyGraphHashPresent, "graphHash"u8, "required"u8);
