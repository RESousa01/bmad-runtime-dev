    ...
    public readonly partial struct BmadValidationReportBmadValidationFinding
    {
        ...
        public readonly partial struct SourceKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SourceKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SourceKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SourceKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SourceKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SourceKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SourceKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SourceKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SourceKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SourceKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SourceKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SourceKindEntity>();
                }
                finally
                {
