    ...
    public readonly partial struct BuilderAuthoringObjectBuilderDraftRevision
    {
        ...
        public readonly partial struct OneOf0Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AuthoringActionEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AuthoringActionEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AuthoringActionEntity DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.AuthoringActionEntity.ActionEntity Action
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.AuthoringActionEntity.ActionEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.AuthoringActionEntity.BuilderKindEntity BuilderKind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuilderKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderDraftRevision.OneOf0Entity.AuthoringActionEntity.BuilderKindEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in AuthoringActionEntity left, in AuthoringActionEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AuthoringActionEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AuthoringActionEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AuthoringActionEntity(JsonElement instance)
                {
                    return AuthoringActionEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AuthoringActionEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AuthoringActionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AuthoringActionEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AuthoringActionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AuthoringActionEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AuthoringActionEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AuthoringActionEntity>(json, options);
                }
                ...
                /// </exception>
                public static AuthoringActionEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AuthoringActionEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AuthoringActionEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AuthoringActionEntity>(ref reader, out result);
                }
...
#if NET
                static AuthoringActionEntity IJsonElement<AuthoringActionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AuthoringActionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AuthoringActionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AuthoringActionEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AuthoringActionEntity>(_idx);
                    }
