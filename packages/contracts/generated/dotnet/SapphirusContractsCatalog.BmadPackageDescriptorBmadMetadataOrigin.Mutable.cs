...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadMetadataOrigin
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadPackageDescriptorBmadMetadataOrigin instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadPackageDescriptorBmadMetadataOrigin"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadPackageDescriptorBmadMetadataOrigin(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadPackageDescriptorBmadMetadataOrigin.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadMetadataOrigin Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadMetadataOrigin Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadPackageDescriptorBmadMetadataOrigin>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadPackageDescriptorBmadMetadataOrigin instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadPackageDescriptorBmadMetadataOrigin, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadPackageDescriptorBmadMetadataOrigin> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadPackageDescriptorBmadMetadataOrigin>();
            }
            finally
            {
