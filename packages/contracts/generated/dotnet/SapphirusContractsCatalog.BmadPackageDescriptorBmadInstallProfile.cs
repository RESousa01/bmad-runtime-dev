...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadInstallProfile
#if NET8_0_OR_GREATER
        : IJsonElement<BmadPackageDescriptorBmadInstallProfile>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadPackageDescriptorBmadInstallProfile"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadPackageDescriptorBmadInstallProfile(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadPackageDescriptorBmadInstallProfile DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadPackageDescriptorBmadInstallProfile value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadInstallProfile left, in BmadPackageDescriptorBmadInstallProfile right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadInstallProfile left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadPackageDescriptorBmadInstallProfile instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadPackageDescriptorBmadInstallProfile(JsonElement instance)
        {
            return BmadPackageDescriptorBmadInstallProfile.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadInstallProfile From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadInstallProfile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadInstallProfile>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadInstallProfile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadInstallProfile>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadInstallProfile ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadInstallProfile>(json, options);
        }
        ...
        /// </exception>
        public static BmadPackageDescriptorBmadInstallProfile ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadInstallProfile>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadPackageDescriptorBmadInstallProfile? result)
        {
            return JsonElementHelpers.TryParseValue<BmadPackageDescriptorBmadInstallProfile>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadPackageDescriptorBmadInstallProfile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadPackageDescriptorBmadInstallProfile IJsonElement<BmadPackageDescriptorBmadInstallProfile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadPackageDescriptorBmadInstallProfile: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadPackageDescriptorBmadInstallProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadPackageDescriptorBmadInstallProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadInstallProfile Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadPackageDescriptorBmadInstallProfile>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadPackageDescriptorBmadInstallProfile"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadInstallProfile Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadPackageDescriptorBmadInstallProfile>(_idx);
            }
        ...
        /// <param name="matchMethodCliV6">Match 1st item.</param>
        /// <param name="matchStandaloneBuilderSetupV2">Match 2nd item.</param>
        /// <param name="matchSapphirusManagedV1">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchMethodCliV6,
            Func<TContext, TResult> matchStandaloneBuilderSetupV2,
            Func<TContext, TResult> matchSapphirusManagedV1,
...
#endif
        {
            ...
            {
                return matchMethodCliV6(context);
            }
            ...
            {
                return matchSapphirusManagedV1(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchMethodCliV6,
            Func<TResult> matchStandaloneBuilderSetupV2,
            Func<TResult> matchSapphirusManagedV1,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchMethodCliV6();
            }
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchSapphirusManagedV1();
            }
