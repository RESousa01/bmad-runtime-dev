    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct ChangedFilesArray
        {
            ...
            public readonly partial struct ChangedFilesEntity
            {
                ...
                public readonly partial struct PostContentHashEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<PostContentHashEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="PostContentHashEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal PostContentHashEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static PostContentHashEntity DefaultInstance { get; }
                    ...
                    public static explicit operator Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256(PostContentHashEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator PostContentHashEntity(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256 value)
                    {
                        return From(value);
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in PostContentHashEntity left, in PostContentHashEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in PostContentHashEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(PostContentHashEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PostContentHashEntity(JsonElement instance)
                    {
                        return PostContentHashEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static PostContentHashEntity From<T>(in T instance)
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out PostContentHashEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<PostContentHashEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PostContentHashEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static PostContentHashEntity IJsonElement<PostContentHashEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PostContentHashEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="PostContentHashEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PostContentHashEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public PostContentHashEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PostContentHashEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PostContentHashEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public PostContentHashEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<PostContentHashEntity>(_idx);
                        }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostContentHashEntity, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostContentHashEntity, TResult> defaultMatch)
                    {
                        if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                        {
