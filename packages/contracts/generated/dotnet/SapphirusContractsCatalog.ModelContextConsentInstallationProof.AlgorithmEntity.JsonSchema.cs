    ...
    public readonly partial struct ModelContextConsentInstallationProof
    {
            ...
            : IJsonElement<AlgorithmEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "ES256"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly AlgorithmEntity ConstJson = ParsedJsonDocument<AlgorithmEntity>.StringConstant([.."\"ES256\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ModelContextConsentInstallationProof/properties/algorithm"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ModelContextConsentInstallationProof/properties/algorithm";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ModelContextConsentInstallationProof/properties/algorithm"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "ES256"u8, "ES256", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "ES256", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
