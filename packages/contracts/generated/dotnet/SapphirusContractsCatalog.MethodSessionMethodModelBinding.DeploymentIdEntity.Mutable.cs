    ...
    public readonly partial struct MethodSessionMethodModelBinding
    {
        ...
        public readonly partial struct DeploymentIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DeploymentIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DeploymentIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeploymentIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeploymentIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DeploymentIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DeploymentIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DeploymentIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DeploymentIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DeploymentIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DeploymentIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DeploymentIdEntity>();
                }
                finally
                {
