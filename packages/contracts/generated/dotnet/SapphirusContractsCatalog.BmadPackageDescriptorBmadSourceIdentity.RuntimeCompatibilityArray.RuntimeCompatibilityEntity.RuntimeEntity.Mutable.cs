            ...
            public readonly partial struct RuntimeCompatibilityEntity
            {
                ...
                public readonly partial struct RuntimeEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RuntimeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RuntimeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RuntimeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RuntimeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuntimeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuntimeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RuntimeEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RuntimeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RuntimeEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RuntimeEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RuntimeEntity>();
                        }
                        finally
                        {
