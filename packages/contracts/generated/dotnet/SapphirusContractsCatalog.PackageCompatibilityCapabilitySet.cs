...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibilityCapabilitySet
        ...
        : IJsonElement<PackageCompatibilityCapabilitySet>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCompatibilityCapabilitySet"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PackageCompatibilityCapabilitySet(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PackageCompatibilityCapabilitySet DefaultInstance { get; }
        ...
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibilityCapabilitySet.PackageCompatibilityCapabilitySetEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibilityCapabilitySet.PackageCompatibilityCapabilitySetEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibilityCapabilitySet.PackageCompatibilityCapabilitySetEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibilityCapabilitySet.PackageCompatibilityCapabilitySetEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in PackageCompatibilityCapabilitySet left, in PackageCompatibilityCapabilitySet right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PackageCompatibilityCapabilitySet left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PackageCompatibilityCapabilitySet instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PackageCompatibilityCapabilitySet(JsonElement instance)
        {
            return PackageCompatibilityCapabilitySet.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityCapabilitySet From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityCapabilitySet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySet>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityCapabilitySet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySet>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityCapabilitySet ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySet>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static PackageCompatibilityCapabilitySet ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySet>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PackageCompatibilityCapabilitySet? result)
        {
            return JsonElementHelpers.TryParseValue<PackageCompatibilityCapabilitySet>(ref reader, out result);
        }
...
#if NET
        static PackageCompatibilityCapabilitySet IJsonElement<PackageCompatibilityCapabilitySet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PackageCompatibilityCapabilitySet: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public PackageCompatibilityCapabilitySet Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public PackageCompatibilityCapabilitySet Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PackageCompatibilityCapabilitySet>(_idx);
            }
