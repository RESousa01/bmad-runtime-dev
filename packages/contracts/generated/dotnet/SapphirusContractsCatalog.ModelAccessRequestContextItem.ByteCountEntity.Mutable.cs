    ...
    public readonly partial struct ModelAccessRequestContextItem
    {
        ...
        public readonly partial struct ByteCountEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ByteCountEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ByteCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ByteCountEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ByteCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ByteCountEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ByteCountEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ByteCountEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ByteCountEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ByteCountEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ByteCountEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ByteCountEntity>();
                }
                finally
                {
