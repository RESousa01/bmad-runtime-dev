    ...
    public readonly partial struct BmadValidationReportBmadValidationFinding
    {
            ...
            : IJsonElement<SourceKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "upstream_method"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SourceKindEntity EnumJson1 = ParsedJsonDocument<SourceKindEntity>.StringConstant([.."\"upstream_method\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "upstream_builder"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SourceKindEntity EnumJson2 = ParsedJsonDocument<SourceKindEntity>.StringConstant([.."\"upstream_builder\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "sapphirus"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SourceKindEntity EnumJson3 = ParsedJsonDocument<SourceKindEntity>.StringConstant([.."\"sapphirus\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "upstream_method"
                /// as a <see cref="SourceKindEntity"/>.
                /// </summary>
                public static SourceKindEntity UpstreamMethod { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "upstream_method"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> UpstreamMethodUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "upstream_builder"
                /// as a <see cref="SourceKindEntity"/>.
                /// </summary>
                public static SourceKindEntity UpstreamBuilder { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "upstream_builder"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> UpstreamBuilderUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "sapphirus"
                /// as a <see cref="SourceKindEntity"/>.
                /// </summary>
                public static SourceKindEntity Sapphirus { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "sapphirus"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SapphirusUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationFinding/properties/sourceKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationFinding/properties/sourceKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationFinding/properties/sourceKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("upstream_method"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("upstream_builder"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("sapphirus"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
