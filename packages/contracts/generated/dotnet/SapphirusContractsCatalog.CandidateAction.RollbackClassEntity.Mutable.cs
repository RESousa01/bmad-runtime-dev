    ...
    public readonly partial struct CandidateAction
    {
        ...
        public readonly partial struct RollbackClassEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RollbackClassEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RollbackClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RollbackClassEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RollbackClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RollbackClassEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RollbackClassEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RollbackClassEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RollbackClassEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RollbackClassEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RollbackClassEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RollbackClassEntity>();
                }
                finally
                {
