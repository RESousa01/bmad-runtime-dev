            ...
            public readonly partial struct InheritedInvariantsEntity
            {
                ...
                public readonly partial struct InvariantIdEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(InvariantIdEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="InvariantIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator InvariantIdEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"InvariantIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InvariantIdEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InvariantIdEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<InvariantIdEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(InvariantIdEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<InvariantIdEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<InvariantIdEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<InvariantIdEntity>();
                        }
                        finally
                        {
