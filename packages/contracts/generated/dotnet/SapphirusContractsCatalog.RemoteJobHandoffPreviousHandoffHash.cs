...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffPreviousHandoffHash
#if NET8_0_OR_GREATER
        : IJsonElement<RemoteJobHandoffPreviousHandoffHash>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteJobHandoffPreviousHandoffHash"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RemoteJobHandoffPreviousHandoffHash(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RemoteJobHandoffPreviousHandoffHash DefaultInstance { get; }
        ...
        public static explicit operator Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256(RemoteJobHandoffPreviousHandoffHash value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RemoteJobHandoffPreviousHandoffHash(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256 value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffPreviousHandoffHash left, in RemoteJobHandoffPreviousHandoffHash right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffPreviousHandoffHash left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RemoteJobHandoffPreviousHandoffHash instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RemoteJobHandoffPreviousHandoffHash(JsonElement instance)
        {
            return RemoteJobHandoffPreviousHandoffHash.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffPreviousHandoffHash From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RemoteJobHandoffPreviousHandoffHash? result)
        {
            return JsonElementHelpers.TryParseValue<RemoteJobHandoffPreviousHandoffHash>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RemoteJobHandoffPreviousHandoffHash(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RemoteJobHandoffPreviousHandoffHash IJsonElement<RemoteJobHandoffPreviousHandoffHash>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RemoteJobHandoffPreviousHandoffHash: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RemoteJobHandoffPreviousHandoffHash"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RemoteJobHandoffPreviousHandoffHash"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffPreviousHandoffHash Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RemoteJobHandoffPreviousHandoffHash>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RemoteJobHandoffPreviousHandoffHash"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffPreviousHandoffHash Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RemoteJobHandoffPreviousHandoffHash>(_idx);
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.RemoteJobHandoffPreviousHandoffHash, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.RemoteJobHandoffPreviousHandoffHash, TResult> defaultMatch)
        {
            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
            {
