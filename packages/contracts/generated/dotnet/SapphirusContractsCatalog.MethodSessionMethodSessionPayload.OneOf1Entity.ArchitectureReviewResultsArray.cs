    ...
    public readonly partial struct MethodSessionMethodSessionPayload
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct ArchitectureReviewResultsArray
                ...
                : IJsonElement<ArchitectureReviewResultsArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ArchitectureReviewResultsArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ArchitectureReviewResultsArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ArchitectureReviewResultsArray DefaultInstance { get; }
                ...
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in ArchitectureReviewResultsArray left, in ArchitectureReviewResultsArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ArchitectureReviewResultsArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ArchitectureReviewResultsArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArchitectureReviewResultsArray(JsonElement instance)
                {
                    return ArchitectureReviewResultsArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureReviewResultsArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureReviewResultsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ArchitectureReviewResultsArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureReviewResultsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ArchitectureReviewResultsArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureReviewResultsArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ArchitectureReviewResultsArray>(json, options);
                }
                ...
                /// </exception>
                public static ArchitectureReviewResultsArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ArchitectureReviewResultsArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ArchitectureReviewResultsArray? result)
                {
                    return JsonElementHelpers.TryParseValue<ArchitectureReviewResultsArray>(ref reader, out result);
                }
...
#if NET
                static ArchitectureReviewResultsArray IJsonElement<ArchitectureReviewResultsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArchitectureReviewResultsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ArchitectureReviewResultsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public ArchitectureReviewResultsArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ArchitectureReviewResultsArray>(_idx);
                    }
