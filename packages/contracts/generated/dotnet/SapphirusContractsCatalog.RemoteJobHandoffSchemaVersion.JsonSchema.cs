...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<RemoteJobHandoffSchemaVersion>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Const = "sapphirus.remote-job-handoff.v1"u8.ToArray();
            /// <summary>
            /// A constant for the <c>const</c> keyword.
            /// </summary>
            public static readonly RemoteJobHandoffSchemaVersion ConstJson = ParsedJsonDocument<RemoteJobHandoffSchemaVersion>.StringConstant([.."\"sapphirus.remote-job-handoff.v1\""u8]);
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffSchemaVersion"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/RemoteJobHandoffSchemaVersion";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffSchemaVersion"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "sapphirus.remote-job-handoff.v1"u8, "sapphirus.remote-job-handoff.v1", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "sapphirus.remote-job-handoff.v1", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
