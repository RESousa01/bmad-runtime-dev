        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct ObjectKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ObjectKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ObjectKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ObjectKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ObjectKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ObjectKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ObjectKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ObjectKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ObjectKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ObjectKindEntity>();
                    }
                    finally
                    {
