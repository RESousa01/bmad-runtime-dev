...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionMethodAdvanceResult
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct UnresolvedOpenItemCountEntity
#if NET8_0_OR_GREATER
                : IJsonElement<UnresolvedOpenItemCountEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="UnresolvedOpenItemCountEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal UnresolvedOpenItemCountEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static UnresolvedOpenItemCountEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator long(UnresolvedOpenItemCountEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator double(UnresolvedOpenItemCountEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator Corvus.Numerics.BigNumber(UnresolvedOpenItemCountEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(UnresolvedOpenItemCountEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator decimal(UnresolvedOpenItemCountEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in UnresolvedOpenItemCountEntity left, in UnresolvedOpenItemCountEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in UnresolvedOpenItemCountEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(UnresolvedOpenItemCountEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UnresolvedOpenItemCountEntity(JsonElement instance)
                {
                    return UnresolvedOpenItemCountEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UnresolvedOpenItemCountEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UnresolvedOpenItemCountEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UnresolvedOpenItemCountEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UnresolvedOpenItemCountEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UnresolvedOpenItemCountEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UnresolvedOpenItemCountEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UnresolvedOpenItemCountEntity>(json, options);
                }
                ...
                /// </exception>
                public static UnresolvedOpenItemCountEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<UnresolvedOpenItemCountEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out UnresolvedOpenItemCountEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<UnresolvedOpenItemCountEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new UnresolvedOpenItemCountEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static UnresolvedOpenItemCountEntity IJsonElement<UnresolvedOpenItemCountEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UnresolvedOpenItemCountEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="UnresolvedOpenItemCountEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="UnresolvedOpenItemCountEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public UnresolvedOpenItemCountEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<UnresolvedOpenItemCountEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="UnresolvedOpenItemCountEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public UnresolvedOpenItemCountEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<UnresolvedOpenItemCountEntity>(_idx);
                    }
