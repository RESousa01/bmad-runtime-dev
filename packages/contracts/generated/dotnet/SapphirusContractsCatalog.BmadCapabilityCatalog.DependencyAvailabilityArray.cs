...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalog
    {
        ...
        public readonly partial struct DependencyAvailabilityArray
            ...
            : IJsonElement<DependencyAvailabilityArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DependencyAvailabilityArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DependencyAvailabilityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DependencyAvailabilityArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in DependencyAvailabilityArray left, in DependencyAvailabilityArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DependencyAvailabilityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DependencyAvailabilityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DependencyAvailabilityArray(JsonElement instance)
            {
                return DependencyAvailabilityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DependencyAvailabilityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DependencyAvailabilityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DependencyAvailabilityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DependencyAvailabilityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DependencyAvailabilityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DependencyAvailabilityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DependencyAvailabilityArray>(json, options);
            }
            ...
            /// </exception>
            public static DependencyAvailabilityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DependencyAvailabilityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DependencyAvailabilityArray? result)
            {
                return JsonElementHelpers.TryParseValue<DependencyAvailabilityArray>(ref reader, out result);
            }
...
#if NET
            static DependencyAvailabilityArray IJsonElement<DependencyAvailabilityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DependencyAvailabilityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DependencyAvailabilityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DependencyAvailabilityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DependencyAvailabilityArray>(_idx);
                }
