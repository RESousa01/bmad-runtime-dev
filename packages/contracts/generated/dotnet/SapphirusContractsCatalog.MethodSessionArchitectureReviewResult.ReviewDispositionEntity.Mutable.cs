    ...
    public readonly partial struct MethodSessionArchitectureReviewResult
    {
        ...
        public readonly partial struct ReviewDispositionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ReviewDispositionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReviewDispositionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReviewDispositionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReviewDispositionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReviewDispositionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReviewDispositionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReviewDispositionEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReviewDispositionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReviewDispositionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReviewDispositionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReviewDispositionEntity>();
                }
                finally
                {
