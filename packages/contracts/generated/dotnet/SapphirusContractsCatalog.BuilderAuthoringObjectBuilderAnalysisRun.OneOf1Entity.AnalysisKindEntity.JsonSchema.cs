        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<AnalysisKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "model_lens"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly AnalysisKindEntity ConstJson = ParsedJsonDocument<AnalysisKindEntity>.StringConstant([.."\"model_lens\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/1/properties/analysisKind"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/1/properties/analysisKind";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/1/properties/analysisKind"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "model_lens"u8, "model_lens", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "model_lens", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
