            ...
            public readonly partial struct ResolvedEntriesEntity
            {
                ...
                public readonly partial struct InterpretationEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(InterpretationEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="InterpretationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator InterpretationEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"InterpretationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InterpretationEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InterpretationEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<InterpretationEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(InterpretationEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<InterpretationEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<InterpretationEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<InterpretationEntity>();
                        }
                        finally
                        {
