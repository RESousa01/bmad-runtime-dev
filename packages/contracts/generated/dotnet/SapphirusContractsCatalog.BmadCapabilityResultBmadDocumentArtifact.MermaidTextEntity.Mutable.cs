    ...
    public readonly partial struct BmadCapabilityResultBmadDocumentArtifact
    {
        ...
        public readonly partial struct MermaidTextEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MermaidTextEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MermaidTextEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MermaidTextEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MermaidTextEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MermaidTextEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MermaidTextEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MermaidTextEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MermaidTextEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MermaidTextEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MermaidTextEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MermaidTextEntity>();
                }
                finally
                {
