    ...
    public readonly partial struct SpecConsumptionRecord
    {
        ...
        public readonly partial struct AttemptNumberEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AttemptNumberEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AttemptNumberEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AttemptNumberEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AttemptNumberEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AttemptNumberEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AttemptNumberEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AttemptNumberEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AttemptNumberEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AttemptNumberEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AttemptNumberEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AttemptNumberEntity>();
                }
                finally
                {
