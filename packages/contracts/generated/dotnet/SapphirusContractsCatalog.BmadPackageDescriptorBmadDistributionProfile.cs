...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadDistributionProfile
#if NET8_0_OR_GREATER
        : IJsonElement<BmadPackageDescriptorBmadDistributionProfile>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadPackageDescriptorBmadDistributionProfile"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadPackageDescriptorBmadDistributionProfile(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadPackageDescriptorBmadDistributionProfile DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadPackageDescriptorBmadDistributionProfile value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadDistributionProfile left, in BmadPackageDescriptorBmadDistributionProfile right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadDistributionProfile left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadPackageDescriptorBmadDistributionProfile instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadPackageDescriptorBmadDistributionProfile(JsonElement instance)
        {
            return BmadPackageDescriptorBmadDistributionProfile.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadDistributionProfile From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadDistributionProfile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadDistributionProfile>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadDistributionProfile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadDistributionProfile>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadDistributionProfile ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadDistributionProfile>(json, options);
        }
        ...
        /// </exception>
        public static BmadPackageDescriptorBmadDistributionProfile ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadDistributionProfile>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadPackageDescriptorBmadDistributionProfile? result)
        {
            return JsonElementHelpers.TryParseValue<BmadPackageDescriptorBmadDistributionProfile>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadPackageDescriptorBmadDistributionProfile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadPackageDescriptorBmadDistributionProfile IJsonElement<BmadPackageDescriptorBmadDistributionProfile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadPackageDescriptorBmadDistributionProfile: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadPackageDescriptorBmadDistributionProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadPackageDescriptorBmadDistributionProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadDistributionProfile Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadPackageDescriptorBmadDistributionProfile>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadPackageDescriptorBmadDistributionProfile"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadDistributionProfile Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadPackageDescriptorBmadDistributionProfile>(_idx);
            }
        ...
        /// <param name="matchMethodSourceTree">Match 1st item.</param>
        /// <param name="matchMethodClaudePlugin">Match 2nd item.</param>
        /// <param name="matchMethodWebBundleV1">Match 3rd item.</param>
        /// <param name="matchBuilderSourceTree">Match 4th item.</param>
        /// <param name="matchBuilderPlugin">Match 5th item.</param>
        /// <param name="matchSapphirusPackage">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchMethodSourceTree,
            Func<TContext, TResult> matchMethodClaudePlugin,
            Func<TContext, TResult> matchMethodWebBundleV1,
            Func<TContext, TResult> matchBuilderSourceTree,
            Func<TContext, TResult> matchBuilderPlugin,
            Func<TContext, TResult> matchSapphirusPackage,
...
#endif
        {
            ...
            {
                return matchMethodSourceTree(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchMethodClaudePlugin(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchMethodWebBundleV1(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBuilderSourceTree(context);
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchBuilderPlugin(context);
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchSapphirusPackage(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchMethodSourceTree,
            Func<TResult> matchMethodClaudePlugin,
            Func<TResult> matchMethodWebBundleV1,
            Func<TResult> matchBuilderSourceTree,
            Func<TResult> matchBuilderPlugin,
            Func<TResult> matchSapphirusPackage,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchMethodSourceTree();
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchMethodClaudePlugin();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchMethodWebBundleV1();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBuilderSourceTree();
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchBuilderPlugin();
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchSapphirusPackage();
            }
