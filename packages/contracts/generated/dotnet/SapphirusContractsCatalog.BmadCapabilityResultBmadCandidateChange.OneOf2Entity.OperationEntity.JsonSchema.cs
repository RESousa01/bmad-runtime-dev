        ...
        public readonly partial struct OneOf2Entity
        {
                ...
                : IJsonElement<OperationEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "delete"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly OperationEntity ConstJson = ParsedJsonDocument<OperationEntity>.StringConstant([.."\"delete\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResultBmadCandidateChange/oneOf/2/properties/operation"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadCapabilityResultBmadCandidateChange/oneOf/2/properties/operation";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResultBmadCandidateChange/oneOf/2/properties/operation"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "delete"u8, "delete", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "delete", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
