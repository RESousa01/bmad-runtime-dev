    ...
    public readonly partial struct SpecConsumptionRecord
    {
            ...
            : IJsonElement<SchemaVersionEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "sapphirus.spec-consumption.v1"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly SchemaVersionEntity ConstJson = ParsedJsonDocument<SchemaVersionEntity>.StringConstant([.."\"sapphirus.spec-consumption.v1\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/SpecConsumptionRecord/properties/schemaVersion"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/SpecConsumptionRecord/properties/schemaVersion";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/SpecConsumptionRecord/properties/schemaVersion"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "sapphirus.spec-consumption.v1"u8, "sapphirus.spec-consumption.v1", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "sapphirus.spec-consumption.v1", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
