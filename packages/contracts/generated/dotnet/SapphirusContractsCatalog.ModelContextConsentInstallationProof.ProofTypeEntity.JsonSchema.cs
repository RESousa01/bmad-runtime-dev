    ...
    public readonly partial struct ModelContextConsentInstallationProof
    {
            ...
            : IJsonElement<ProofTypeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "installation_signature"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly ProofTypeEntity ConstJson = ParsedJsonDocument<ProofTypeEntity>.StringConstant([.."\"installation_signature\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ModelContextConsentInstallationProof/properties/proofType"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ModelContextConsentInstallationProof/properties/proofType";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ModelContextConsentInstallationProof/properties/proofType"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "installation_signature"u8, "installation_signature", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "installation_signature", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
