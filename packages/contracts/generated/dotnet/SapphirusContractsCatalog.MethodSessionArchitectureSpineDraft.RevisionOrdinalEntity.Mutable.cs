    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct RevisionOrdinalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RevisionOrdinalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RevisionOrdinalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RevisionOrdinalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RevisionOrdinalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RevisionOrdinalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RevisionOrdinalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RevisionOrdinalEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RevisionOrdinalEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RevisionOrdinalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RevisionOrdinalEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RevisionOrdinalEntity>();
                }
                finally
                {
