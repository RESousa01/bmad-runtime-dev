    ...
    public readonly partial struct BmadCapabilityCatalogBmadAgentPromptReferenceTarget
    {
            ...
            : IJsonElement<AvailabilityEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "unavailable_source_prompt"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly AvailabilityEntity ConstJson = ParsedJsonDocument<AvailabilityEntity>.StringConstant([.."\"unavailable_source_prompt\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityCatalogBmadAgentPromptReferenceTarget/properties/availability"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadCapabilityCatalogBmadAgentPromptReferenceTarget/properties/availability";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityCatalogBmadAgentPromptReferenceTarget/properties/availability"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "unavailable_source_prompt"u8, "unavailable_source_prompt", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "unavailable_source_prompt", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
