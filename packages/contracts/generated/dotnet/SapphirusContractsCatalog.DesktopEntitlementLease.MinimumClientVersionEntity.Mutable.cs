    ...
    public readonly partial struct DesktopEntitlementLease
    {
        ...
        public readonly partial struct MinimumClientVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MinimumClientVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinimumClientVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumClientVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumClientVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumClientVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumClientVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinimumClientVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinimumClientVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinimumClientVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinimumClientVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinimumClientVersionEntity>();
                }
                finally
                {
