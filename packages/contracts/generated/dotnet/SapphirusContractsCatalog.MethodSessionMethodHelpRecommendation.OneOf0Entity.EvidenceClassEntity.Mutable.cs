        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct EvidenceClassEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EvidenceClassEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EvidenceClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EvidenceClassEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EvidenceClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EvidenceClassEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EvidenceClassEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EvidenceClassEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EvidenceClassEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EvidenceClassEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EvidenceClassEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EvidenceClassEntity>();
                    }
                    finally
                    {
