...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct RuntimeUseEntity
#if NET8_0_OR_GREATER
            : IJsonElement<RuntimeUseEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RuntimeUseEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RuntimeUseEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RuntimeUseEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RuntimeUseEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RuntimeUseEntity left, in RuntimeUseEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RuntimeUseEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RuntimeUseEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RuntimeUseEntity(JsonElement instance)
            {
                return RuntimeUseEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RuntimeUseEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RuntimeUseEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RuntimeUseEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RuntimeUseEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RuntimeUseEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RuntimeUseEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RuntimeUseEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static RuntimeUseEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RuntimeUseEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RuntimeUseEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RuntimeUseEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RuntimeUseEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RuntimeUseEntity IJsonElement<RuntimeUseEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RuntimeUseEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RuntimeUseEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RuntimeUseEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RuntimeUseEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RuntimeUseEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RuntimeUseEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RuntimeUseEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RuntimeUseEntity>(_idx);
                }
            ...
            /// <param name="matchInstructionData">Match 1st item.</param>
            /// <param name="matchReferenceData">Match 2nd item.</param>
            /// <param name="matchDescriptiveEvidence">Match 3rd item.</param>
            /// <param name="matchBlockedExecutable">Match 4th item.</param>
            /// <param name="matchUnavailableReference">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchInstructionData,
                Func<TContext, TResult> matchReferenceData,
                Func<TContext, TResult> matchDescriptiveEvidence,
                Func<TContext, TResult> matchBlockedExecutable,
                Func<TContext, TResult> matchUnavailableReference,
...
#endif
            {
                ...
                {
                    return matchInstructionData(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReferenceData(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchDescriptiveEvidence(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchBlockedExecutable(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchUnavailableReference(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchInstructionData,
                Func<TResult> matchReferenceData,
                Func<TResult> matchDescriptiveEvidence,
                Func<TResult> matchBlockedExecutable,
                Func<TResult> matchUnavailableReference,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchInstructionData();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReferenceData();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchDescriptiveEvidence();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchBlockedExecutable();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchUnavailableReference();
                }
