...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessReceiptSafeSize
#if NET8_0_OR_GREATER
        : IJsonElement<ModelAccessReceiptSafeSize>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelAccessReceiptSafeSize"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModelAccessReceiptSafeSize(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModelAccessReceiptSafeSize DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(ModelAccessReceiptSafeSize value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(ModelAccessReceiptSafeSize value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(ModelAccessReceiptSafeSize value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(ModelAccessReceiptSafeSize value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(ModelAccessReceiptSafeSize value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ModelAccessReceiptSafeSize left, in ModelAccessReceiptSafeSize right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModelAccessReceiptSafeSize left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ModelAccessReceiptSafeSize instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModelAccessReceiptSafeSize(JsonElement instance)
        {
            return ModelAccessReceiptSafeSize.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptSafeSize From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptSafeSize ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptSafeSize>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptSafeSize ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptSafeSize>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessReceiptSafeSize ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptSafeSize>(json, options);
        }
        ...
        /// </exception>
        public static ModelAccessReceiptSafeSize ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ModelAccessReceiptSafeSize>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModelAccessReceiptSafeSize? result)
        {
            return JsonElementHelpers.TryParseValue<ModelAccessReceiptSafeSize>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ModelAccessReceiptSafeSize(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ModelAccessReceiptSafeSize IJsonElement<ModelAccessReceiptSafeSize>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModelAccessReceiptSafeSize: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ModelAccessReceiptSafeSize"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ModelAccessReceiptSafeSize"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ModelAccessReceiptSafeSize Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ModelAccessReceiptSafeSize>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ModelAccessReceiptSafeSize"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ModelAccessReceiptSafeSize Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModelAccessReceiptSafeSize>(_idx);
            }
