    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct PackageIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PackageIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PackageIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PackageIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PackageIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PackageIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PackageIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PackageIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PackageIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PackageIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PackageIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PackageIdEntity>();
                }
                finally
                {
