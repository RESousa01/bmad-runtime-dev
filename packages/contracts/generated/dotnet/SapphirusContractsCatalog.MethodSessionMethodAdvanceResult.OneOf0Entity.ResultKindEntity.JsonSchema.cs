        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<ResultKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "conversation_turn"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ResultKindEntity ConstJson = ParsedJsonDocument<ResultKindEntity>.StringConstant([.."\"conversation_turn\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodAdvanceResult/oneOf/0/properties/resultKind"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionMethodAdvanceResult/oneOf/0/properties/resultKind";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodAdvanceResult/oneOf/0/properties/resultKind"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "conversation_turn"u8, "conversation_turn", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "conversation_turn", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
