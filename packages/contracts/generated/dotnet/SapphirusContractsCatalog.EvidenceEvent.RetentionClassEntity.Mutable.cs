    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct RetentionClassEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RetentionClassEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetentionClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetentionClassEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetentionClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionClassEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionClassEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetentionClassEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RetentionClassEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RetentionClassEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RetentionClassEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RetentionClassEntity>();
                }
                finally
                {
