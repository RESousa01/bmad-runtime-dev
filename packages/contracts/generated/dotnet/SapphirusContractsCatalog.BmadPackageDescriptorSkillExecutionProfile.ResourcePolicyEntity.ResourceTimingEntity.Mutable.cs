        ...
        public readonly partial struct ResourcePolicyEntity
        {
            ...
            public readonly partial struct ResourceTimingEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ResourceTimingEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ResourceTimingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ResourceTimingEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ResourceTimingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResourceTimingEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResourceTimingEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ResourceTimingEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ResourceTimingEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ResourceTimingEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ResourceTimingEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ResourceTimingEntity>();
                    }
                    finally
                    {
