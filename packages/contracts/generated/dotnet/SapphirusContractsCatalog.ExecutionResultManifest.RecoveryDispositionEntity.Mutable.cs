    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct RecoveryDispositionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RecoveryDispositionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RecoveryDispositionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RecoveryDispositionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RecoveryDispositionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RecoveryDispositionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RecoveryDispositionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RecoveryDispositionEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RecoveryDispositionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RecoveryDispositionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RecoveryDispositionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RecoveryDispositionEntity>();
                }
                finally
                {
