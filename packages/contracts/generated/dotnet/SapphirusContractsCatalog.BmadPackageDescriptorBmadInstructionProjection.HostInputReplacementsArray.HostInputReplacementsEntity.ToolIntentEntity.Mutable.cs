            ...
            public readonly partial struct HostInputReplacementsEntity
            {
                ...
                public readonly partial struct ToolIntentEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ToolIntentEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ToolIntentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ToolIntentEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ToolIntentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ToolIntentEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ToolIntentEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ToolIntentEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ToolIntentEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ToolIntentEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ToolIntentEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ToolIntentEntity>();
                        }
                        finally
                        {
