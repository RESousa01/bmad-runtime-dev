    ...
    public readonly partial struct CommonMutableInputBinding
    {
        ...
        public readonly partial struct InputIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(InputIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InputIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InputIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InputIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InputIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InputIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InputIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(InputIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<InputIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InputIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InputIdEntity>();
                }
                finally
                {
