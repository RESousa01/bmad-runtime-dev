    ...
    public readonly partial struct CandidateAction
    {
        ...
        public readonly partial struct ActionKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ActionKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ActionKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ActionKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ActionKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ActionKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ActionKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ActionKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ActionKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ActionKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ActionKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ActionKindEntity>();
                }
                finally
                {
