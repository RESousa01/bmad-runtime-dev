            ...
            public readonly partial struct FindingsEntity
            {
                ...
                public readonly partial struct PredictedDeltaEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PredictedDeltaEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PredictedDeltaEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PredictedDeltaEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PredictedDeltaEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PredictedDeltaEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PredictedDeltaEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PredictedDeltaEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PredictedDeltaEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PredictedDeltaEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PredictedDeltaEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PredictedDeltaEntity>();
                        }
                        finally
                        {
