...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffHandoffVersion
#if NET8_0_OR_GREATER
        : IJsonElement<RemoteJobHandoffHandoffVersion>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteJobHandoffHandoffVersion"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RemoteJobHandoffHandoffVersion(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RemoteJobHandoffHandoffVersion DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(RemoteJobHandoffHandoffVersion value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(RemoteJobHandoffHandoffVersion value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(RemoteJobHandoffHandoffVersion value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(RemoteJobHandoffHandoffVersion value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(RemoteJobHandoffHandoffVersion value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffHandoffVersion left, in RemoteJobHandoffHandoffVersion right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RemoteJobHandoffHandoffVersion left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RemoteJobHandoffHandoffVersion instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RemoteJobHandoffHandoffVersion(JsonElement instance)
        {
            return RemoteJobHandoffHandoffVersion.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffHandoffVersion From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffHandoffVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RemoteJobHandoffHandoffVersion>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffHandoffVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RemoteJobHandoffHandoffVersion>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RemoteJobHandoffHandoffVersion ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RemoteJobHandoffHandoffVersion>(json, options);
        }
        ...
        /// </exception>
        public static RemoteJobHandoffHandoffVersion ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RemoteJobHandoffHandoffVersion>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RemoteJobHandoffHandoffVersion? result)
        {
            return JsonElementHelpers.TryParseValue<RemoteJobHandoffHandoffVersion>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RemoteJobHandoffHandoffVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RemoteJobHandoffHandoffVersion IJsonElement<RemoteJobHandoffHandoffVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RemoteJobHandoffHandoffVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RemoteJobHandoffHandoffVersion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RemoteJobHandoffHandoffVersion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffHandoffVersion Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RemoteJobHandoffHandoffVersion>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RemoteJobHandoffHandoffVersion"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RemoteJobHandoffHandoffVersion Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RemoteJobHandoffHandoffVersion>(_idx);
            }
