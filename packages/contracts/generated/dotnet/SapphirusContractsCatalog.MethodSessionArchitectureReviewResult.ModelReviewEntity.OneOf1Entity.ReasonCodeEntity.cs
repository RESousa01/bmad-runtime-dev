        ...
        public readonly partial struct ModelReviewEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="ReasonCodeEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal ReasonCodeEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static ReasonCodeEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(ReasonCodeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in ReasonCodeEntity left, in ReasonCodeEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in ReasonCodeEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(ReasonCodeEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReasonCodeEntity(JsonElement instance)
                    {
                        return ReasonCodeEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ReasonCodeEntity From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ReasonCodeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<ReasonCodeEntity>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ReasonCodeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<ReasonCodeEntity>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ReasonCodeEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<ReasonCodeEntity>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static ReasonCodeEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<ReasonCodeEntity>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out ReasonCodeEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<ReasonCodeEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReasonCodeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static ReasonCodeEntity IJsonElement<ReasonCodeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReasonCodeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReasonCodeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReasonCodeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public ReasonCodeEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReasonCodeEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReasonCodeEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public ReasonCodeEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<ReasonCodeEntity>(_idx);
                        }
                    ...
                    /// <param name="matchConsentMissing">Match 1st item.</param>
                    /// <param name="matchConnectivityUnavailable">Match 2nd item.</param>
                    /// <param name="matchModelRefused">Match 3rd item.</param>
                    /// <param name="matchInvalidResult">Match 4th item.</param>
                    /// <param name="matchRequestTimeout">Match 5th item.</param>
                    /// <param name="matchRequestCancelled">Match 6th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchConsentMissing,
                        Func<TContext, TResult> matchConnectivityUnavailable,
                        Func<TContext, TResult> matchModelRefused,
                        Func<TContext, TResult> matchInvalidResult,
                        Func<TContext, TResult> matchRequestTimeout,
                        Func<TContext, TResult> matchRequestCancelled,
...
#endif
                    {
                        ...
                        {
                            return matchConsentMissing(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchConnectivityUnavailable(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchModelRefused(context);
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchInvalidResult(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchRequestTimeout(context);
                        }

                        if (this.ValueEquals(Constants.Enum6))
                        {
                            return matchRequestCancelled(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchConsentMissing,
                        Func<TResult> matchConnectivityUnavailable,
                        Func<TResult> matchModelRefused,
                        Func<TResult> matchInvalidResult,
                        Func<TResult> matchRequestTimeout,
                        Func<TResult> matchRequestCancelled,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchConsentMissing();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchConnectivityUnavailable();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchModelRefused();
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchInvalidResult();
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchRequestTimeout();
                        }

                        if (this.ValueEquals(Constants.Enum6))
                        {
                            return matchRequestCancelled();
                        }
