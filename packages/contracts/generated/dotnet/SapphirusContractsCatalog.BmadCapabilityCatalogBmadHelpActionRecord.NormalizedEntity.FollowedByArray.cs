    ...
    public readonly partial struct BmadCapabilityCatalogBmadHelpActionRecord
    {
        ...
        public readonly partial struct NormalizedEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FollowedByArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FollowedByArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FollowedByArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in FollowedByArray left, in FollowedByArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FollowedByArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(FollowedByArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FollowedByArray(JsonElement instance)
                {
                    return FollowedByArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FollowedByArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FollowedByArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FollowedByArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FollowedByArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FollowedByArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FollowedByArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FollowedByArray>(json, options);
                }
                ...
                /// </exception>
                public static FollowedByArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FollowedByArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FollowedByArray? result)
                {
                    return JsonElementHelpers.TryParseValue<FollowedByArray>(ref reader, out result);
                }
...
#if NET
                static FollowedByArray IJsonElement<FollowedByArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FollowedByArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public FollowedByArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FollowedByArray>(_idx);
                    }
