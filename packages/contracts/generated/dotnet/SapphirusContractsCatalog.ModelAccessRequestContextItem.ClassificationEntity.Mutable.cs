    ...
    public readonly partial struct ModelAccessRequestContextItem
    {
        ...
        public readonly partial struct ClassificationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClassificationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClassificationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClassificationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClassificationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClassificationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClassificationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClassificationEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClassificationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClassificationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClassificationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClassificationEntity>();
                }
                finally
                {
