            ...
            public readonly partial struct ActionsArray
            {
                ...
                public readonly partial struct ActionsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ActionsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ActionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ActionsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ActionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ActionsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ActionsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ActionsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ActionsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ActionsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ActionsEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ActionsEntity>();
                        }
                        finally
                        {
