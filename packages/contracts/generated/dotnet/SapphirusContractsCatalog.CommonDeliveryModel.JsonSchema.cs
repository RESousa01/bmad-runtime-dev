...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<CommonDeliveryModel>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "web_managed"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly CommonDeliveryModel EnumJson1 = ParsedJsonDocument<CommonDeliveryModel>.StringConstant([.."\"web_managed\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "windows_local"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly CommonDeliveryModel EnumJson2 = ParsedJsonDocument<CommonDeliveryModel>.StringConstant([.."\"windows_local\""u8]);
        }
        ...
        {
            /// <summary>
            /// Gets the string "web_managed"
            /// as a <see cref="CommonDeliveryModel"/>.
            /// </summary>
            public static CommonDeliveryModel WebManaged { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "web_managed"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> WebManagedUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "windows_local"
            /// as a <see cref="CommonDeliveryModel"/>.
            /// </summary>
            public static CommonDeliveryModel WindowsLocal { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "windows_local"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> WindowsLocalUtf8 => Constants.Enum2;
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonDeliveryModel"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/CommonDeliveryModel";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonDeliveryModel"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("web_managed"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("windows_local"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
                }
