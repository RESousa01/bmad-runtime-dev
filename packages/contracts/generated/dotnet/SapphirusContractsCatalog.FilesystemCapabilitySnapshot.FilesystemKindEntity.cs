...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct FilesystemKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<FilesystemKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FilesystemKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FilesystemKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FilesystemKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(FilesystemKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in FilesystemKindEntity left, in FilesystemKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FilesystemKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FilesystemKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FilesystemKindEntity(JsonElement instance)
            {
                return FilesystemKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FilesystemKindEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FilesystemKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FilesystemKindEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FilesystemKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FilesystemKindEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FilesystemKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FilesystemKindEntity>(json, options);
            }
            ...
            /// </exception>
            public static FilesystemKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FilesystemKindEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FilesystemKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<FilesystemKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FilesystemKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FilesystemKindEntity IJsonElement<FilesystemKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FilesystemKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FilesystemKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FilesystemKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FilesystemKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FilesystemKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FilesystemKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FilesystemKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FilesystemKindEntity>(_idx);
                }
            ...
            /// <param name="matchNtfs">Match 1st item.</param>
            /// <param name="matchRefs">Match 2nd item.</param>
            /// <param name="matchFat">Match 3rd item.</param>
            /// <param name="matchExfat">Match 4th item.</param>
            /// <param name="matchOther">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNtfs,
                Func<TContext, TResult> matchRefs,
                Func<TContext, TResult> matchFat,
                Func<TContext, TResult> matchExfat,
                Func<TContext, TResult> matchOther,
...
#endif
            {
                ...
                {
                    return matchFat(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchExfat(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchOther(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchNtfs,
                Func<TResult> matchRefs,
                Func<TResult> matchFat,
                Func<TResult> matchExfat,
                Func<TResult> matchOther,
