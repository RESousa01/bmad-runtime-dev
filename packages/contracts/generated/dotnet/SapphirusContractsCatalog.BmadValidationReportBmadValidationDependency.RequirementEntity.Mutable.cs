    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
        ...
        public readonly partial struct RequirementEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequirementEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequirementEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequirementEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequirementEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequirementEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequirementEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequirementEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RequirementEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RequirementEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequirementEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequirementEntity>();
                }
                finally
                {
