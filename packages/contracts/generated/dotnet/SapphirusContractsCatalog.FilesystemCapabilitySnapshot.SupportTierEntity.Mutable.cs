    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct SupportTierEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SupportTierEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SupportTierEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SupportTierEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SupportTierEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SupportTierEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SupportTierEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SupportTierEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SupportTierEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SupportTierEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SupportTierEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SupportTierEntity>();
                }
                finally
                {
