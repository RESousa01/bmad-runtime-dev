    ...
    public readonly partial struct MethodSessionBmadContextDecisionConsumption
    {
        ...
        public readonly partial struct RecordKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RecordKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RecordKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RecordKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RecordKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RecordKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RecordKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RecordKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RecordKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RecordKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RecordKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RecordKindEntity>();
                }
                finally
                {
