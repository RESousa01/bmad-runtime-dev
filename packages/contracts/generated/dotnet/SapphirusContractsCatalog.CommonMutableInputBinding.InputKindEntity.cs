...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonMutableInputBinding
    {
...
#endif
        {
            ...
            /// <param name="matchWorkspaceManifest">Match 1st item.</param>
            /// <param name="matchPathPreimage">Match 2nd item.</param>
            /// <param name="matchPackage">Match 3rd item.</param>
            /// <param name="matchToolchain">Match 4th item.</param>
            /// <param name="matchPolicy">Match 5th item.</param>
            /// <param name="matchExternalResource">Match 6th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchWorkspaceManifest,
                Func<TContext, TResult> matchPathPreimage,
                Func<TContext, TResult> matchPackage,
                Func<TContext, TResult> matchToolchain,
                Func<TContext, TResult> matchPolicy,
                Func<TContext, TResult> matchExternalResource,
...
#endif
            {
                ...
                {
                    return matchWorkspaceManifest(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPathPreimage(context);
                }
                ...
                {
                    return matchExternalResource(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchWorkspaceManifest,
                Func<TResult> matchPathPreimage,
                Func<TResult> matchPackage,
                Func<TResult> matchToolchain,
                Func<TResult> matchPolicy,
                Func<TResult> matchExternalResource,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchWorkspaceManifest();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPathPreimage();
                }
