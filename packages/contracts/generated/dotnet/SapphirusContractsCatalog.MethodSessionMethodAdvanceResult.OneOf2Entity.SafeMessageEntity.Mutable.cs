        ...
        public readonly partial struct OneOf2Entity
        {
            ...
            public readonly partial struct SafeMessageEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SafeMessageEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SafeMessageEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SafeMessageEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SafeMessageEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SafeMessageEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SafeMessageEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SafeMessageEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SafeMessageEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SafeMessageEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SafeMessageEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SafeMessageEntity>();
                    }
                    finally
                    {
