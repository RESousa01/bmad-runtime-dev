        ...
        public readonly partial struct StackArray
        {
                ...
                : IJsonElement<StackEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchVersionEvidence(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
