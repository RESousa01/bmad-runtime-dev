            ...
            public readonly partial struct OutputsArray
            {
                ...
                public readonly partial struct OutputsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(OutputsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="OutputsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator OutputsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"OutputsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly OutputsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly OutputsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<OutputsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(OutputsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<OutputsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<OutputsEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<OutputsEntity>();
                        }
                        finally
                        {
