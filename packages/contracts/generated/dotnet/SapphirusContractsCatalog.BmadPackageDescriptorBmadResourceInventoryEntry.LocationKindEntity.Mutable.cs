    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct LocationKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LocationKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LocationKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LocationKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LocationKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LocationKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LocationKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LocationKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LocationKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LocationKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LocationKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocationKindEntity>();
                }
                finally
                {
