    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
            ...
            : IJsonElement<SupportTierEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "supported_writable"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SupportTierEntity EnumJson1 = ParsedJsonDocument<SupportTierEntity>.StringConstant([.."\"supported_writable\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "read_only_evaluation"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SupportTierEntity EnumJson2 = ParsedJsonDocument<SupportTierEntity>.StringConstant([.."\"read_only_evaluation\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                ...
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SupportTierEntity EnumJson3 = ParsedJsonDocument<SupportTierEntity>.StringConstant([.."\"blocked\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "supported_writable"
                /// as a <see cref="SupportTierEntity"/>.
                /// </summary>
                public static SupportTierEntity SupportedWritable { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "supported_writable"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SupportedWritableUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "read_only_evaluation"
                /// as a <see cref="SupportTierEntity"/>.
                /// </summary>
                public static SupportTierEntity ReadOnlyEvaluation { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "read_only_evaluation"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ReadOnlyEvaluationUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "blocked"
                /// as a <see cref="SupportTierEntity"/>.
                /// </summary>
                public static SupportTierEntity Blocked { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "blocked"
                /// as a UTF8 byte array.
                /// </summary>
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/FilesystemCapabilitySnapshot/properties/supportTier"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/FilesystemCapabilitySnapshot/properties/supportTier";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/FilesystemCapabilitySnapshot/properties/supportTier"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("supported_writable"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("read_only_evaluation"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
