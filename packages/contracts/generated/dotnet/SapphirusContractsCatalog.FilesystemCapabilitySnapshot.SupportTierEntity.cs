...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct SupportTierEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SupportTierEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SupportTierEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SupportTierEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SupportTierEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SupportTierEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SupportTierEntity left, in SupportTierEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SupportTierEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SupportTierEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SupportTierEntity(JsonElement instance)
            {
                return SupportTierEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportTierEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportTierEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportTierEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportTierEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportTierEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportTierEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportTierEntity>(json, options);
            }
            ...
            /// </exception>
            public static SupportTierEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SupportTierEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SupportTierEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SupportTierEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SupportTierEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SupportTierEntity IJsonElement<SupportTierEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SupportTierEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SupportTierEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SupportTierEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SupportTierEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SupportTierEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SupportTierEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SupportTierEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SupportTierEntity>(_idx);
                }
            ...
            /// <param name="matchSupportedWritable">Match 1st item.</param>
            /// <param name="matchReadOnlyEvaluation">Match 2nd item.</param>
            /// <param name="matchBlocked">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSupportedWritable,
                Func<TContext, TResult> matchReadOnlyEvaluation,
...
#endif
            {
                ...
                {
                    return matchSupportedWritable(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReadOnlyEvaluation(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSupportedWritable,
                Func<TResult> matchReadOnlyEvaluation,
                Func<TResult> matchBlocked,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSupportedWritable();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReadOnlyEvaluation();
                }
