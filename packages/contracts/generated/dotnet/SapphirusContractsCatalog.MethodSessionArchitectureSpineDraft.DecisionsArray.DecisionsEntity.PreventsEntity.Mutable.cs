            ...
            public readonly partial struct DecisionsEntity
            {
                ...
                public readonly partial struct PreventsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PreventsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PreventsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PreventsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PreventsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreventsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreventsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PreventsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PreventsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PreventsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PreventsEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PreventsEntity>();
                        }
                        finally
                        {
