...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessRequestCanonicalSchemaId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelAccessRequestCanonicalSchemaId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelAccessRequestCanonicalSchemaId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelAccessRequestCanonicalSchemaId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelAccessRequestCanonicalSchemaId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessRequestCanonicalSchemaId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessRequestCanonicalSchemaId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelAccessRequestCanonicalSchemaId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelAccessRequestCanonicalSchemaId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelAccessRequestCanonicalSchemaId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelAccessRequestCanonicalSchemaId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelAccessRequestCanonicalSchemaId>();
            }
            finally
            {
