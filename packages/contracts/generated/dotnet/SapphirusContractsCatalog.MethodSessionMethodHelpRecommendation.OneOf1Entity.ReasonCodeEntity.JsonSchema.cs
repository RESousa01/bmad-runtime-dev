        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<ReasonCodeEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "catalog_evidence_absent"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly ReasonCodeEntity EnumJson1 = ParsedJsonDocument<ReasonCodeEntity>.StringConstant([.."\"catalog_evidence_absent\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "completion_evidence_ambiguous"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly ReasonCodeEntity EnumJson2 = ParsedJsonDocument<ReasonCodeEntity>.StringConstant([.."\"completion_evidence_ambiguous\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "dependency_unavailable"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly ReasonCodeEntity EnumJson3 = ParsedJsonDocument<ReasonCodeEntity>.StringConstant([.."\"dependency_unavailable\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "catalog_evidence_absent"
                    /// as a <see cref="ReasonCodeEntity"/>.
                    /// </summary>
                    public static ReasonCodeEntity CatalogEvidenceAbsent { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "catalog_evidence_absent"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> CatalogEvidenceAbsentUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "completion_evidence_ambiguous"
                    /// as a <see cref="ReasonCodeEntity"/>.
                    /// </summary>
                    public static ReasonCodeEntity CompletionEvidenceAmbiguous { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "completion_evidence_ambiguous"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> CompletionEvidenceAmbiguousUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "dependency_unavailable"
                    /// as a <see cref="ReasonCodeEntity"/>.
                    /// </summary>
                    public static ReasonCodeEntity DependencyUnavailable { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "dependency_unavailable"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> DependencyUnavailableUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodHelpRecommendation/oneOf/1/properties/reasonCode"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionMethodHelpRecommendation/oneOf/1/properties/reasonCode";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodHelpRecommendation/oneOf/1/properties/reasonCode"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("catalog_evidence_absent"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("completion_evidence_ambiguous"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("dependency_unavailable"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
