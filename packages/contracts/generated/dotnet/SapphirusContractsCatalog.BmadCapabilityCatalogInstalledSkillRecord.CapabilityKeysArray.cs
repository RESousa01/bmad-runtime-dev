...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalogInstalledSkillRecord
    {
        ...
        public readonly partial struct CapabilityKeysArray
            ...
            : IJsonElement<CapabilityKeysArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CapabilityKeysArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CapabilityKeysArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CapabilityKeysArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadCapabilityKey this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadCapabilityKey>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadCapabilityKey> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadCapabilityKey>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in CapabilityKeysArray left, in CapabilityKeysArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CapabilityKeysArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CapabilityKeysArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CapabilityKeysArray(JsonElement instance)
            {
                return CapabilityKeysArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityKeysArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityKeysArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityKeysArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityKeysArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityKeysArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityKeysArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityKeysArray>(json, options);
            }
            ...
            /// </exception>
            public static CapabilityKeysArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CapabilityKeysArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CapabilityKeysArray? result)
            {
                return JsonElementHelpers.TryParseValue<CapabilityKeysArray>(ref reader, out result);
            }
...
#if NET
            static CapabilityKeysArray IJsonElement<CapabilityKeysArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CapabilityKeysArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public CapabilityKeysArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public CapabilityKeysArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CapabilityKeysArray>(_idx);
                }
