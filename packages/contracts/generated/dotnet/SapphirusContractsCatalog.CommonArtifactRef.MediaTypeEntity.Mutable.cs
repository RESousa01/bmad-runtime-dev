    ...
    public readonly partial struct CommonArtifactRef
    {
        ...
        public readonly partial struct MediaTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MediaTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MediaTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MediaTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MediaTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MediaTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MediaTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MediaTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MediaTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MediaTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MediaTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MediaTypeEntity>();
                }
                finally
                {
