...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigResolution
    {
        ...
        public readonly partial struct OrderedLayerHashesArray
            ...
            : IJsonElement<OrderedLayerHashesArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OrderedLayerHashesArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OrderedLayerHashesArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OrderedLayerHashesArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in OrderedLayerHashesArray left, in OrderedLayerHashesArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OrderedLayerHashesArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OrderedLayerHashesArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OrderedLayerHashesArray(JsonElement instance)
            {
                return OrderedLayerHashesArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OrderedLayerHashesArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OrderedLayerHashesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OrderedLayerHashesArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OrderedLayerHashesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OrderedLayerHashesArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OrderedLayerHashesArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OrderedLayerHashesArray>(json, options);
            }
            ...
            /// </exception>
            public static OrderedLayerHashesArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OrderedLayerHashesArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OrderedLayerHashesArray? result)
            {
                return JsonElementHelpers.TryParseValue<OrderedLayerHashesArray>(ref reader, out result);
            }
...
#if NET
            static OrderedLayerHashesArray IJsonElement<OrderedLayerHashesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OrderedLayerHashesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OrderedLayerHashesArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OrderedLayerHashesArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OrderedLayerHashesArray>(_idx);
                }
