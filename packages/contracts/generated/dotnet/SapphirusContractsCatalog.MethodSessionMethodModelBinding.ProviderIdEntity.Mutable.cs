    ...
    public readonly partial struct MethodSessionMethodModelBinding
    {
        ...
        public readonly partial struct ProviderIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProviderIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProviderIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProviderIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProviderIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProviderIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProviderIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProviderIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProviderIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProviderIdEntity>();
                }
                finally
                {
