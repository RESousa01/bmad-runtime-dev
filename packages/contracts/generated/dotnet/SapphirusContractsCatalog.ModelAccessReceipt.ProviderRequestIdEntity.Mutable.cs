    ...
    public readonly partial struct ModelAccessReceipt
    {
        ...
        public readonly partial struct ProviderRequestIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProviderRequestIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProviderRequestIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProviderRequestIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProviderRequestIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderRequestIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderRequestIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProviderRequestIdEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ModelAccessReceipt.ProviderRequestIdEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ModelAccessReceipt.ProviderRequestIdEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonOpaqueRef.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProviderRequestIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProviderRequestIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProviderRequestIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProviderRequestIdEntity>();
                }
                finally
                {
