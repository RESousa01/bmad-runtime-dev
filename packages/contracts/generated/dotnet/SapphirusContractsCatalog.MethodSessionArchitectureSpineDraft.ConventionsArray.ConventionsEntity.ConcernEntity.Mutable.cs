            ...
            public readonly partial struct ConventionsEntity
            {
                ...
                public readonly partial struct ConcernEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ConcernEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ConcernEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ConcernEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ConcernEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ConcernEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ConcernEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ConcernEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ConcernEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ConcernEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ConcernEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ConcernEntity>();
                        }
                        finally
                        {
