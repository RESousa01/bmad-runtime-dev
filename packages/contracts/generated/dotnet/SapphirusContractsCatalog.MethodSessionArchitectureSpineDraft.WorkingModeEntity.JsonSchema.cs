    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
            ...
            : IJsonElement<WorkingModeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "coaching"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly WorkingModeEntity EnumJson1 = ParsedJsonDocument<WorkingModeEntity>.StringConstant([.."\"coaching\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "fast"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly WorkingModeEntity EnumJson2 = ParsedJsonDocument<WorkingModeEntity>.StringConstant([.."\"fast\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "coaching"
                /// as a <see cref="WorkingModeEntity"/>.
                /// </summary>
                public static WorkingModeEntity Coaching { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "coaching"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> CoachingUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "fast"
                /// as a <see cref="WorkingModeEntity"/>.
                /// </summary>
                public static WorkingModeEntity Fast { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "fast"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FastUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureSpineDraft/properties/workingMode"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodSessionArchitectureSpineDraft/properties/workingMode";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureSpineDraft/properties/workingMode"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("coaching"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("fast"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
