        ...
        public readonly partial struct OneOf2Entity
        {
                ...
                : IJsonElement<DispositionKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "incomplete"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly DispositionKindEntity ConstJson = ParsedJsonDocument<DispositionKindEntity>.StringConstant([.."\"incomplete\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2/properties/dispositionKind"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2/properties/dispositionKind";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/2/properties/dispositionKind"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "incomplete"u8, "incomplete", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "incomplete", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
