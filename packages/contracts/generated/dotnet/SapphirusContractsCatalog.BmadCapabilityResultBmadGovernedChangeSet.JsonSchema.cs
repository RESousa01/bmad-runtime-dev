...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadCapabilityResultBmadGovernedChangeSet>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyChangesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("changes"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyChangesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("changes"u8, buffer, out written);

            private const int RequiredOffsetForChanges = 0;
            private const uint RequiredBitForChanges = 0b00000000000000000000000000000001;
            ...
            private const uint RequiredBitForSummary = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForChanges | RequiredBitForSchemaVersion | RequiredBitForSummary;
            private static readonly JsonSchemaPathProvider ChangesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/changes"u8, buffer, out written);
            ...
            private static void MatchChanges(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.ChangesArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ChangesUtf8,
                        evaluationPath: ChangesSchemaEvaluationPath);

                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.ChangesArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForChanges] |= RequiredBitForChanges;
            }
            ...
            private static void MatchSchemaVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.SchemaVersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.SchemaVersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static void MatchSummary(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.SummaryEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.SummaryEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.ChangesUtf8, MatchChanges),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResultBmadGovernedChangeSet"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadCapabilityResultBmadGovernedChangeSet";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResultBmadGovernedChangeSet"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyChangesPresent, "changes"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySchemaVersionPresent, "schemaVersion"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySummaryPresent, "summary"u8, "required"u8);
                        }
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForChanges] & RequiredBitForChanges) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyChangesNotPresent, "changes"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyChangesPresent, "changes"u8, "required"u8);
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySummaryNotPresent, "summary"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySummaryPresent, "summary"u8, "required"u8);
