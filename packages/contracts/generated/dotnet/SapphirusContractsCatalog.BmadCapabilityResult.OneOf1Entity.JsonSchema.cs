...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResult
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGovernedChangeSetPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("governedChangeSet"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGovernedChangeSetNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("governedChangeSet"u8, buffer, out written);

                private const int RequiredOffsetForGovernedChangeSet = 0;
                private const uint RequiredBitForGovernedChangeSet = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForGovernedChangeSet | RequiredBitForResultKind;
                private static readonly JsonSchemaPathProvider GovernedChangeSetSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/governedChangeSet/$ref"u8, buffer, out written);
                ...
                private static void MatchGovernedChangeSet(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.GovernedChangeSetUtf8,
                            evaluationPath: GovernedChangeSetSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadGovernedChangeSet.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForGovernedChangeSet] |= RequiredBitForGovernedChangeSet;
                }
                ...
                private static void MatchResultKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf1Entity.ResultKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf1Entity.ResultKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.GovernedChangeSetUtf8, MatchGovernedChangeSet),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResult/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadCapabilityResult/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResult/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyGovernedChangeSetPresent, "governedChangeSet"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForGovernedChangeSet] & RequiredBitForGovernedChangeSet) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyGovernedChangeSetNotPresent, "governedChangeSet"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyGovernedChangeSetPresent, "governedChangeSet"u8, "required"u8);
