...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffSchemaVersion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RemoteJobHandoffSchemaVersion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RemoteJobHandoffSchemaVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RemoteJobHandoffSchemaVersion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RemoteJobHandoffSchemaVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffSchemaVersion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffSchemaVersion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RemoteJobHandoffSchemaVersion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RemoteJobHandoffSchemaVersion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RemoteJobHandoffSchemaVersion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RemoteJobHandoffSchemaVersion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RemoteJobHandoffSchemaVersion>();
            }
            finally
            {
