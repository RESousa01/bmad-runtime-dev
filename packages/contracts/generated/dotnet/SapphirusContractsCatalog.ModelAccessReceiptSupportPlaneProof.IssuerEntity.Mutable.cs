    ...
    public readonly partial struct ModelAccessReceiptSupportPlaneProof
    {
        ...
        public readonly partial struct IssuerEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IssuerEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IssuerEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IssuerEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IssuerEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IssuerEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IssuerEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IssuerEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IssuerEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IssuerEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IssuerEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IssuerEntity>();
                }
                finally
                {
