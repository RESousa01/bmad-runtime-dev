...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadMetadataOrigin
#if NET8_0_OR_GREATER
        : IJsonElement<BmadPackageDescriptorBmadMetadataOrigin>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadPackageDescriptorBmadMetadataOrigin"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadPackageDescriptorBmadMetadataOrigin(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadPackageDescriptorBmadMetadataOrigin DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadPackageDescriptorBmadMetadataOrigin value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadMetadataOrigin left, in BmadPackageDescriptorBmadMetadataOrigin right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadMetadataOrigin left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadPackageDescriptorBmadMetadataOrigin instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadPackageDescriptorBmadMetadataOrigin(JsonElement instance)
        {
            return BmadPackageDescriptorBmadMetadataOrigin.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadMetadataOrigin From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadMetadataOrigin ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadMetadataOrigin>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadMetadataOrigin ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadMetadataOrigin>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadMetadataOrigin ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadMetadataOrigin>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BmadPackageDescriptorBmadMetadataOrigin ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadMetadataOrigin>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadPackageDescriptorBmadMetadataOrigin? result)
        {
            return JsonElementHelpers.TryParseValue<BmadPackageDescriptorBmadMetadataOrigin>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadPackageDescriptorBmadMetadataOrigin(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadPackageDescriptorBmadMetadataOrigin IJsonElement<BmadPackageDescriptorBmadMetadataOrigin>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadPackageDescriptorBmadMetadataOrigin: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadPackageDescriptorBmadMetadataOrigin"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadPackageDescriptorBmadMetadataOrigin"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadMetadataOrigin Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadPackageDescriptorBmadMetadataOrigin>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadPackageDescriptorBmadMetadataOrigin"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadMetadataOrigin Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadPackageDescriptorBmadMetadataOrigin>(_idx);
            }
        ...
        /// <param name="matchSynthesized">Match 2nd item.</param>
        /// <param name="matchInstalledProjection">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchSource,
            Func<TContext, TResult> matchSynthesized,
            Func<TContext, TResult> matchInstalledProjection,
...
#endif
        {
            ...
            {
                return matchSynthesized(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchInstalledProjection(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchSource,
            Func<TResult> matchSynthesized,
            Func<TResult> matchInstalledProjection,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchSynthesized();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchInstalledProjection();
            }
