        ...
        public readonly partial struct LimitsEntity
        {
            ...
            public readonly partial struct MaxProcessCountEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxProcessCountEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxProcessCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxProcessCountEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxProcessCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxProcessCountEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxProcessCountEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxProcessCountEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxProcessCountEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxProcessCountEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxProcessCountEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxProcessCountEntity>();
                    }
                    finally
                    {
