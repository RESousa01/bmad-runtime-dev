...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalogBmadDependencyAvailability
        : IJsonElement<BmadCapabilityCatalogBmadDependencyAvailability>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEvidenceHashPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("evidenceHash"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEvidenceHashNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("evidenceHash"u8, buffer, out written);

            private const int RequiredOffsetForEvidenceHash = 0;
            private const uint RequiredBitForEvidenceHash = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForAvailability | RequiredBitForCapabilityKey | RequiredBitForEvidenceHash;
            ...
            private static readonly JsonSchemaPathProvider EvidenceHashSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/evidenceHash/$ref"u8, buffer, out written);
            ...
            private static void MatchAvailability(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability.AvailabilityEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadDependencyAvailability.AvailabilityEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchEvidenceHash(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.EvidenceHashUtf8,
                        evaluationPath: EvidenceHashSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForEvidenceHash] |= RequiredBitForEvidenceHash;
            }
            ...
            private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.EvidenceHashUtf8, MatchEvidenceHash),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityCatalogBmadDependencyAvailability"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadCapabilityCatalogBmadDependencyAvailability";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityCatalogBmadDependencyAvailability"u8;
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyEvidenceHashPresent, "evidenceHash"u8, "required"u8);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEvidenceHash] & RequiredBitForEvidenceHash) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyEvidenceHashNotPresent, "evidenceHash"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyEvidenceHashPresent, "evidenceHash"u8, "required"u8);
