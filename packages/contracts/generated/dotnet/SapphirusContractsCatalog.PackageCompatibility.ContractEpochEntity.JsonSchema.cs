            ...
            : IJsonElement<ContractEpochEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForMaximum | RequiredBitForMinimum;
                ...
                private static void MatchMaximum(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.ContractEpochEntity.MaximumEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.ContractEpochEntity.MaximumEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchMinimum(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.ContractEpochEntity.MinimumEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.ContractEpochEntity.MinimumEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/PackageCompatibility/properties/contractEpoch"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/PackageCompatibility/properties/contractEpoch";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/PackageCompatibility/properties/contractEpoch"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMaximumPresent, "maximum"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMinimumPresent, "minimum"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyMaximumNotPresent, "maximum"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMaximumPresent, "maximum"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyMinimumNotPresent, "minimum"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMinimumPresent, "minimum"u8, "required"u8);
