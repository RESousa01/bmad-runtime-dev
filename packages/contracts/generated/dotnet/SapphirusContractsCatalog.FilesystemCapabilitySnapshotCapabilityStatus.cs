...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshotCapabilityStatus
#if NET8_0_OR_GREATER
        : IJsonElement<FilesystemCapabilitySnapshotCapabilityStatus>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal FilesystemCapabilitySnapshotCapabilityStatus(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static FilesystemCapabilitySnapshotCapabilityStatus DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(FilesystemCapabilitySnapshotCapabilityStatus value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in FilesystemCapabilitySnapshotCapabilityStatus left, in FilesystemCapabilitySnapshotCapabilityStatus right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in FilesystemCapabilitySnapshotCapabilityStatus left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(FilesystemCapabilitySnapshotCapabilityStatus instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator FilesystemCapabilitySnapshotCapabilityStatus(JsonElement instance)
        {
            return FilesystemCapabilitySnapshotCapabilityStatus.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesystemCapabilitySnapshotCapabilityStatus From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesystemCapabilitySnapshotCapabilityStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<FilesystemCapabilitySnapshotCapabilityStatus>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesystemCapabilitySnapshotCapabilityStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<FilesystemCapabilitySnapshotCapabilityStatus>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesystemCapabilitySnapshotCapabilityStatus ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<FilesystemCapabilitySnapshotCapabilityStatus>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static FilesystemCapabilitySnapshotCapabilityStatus ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<FilesystemCapabilitySnapshotCapabilityStatus>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out FilesystemCapabilitySnapshotCapabilityStatus? result)
        {
            return JsonElementHelpers.TryParseValue<FilesystemCapabilitySnapshotCapabilityStatus>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new FilesystemCapabilitySnapshotCapabilityStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static FilesystemCapabilitySnapshotCapabilityStatus IJsonElement<FilesystemCapabilitySnapshotCapabilityStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"FilesystemCapabilitySnapshotCapabilityStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public FilesystemCapabilitySnapshotCapabilityStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<FilesystemCapabilitySnapshotCapabilityStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="FilesystemCapabilitySnapshotCapabilityStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public FilesystemCapabilitySnapshotCapabilityStatus Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<FilesystemCapabilitySnapshotCapabilityStatus>(_idx);
            }
        ...
        /// <param name="matchUnsupported">Match 2nd item.</param>
        /// <param name="matchUnknown">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchVerified,
            Func<TContext, TResult> matchUnsupported,
...
#endif
        {
            ...
            {
                return matchUnsupported(context);
            }
