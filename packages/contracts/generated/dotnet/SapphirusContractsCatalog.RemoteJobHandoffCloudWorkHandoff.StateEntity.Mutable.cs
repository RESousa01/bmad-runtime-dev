    ...
    public readonly partial struct RemoteJobHandoffCloudWorkHandoff
    {
        ...
        public readonly partial struct StateEntity
        {
...
#endif
            {
                ...
                /// <param name="matchCloudAccepted">Match 1st item.</param>
                /// <param name="matchRemoteRunning">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchCloudAccepted,
                    Func<TContext, TResult> matchRemoteRunning,
...
#endif
                {
                    ...
                    {
                        return matchCloudAccepted(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchRemoteRunning(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchCloudAccepted,
                    Func<TResult> matchRemoteRunning,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchCloudAccepted();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchRemoteRunning();
                    }
