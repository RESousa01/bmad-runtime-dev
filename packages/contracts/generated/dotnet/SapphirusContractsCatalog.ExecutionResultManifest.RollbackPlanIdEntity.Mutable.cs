    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct RollbackPlanIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RollbackPlanIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RollbackPlanIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RollbackPlanIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RollbackPlanIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RollbackPlanIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RollbackPlanIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RollbackPlanIdEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.RollbackPlanIdEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.RollbackPlanIdEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RollbackPlanIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RollbackPlanIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RollbackPlanIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RollbackPlanIdEntity>();
                }
                finally
                {
