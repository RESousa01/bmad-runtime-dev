            ...
            public readonly partial struct EntriesEntity
            {
                ...
                public readonly partial struct ReviewOrdinalEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ReviewOrdinalEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ReviewOrdinalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ReviewOrdinalEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ReviewOrdinalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ReviewOrdinalEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ReviewOrdinalEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ReviewOrdinalEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ReviewOrdinalEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ReviewOrdinalEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ReviewOrdinalEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ReviewOrdinalEntity>();
                        }
                        finally
                        {
