        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct ModelLensesNotPerformedReasonEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ModelLensesNotPerformedReasonEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ModelLensesNotPerformedReasonEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ModelLensesNotPerformedReasonEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ModelLensesNotPerformedReasonEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelLensesNotPerformedReasonEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelLensesNotPerformedReasonEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ModelLensesNotPerformedReasonEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ModelLensesNotPerformedReasonEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ModelLensesNotPerformedReasonEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ModelLensesNotPerformedReasonEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ModelLensesNotPerformedReasonEntity>();
                    }
                    finally
                    {
