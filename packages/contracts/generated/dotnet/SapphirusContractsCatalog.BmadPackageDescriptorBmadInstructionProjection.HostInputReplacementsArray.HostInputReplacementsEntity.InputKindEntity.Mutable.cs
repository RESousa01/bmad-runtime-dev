            ...
            public readonly partial struct HostInputReplacementsEntity
            {
                ...
                public readonly partial struct InputKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(InputKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="InputKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator InputKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"InputKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InputKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly InputKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<InputKindEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(InputKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<InputKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<InputKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<InputKindEntity>();
                        }
                        finally
                        {
