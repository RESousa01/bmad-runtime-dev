        ...
        public readonly partial struct ConformanceBundleEntity
        {
            ...
            public readonly partial struct MinimumConformanceLevelEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MinimumConformanceLevelEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MinimumConformanceLevelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MinimumConformanceLevelEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MinimumConformanceLevelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumConformanceLevelEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumConformanceLevelEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MinimumConformanceLevelEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MinimumConformanceLevelEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MinimumConformanceLevelEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MinimumConformanceLevelEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MinimumConformanceLevelEntity>();
                    }
                    finally
                    {
