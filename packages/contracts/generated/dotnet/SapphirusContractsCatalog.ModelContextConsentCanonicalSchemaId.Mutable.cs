...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelContextConsentCanonicalSchemaId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelContextConsentCanonicalSchemaId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelContextConsentCanonicalSchemaId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelContextConsentCanonicalSchemaId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelContextConsentCanonicalSchemaId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelContextConsentCanonicalSchemaId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelContextConsentCanonicalSchemaId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelContextConsentCanonicalSchemaId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelContextConsentCanonicalSchemaId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelContextConsentCanonicalSchemaId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelContextConsentCanonicalSchemaId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelContextConsentCanonicalSchemaId>();
            }
            finally
            {
