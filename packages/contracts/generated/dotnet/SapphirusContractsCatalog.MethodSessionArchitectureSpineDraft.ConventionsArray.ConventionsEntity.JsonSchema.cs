    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct ConventionsArray
        {
            ...
            public readonly partial struct ConventionsEntity
                : IJsonElement<ConventionsEntity>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConcernPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("concern"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConcernNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("concern"u8, buffer, out written);

                    private const int RequiredOffsetForConcern = 0;
                    private const uint RequiredBitForConcern = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConventionPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("convention"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConventionNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("convention"u8, buffer, out written);

                    private const int RequiredOffsetForConvention = 0;
                    private const uint RequiredBitForConvention = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForConcern | RequiredBitForConvention;
                    private static readonly JsonSchemaPathProvider ConcernSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/concern"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider ConventionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/convention"u8, buffer, out written);

                    private static void MatchConcern(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.ConventionsArray.ConventionsEntity.ConcernEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ConcernUtf8,
                                evaluationPath: ConcernSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.ConventionsArray.ConventionsEntity.ConcernEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForConcern] |= RequiredBitForConcern;
                    }

                    private static void MatchConvention(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.ConventionsArray.ConventionsEntity.ConventionEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ConventionUtf8,
                                evaluationPath: ConventionSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.ConventionsArray.ConventionsEntity.ConventionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        requiredBitBuffer[RequiredOffsetForConvention] |= RequiredBitForConvention;
                    }
                    ...
                    private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.ConcernUtf8, MatchConcern),
                            (static () => JsonPropertyNames.ConventionUtf8, MatchConvention),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureSpineDraft/properties/conventions/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionArchitectureSpineDraft/properties/conventions/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureSpineDraft/properties/conventions/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyConcernPresent, "concern"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyConventionPresent, "convention"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForConcern] & RequiredBitForConcern) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyConcernNotPresent, "concern"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyConcernPresent, "concern"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForConvention] & RequiredBitForConvention) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyConventionNotPresent, "convention"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyConventionPresent, "convention"u8, "required"u8);
