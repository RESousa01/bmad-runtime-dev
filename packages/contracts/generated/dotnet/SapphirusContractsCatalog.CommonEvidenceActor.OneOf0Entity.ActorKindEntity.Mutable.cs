        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct ActorKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ActorKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ActorKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ActorKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ActorKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ActorKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ActorKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ActorKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ActorKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ActorKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ActorKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ActorKindEntity>();
                    }
                    finally
                    {
