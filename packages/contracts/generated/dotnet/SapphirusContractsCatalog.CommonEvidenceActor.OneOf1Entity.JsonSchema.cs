    ...
    public readonly partial struct CommonEvidenceActor
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchServiceId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
