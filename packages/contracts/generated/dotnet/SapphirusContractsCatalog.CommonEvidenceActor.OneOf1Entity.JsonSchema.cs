    ...
    public readonly partial struct CommonEvidenceActor
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyServiceIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("serviceId"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyServiceIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("serviceId"u8, buffer, out written);

                private const int RequiredOffsetForServiceId = 0;
                private const uint RequiredBitForServiceId = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForActorKind | RequiredBitForServiceId;
                ...
                private static readonly JsonSchemaPathProvider ServiceIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/serviceId"u8, buffer, out written);
                ...
                private static void MatchActorKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchServiceId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ServiceIdUtf8,
                            evaluationPath: ServiceIdSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    requiredBitBuffer[RequiredOffsetForServiceId] |= RequiredBitForServiceId;
                }
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        ...
                        (static () => JsonPropertyNames.ServiceIdUtf8, MatchServiceId),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonEvidenceActor/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonEvidenceActor/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonEvidenceActor/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyServiceIdPresent, "serviceId"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForServiceId] & RequiredBitForServiceId) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyServiceIdNotPresent, "serviceId"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyServiceIdPresent, "serviceId"u8, "required"u8);
