    ...
    public readonly partial struct CommonAzureControlPlaneAuthorityRef
    {
            ...
            : IJsonElement<AuthorityKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "azure_control_plane"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly AuthorityKindEntity ConstJson = ParsedJsonDocument<AuthorityKindEntity>.StringConstant([.."\"azure_control_plane\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonAzureControlPlaneAuthorityRef/properties/authorityKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonAzureControlPlaneAuthorityRef/properties/authorityKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonAzureControlPlaneAuthorityRef/properties/authorityKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "azure_control_plane"u8, "azure_control_plane", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "azure_control_plane", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
