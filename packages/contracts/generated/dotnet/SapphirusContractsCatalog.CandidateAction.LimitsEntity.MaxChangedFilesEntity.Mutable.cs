        ...
        public readonly partial struct LimitsEntity
        {
            ...
            public readonly partial struct MaxChangedFilesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxChangedFilesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxChangedFilesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxChangedFilesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxChangedFilesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxChangedFilesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxChangedFilesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxChangedFilesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxChangedFilesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxChangedFilesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxChangedFilesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxChangedFilesEntity>();
                    }
                    finally
                    {
