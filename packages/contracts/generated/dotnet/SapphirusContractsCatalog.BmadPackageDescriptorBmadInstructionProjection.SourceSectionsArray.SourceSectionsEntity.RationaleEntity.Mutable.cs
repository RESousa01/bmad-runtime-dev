            ...
            public readonly partial struct SourceSectionsEntity
            {
                ...
                public readonly partial struct RationaleEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RationaleEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RationaleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RationaleEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RationaleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RationaleEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RationaleEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RationaleEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RationaleEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RationaleEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RationaleEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RationaleEntity>();
                        }
                        finally
                        {
