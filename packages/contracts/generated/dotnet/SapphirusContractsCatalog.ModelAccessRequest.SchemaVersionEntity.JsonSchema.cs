    ...
    public readonly partial struct ModelAccessRequest
    {
            ...
            : IJsonElement<SchemaVersionEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "desktop-model-access-request.v1"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly SchemaVersionEntity ConstJson = ParsedJsonDocument<SchemaVersionEntity>.StringConstant([.."\"desktop-model-access-request.v1\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ModelAccessRequest/properties/schemaVersion"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ModelAccessRequest/properties/schemaVersion";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ModelAccessRequest/properties/schemaVersion"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "desktop-model-access-request.v1"u8, "desktop-model-access-request.v1", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "desktop-model-access-request.v1", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
