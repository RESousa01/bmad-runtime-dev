    ...
    public readonly partial struct DesktopPolicy
    {
        ...
        public readonly partial struct PolicyVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PolicyVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PolicyVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PolicyVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PolicyVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PolicyVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PolicyVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PolicyVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PolicyVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PolicyVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PolicyVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PolicyVersionEntity>();
                }
                finally
                {
