...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffHandoffVersion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RemoteJobHandoffHandoffVersion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RemoteJobHandoffHandoffVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RemoteJobHandoffHandoffVersion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RemoteJobHandoffHandoffVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffHandoffVersion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffHandoffVersion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RemoteJobHandoffHandoffVersion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RemoteJobHandoffHandoffVersion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RemoteJobHandoffHandoffVersion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RemoteJobHandoffHandoffVersion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RemoteJobHandoffHandoffVersion>();
            }
            finally
            {
