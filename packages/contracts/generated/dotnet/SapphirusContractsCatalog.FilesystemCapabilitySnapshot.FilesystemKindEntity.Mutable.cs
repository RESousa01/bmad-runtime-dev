    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct FilesystemKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FilesystemKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FilesystemKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FilesystemKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FilesystemKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FilesystemKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FilesystemKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FilesystemKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FilesystemKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FilesystemKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FilesystemKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FilesystemKindEntity>();
                }
                finally
                {
