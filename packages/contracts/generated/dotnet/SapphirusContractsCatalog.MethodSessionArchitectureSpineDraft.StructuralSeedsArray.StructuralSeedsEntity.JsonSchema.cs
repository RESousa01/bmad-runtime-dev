    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct StructuralSeedsArray
        {
            ...
            public readonly partial struct StructuralSeedsEntity
                : IJsonElement<StructuralSeedsEntity>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyContentRefPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("contentRef"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyContentRefNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("contentRef"u8, buffer, out written);

                    private const int RequiredOffsetForContentRef = 0;
                    private const uint RequiredBitForContentRef = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertySeedKindPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("seedKind"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertySeedKindNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("seedKind"u8, buffer, out written);

                    private const int RequiredOffsetForSeedKind = 0;
                    private const uint RequiredBitForSeedKind = 0b00000000000000000000000000000010;
                    ...
                    private const uint RequiredBitMask0 =
                        RequiredBitForContentRef | RequiredBitForSeedKind | RequiredBitForTitle;
                    private static readonly JsonSchemaPathProvider ContentRefSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/contentRef/$ref"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider SeedKindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/seedKind"u8, buffer, out written);
                    ...
                    private static void MatchContentRef(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContentRef.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ContentRefUtf8,
                                evaluationPath: ContentRefSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContentRef.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForContentRef] |= RequiredBitForContentRef;
                    }

                    private static void MatchSeedKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StructuralSeedsArray.StructuralSeedsEntity.SeedKindEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.SeedKindUtf8,
                                evaluationPath: SeedKindSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StructuralSeedsArray.StructuralSeedsEntity.SeedKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        requiredBitBuffer[RequiredOffsetForSeedKind] |= RequiredBitForSeedKind;
                    }
                    ...
                    private static void MatchTitle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StructuralSeedsArray.StructuralSeedsEntity.TitleEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StructuralSeedsArray.StructuralSeedsEntity.TitleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    ...
                    private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.ContentRefUtf8, MatchContentRef),
                            (static () => JsonPropertyNames.SeedKindUtf8, MatchSeedKind),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureSpineDraft/properties/structuralSeeds/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionArchitectureSpineDraft/properties/structuralSeeds/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureSpineDraft/properties/structuralSeeds/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                            {
                                if (context.HasCollector)
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyContentRefPresent, "contentRef"u8, "required"u8);
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySeedKindPresent, "seedKind"u8, "required"u8);
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForContentRef] & RequiredBitForContentRef) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyContentRefNotPresent, "contentRef"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyContentRefPresent, "contentRef"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSeedKind] & RequiredBitForSeedKind) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertySeedKindNotPresent, "seedKind"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySeedKindPresent, "seedKind"u8, "required"u8);
