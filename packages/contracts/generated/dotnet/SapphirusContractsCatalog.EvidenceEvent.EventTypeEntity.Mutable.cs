    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct EventTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EventTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EventTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EventTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EventTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EventTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EventTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EventTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EventTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EventTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EventTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EventTypeEntity>();
                }
                finally
                {
