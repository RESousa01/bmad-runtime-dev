    ...
    public readonly partial struct ModelAccessRequest
    {
            ...
            : IJsonElement<RetentionModeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "transient_no_store"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly RetentionModeEntity ConstJson = ParsedJsonDocument<RetentionModeEntity>.StringConstant([.."\"transient_no_store\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ModelAccessRequest/properties/retentionMode"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ModelAccessRequest/properties/retentionMode";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ModelAccessRequest/properties/retentionMode"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "transient_no_store"u8, "transient_no_store", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "transient_no_store", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
