    ...
    public readonly partial struct CommonLocalPathPreimage
    {
        ...
        public readonly partial struct MetadataHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MetadataHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MetadataHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MetadataHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MetadataHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MetadataHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MetadataHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MetadataHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.MetadataHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.MetadataHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MetadataHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MetadataHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MetadataHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MetadataHashEntity>();
                }
                finally
                {
