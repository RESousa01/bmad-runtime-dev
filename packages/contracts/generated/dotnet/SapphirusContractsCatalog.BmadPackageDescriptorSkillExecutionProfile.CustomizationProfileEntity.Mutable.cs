    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct CustomizationProfileEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CustomizationProfileEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CustomizationProfileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomizationProfileEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomizationProfileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CustomizationProfileEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CustomizationProfileEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CustomizationProfileEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CustomizationProfileEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CustomizationProfileEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CustomizationProfileEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CustomizationProfileEntity>();
                }
                finally
                {
