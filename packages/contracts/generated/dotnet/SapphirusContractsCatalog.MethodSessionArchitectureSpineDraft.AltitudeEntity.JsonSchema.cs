    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
            ...
            : IJsonElement<AltitudeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "initiative"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AltitudeEntity EnumJson1 = ParsedJsonDocument<AltitudeEntity>.StringConstant([.."\"initiative\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "feature"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AltitudeEntity EnumJson2 = ParsedJsonDocument<AltitudeEntity>.StringConstant([.."\"feature\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "epic"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AltitudeEntity EnumJson3 = ParsedJsonDocument<AltitudeEntity>.StringConstant([.."\"epic\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "initiative"
                /// as a <see cref="AltitudeEntity"/>.
                /// </summary>
                public static AltitudeEntity Initiative { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "initiative"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> InitiativeUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "feature"
                /// as a <see cref="AltitudeEntity"/>.
                /// </summary>
                public static AltitudeEntity Feature { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "feature"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FeatureUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "epic"
                /// as a <see cref="AltitudeEntity"/>.
                /// </summary>
                public static AltitudeEntity Epic { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "epic"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> EpicUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureSpineDraft/properties/altitude"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodSessionArchitectureSpineDraft/properties/altitude";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureSpineDraft/properties/altitude"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("initiative"u8))
                        {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("epic"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
