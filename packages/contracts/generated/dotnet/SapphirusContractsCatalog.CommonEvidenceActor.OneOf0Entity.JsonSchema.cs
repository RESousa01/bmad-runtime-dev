    ...
    public readonly partial struct CommonEvidenceActor
    {
            ...
            : IJsonElement<OneOf0Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForSubjectId = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForActorKind | RequiredBitForSubjectId;
                ...
                private static readonly JsonSchemaPathProvider SubjectIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/subjectId"u8, buffer, out written);
                ...
                private static void MatchActorKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf0Entity.ActorKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf0Entity.ActorKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchSubjectId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf0Entity.SubjectIdEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf0Entity.SubjectIdEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonEvidenceActor/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonEvidenceActor/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonEvidenceActor/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySubjectIdPresent, "subjectId"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertySubjectIdNotPresent, "subjectId"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySubjectIdPresent, "subjectId"u8, "required"u8);
