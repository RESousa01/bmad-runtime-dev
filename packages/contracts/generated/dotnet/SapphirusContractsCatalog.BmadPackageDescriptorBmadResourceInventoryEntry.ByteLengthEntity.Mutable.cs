    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct ByteLengthEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ByteLengthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ByteLengthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ByteLengthEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ByteLengthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ByteLengthEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ByteLengthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ByteLengthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ByteLengthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ByteLengthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ByteLengthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ByteLengthEntity>();
                }
                finally
                {
