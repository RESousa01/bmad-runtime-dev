        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<ValidationProfileEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "BuilderAgentV2Stateless"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly ValidationProfileEntity EnumJson1 = ParsedJsonDocument<ValidationProfileEntity>.StringConstant([.."\"BuilderAgentV2Stateless\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "BuilderOutcomeSkillV2"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly ValidationProfileEntity EnumJson2 = ParsedJsonDocument<ValidationProfileEntity>.StringConstant([.."\"BuilderOutcomeSkillV2\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// </summary>
                    public static ValidationProfileEntity BuilderAgentV2Stateless { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "BuilderAgentV2Stateless"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> BuilderAgentV2StatelessUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "BuilderOutcomeSkillV2"
                    /// as a <see cref="ValidationProfileEntity"/>.
                    /// </summary>
                    public static ValidationProfileEntity BuilderOutcomeSkillV2 { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "BuilderOutcomeSkillV2"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> BuilderOutcomeSkillV2Utf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/0/properties/validationProfile"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/0/properties/validationProfile";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/0/properties/validationProfile"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("BuilderAgentV2Stateless"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("BuilderOutcomeSkillV2"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
