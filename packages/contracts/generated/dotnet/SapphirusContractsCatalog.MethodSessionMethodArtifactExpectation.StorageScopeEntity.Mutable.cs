    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct StorageScopeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(StorageScopeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StorageScopeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StorageScopeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StorageScopeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly StorageScopeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly StorageScopeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StorageScopeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StorageScopeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StorageScopeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StorageScopeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StorageScopeEntity>();
                }
                finally
                {
