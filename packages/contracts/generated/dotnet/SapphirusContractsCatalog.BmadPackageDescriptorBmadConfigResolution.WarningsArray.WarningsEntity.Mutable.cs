        ...
        public readonly partial struct WarningsArray
        {
            ...
            public readonly partial struct WarningsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WarningsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WarningsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WarningsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WarningsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WarningsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WarningsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WarningsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WarningsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<WarningsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WarningsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WarningsEntity>();
                    }
                    finally
                    {
