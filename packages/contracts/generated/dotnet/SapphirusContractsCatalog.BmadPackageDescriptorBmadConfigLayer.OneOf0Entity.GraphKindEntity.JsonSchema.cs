        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<GraphKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "method_central_toml"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly GraphKindEntity ConstJson = ParsedJsonDocument<GraphKindEntity>.StringConstant([.."\"method_central_toml\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/graphKind"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/graphKind";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/graphKind"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "method_central_toml"u8, "method_central_toml", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "method_central_toml", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
