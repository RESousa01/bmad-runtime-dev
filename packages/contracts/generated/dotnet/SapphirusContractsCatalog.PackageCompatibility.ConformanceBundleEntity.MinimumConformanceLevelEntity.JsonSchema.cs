        ...
        public readonly partial struct ConformanceBundleEntity
        {
                ...
                : IJsonElement<MinimumConformanceLevelEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "schema"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly MinimumConformanceLevelEntity EnumJson1 = ParsedJsonDocument<MinimumConformanceLevelEntity>.StringConstant([.."\"schema\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "semantic"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly MinimumConformanceLevelEntity EnumJson2 = ParsedJsonDocument<MinimumConformanceLevelEntity>.StringConstant([.."\"semantic\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "execution_rehearsal"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly MinimumConformanceLevelEntity EnumJson3 = ParsedJsonDocument<MinimumConformanceLevelEntity>.StringConstant([.."\"execution_rehearsal\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// as a <see cref="MinimumConformanceLevelEntity"/>.
                    /// </summary>
                    public static MinimumConformanceLevelEntity Schema { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "schema"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "semantic"
                    /// as a <see cref="MinimumConformanceLevelEntity"/>.
                    /// </summary>
                    public static MinimumConformanceLevelEntity Semantic { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "semantic"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> SemanticUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "execution_rehearsal"
                    /// as a <see cref="MinimumConformanceLevelEntity"/>.
                    /// </summary>
                    public static MinimumConformanceLevelEntity ExecutionRehearsal { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "execution_rehearsal"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ExecutionRehearsalUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/PackageCompatibility/properties/conformanceBundle/properties/minimumConformanceLevel"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/PackageCompatibility/properties/conformanceBundle/properties/minimumConformanceLevel";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/PackageCompatibility/properties/conformanceBundle/properties/minimumConformanceLevel"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("schema"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("semantic"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("execution_rehearsal"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
