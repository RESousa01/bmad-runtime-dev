    ...
    public readonly partial struct CommonLocalFolderCapabilityTarget
    {
            ...
            : IJsonElement<TargetKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "local_folder_capability"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly TargetKindEntity ConstJson = ParsedJsonDocument<TargetKindEntity>.StringConstant([.."\"local_folder_capability\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonLocalFolderCapabilityTarget/properties/targetKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonLocalFolderCapabilityTarget/properties/targetKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonLocalFolderCapabilityTarget/properties/targetKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "local_folder_capability"u8, "local_folder_capability", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "local_folder_capability", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
