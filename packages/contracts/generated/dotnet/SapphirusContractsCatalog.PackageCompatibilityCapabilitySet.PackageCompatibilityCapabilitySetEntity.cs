...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibilityCapabilitySet
    {
        ...
        public readonly partial struct PackageCompatibilityCapabilitySetEntity
#if NET8_0_OR_GREATER
            : IJsonElement<PackageCompatibilityCapabilitySetEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PackageCompatibilityCapabilitySetEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PackageCompatibilityCapabilitySetEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PackageCompatibilityCapabilitySetEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PackageCompatibilityCapabilitySetEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PackageCompatibilityCapabilitySetEntity left, in PackageCompatibilityCapabilitySetEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PackageCompatibilityCapabilitySetEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PackageCompatibilityCapabilitySetEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PackageCompatibilityCapabilitySetEntity(JsonElement instance)
            {
                return PackageCompatibilityCapabilitySetEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageCompatibilityCapabilitySetEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageCompatibilityCapabilitySetEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySetEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageCompatibilityCapabilitySetEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySetEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageCompatibilityCapabilitySetEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySetEntity>(json, options);
            }
            ...
            /// </exception>
            public static PackageCompatibilityCapabilitySetEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PackageCompatibilityCapabilitySetEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PackageCompatibilityCapabilitySetEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PackageCompatibilityCapabilitySetEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PackageCompatibilityCapabilitySetEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PackageCompatibilityCapabilitySetEntity IJsonElement<PackageCompatibilityCapabilitySetEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PackageCompatibilityCapabilitySetEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PackageCompatibilityCapabilitySetEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PackageCompatibilityCapabilitySetEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PackageCompatibilityCapabilitySetEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PackageCompatibilityCapabilitySetEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PackageCompatibilityCapabilitySetEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PackageCompatibilityCapabilitySetEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PackageCompatibilityCapabilitySetEntity>(_idx);
                }
