...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ContentRoleEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ContentRoleEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentRoleEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ContentRoleEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ContentRoleEntity left, in ContentRoleEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentRoleEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ContentRoleEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentRoleEntity(JsonElement instance)
            {
                return ContentRoleEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentRoleEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentRoleEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentRoleEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentRoleEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentRoleEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentRoleEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentRoleEntity>(json, options);
            }
            ...
            /// </exception>
            public static ContentRoleEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentRoleEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentRoleEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ContentRoleEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentRoleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ContentRoleEntity IJsonElement<ContentRoleEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentRoleEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentRoleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentRoleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ContentRoleEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentRoleEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentRoleEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ContentRoleEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentRoleEntity>(_idx);
                }
            ...
            /// <param name="matchEntrypoint">Match 1st item.</param>
            /// <param name="matchReference">Match 2nd item.</param>
            /// <param name="matchAsset">Match 3rd item.</param>
            /// <param name="matchScript">Match 4th item.</param>
            /// <param name="matchConfig">Match 5th item.</param>
            /// <param name="matchHelpCatalog">Match 6th item.</param>
            /// <param name="matchMetadata">Match 7th item.</param>
            /// <param name="matchManagedInstruction">Match 8th item.</param>
            /// <param name="matchEvidence">Match 9th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchEntrypoint,
                Func<TContext, TResult> matchReference,
                Func<TContext, TResult> matchAsset,
                Func<TContext, TResult> matchScript,
                Func<TContext, TResult> matchConfig,
                Func<TContext, TResult> matchHelpCatalog,
                Func<TContext, TResult> matchMetadata,
                Func<TContext, TResult> matchManagedInstruction,
                Func<TContext, TResult> matchEvidence,
...
#endif
            {
                ...
                {
                    return matchEntrypoint(context);
                }
                ...
                {
                    return matchConfig(context);
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchHelpCatalog(context);
                }
                ...
                {
                    return matchManagedInstruction(context);
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchEvidence(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchEntrypoint,
                Func<TResult> matchReference,
                Func<TResult> matchAsset,
                Func<TResult> matchScript,
                Func<TResult> matchConfig,
                Func<TResult> matchHelpCatalog,
                Func<TResult> matchMetadata,
                Func<TResult> matchManagedInstruction,
                Func<TResult> matchEvidence,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchEntrypoint();
                }
                ...
                if (this.ValueEquals(Constants.Enum8))
                {
                    return matchManagedInstruction();
                }
