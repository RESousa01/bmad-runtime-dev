...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BuilderAuthoringObjectBuilderProposedFile
        ...
        : IJsonElement<BuilderAuthoringObjectBuilderProposedFile>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuilderAuthoringObjectBuilderProposedFile"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuilderAuthoringObjectBuilderProposedFile(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuilderAuthoringObjectBuilderProposedFile DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFile.ContentEntity Content
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFile.ContentEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFile.PathEntity Path
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFile.PathEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BuilderAuthoringObjectBuilderProposedFile left, in BuilderAuthoringObjectBuilderProposedFile right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuilderAuthoringObjectBuilderProposedFile left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BuilderAuthoringObjectBuilderProposedFile instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuilderAuthoringObjectBuilderProposedFile(JsonElement instance)
        {
            return BuilderAuthoringObjectBuilderProposedFile.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuilderAuthoringObjectBuilderProposedFile From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuilderAuthoringObjectBuilderProposedFile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuilderAuthoringObjectBuilderProposedFile>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuilderAuthoringObjectBuilderProposedFile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuilderAuthoringObjectBuilderProposedFile>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuilderAuthoringObjectBuilderProposedFile ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuilderAuthoringObjectBuilderProposedFile>(json, options);
        }
        ...
        /// </exception>
        public static BuilderAuthoringObjectBuilderProposedFile ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuilderAuthoringObjectBuilderProposedFile>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuilderAuthoringObjectBuilderProposedFile? result)
        {
            return JsonElementHelpers.TryParseValue<BuilderAuthoringObjectBuilderProposedFile>(ref reader, out result);
        }
...
#if NET
        static BuilderAuthoringObjectBuilderProposedFile IJsonElement<BuilderAuthoringObjectBuilderProposedFile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuilderAuthoringObjectBuilderProposedFile: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuilderAuthoringObjectBuilderProposedFile Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BuilderAuthoringObjectBuilderProposedFile Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuilderAuthoringObjectBuilderProposedFile>(_idx);
            }
