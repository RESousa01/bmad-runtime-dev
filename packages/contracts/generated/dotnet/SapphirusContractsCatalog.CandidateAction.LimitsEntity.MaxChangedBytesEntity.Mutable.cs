        ...
        public readonly partial struct LimitsEntity
        {
            ...
            public readonly partial struct MaxChangedBytesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxChangedBytesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxChangedBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxChangedBytesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxChangedBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxChangedBytesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxChangedBytesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxChangedBytesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxChangedBytesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxChangedBytesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxChangedBytesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxChangedBytesEntity>();
                    }
                    finally
                    {
