    ...
    public readonly partial struct MethodSessionArchitectureReviewResult
    {
        ...
        public readonly partial struct ModelReviewEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
                ...
                public readonly partial struct ModelReviewKindEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<ModelReviewKindEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="ModelReviewKindEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal ModelReviewKindEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static ModelReviewKindEntity DefaultInstance { get; }

                    /// <summary>
                    /// Gets the const instance.
                    /// </summary>
                    public static ModelReviewKindEntity ConstInstance => Constants.ConstJson;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(ModelReviewKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in ModelReviewKindEntity left, in ModelReviewKindEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in ModelReviewKindEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(ModelReviewKindEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ModelReviewKindEntity(JsonElement instance)
                    {
                        return ModelReviewKindEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ModelReviewKindEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ModelReviewKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ModelReviewKindEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ModelReviewKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ModelReviewKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ModelReviewKindEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ModelReviewKindEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static ModelReviewKindEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<ModelReviewKindEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out ModelReviewKindEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<ModelReviewKindEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ModelReviewKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static ModelReviewKindEntity IJsonElement<ModelReviewKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ModelReviewKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ModelReviewKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ModelReviewKindEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public ModelReviewKindEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ModelReviewKindEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ModelReviewKindEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public ModelReviewKindEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<ModelReviewKindEntity>(_idx);
                        }
