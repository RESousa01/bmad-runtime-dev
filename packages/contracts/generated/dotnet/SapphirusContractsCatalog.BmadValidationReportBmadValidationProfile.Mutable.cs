...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationProfile
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadValidationReportBmadValidationProfile instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadValidationReportBmadValidationProfile"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadValidationReportBmadValidationProfile(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadValidationReportBmadValidationProfile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadValidationReportBmadValidationProfile Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadValidationReportBmadValidationProfile Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadValidationReportBmadValidationProfile>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadValidationReportBmadValidationProfile instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadValidationReportBmadValidationProfile, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadValidationReportBmadValidationProfile> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadValidationReportBmadValidationProfile>();
            }
            finally
            {
