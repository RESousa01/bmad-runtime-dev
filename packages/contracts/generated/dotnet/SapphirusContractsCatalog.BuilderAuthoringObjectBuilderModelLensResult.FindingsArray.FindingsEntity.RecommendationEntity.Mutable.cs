            ...
            public readonly partial struct FindingsEntity
            {
                ...
                public readonly partial struct RecommendationEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RecommendationEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RecommendationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RecommendationEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RecommendationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RecommendationEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RecommendationEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RecommendationEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RecommendationEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RecommendationEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RecommendationEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RecommendationEntity>();
                        }
                        finally
                        {
