        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct MenuCodeEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MenuCodeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MenuCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MenuCodeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MenuCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MenuCodeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MenuCodeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MenuCodeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MenuCodeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MenuCodeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MenuCodeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MenuCodeEntity>();
                    }
                    finally
                    {
