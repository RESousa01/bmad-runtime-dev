...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResult
    {
            ...
            : IJsonElement<OneOf0Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDocumentArtifactPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("documentArtifact"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDocumentArtifactNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("documentArtifact"u8, buffer, out written);

                private const int RequiredOffsetForDocumentArtifact = 0;
                private const uint RequiredBitForDocumentArtifact = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForDocumentArtifact | RequiredBitForResultKind;
                private static readonly JsonSchemaPathProvider DocumentArtifactSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/documentArtifact/$ref"u8, buffer, out written);
                ...
                private static void MatchDocumentArtifact(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadDocumentArtifact.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.DocumentArtifactUtf8,
                            evaluationPath: DocumentArtifactSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadDocumentArtifact.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForDocumentArtifact] |= RequiredBitForDocumentArtifact;
                }
                ...
                private static void MatchResultKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf0Entity.ResultKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf0Entity.ResultKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.DocumentArtifactUtf8, MatchDocumentArtifact),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResult/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadCapabilityResult/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResult/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentArtifactPresent, "documentArtifact"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDocumentArtifact] & RequiredBitForDocumentArtifact) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDocumentArtifactNotPresent, "documentArtifact"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentArtifactPresent, "documentArtifact"u8, "required"u8);
