    ...
    public readonly partial struct MethodSessionMethodHelpRecommendation
    {
        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                /// <param name="matchCatalogEvidenceAbsent">Match 1st item.</param>
                /// <param name="matchCompletionEvidenceAmbiguous">Match 2nd item.</param>
                /// <param name="matchDependencyUnavailable">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchCatalogEvidenceAbsent,
                    Func<TContext, TResult> matchCompletionEvidenceAmbiguous,
                    Func<TContext, TResult> matchDependencyUnavailable,
...
#endif
                {
                    ...
                    {
                        return matchCatalogEvidenceAbsent(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchCompletionEvidenceAmbiguous(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchDependencyUnavailable(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchCatalogEvidenceAbsent,
                    Func<TResult> matchCompletionEvidenceAmbiguous,
                    Func<TResult> matchDependencyUnavailable,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchCatalogEvidenceAbsent();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchCompletionEvidenceAmbiguous();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchDependencyUnavailable();
                    }
