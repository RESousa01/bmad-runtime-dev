    ...
    public readonly partial struct ModelAccessResult
    {
        ...
        public readonly partial struct PayloadJsonEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PayloadJsonEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PayloadJsonEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PayloadJsonEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PayloadJsonEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadJsonEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadJsonEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PayloadJsonEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PayloadJsonEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PayloadJsonEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PayloadJsonEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PayloadJsonEntity>();
                }
                finally
                {
