        ...
        public readonly partial struct ConformanceBundleEntity
        {
            ...
            public readonly partial struct FixtureSetIdEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FixtureSetIdEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FixtureSetIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FixtureSetIdEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FixtureSetIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FixtureSetIdEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FixtureSetIdEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FixtureSetIdEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FixtureSetIdEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FixtureSetIdEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FixtureSetIdEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FixtureSetIdEntity>();
                    }
                    finally
                    {
