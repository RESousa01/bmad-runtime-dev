        ...
        public readonly partial struct StateHintsArray
        {
            ...
            public readonly partial struct StateHintsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(StateHintsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StateHintsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StateHintsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StateHintsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StateHintsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StateHintsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StateHintsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(StateHintsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<StateHintsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<StateHintsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<StateHintsEntity>();
                    }
                    finally
                    {
