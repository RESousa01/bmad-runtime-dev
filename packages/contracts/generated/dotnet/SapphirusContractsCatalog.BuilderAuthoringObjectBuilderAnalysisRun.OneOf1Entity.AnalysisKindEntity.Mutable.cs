        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct AnalysisKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnalysisKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnalysisKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnalysisKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnalysisKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnalysisKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnalysisKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnalysisKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AnalysisKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AnalysisKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnalysisKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnalysisKindEntity>();
                    }
                    finally
                    {
