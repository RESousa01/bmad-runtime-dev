...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct SupportedDeliveryModelsArray
            ...
            : IJsonElement<SupportedDeliveryModelsArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SupportedDeliveryModelsArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SupportedDeliveryModelsArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SupportedDeliveryModelsArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeliveryModel this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeliveryModel>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeliveryModel> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeliveryModel>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in SupportedDeliveryModelsArray left, in SupportedDeliveryModelsArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SupportedDeliveryModelsArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SupportedDeliveryModelsArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SupportedDeliveryModelsArray(JsonElement instance)
            {
                return SupportedDeliveryModelsArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedDeliveryModelsArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedDeliveryModelsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedDeliveryModelsArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedDeliveryModelsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedDeliveryModelsArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedDeliveryModelsArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedDeliveryModelsArray>(json, options);
            }
            ...
            /// </exception>
            public static SupportedDeliveryModelsArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SupportedDeliveryModelsArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SupportedDeliveryModelsArray? result)
            {
                return JsonElementHelpers.TryParseValue<SupportedDeliveryModelsArray>(ref reader, out result);
            }
...
#if NET
            static SupportedDeliveryModelsArray IJsonElement<SupportedDeliveryModelsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SupportedDeliveryModelsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SupportedDeliveryModelsArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SupportedDeliveryModelsArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SupportedDeliveryModelsArray>(_idx);
                }
