            ...
            public readonly partial struct AuthoringActionEntity
            {
                    ...
                    : IJsonElement<ActionEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Enum1 = "build"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly ActionEntity EnumJson1 = ParsedJsonDocument<ActionEntity>.StringConstant([.."\"build\""u8]);
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                    ...
                    public static class EnumValues
                    {
                        ...
                        /// </summary>
                        public static ActionEntity Build { get; } = Constants.EnumJson1;
                        /// <summary>
                        /// Gets the string "build"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> BuildUtf8 => Constants.Enum1;
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderDraftRevision/oneOf/1/properties/authoringAction/properties/action"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderDraftRevision/oneOf/1/properties/authoringAction/properties/action";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderDraftRevision/oneOf/1/properties/authoringAction/properties/action"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                if (unescapedUtf8JsonString.Span.SequenceEqual("build"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }

                                if (unescapedUtf8JsonString.Span.SequenceEqual("edit"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }
                            }
