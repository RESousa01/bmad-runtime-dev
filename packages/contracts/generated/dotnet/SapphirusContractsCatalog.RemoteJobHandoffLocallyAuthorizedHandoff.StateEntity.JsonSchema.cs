    ...
    public readonly partial struct RemoteJobHandoffLocallyAuthorizedHandoff
    {
            ...
            : IJsonElement<StateEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "locally_approved"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson1 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"locally_approved\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "uploading"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson2 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"uploading\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "locally_approved"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity LocallyApproved { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "locally_approved"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> LocallyApprovedUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "uploading"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity Uploading { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "uploading"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> UploadingUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffLocallyAuthorizedHandoff/properties/state"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/RemoteJobHandoffLocallyAuthorizedHandoff/properties/state";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffLocallyAuthorizedHandoff/properties/state"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("locally_approved"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("uploading"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
