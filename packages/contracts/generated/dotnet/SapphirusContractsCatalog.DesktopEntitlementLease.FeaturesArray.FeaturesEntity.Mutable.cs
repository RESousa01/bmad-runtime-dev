        ...
        public readonly partial struct FeaturesArray
        {
            ...
            public readonly partial struct FeaturesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FeaturesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FeaturesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FeaturesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FeaturesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FeaturesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FeaturesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FeaturesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FeaturesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FeaturesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FeaturesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FeaturesEntity>();
                    }
                    finally
                    {
