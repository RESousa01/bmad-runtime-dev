    ...
    public readonly partial struct MethodHelpProposal
    {
        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct EvidenceTokenIdsArray
                ...
                : IJsonElement<EvidenceTokenIdsArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EvidenceTokenIdsArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EvidenceTokenIdsArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EvidenceTokenIdsArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in EvidenceTokenIdsArray left, in EvidenceTokenIdsArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EvidenceTokenIdsArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(EvidenceTokenIdsArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EvidenceTokenIdsArray(JsonElement instance)
                {
                    return EvidenceTokenIdsArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EvidenceTokenIdsArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EvidenceTokenIdsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EvidenceTokenIdsArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EvidenceTokenIdsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EvidenceTokenIdsArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EvidenceTokenIdsArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EvidenceTokenIdsArray>(json, options);
                }
                ...
                /// </exception>
                public static EvidenceTokenIdsArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EvidenceTokenIdsArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EvidenceTokenIdsArray? result)
                {
                    return JsonElementHelpers.TryParseValue<EvidenceTokenIdsArray>(ref reader, out result);
                }
...
#if NET
                static EvidenceTokenIdsArray IJsonElement<EvidenceTokenIdsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EvidenceTokenIdsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public EvidenceTokenIdsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public EvidenceTokenIdsArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EvidenceTokenIdsArray>(_idx);
                    }
