    ...
    public readonly partial struct BmadCapabilityCatalogInstalledSkillRecord
    {
        ...
        public readonly partial struct InstructionProjectionHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(InstructionProjectionHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InstructionProjectionHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InstructionProjectionHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InstructionProjectionHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InstructionProjectionHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InstructionProjectionHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InstructionProjectionHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogInstalledSkillRecord.InstructionProjectionHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogInstalledSkillRecord.InstructionProjectionHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(InstructionProjectionHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<InstructionProjectionHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InstructionProjectionHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InstructionProjectionHashEntity>();
                }
                finally
                {
