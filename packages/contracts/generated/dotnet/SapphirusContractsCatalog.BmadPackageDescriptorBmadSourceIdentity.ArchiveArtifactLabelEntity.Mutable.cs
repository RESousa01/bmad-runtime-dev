    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct ArchiveArtifactLabelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ArchiveArtifactLabelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ArchiveArtifactLabelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArchiveArtifactLabelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArchiveArtifactLabelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ArchiveArtifactLabelEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ArchiveArtifactLabelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArchiveArtifactLabelEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ArchiveArtifactLabelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ArchiveArtifactLabelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ArchiveArtifactLabelEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArchiveArtifactLabelEntity>();
                }
                finally
                {
