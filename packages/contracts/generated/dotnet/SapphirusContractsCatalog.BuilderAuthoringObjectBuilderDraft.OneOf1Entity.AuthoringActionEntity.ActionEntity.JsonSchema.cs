            ...
            public readonly partial struct AuthoringActionEntity
            {
                    ...
                    : IJsonElement<ActionEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Const = "build"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>const</c> keyword.
                        /// </summary>
                        public static readonly ActionEntity ConstJson = ParsedJsonDocument<ActionEntity>.StringConstant([.."\"build\""u8]);
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderDraft/oneOf/1/properties/authoringAction/properties/action"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderDraft/oneOf/1/properties/authoringAction/properties/action";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderDraft/oneOf/1/properties/authoringAction/properties/action"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "build"u8, "build", "const"u8, ref context);
                            }
                            else
                            {
                                context.EvaluatedKeyword(false, "build", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                            }
                        }
