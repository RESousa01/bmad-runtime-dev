...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationDisposition
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBlockingFindingIdsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("blockingFindingIds"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBlockingFindingIdsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("blockingFindingIds"u8, buffer, out written);

                private const int RequiredOffsetForBlockingFindingIds = 0;
                private const uint RequiredBitForBlockingFindingIds = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitForDispositionKind = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForBlockingFindingIds | RequiredBitForDispositionKind;
                private static readonly JsonSchemaPathProvider BlockingFindingIdsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/blockingFindingIds"u8, buffer, out written);
                ...
                private static void MatchBlockingFindingIds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.BlockingFindingIdsArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.BlockingFindingIdsUtf8,
                            evaluationPath: BlockingFindingIdsSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.BlockingFindingIdsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForBlockingFindingIds] |= RequiredBitForBlockingFindingIds;
                }
                ...
                private static void MatchDispositionKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.DispositionKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.DispositionKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.BlockingFindingIdsUtf8, MatchBlockingFindingIds),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDisposition/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDisposition/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBlockingFindingIdsPresent, "blockingFindingIds"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyDispositionKindPresent, "dispositionKind"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBlockingFindingIds] & RequiredBitForBlockingFindingIds) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBlockingFindingIdsNotPresent, "blockingFindingIds"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBlockingFindingIdsPresent, "blockingFindingIds"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyDispositionKindNotPresent, "dispositionKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyDispositionKindPresent, "dispositionKind"u8, "required"u8);
