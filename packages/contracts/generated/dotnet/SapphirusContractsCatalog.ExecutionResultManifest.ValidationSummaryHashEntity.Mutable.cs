    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct ValidationSummaryHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ValidationSummaryHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ValidationSummaryHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ValidationSummaryHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ValidationSummaryHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationSummaryHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationSummaryHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ValidationSummaryHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ValidationSummaryHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ValidationSummaryHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ValidationSummaryHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ValidationSummaryHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ValidationSummaryHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ValidationSummaryHashEntity>();
                }
                finally
                {
