...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonDeliveryModel
#if NET8_0_OR_GREATER
        : IJsonElement<CommonDeliveryModel>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonDeliveryModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CommonDeliveryModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CommonDeliveryModel DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CommonDeliveryModel value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CommonDeliveryModel left, in CommonDeliveryModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CommonDeliveryModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CommonDeliveryModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CommonDeliveryModel(JsonElement instance)
        {
            return CommonDeliveryModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonDeliveryModel From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonDeliveryModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonDeliveryModel>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonDeliveryModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonDeliveryModel>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonDeliveryModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonDeliveryModel>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static CommonDeliveryModel ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonDeliveryModel>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CommonDeliveryModel? result)
        {
            return JsonElementHelpers.TryParseValue<CommonDeliveryModel>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CommonDeliveryModel(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static CommonDeliveryModel IJsonElement<CommonDeliveryModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CommonDeliveryModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CommonDeliveryModel"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CommonDeliveryModel"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CommonDeliveryModel Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CommonDeliveryModel>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CommonDeliveryModel"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public CommonDeliveryModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CommonDeliveryModel>(_idx);
            }
        ...
        /// <param name="matchWebManaged">Match 1st item.</param>
        /// <param name="matchWindowsLocal">Match 2nd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchWebManaged,
            Func<TContext, TResult> matchWindowsLocal,
...
#endif
        {
            ...
            {
                return matchWebManaged(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWindowsLocal(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchWebManaged,
            Func<TResult> matchWindowsLocal,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchWebManaged();
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWindowsLocal();
            }
