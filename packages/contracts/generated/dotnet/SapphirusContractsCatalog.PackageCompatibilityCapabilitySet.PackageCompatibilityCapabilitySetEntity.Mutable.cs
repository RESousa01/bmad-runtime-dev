    ...
    public readonly partial struct PackageCompatibilityCapabilitySet
    {
        ...
        public readonly partial struct PackageCompatibilityCapabilitySetEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PackageCompatibilityCapabilitySetEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PackageCompatibilityCapabilitySetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PackageCompatibilityCapabilitySetEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PackageCompatibilityCapabilitySetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PackageCompatibilityCapabilitySetEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PackageCompatibilityCapabilitySetEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PackageCompatibilityCapabilitySetEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PackageCompatibilityCapabilitySetEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PackageCompatibilityCapabilitySetEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PackageCompatibilityCapabilitySetEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PackageCompatibilityCapabilitySetEntity>();
                }
                finally
                {
