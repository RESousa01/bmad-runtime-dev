        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct DispositionKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DispositionKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DispositionKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DispositionKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DispositionKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DispositionKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DispositionKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DispositionKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DispositionKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DispositionKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DispositionKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DispositionKindEntity>();
                    }
                    finally
                    {
