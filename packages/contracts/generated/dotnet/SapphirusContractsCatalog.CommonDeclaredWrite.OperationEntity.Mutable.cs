    ...
    public readonly partial struct CommonDeclaredWrite
    {
        ...
        public readonly partial struct OperationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OperationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OperationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OperationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OperationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OperationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OperationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OperationEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OperationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OperationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OperationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OperationEntity>();
                }
                finally
                {
