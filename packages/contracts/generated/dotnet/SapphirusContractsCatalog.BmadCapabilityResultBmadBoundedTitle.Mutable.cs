...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResultBmadBoundedTitle
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadCapabilityResultBmadBoundedTitle instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadCapabilityResultBmadBoundedTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadCapabilityResultBmadBoundedTitle(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadCapabilityResultBmadBoundedTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityResultBmadBoundedTitle Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityResultBmadBoundedTitle Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadCapabilityResultBmadBoundedTitle>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadCapabilityResultBmadBoundedTitle instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadCapabilityResultBmadBoundedTitle, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadCapabilityResultBmadBoundedTitle> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadCapabilityResultBmadBoundedTitle>();
            }
            finally
            {
