    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct ContentRoleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentRoleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentRoleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentRoleEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentRoleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ContentRoleEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ContentRoleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentRoleEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ContentRoleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ContentRoleEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ContentRoleEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentRoleEntity>();
                }
                finally
                {
