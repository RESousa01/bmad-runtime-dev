    ...
    public readonly partial struct BmadCapabilityRun
    {
        ...
        public readonly partial struct OutputSchemaIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OutputSchemaIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputSchemaIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputSchemaIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputSchemaIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OutputSchemaIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OutputSchemaIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputSchemaIdEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputSchemaIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputSchemaIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputSchemaIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputSchemaIdEntity>();
                }
                finally
                {
