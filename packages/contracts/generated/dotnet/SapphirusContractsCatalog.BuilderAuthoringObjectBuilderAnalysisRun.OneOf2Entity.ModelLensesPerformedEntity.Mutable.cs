        ...
        public readonly partial struct OneOf2Entity
        {
            ...
            public readonly partial struct ModelLensesPerformedEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ModelLensesPerformedEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ModelLensesPerformedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ModelLensesPerformedEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ModelLensesPerformedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelLensesPerformedEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelLensesPerformedEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ModelLensesPerformedEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ModelLensesPerformedEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ModelLensesPerformedEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ModelLensesPerformedEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ModelLensesPerformedEntity>();
                    }
                    finally
                    {
