...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct RedactionLevelEntity
#if NET8_0_OR_GREATER
            : IJsonElement<RedactionLevelEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RedactionLevelEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RedactionLevelEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RedactionLevelEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RedactionLevelEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RedactionLevelEntity left, in RedactionLevelEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RedactionLevelEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RedactionLevelEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RedactionLevelEntity(JsonElement instance)
            {
                return RedactionLevelEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RedactionLevelEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RedactionLevelEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RedactionLevelEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RedactionLevelEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RedactionLevelEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RedactionLevelEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RedactionLevelEntity>(json, options);
            }
            ...
            /// </exception>
            public static RedactionLevelEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RedactionLevelEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RedactionLevelEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RedactionLevelEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RedactionLevelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RedactionLevelEntity IJsonElement<RedactionLevelEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RedactionLevelEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RedactionLevelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RedactionLevelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RedactionLevelEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RedactionLevelEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RedactionLevelEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RedactionLevelEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RedactionLevelEntity>(_idx);
                }
            ...
            /// <param name="matchSummary">Match 1st item.</param>
            /// <param name="matchRedacted">Match 2nd item.</param>
            /// <param name="matchPrivileged">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSummary,
                Func<TContext, TResult> matchRedacted,
...
#endif
            {
                ...
                {
                    return matchSummary(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchRedacted(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSummary,
                Func<TResult> matchRedacted,
