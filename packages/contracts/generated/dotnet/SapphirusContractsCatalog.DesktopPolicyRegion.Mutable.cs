...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DesktopPolicyRegion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DesktopPolicyRegion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DesktopPolicyRegion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DesktopPolicyRegion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DesktopPolicyRegion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DesktopPolicyRegion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DesktopPolicyRegion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DesktopPolicyRegion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DesktopPolicyRegion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DesktopPolicyRegion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DesktopPolicyRegion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DesktopPolicyRegion>();
            }
            finally
            {
