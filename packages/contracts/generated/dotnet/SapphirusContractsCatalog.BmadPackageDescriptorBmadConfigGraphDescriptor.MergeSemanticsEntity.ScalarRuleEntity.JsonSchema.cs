        ...
        public readonly partial struct MergeSemanticsEntity
        {
                ...
                : IJsonElement<ScalarRuleEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "later_replaces"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ScalarRuleEntity ConstJson = ParsedJsonDocument<ScalarRuleEntity>.StringConstant([.."\"later_replaces\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/scalarRule"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/scalarRule";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/scalarRule"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "later_replaces"u8, "later_replaces", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "later_replaces", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
