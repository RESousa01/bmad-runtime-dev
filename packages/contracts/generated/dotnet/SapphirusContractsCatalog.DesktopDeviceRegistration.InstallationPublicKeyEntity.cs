...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DesktopDeviceRegistration
    {
        ...
        public readonly partial struct InstallationPublicKeyEntity
#if NET8_0_OR_GREATER
            : IJsonElement<InstallationPublicKeyEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="InstallationPublicKeyEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal InstallationPublicKeyEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static InstallationPublicKeyEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(InstallationPublicKeyEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in InstallationPublicKeyEntity left, in InstallationPublicKeyEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in InstallationPublicKeyEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(InstallationPublicKeyEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InstallationPublicKeyEntity(JsonElement instance)
            {
                return InstallationPublicKeyEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InstallationPublicKeyEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InstallationPublicKeyEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InstallationPublicKeyEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InstallationPublicKeyEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InstallationPublicKeyEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InstallationPublicKeyEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InstallationPublicKeyEntity>(json, options);
            }
            ...
            /// </exception>
            public static InstallationPublicKeyEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<InstallationPublicKeyEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out InstallationPublicKeyEntity? result)
            {
                return JsonElementHelpers.TryParseValue<InstallationPublicKeyEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new InstallationPublicKeyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static InstallationPublicKeyEntity IJsonElement<InstallationPublicKeyEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InstallationPublicKeyEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="InstallationPublicKeyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="InstallationPublicKeyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public InstallationPublicKeyEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<InstallationPublicKeyEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="InstallationPublicKeyEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public InstallationPublicKeyEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<InstallationPublicKeyEntity>(_idx);
                }
