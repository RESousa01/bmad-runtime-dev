    ...
    public readonly partial struct BmadCapabilityCatalogInstalledSkillRecord
    {
            ...
            : IJsonElement<ActionCardinalityEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "single_action"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ActionCardinalityEntity EnumJson1 = ParsedJsonDocument<ActionCardinalityEntity>.StringConstant([.."\"single_action\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "multi_action"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ActionCardinalityEntity EnumJson2 = ParsedJsonDocument<ActionCardinalityEntity>.StringConstant([.."\"multi_action\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "single_action"
                /// as a <see cref="ActionCardinalityEntity"/>.
                /// </summary>
                public static ActionCardinalityEntity SingleAction { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "single_action"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SingleActionUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "multi_action"
                /// as a <see cref="ActionCardinalityEntity"/>.
                /// </summary>
                public static ActionCardinalityEntity MultiAction { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "multi_action"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> MultiActionUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityCatalogInstalledSkillRecord/properties/actionCardinality"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadCapabilityCatalogInstalledSkillRecord/properties/actionCardinality";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityCatalogInstalledSkillRecord/properties/actionCardinality"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("single_action"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("multi_action"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
