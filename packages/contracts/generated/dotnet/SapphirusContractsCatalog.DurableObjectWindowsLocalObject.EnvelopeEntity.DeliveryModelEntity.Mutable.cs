        ...
        public readonly partial struct EnvelopeEntity
        {
            ...
            public readonly partial struct DeliveryModelEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DeliveryModelEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeliveryModelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeliveryModelEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeliveryModelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeliveryModelEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeliveryModelEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeliveryModelEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeliveryModelEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DeliveryModelEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeliveryModelEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeliveryModelEntity>();
                    }
                    finally
                    {
