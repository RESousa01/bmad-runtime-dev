...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessReceiptSafeSize
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelAccessReceiptSafeSize instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelAccessReceiptSafeSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelAccessReceiptSafeSize(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelAccessReceiptSafeSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptSafeSize Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptSafeSize Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelAccessReceiptSafeSize>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelAccessReceiptSafeSize instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelAccessReceiptSafeSize, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelAccessReceiptSafeSize> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelAccessReceiptSafeSize>();
            }
            finally
            {
