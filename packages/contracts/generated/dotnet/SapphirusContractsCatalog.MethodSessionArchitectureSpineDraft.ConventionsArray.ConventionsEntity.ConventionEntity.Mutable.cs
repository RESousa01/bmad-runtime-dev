            ...
            public readonly partial struct ConventionsEntity
            {
                ...
                public readonly partial struct ConventionEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ConventionEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ConventionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ConventionEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ConventionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ConventionEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ConventionEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ConventionEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ConventionEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ConventionEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ConventionEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ConventionEntity>();
                        }
                        finally
                        {
