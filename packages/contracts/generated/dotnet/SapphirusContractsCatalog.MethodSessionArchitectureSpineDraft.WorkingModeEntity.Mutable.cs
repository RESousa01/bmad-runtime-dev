    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct WorkingModeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WorkingModeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WorkingModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WorkingModeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WorkingModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WorkingModeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WorkingModeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WorkingModeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WorkingModeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WorkingModeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WorkingModeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WorkingModeEntity>();
                }
                finally
                {
