...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
...
#endif
        {
            ...
            /// <param name="matchUnavailable">Match 2nd item.</param>
            /// <param name="matchAmbiguous">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAvailable,
                Func<TContext, TResult> matchUnavailable,
                Func<TContext, TResult> matchAmbiguous,
...
#endif
            {
                ...
                {
                    return matchUnavailable(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAmbiguous(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchUnavailable,
                Func<TResult> matchAmbiguous,
