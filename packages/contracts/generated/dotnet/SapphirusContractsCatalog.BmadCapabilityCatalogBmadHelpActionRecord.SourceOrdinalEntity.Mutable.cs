    ...
    public readonly partial struct BmadCapabilityCatalogBmadHelpActionRecord
    {
        ...
        public readonly partial struct SourceOrdinalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SourceOrdinalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SourceOrdinalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SourceOrdinalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SourceOrdinalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SourceOrdinalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SourceOrdinalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SourceOrdinalEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SourceOrdinalEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SourceOrdinalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SourceOrdinalEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SourceOrdinalEntity>();
                }
                finally
                {
