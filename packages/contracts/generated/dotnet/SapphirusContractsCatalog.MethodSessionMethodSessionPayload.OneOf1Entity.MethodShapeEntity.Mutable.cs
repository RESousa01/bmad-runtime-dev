        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct MethodShapeEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MethodShapeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MethodShapeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MethodShapeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MethodShapeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MethodShapeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MethodShapeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MethodShapeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MethodShapeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MethodShapeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MethodShapeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MethodShapeEntity>();
                    }
                    finally
                    {
