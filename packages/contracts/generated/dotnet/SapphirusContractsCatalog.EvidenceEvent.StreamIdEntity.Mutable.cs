    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct StreamIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(StreamIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StreamIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StreamIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StreamIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly StreamIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly StreamIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StreamIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StreamIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StreamIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StreamIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StreamIdEntity>();
                }
                finally
                {
