    ...
    public readonly partial struct BmadValidationReport
    {
            ...
            : IJsonElement<SubjectKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "source_skill"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SubjectKindEntity EnumJson1 = ParsedJsonDocument<SubjectKindEntity>.StringConstant([.."\"source_skill\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "installed_workspace"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SubjectKindEntity EnumJson2 = ParsedJsonDocument<SubjectKindEntity>.StringConstant([.."\"installed_workspace\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "builder_draft_revision"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly SubjectKindEntity EnumJson3 = ParsedJsonDocument<SubjectKindEntity>.StringConstant([.."\"builder_draft_revision\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "source_skill"
                /// as a <see cref="SubjectKindEntity"/>.
                /// </summary>
                public static SubjectKindEntity SourceSkill { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "source_skill"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SourceSkillUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "installed_workspace"
                /// as a <see cref="SubjectKindEntity"/>.
                /// </summary>
                public static SubjectKindEntity InstalledWorkspace { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "installed_workspace"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> InstalledWorkspaceUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "builder_draft_revision"
                /// as a <see cref="SubjectKindEntity"/>.
                /// </summary>
                public static SubjectKindEntity BuilderDraftRevision { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "builder_draft_revision"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> BuilderDraftRevisionUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReport/properties/subjectKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadValidationReport/properties/subjectKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReport/properties/subjectKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("source_skill"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("installed_workspace"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("builder_draft_revision"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
