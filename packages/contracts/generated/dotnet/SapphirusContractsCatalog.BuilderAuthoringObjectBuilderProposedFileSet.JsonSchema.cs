...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BuilderAuthoringObjectBuilderProposedFileSet>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLimitProfilePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("limitProfile"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLimitProfileNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("limitProfile"u8, buffer, out written);

            private const int RequiredOffsetForLimitProfile = 0;
            private const uint RequiredBitForLimitProfile = 0b00000000000000000000000000000010;

            private const uint RequiredBitMask0 =
                RequiredBitForFiles | RequiredBitForLimitProfile;
            ...
            private static readonly JsonSchemaPathProvider LimitProfileSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/limitProfile"u8, buffer, out written);
            ...
            private static void MatchFiles(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFileSet.FilesArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFileSet.FilesArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchLimitProfile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFileSet.LimitProfileEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LimitProfileUtf8,
                        evaluationPath: LimitProfileSchemaEvaluationPath);

                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderProposedFileSet.LimitProfileEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForLimitProfile] |= RequiredBitForLimitProfile;
            }
            ...
            private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.LimitProfileUtf8, MatchLimitProfile),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderProposedFileSet"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderProposedFileSet";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderProposedFileSet"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLimitProfilePresent, "limitProfile"u8, "required"u8);
                    }
                    ...
                    else
                    {
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLimitProfile] & RequiredBitForLimitProfile) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLimitProfileNotPresent, "limitProfile"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLimitProfilePresent, "limitProfile"u8, "required"u8);
