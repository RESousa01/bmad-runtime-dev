...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BuilderAuthoringObjectBuilderProposedFileSet>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchLimitProfile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
