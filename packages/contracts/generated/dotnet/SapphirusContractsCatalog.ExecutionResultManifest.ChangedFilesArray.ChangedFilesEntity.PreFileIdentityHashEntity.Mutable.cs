            ...
            public readonly partial struct ChangedFilesEntity
            {
                ...
                public readonly partial struct PreFileIdentityHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PreFileIdentityHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PreFileIdentityHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PreFileIdentityHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PreFileIdentityHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreFileIdentityHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreFileIdentityHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PreFileIdentityHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PreFileIdentityHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PreFileIdentityHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PreFileIdentityHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PreFileIdentityHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PreFileIdentityHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PreFileIdentityHashEntity>();
                        }
                        finally
                        {
