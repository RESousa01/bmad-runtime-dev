...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonUtcInstant
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonUtcInstant instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonUtcInstant"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonUtcInstant(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonUtcInstant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonUtcInstant Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonUtcInstant Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonUtcInstant>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonUtcInstant instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonUtcInstant, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonUtcInstant> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonUtcInstant>();
            }
            finally
            {
