        ...
        public readonly partial struct ResourcePolicyEntity
        {
            ...
            public readonly partial struct EntrypointTimingEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EntrypointTimingEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EntrypointTimingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EntrypointTimingEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EntrypointTimingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EntrypointTimingEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EntrypointTimingEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EntrypointTimingEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EntrypointTimingEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EntrypointTimingEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EntrypointTimingEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EntrypointTimingEntity>();
                    }
                    finally
                    {
