...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodHelpProposal
    {
        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct EvidenceTokenIdsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EvidenceTokenIdsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EvidenceTokenIdsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EvidenceTokenIdsArray(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new EvidenceTokenIdsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EvidenceTokenIdsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// <summary>
                    /// Gets a <see cref="EvidenceTokenIdsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="EvidenceTokenIdsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EvidenceTokenIdsArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<EvidenceTokenIdsArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="EvidenceTokenIdsArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EvidenceTokenIdsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EvidenceTokenIdsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf0Entity.EvidenceTokenIdsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(EvidenceTokenIdsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodHelpProposal.OneOf0Entity.EvidenceTokenIdsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<EvidenceTokenIdsArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EvidenceTokenIdsArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EvidenceTokenIdsArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<EvidenceTokenIdsArray> Create<TContext>(
