    ...
    public readonly partial struct ExecutionResultManifest
    {
            ...
            : IJsonElement<ChangedFilesArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ExecutionResultManifest/properties/changedFiles"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ExecutionResultManifest/properties/changedFiles";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ExecutionResultManifest/properties/changedFiles"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.JsonSchema.PushChildContext(
                                parentDocument,
                                arrayValidation_currentIndex,
                                ref context,
                                itemIndex: arrayValidation_itemCount,
                                evaluationPath: ItemsSchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
