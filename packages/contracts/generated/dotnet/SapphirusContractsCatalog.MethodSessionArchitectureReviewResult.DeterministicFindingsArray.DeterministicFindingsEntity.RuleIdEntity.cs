    ...
    public readonly partial struct MethodSessionArchitectureReviewResult
    {
        ...
        public readonly partial struct DeterministicFindingsArray
        {
            ...
            public readonly partial struct DeterministicFindingsEntity
            {
                ...
                public readonly partial struct RuleIdEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<RuleIdEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RuleIdEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RuleIdEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RuleIdEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(RuleIdEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in RuleIdEntity left, in RuleIdEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RuleIdEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(RuleIdEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RuleIdEntity(JsonElement instance)
                    {
                        return RuleIdEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RuleIdEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RuleIdEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RuleIdEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RuleIdEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RuleIdEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RuleIdEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RuleIdEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RuleIdEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RuleIdEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RuleIdEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<RuleIdEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RuleIdEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RuleIdEntity IJsonElement<RuleIdEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RuleIdEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RuleIdEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RuleIdEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RuleIdEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RuleIdEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RuleIdEntity"/> that lives for the lifetime of its
                    ...
                    /// <param name="matchPlaceholderMarker">Match 1st item.</param>
                    /// <param name="matchDecisionIdDuplicate">Match 2nd item.</param>
                    /// <param name="matchDecisionIdNonMonotonic">Match 3rd item.</param>
                    /// <param name="matchDecisionFieldMissing">Match 4th item.</param>
                    /// <param name="matchStackVersionUnpinned">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchPlaceholderMarker,
                        Func<TContext, TResult> matchDecisionIdDuplicate,
                        Func<TContext, TResult> matchDecisionIdNonMonotonic,
                        Func<TContext, TResult> matchDecisionFieldMissing,
                        Func<TContext, TResult> matchStackVersionUnpinned,
...
#endif
                    {
                        ...
                        {
                            return matchPlaceholderMarker(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDecisionIdDuplicate(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchDecisionIdNonMonotonic(context);
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchDecisionFieldMissing(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchStackVersionUnpinned(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchPlaceholderMarker,
                        Func<TResult> matchDecisionIdDuplicate,
                        Func<TResult> matchDecisionIdNonMonotonic,
                        Func<TResult> matchDecisionFieldMissing,
                        Func<TResult> matchStackVersionUnpinned,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchPlaceholderMarker();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDecisionIdDuplicate();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchDecisionIdNonMonotonic();
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchDecisionFieldMissing();
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchStackVersionUnpinned();
                        }
