    ...
    public readonly partial struct RemoteJobHandoffRemoteResultHandoff
    {
            ...
            : IJsonElement<StateEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "result_available"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson1 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"result_available\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "result_verified"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson2 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"result_verified\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "result_available"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity ResultAvailable { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "result_available"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ResultAvailableUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "result_verified"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity ResultVerified { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "result_verified"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ResultVerifiedUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffRemoteResultHandoff/properties/state"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/RemoteJobHandoffRemoteResultHandoff/properties/state";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffRemoteResultHandoff/properties/state"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("result_available"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("result_verified"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
