        ...
        public readonly partial struct MergeSemanticsEntity
        {
            ...
            public readonly partial struct DeletionOperatorEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DeletionOperatorEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeletionOperatorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeletionOperatorEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeletionOperatorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeletionOperatorEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeletionOperatorEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeletionOperatorEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeletionOperatorEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DeletionOperatorEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeletionOperatorEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeletionOperatorEntity>();
                    }
                    finally
                    {
