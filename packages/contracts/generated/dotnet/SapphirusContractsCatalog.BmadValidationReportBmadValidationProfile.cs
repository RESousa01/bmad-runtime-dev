...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadValidationReportBmadValidationProfile
#if NET8_0_OR_GREATER
        : IJsonElement<BmadValidationReportBmadValidationProfile>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadValidationReportBmadValidationProfile"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadValidationReportBmadValidationProfile(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadValidationReportBmadValidationProfile DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadValidationReportBmadValidationProfile value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadValidationReportBmadValidationProfile left, in BmadValidationReportBmadValidationProfile right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadValidationReportBmadValidationProfile left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadValidationReportBmadValidationProfile instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadValidationReportBmadValidationProfile(JsonElement instance)
        {
            return BmadValidationReportBmadValidationProfile.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadValidationReportBmadValidationProfile From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadValidationReportBmadValidationProfile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadValidationReportBmadValidationProfile>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadValidationReportBmadValidationProfile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadValidationReportBmadValidationProfile>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadValidationReportBmadValidationProfile ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadValidationReportBmadValidationProfile>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BmadValidationReportBmadValidationProfile ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadValidationReportBmadValidationProfile>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadValidationReportBmadValidationProfile? result)
        {
            return JsonElementHelpers.TryParseValue<BmadValidationReportBmadValidationProfile>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadValidationReportBmadValidationProfile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadValidationReportBmadValidationProfile IJsonElement<BmadValidationReportBmadValidationProfile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadValidationReportBmadValidationProfile: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadValidationReportBmadValidationProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadValidationReportBmadValidationProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadValidationReportBmadValidationProfile Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadValidationReportBmadValidationProfile>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadValidationReportBmadValidationProfile"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadValidationReportBmadValidationProfile Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadValidationReportBmadValidationProfile>(_idx);
            }
        ...
        /// <param name="matchMethodOfficialSkillV6">Match 1st item.</param>
        /// <param name="matchMethodStepWorkflowV6">Match 2nd item.</param>
        /// <param name="matchBuilderOutcomeSkillV2">Match 3rd item.</param>
        /// <param name="matchBuilderAgentV2Stateless">Match 4th item.</param>
        /// <param name="matchMethodCliInstalledV6">Match 5th item.</param>
        /// <param name="matchStandaloneBuilderSetupV2">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchMethodOfficialSkillV6,
            Func<TContext, TResult> matchMethodStepWorkflowV6,
            Func<TContext, TResult> matchBuilderOutcomeSkillV2,
            Func<TContext, TResult> matchBuilderAgentV2Stateless,
            Func<TContext, TResult> matchMethodCliInstalledV6,
            Func<TContext, TResult> matchStandaloneBuilderSetupV2,
...
#endif
        {
            ...
            {
                return matchMethodOfficialSkillV6(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchMethodStepWorkflowV6(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchBuilderOutcomeSkillV2(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBuilderAgentV2Stateless(context);
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchMethodCliInstalledV6(context);
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchStandaloneBuilderSetupV2(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchMethodOfficialSkillV6,
            Func<TResult> matchMethodStepWorkflowV6,
            Func<TResult> matchBuilderOutcomeSkillV2,
            Func<TResult> matchBuilderAgentV2Stateless,
            Func<TResult> matchMethodCliInstalledV6,
            Func<TResult> matchStandaloneBuilderSetupV2,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchMethodOfficialSkillV6();
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchMethodStepWorkflowV6();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchBuilderOutcomeSkillV2();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBuilderAgentV2Stateless();
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchMethodCliInstalledV6();
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchStandaloneBuilderSetupV2();
            }
