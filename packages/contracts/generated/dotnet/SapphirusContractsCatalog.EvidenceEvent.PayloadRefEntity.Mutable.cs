    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct PayloadRefEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PayloadRefEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PayloadRefEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PayloadRefEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PayloadRefEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadRefEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadRefEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PayloadRefEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.PayloadRefEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.PayloadRefEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonOpaqueRef.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PayloadRefEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PayloadRefEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PayloadRefEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PayloadRefEntity>();
                }
                finally
                {
