        ...
        public readonly partial struct BlockedToolIntentsArray
        {
            ...
            public readonly partial struct BlockedToolIntentsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(BlockedToolIntentsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BlockedToolIntentsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BlockedToolIntentsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BlockedToolIntentsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlockedToolIntentsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlockedToolIntentsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BlockedToolIntentsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(BlockedToolIntentsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<BlockedToolIntentsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<BlockedToolIntentsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BlockedToolIntentsEntity>();
                    }
                    finally
                    {
