    ...
    public readonly partial struct MethodSessionMethodAgentBinding
    {
        ...
        public readonly partial struct AgentNameEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AgentNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AgentNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AgentNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AgentNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AgentNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AgentNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AgentNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AgentNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AgentNameEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AgentNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AgentNameEntity>();
                }
                finally
                {
