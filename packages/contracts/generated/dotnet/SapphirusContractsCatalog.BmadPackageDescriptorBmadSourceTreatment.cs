...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceTreatment
#if NET8_0_OR_GREATER
        : IJsonElement<BmadPackageDescriptorBmadSourceTreatment>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadPackageDescriptorBmadSourceTreatment"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadPackageDescriptorBmadSourceTreatment(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadPackageDescriptorBmadSourceTreatment DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadPackageDescriptorBmadSourceTreatment value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadSourceTreatment left, in BmadPackageDescriptorBmadSourceTreatment right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadPackageDescriptorBmadSourceTreatment left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadPackageDescriptorBmadSourceTreatment instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadPackageDescriptorBmadSourceTreatment(JsonElement instance)
        {
            return BmadPackageDescriptorBmadSourceTreatment.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadSourceTreatment From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadSourceTreatment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadSourceTreatment>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadSourceTreatment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadSourceTreatment>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadPackageDescriptorBmadSourceTreatment ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadSourceTreatment>(json, options);
        }
        ...
        /// </exception>
        public static BmadPackageDescriptorBmadSourceTreatment ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BmadPackageDescriptorBmadSourceTreatment>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadPackageDescriptorBmadSourceTreatment? result)
        {
            return JsonElementHelpers.TryParseValue<BmadPackageDescriptorBmadSourceTreatment>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadPackageDescriptorBmadSourceTreatment(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadPackageDescriptorBmadSourceTreatment IJsonElement<BmadPackageDescriptorBmadSourceTreatment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadPackageDescriptorBmadSourceTreatment: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadPackageDescriptorBmadSourceTreatment"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadPackageDescriptorBmadSourceTreatment"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadSourceTreatment Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadPackageDescriptorBmadSourceTreatment>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadPackageDescriptorBmadSourceTreatment"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadPackageDescriptorBmadSourceTreatment Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadPackageDescriptorBmadSourceTreatment>(_idx);
            }
        ...
        /// <param name="matchAdopt">Match 1st item.</param>
        /// <param name="matchAdapt">Match 2nd item.</param>
        /// <param name="matchDefer">Match 3rd item.</param>
        /// <param name="matchReject">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchAdopt,
            Func<TContext, TResult> matchAdapt,
            Func<TContext, TResult> matchDefer,
...
#endif
        {
            ...
            {
                return matchAdopt(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchAdapt(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchDefer(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchAdopt,
            Func<TResult> matchAdapt,
            Func<TResult> matchDefer,
