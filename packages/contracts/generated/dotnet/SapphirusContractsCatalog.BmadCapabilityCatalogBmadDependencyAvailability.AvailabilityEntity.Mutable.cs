    ...
    public readonly partial struct BmadCapabilityCatalogBmadDependencyAvailability
    {
        ...
        public readonly partial struct AvailabilityEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AvailabilityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AvailabilityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AvailabilityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AvailabilityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AvailabilityEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AvailabilityEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AvailabilityEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AvailabilityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AvailabilityEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AvailabilityEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AvailabilityEntity>();
                }
                finally
                {
