            ...
            public readonly partial struct FindingsEntity
            {
                ...
                public readonly partial struct EvidenceEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(EvidenceEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="EvidenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator EvidenceEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"EvidenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EvidenceEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EvidenceEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<EvidenceEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(EvidenceEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<EvidenceEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<EvidenceEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<EvidenceEntity>();
                        }
                        finally
                        {
