        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct PrecededByEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PrecededByEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PrecededByEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PrecededByEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PrecededByEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrecededByEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrecededByEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PrecededByEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PrecededByEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PrecededByEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PrecededByEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PrecededByEntity>();
                    }
                    finally
                    {
