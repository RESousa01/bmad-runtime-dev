    ...
    public readonly partial struct MethodSessionMethodAgentBinding
    {
        ...
        public readonly partial struct MenuTargetKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MenuTargetKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MenuTargetKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MenuTargetKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MenuTargetKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MenuTargetKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MenuTargetKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MenuTargetKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MenuTargetKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MenuTargetKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MenuTargetKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MenuTargetKindEntity>();
                }
                finally
                {
