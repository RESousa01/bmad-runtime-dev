...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DurableObjectCandidatePointer
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DurableObjectCandidatePointer instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DurableObjectCandidatePointer"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DurableObjectCandidatePointer(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DurableObjectCandidatePointer(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DurableObjectCandidatePointer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DurableObjectCandidatePointer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DurableObjectCandidatePointer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DurableObjectCandidatePointer Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DurableObjectCandidatePointer>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DurableObjectCandidatePointer"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DurableObjectCandidatePointer Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DurableObjectCandidatePointer>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectCandidatePointer.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(DurableObjectCandidatePointer instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectCandidatePointer.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DurableObjectCandidatePointer"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.Source candidateId)
            {
            ...
            /// Creates an instance of a <see cref="DurableObjectCandidatePointer"/>.
            /// </summary>
            public void Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.Source candidateId)
            {
                Create(ref _builder, candidateId);
            }
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.Source candidateId)
        {
            return new Source(candidateId);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.Source candidateId, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(candidateId);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<DurableObjectCandidatePointer, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DurableObjectCandidatePointer> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DurableObjectCandidatePointer>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DurableObjectCandidatePointer> Create<TContext>(
        ...
        public static ParsedJsonDocument<DurableObjectCandidatePointer> Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.Source candidateId, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
