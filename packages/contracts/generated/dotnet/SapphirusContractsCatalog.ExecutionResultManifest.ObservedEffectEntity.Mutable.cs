...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct ObservedEffectEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ObservedEffectEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ObservedEffectEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ObservedEffectEntity(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the <c>observedKind</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.Mutable ObservedKind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObservedKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ObservedEffectEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>observedKind</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetObservedKind(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("observedKind");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObservedKindUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ObservedKind, ref cvb);
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ObservedEffectEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ObservedEffectEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ObservedEffectEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ObservedEffectEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ObservedEffectEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ObservedEffectEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ObservedEffectEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ObservedEffectEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(ObservedEffectEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ObservedEffectEntity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source patchHash)
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.ObservedKind, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ObservedEffectEntity.ObservedKindEntity.ConstInstance);
                ...
                /// Creates an instance of a <see cref="ObservedEffectEntity"/>.
                /// </summary>
                public void Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source patchHash)
                {
                    Create(ref _builder, patchHash);
                }
                ...
                internal static void BuildCreateValue(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// </summary>
            /// <param name="patchHash">The value of the <c>"patchHash"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source patchHash)
            {
                return new Source(patchHash);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source patchHash, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(patchHash);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ObservedEffectEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ObservedEffectEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ObservedEffectEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ObservedEffectEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<ObservedEffectEntity> Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.Source patchHash, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
