    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct StackArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="StackEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal StackEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static StackEntity DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.NameEntity Name
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.NameEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.VersionEntity Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.VersionEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.VersionEvidenceEntity VersionEvidence
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionEvidenceUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.StackArray.StackEntity.VersionEvidenceEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in StackEntity left, in StackEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StackEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(StackEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StackEntity(JsonElement instance)
                {
                    return StackEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StackEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StackEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StackEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StackEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StackEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StackEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StackEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static StackEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StackEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StackEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<StackEntity>(ref reader, out result);
                }
...
#if NET
                static StackEntity IJsonElement<StackEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StackEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="VersionEvidence"/>.
                    /// </summary>
                    public const string VersionEvidence = "versionEvidence";
                    ...
                    /// Gets the JSON property name for <see cref="VersionEvidence"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> VersionEvidenceUtf8 => "versionEvidence"u8;
                }
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="VersionEvidence"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> VersionEvidence => "versionEvidence"u8;
                }
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="VersionEvidence"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> VersionEvidence => [0x15, 0x01, 0x00, 0x00, 0x22, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E, 0x45, 0x76, 0x69, 0x64, 0x65, 0x6E, 0x63, 0x65, 0x22];
                }
            }
        }
    }
