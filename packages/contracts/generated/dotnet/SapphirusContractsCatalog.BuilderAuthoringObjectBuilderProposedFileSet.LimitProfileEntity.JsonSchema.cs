    ...
    public readonly partial struct BuilderAuthoringObjectBuilderProposedFileSet
    {
            ...
            : IJsonElement<LimitProfileEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "sapphirus.bmad-builder-limits.v1"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly LimitProfileEntity ConstJson = ParsedJsonDocument<LimitProfileEntity>.StringConstant([.."\"sapphirus.bmad-builder-limits.v1\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderProposedFileSet/properties/limitProfile"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderProposedFileSet/properties/limitProfile";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderProposedFileSet/properties/limitProfile"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "sapphirus.bmad-builder-limits.v1"u8, "sapphirus.bmad-builder-limits.v1", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "sapphirus.bmad-builder-limits.v1", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
