...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct StateHintsArray
        {
            ...
            public readonly partial struct StateHintsEntity
#if NET8_0_OR_GREATER
                : IJsonElement<StateHintsEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="StateHintsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal StateHintsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static StateHintsEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(StateHintsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in StateHintsEntity left, in StateHintsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StateHintsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(StateHintsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StateHintsEntity(JsonElement instance)
                {
                    return StateHintsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StateHintsEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StateHintsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StateHintsEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StateHintsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StateHintsEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StateHintsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StateHintsEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static StateHintsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StateHintsEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StateHintsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<StateHintsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StateHintsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static StateHintsEntity IJsonElement<StateHintsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StateHintsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StateHintsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StateHintsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public StateHintsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StateHintsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StateHintsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public StateHintsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<StateHintsEntity>(_idx);
                    }
                ...
                /// <param name="matchMemlog">Match 1st item.</param>
                /// <param name="matchArtifactWorkspace">Match 2nd item.</param>
                /// <param name="matchSprintStatus">Match 3rd item.</param>
                /// <param name="matchStory">Match 4th item.</param>
                /// <param name="matchSpec">Match 5th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchMemlog,
                    Func<TContext, TResult> matchArtifactWorkspace,
                    Func<TContext, TResult> matchSprintStatus,
                    Func<TContext, TResult> matchStory,
...
#endif
                {
                    ...
                    {
                        return matchMemlog(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchArtifactWorkspace(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchSprintStatus(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchStory(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchMemlog,
                    Func<TResult> matchArtifactWorkspace,
                    Func<TResult> matchSprintStatus,
                    Func<TResult> matchStory,
                    ...
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchArtifactWorkspace();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchSprintStatus();
                    }
