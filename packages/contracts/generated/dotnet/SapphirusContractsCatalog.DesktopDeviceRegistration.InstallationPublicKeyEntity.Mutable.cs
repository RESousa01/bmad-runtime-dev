    ...
    public readonly partial struct DesktopDeviceRegistration
    {
        ...
        public readonly partial struct InstallationPublicKeyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(InstallationPublicKeyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InstallationPublicKeyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InstallationPublicKeyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InstallationPublicKeyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InstallationPublicKeyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InstallationPublicKeyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InstallationPublicKeyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(InstallationPublicKeyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<InstallationPublicKeyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InstallationPublicKeyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InstallationPublicKeyEntity>();
                }
                finally
                {
