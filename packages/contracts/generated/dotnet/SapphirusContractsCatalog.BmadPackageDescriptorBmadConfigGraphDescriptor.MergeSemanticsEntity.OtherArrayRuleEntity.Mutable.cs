        ...
        public readonly partial struct MergeSemanticsEntity
        {
            ...
            public readonly partial struct OtherArrayRuleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OtherArrayRuleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OtherArrayRuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OtherArrayRuleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OtherArrayRuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OtherArrayRuleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OtherArrayRuleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OtherArrayRuleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OtherArrayRuleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OtherArrayRuleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OtherArrayRuleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OtherArrayRuleEntity>();
                    }
                    finally
                    {
