    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
            ...
            : IJsonElement<ProvenanceStatusEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "immutable_identity_verified"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ProvenanceStatusEntity EnumJson1 = ParsedJsonDocument<ProvenanceStatusEntity>.StringConstant([.."\"immutable_identity_verified\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "reviewed_snapshot_only"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ProvenanceStatusEntity EnumJson2 = ParsedJsonDocument<ProvenanceStatusEntity>.StringConstant([.."\"reviewed_snapshot_only\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "blocked_provenance"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ProvenanceStatusEntity EnumJson3 = ParsedJsonDocument<ProvenanceStatusEntity>.StringConstant([.."\"blocked_provenance\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "immutable_identity_verified"
                /// as a <see cref="ProvenanceStatusEntity"/>.
                /// </summary>
                public static ProvenanceStatusEntity ImmutableIdentityVerified { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "immutable_identity_verified"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ImmutableIdentityVerifiedUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "reviewed_snapshot_only"
                /// as a <see cref="ProvenanceStatusEntity"/>.
                /// </summary>
                public static ProvenanceStatusEntity ReviewedSnapshotOnly { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "reviewed_snapshot_only"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ReviewedSnapshotOnlyUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "blocked_provenance"
                /// as a <see cref="ProvenanceStatusEntity"/>.
                /// </summary>
                public static ProvenanceStatusEntity BlockedProvenance { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "blocked_provenance"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> BlockedProvenanceUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadSourceIdentity/properties/provenanceStatus"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadSourceIdentity/properties/provenanceStatus";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadSourceIdentity/properties/provenanceStatus"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("immutable_identity_verified"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("reviewed_snapshot_only"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("blocked_provenance"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
