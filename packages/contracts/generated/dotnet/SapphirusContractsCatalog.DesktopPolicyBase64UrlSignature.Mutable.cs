...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DesktopPolicyBase64UrlSignature
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DesktopPolicyBase64UrlSignature instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DesktopPolicyBase64UrlSignature"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DesktopPolicyBase64UrlSignature(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DesktopPolicyBase64UrlSignature.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DesktopPolicyBase64UrlSignature Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DesktopPolicyBase64UrlSignature Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DesktopPolicyBase64UrlSignature>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DesktopPolicyBase64UrlSignature instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DesktopPolicyBase64UrlSignature, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DesktopPolicyBase64UrlSignature> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DesktopPolicyBase64UrlSignature>();
            }
            finally
            {
