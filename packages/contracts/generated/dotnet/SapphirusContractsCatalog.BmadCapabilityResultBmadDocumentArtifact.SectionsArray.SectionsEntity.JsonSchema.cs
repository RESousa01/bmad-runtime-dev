        ...
        public readonly partial struct SectionsArray
        {
                ...
                : IJsonElement<SectionsEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchHeading(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
