        ...
        public readonly partial struct SectionsArray
        {
                ...
                : IJsonElement<SectionsEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHeadingPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("heading"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHeadingNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("heading"u8, buffer, out written);

                    private const int RequiredOffsetForHeading = 0;
                    private const uint RequiredBitForHeading = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForBody | RequiredBitForHeading;
                    ...
                    private static readonly JsonSchemaPathProvider HeadingSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/heading/$ref"u8, buffer, out written);
                    ...
                    private static void MatchBody(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedProse.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedProse.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchHeading(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedTitle.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.HeadingUtf8,
                                evaluationPath: HeadingSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedTitle.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        requiredBitBuffer[RequiredOffsetForHeading] |= RequiredBitForHeading;
                    }
                    ...
                    private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                            ...
                            (static () => JsonPropertyNames.HeadingUtf8, MatchHeading),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResultBmadDocumentArtifact/properties/sections/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadCapabilityResultBmadDocumentArtifact/properties/sections/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResultBmadDocumentArtifact/properties/sections/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                            {
                                ...
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyHeadingPresent, "heading"u8, "required"u8);
                            }
                            ...
                            else
                            {
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForHeading] & RequiredBitForHeading) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyHeadingNotPresent, "heading"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyHeadingPresent, "heading"u8, "required"u8);
