            ...
            public readonly partial struct EntriesEntity
            {
                ...
                public readonly partial struct EntryKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(EntryKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="EntryKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator EntryKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"EntryKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EntryKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EntryKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<EntryKindEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(EntryKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<EntryKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<EntryKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<EntryKindEntity>();
                        }
                        finally
                        {
