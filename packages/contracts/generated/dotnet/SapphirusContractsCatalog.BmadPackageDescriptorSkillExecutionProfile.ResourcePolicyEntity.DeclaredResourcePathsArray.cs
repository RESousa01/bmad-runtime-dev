    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct ResourcePolicyEntity
        {
            ...
            public readonly partial struct DeclaredResourcePathsArray
                ...
                : IJsonElement<DeclaredResourcePathsArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DeclaredResourcePathsArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DeclaredResourcePathsArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DeclaredResourcePathsArray DefaultInstance { get; }
                ...
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonRelativeWorkspacePath this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonRelativeWorkspacePath>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonRelativeWorkspacePath> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonRelativeWorkspacePath>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in DeclaredResourcePathsArray left, in DeclaredResourcePathsArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DeclaredResourcePathsArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(DeclaredResourcePathsArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeclaredResourcePathsArray(JsonElement instance)
                {
                    return DeclaredResourcePathsArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredResourcePathsArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredResourcePathsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DeclaredResourcePathsArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredResourcePathsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DeclaredResourcePathsArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DeclaredResourcePathsArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DeclaredResourcePathsArray>(json, options);
                }
                ...
                /// </exception>
                public static DeclaredResourcePathsArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DeclaredResourcePathsArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DeclaredResourcePathsArray? result)
                {
                    return JsonElementHelpers.TryParseValue<DeclaredResourcePathsArray>(ref reader, out result);
                }
...
#if NET
                static DeclaredResourcePathsArray IJsonElement<DeclaredResourcePathsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeclaredResourcePathsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public DeclaredResourcePathsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public DeclaredResourcePathsArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DeclaredResourcePathsArray>(_idx);
                    }
