...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct RemoteJobHandoffPreviousHandoffHash
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RemoteJobHandoffPreviousHandoffHash instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RemoteJobHandoffPreviousHandoffHash"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RemoteJobHandoffPreviousHandoffHash(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RemoteJobHandoffPreviousHandoffHash.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffPreviousHandoffHash Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RemoteJobHandoffPreviousHandoffHash Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RemoteJobHandoffPreviousHandoffHash>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.RemoteJobHandoffPreviousHandoffHash.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.RemoteJobHandoffPreviousHandoffHash.Mutable, TResult> defaultMatch)
            {
                if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RemoteJobHandoffPreviousHandoffHash instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RemoteJobHandoffPreviousHandoffHash, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RemoteJobHandoffPreviousHandoffHash> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RemoteJobHandoffPreviousHandoffHash>();
            }
            finally
            {
