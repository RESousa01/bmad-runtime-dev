...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ContractError
    {
...
#endif
        {
            ...
            internal CodeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CodeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CodeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CodeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CodeEntity(JsonElement instance)
            {
                return CodeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CodeEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CodeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<CodeEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CodeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<CodeEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CodeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<CodeEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static CodeEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<CodeEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CodeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CodeEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CodeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CodeEntity IJsonElement<CodeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CodeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CodeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CodeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<CodeEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CodeEntity"/> that lives for the lifetime of its
            ...
            /// <param name="matchSchemaUnsupported">Match 1st item.</param>
            /// <param name="matchSchemaInvalid">Match 2nd item.</param>
            /// <param name="matchDeliveryModelMismatch">Match 3rd item.</param>
            /// <param name="matchAuthorityMismatch">Match 4th item.</param>
            /// <param name="matchWorkspaceTargetMismatch">Match 5th item.</param>
            /// <param name="matchExecutorAudienceMismatch">Match 6th item.</param>
            /// <param name="matchHashMismatch">Match 7th item.</param>
            /// <param name="matchStaleMutableInput">Match 8th item.</param>
            /// <param name="matchSpecExpired">Match 9th item.</param>
            /// <param name="matchSpecAlreadyConsumed">Match 10th item.</param>
            /// <param name="matchSyncConflict">Match 11th item.</param>
            /// <param name="matchSignatureInvalid">Match 12th item.</param>
            /// <param name="matchCompatibilityBlocked">Match 13th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSchemaUnsupported,
                Func<TContext, TResult> matchSchemaInvalid,
                Func<TContext, TResult> matchDeliveryModelMismatch,
                Func<TContext, TResult> matchAuthorityMismatch,
                Func<TContext, TResult> matchWorkspaceTargetMismatch,
                Func<TContext, TResult> matchExecutorAudienceMismatch,
                Func<TContext, TResult> matchHashMismatch,
                Func<TContext, TResult> matchStaleMutableInput,
                Func<TContext, TResult> matchSpecExpired,
                Func<TContext, TResult> matchSpecAlreadyConsumed,
                Func<TContext, TResult> matchSyncConflict,
                Func<TContext, TResult> matchSignatureInvalid,
                Func<TContext, TResult> matchCompatibilityBlocked,
...
#endif
            {
                ...
                {
                    return matchSchemaUnsupported(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSchemaInvalid(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchDeliveryModelMismatch(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAuthorityMismatch(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchWorkspaceTargetMismatch(context);
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchExecutorAudienceMismatch(context);
                }

                if (this.ValueEquals(Constants.Enum7))
                {
                    return matchHashMismatch(context);
                }

                if (this.ValueEquals(Constants.Enum8))
                {
                    return matchStaleMutableInput(context);
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchSpecExpired(context);
                }

                if (this.ValueEquals(Constants.Enum10))
                {
                    return matchSpecAlreadyConsumed(context);
                }

                if (this.ValueEquals(Constants.Enum11))
                {
                    return matchSyncConflict(context);
                }

                if (this.ValueEquals(Constants.Enum12))
                {
                    return matchSignatureInvalid(context);
                }

                if (this.ValueEquals(Constants.Enum13))
                {
                    return matchCompatibilityBlocked(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSchemaUnsupported,
                Func<TResult> matchSchemaInvalid,
                Func<TResult> matchDeliveryModelMismatch,
                Func<TResult> matchAuthorityMismatch,
                Func<TResult> matchWorkspaceTargetMismatch,
                Func<TResult> matchExecutorAudienceMismatch,
                Func<TResult> matchHashMismatch,
                Func<TResult> matchStaleMutableInput,
                Func<TResult> matchSpecExpired,
                Func<TResult> matchSpecAlreadyConsumed,
                Func<TResult> matchSyncConflict,
                Func<TResult> matchSignatureInvalid,
                Func<TResult> matchCompatibilityBlocked,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSchemaUnsupported();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSchemaInvalid();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchDeliveryModelMismatch();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAuthorityMismatch();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchWorkspaceTargetMismatch();
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchExecutorAudienceMismatch();
                }

                if (this.ValueEquals(Constants.Enum7))
                {
                    return matchHashMismatch();
                }

                if (this.ValueEquals(Constants.Enum8))
                {
                    return matchStaleMutableInput();
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchSpecExpired();
                }

                if (this.ValueEquals(Constants.Enum10))
                {
                    return matchSpecAlreadyConsumed();
                }

                if (this.ValueEquals(Constants.Enum11))
                {
                    return matchSyncConflict();
                }

                if (this.ValueEquals(Constants.Enum12))
                {
                    return matchSignatureInvalid();
                }

                if (this.ValueEquals(Constants.Enum13))
                {
                    return matchCompatibilityBlocked();
                }
