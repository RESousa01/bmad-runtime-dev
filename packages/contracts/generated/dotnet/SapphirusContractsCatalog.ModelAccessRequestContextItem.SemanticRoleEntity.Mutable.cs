    ...
    public readonly partial struct ModelAccessRequestContextItem
    {
        ...
        public readonly partial struct SemanticRoleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SemanticRoleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SemanticRoleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SemanticRoleEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SemanticRoleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SemanticRoleEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SemanticRoleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SemanticRoleEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SemanticRoleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SemanticRoleEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SemanticRoleEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SemanticRoleEntity>();
                }
                finally
                {
