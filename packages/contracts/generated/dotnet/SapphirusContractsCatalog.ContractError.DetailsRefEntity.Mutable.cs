    ...
    public readonly partial struct ContractError
    {
        ...
        public readonly partial struct DetailsRefEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DetailsRefEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DetailsRefEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DetailsRefEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DetailsRefEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DetailsRefEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DetailsRefEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DetailsRefEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ContractError.DetailsRefEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ContractError.DetailsRefEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonOpaqueRef.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DetailsRefEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DetailsRefEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DetailsRefEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DetailsRefEntity>();
                }
                finally
                {
