    ...
    public readonly partial struct MethodSessionBmadContextDecisionConsumption
    {
            ...
            : IJsonElement<RecordKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "context_decision_consumption"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly RecordKindEntity ConstJson = ParsedJsonDocument<RecordKindEntity>.StringConstant([.."\"context_decision_consumption\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionBmadContextDecisionConsumption/properties/recordKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodSessionBmadContextDecisionConsumption/properties/recordKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionBmadContextDecisionConsumption/properties/recordKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "context_decision_consumption"u8, "context_decision_consumption", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "context_decision_consumption", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
