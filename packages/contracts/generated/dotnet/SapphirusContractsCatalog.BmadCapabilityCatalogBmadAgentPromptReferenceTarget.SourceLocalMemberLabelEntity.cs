...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalogBmadAgentPromptReferenceTarget
    {
        ...
        public readonly partial struct SourceLocalMemberLabelEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SourceLocalMemberLabelEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SourceLocalMemberLabelEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SourceLocalMemberLabelEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SourceLocalMemberLabelEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SourceLocalMemberLabelEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SourceLocalMemberLabelEntity left, in SourceLocalMemberLabelEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SourceLocalMemberLabelEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SourceLocalMemberLabelEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SourceLocalMemberLabelEntity(JsonElement instance)
            {
                return SourceLocalMemberLabelEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceLocalMemberLabelEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceLocalMemberLabelEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceLocalMemberLabelEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceLocalMemberLabelEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceLocalMemberLabelEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceLocalMemberLabelEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceLocalMemberLabelEntity>(json, options);
            }
            ...
            /// </exception>
            public static SourceLocalMemberLabelEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SourceLocalMemberLabelEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SourceLocalMemberLabelEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SourceLocalMemberLabelEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SourceLocalMemberLabelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SourceLocalMemberLabelEntity IJsonElement<SourceLocalMemberLabelEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SourceLocalMemberLabelEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SourceLocalMemberLabelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SourceLocalMemberLabelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SourceLocalMemberLabelEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SourceLocalMemberLabelEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SourceLocalMemberLabelEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SourceLocalMemberLabelEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SourceLocalMemberLabelEntity>(_idx);
                }
