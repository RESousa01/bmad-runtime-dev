...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct CompletionEvidenceClassEntity
#if NET8_0_OR_GREATER
            : IJsonElement<CompletionEvidenceClassEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CompletionEvidenceClassEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CompletionEvidenceClassEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CompletionEvidenceClassEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CompletionEvidenceClassEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CompletionEvidenceClassEntity left, in CompletionEvidenceClassEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CompletionEvidenceClassEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CompletionEvidenceClassEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CompletionEvidenceClassEntity(JsonElement instance)
            {
                return CompletionEvidenceClassEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceClassEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceClassEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceClassEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceClassEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceClassEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceClassEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceClassEntity>(json, options);
            }
            ...
            /// </exception>
            public static CompletionEvidenceClassEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceClassEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CompletionEvidenceClassEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CompletionEvidenceClassEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CompletionEvidenceClassEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CompletionEvidenceClassEntity IJsonElement<CompletionEvidenceClassEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CompletionEvidenceClassEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CompletionEvidenceClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CompletionEvidenceClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CompletionEvidenceClassEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CompletionEvidenceClassEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CompletionEvidenceClassEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CompletionEvidenceClassEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CompletionEvidenceClassEntity>(_idx);
                }
            ...
            /// <param name="matchAuthoritative">Match 1st item.</param>
            /// <param name="matchUserAsserted">Match 2nd item.</param>
            /// <param name="matchHeuristic">Match 3rd item.</param>
            /// <param name="matchContextual">Match 4th item.</param>
            /// <param name="matchUnknown">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAuthoritative,
                Func<TContext, TResult> matchUserAsserted,
                Func<TContext, TResult> matchHeuristic,
                Func<TContext, TResult> matchContextual,
...
#endif
            {
                ...
                {
                    return matchAuthoritative(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUserAsserted(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchHeuristic(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchContextual(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchAuthoritative,
                Func<TResult> matchUserAsserted,
                Func<TResult> matchHeuristic,
                Func<TResult> matchContextual,
                Func<TResult> matchUnknown,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchAuthoritative();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUserAsserted();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchHeuristic();
                }
