    ...
    public readonly partial struct DesktopEntitlementLease
    {
            ...
            : IJsonElement<MinimumClientVersionEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DesktopEntitlementLease/properties/minimumClientVersion"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/DesktopEntitlementLease/properties/minimumClientVersion";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DesktopEntitlementLease/properties/minimumClientVersion"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[0-9A-Za-z.+-]+$", "pattern"u8, ref context);
                    }
                }
...
#else
                private static Regex CreatePattern() => new("^[0-9A-Za-z.+-]+$", RegexOptions.Compiled);
#endif
