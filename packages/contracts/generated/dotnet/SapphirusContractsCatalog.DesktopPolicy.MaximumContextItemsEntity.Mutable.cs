    ...
    public readonly partial struct DesktopPolicy
    {
        ...
        public readonly partial struct MaximumContextItemsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumContextItemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumContextItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumContextItemsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumContextItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumContextItemsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumContextItemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumContextItemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumContextItemsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumContextItemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaximumContextItemsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumContextItemsEntity>();
                }
                finally
                {
