            ...
            public readonly partial struct FindingsEntity
            {
                ...
                public readonly partial struct ProposedSmallestEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ProposedSmallestEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ProposedSmallestEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ProposedSmallestEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ProposedSmallestEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProposedSmallestEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProposedSmallestEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ProposedSmallestEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ProposedSmallestEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ProposedSmallestEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ProposedSmallestEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ProposedSmallestEntity>();
                        }
                        finally
                        {
