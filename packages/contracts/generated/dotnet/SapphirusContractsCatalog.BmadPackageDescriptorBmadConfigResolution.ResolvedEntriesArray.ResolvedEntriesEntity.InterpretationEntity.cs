    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigResolution
    {
        ...
        public readonly partial struct ResolvedEntriesArray
        {
            ...
            public readonly partial struct ResolvedEntriesEntity
            {
                ...
                public readonly partial struct InterpretationEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<InterpretationEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="InterpretationEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal InterpretationEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static InterpretationEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(InterpretationEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in InterpretationEntity left, in InterpretationEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in InterpretationEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(InterpretationEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator InterpretationEntity(JsonElement instance)
                    {
                        return InterpretationEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InterpretationEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InterpretationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InterpretationEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InterpretationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InterpretationEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static InterpretationEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<InterpretationEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static InterpretationEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<InterpretationEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out InterpretationEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<InterpretationEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new InterpretationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static InterpretationEntity IJsonElement<InterpretationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"InterpretationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="InterpretationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="InterpretationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public InterpretationEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<InterpretationEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="InterpretationEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public InterpretationEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<InterpretationEntity>(_idx);
                        }
                    ...
                    /// <param name="matchKnownUntrusted">Match 1st item.</param>
                    /// <param name="matchUnknownUntrusted">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchKnownUntrusted,
                        Func<TContext, TResult> matchUnknownUntrusted,
...
#endif
                    {
                        ...
                        {
                            return matchKnownUntrusted(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchUnknownUntrusted(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchKnownUntrusted,
                        Func<TResult> matchUnknownUntrusted,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchKnownUntrusted();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchUnknownUntrusted();
                        }
