...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityRunBmadClosureCapabilityId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadCapabilityRunBmadClosureCapabilityId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadCapabilityRunBmadClosureCapabilityId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadCapabilityRunBmadClosureCapabilityId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadCapabilityRunBmadClosureCapabilityId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityRunBmadClosureCapabilityId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityRunBmadClosureCapabilityId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadCapabilityRunBmadClosureCapabilityId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadCapabilityRunBmadClosureCapabilityId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadCapabilityRunBmadClosureCapabilityId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadCapabilityRunBmadClosureCapabilityId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadCapabilityRunBmadClosureCapabilityId>();
            }
            finally
            {
