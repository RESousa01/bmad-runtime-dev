    ...
    public readonly partial struct RemoteJobHandoffUploadPreviewedHandoff
    {
            ...
            : IJsonElement<StateEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "upload_previewed"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly StateEntity ConstJson = ParsedJsonDocument<StateEntity>.StringConstant([.."\"upload_previewed\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffUploadPreviewedHandoff/properties/state"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/RemoteJobHandoffUploadPreviewedHandoff/properties/state";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffUploadPreviewedHandoff/properties/state"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "upload_previewed"u8, "upload_previewed", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "upload_previewed", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
