    ...
    public readonly partial struct RemoteJobHandoffCloudWorkHandoff
    {
            ...
            : IJsonElement<StateEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "cloud_accepted"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson1 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"cloud_accepted\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "remote_running"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson2 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"remote_running\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "cloud_accepted"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity CloudAccepted { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "cloud_accepted"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> CloudAcceptedUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "remote_running"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity RemoteRunning { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "remote_running"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> RemoteRunningUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffCloudWorkHandoff/properties/state"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/RemoteJobHandoffCloudWorkHandoff/properties/state";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffCloudWorkHandoff/properties/state"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("cloud_accepted"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("remote_running"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
