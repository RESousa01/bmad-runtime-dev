        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<LayerKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "packaged_default"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly LayerKindEntity EnumJson1 = ParsedJsonDocument<LayerKindEntity>.StringConstant([.."\"packaged_default\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "team_override"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly LayerKindEntity EnumJson2 = ParsedJsonDocument<LayerKindEntity>.StringConstant([.."\"team_override\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "user_override"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly LayerKindEntity EnumJson3 = ParsedJsonDocument<LayerKindEntity>.StringConstant([.."\"user_override\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// </summary>
                    public static LayerKindEntity PackagedDefault { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "packaged_default"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> PackagedDefaultUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "team_override"
                    /// as a <see cref="LayerKindEntity"/>.
                    /// </summary>
                    public static LayerKindEntity TeamOverride { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "team_override"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> TeamOverrideUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "user_override"
                    /// as a <see cref="LayerKindEntity"/>.
                    /// </summary>
                    public static LayerKindEntity UserOverride { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "user_override"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> UserOverrideUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("packaged_default"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("team_override"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("user_override"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
