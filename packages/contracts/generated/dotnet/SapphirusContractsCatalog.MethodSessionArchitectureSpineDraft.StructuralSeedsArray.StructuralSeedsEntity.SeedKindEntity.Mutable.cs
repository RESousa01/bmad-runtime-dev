            ...
            public readonly partial struct StructuralSeedsEntity
            {
                ...
                public readonly partial struct SeedKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(SeedKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SeedKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SeedKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SeedKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SeedKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SeedKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SeedKindEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SeedKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SeedKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<SeedKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<SeedKindEntity>();
                        }
                        finally
                        {
