        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<AgentBindingEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private const uint RequiredBitForBindingKind = 0b00000000000000000000000000000001;

                    private const uint RequiredBitMask0 =
                        RequiredBitForBindingKind;
                    ...
                    private static void MatchBindingKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf0Entity.AgentBindingEntity.BindingKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.BindingKindUtf8))
                        {
                            matcher = MatchBindingKind;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodSessionPayload/oneOf/0/properties/agentBinding"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionMethodSessionPayload/oneOf/0/properties/agentBinding";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodSessionPayload/oneOf/0/properties/agentBinding"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBindingKindPresent, "bindingKind"u8, "required"u8);
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBindingKindNotPresent, "bindingKind"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBindingKindPresent, "bindingKind"u8, "required"u8);
