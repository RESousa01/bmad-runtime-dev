            ...
            public readonly partial struct RuntimeCompatibilityEntity
            {
                ...
                public readonly partial struct VersionRangeEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(VersionRangeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="VersionRangeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator VersionRangeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"VersionRangeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly VersionRangeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly VersionRangeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<VersionRangeEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(VersionRangeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<VersionRangeEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<VersionRangeEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<VersionRangeEntity>();
                        }
                        finally
                        {
