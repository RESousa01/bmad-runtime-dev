    ...
    public readonly partial struct CommonNativePatchEngineAudience
    {
            ...
            : IJsonElement<AudienceKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Const = "native_patch_engine"u8.ToArray();
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly AudienceKindEntity ConstJson = ParsedJsonDocument<AudienceKindEntity>.StringConstant([.."\"native_patch_engine\""u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonNativePatchEngineAudience/properties/audienceKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonNativePatchEngineAudience/properties/audienceKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonNativePatchEngineAudience/properties/audienceKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "native_patch_engine"u8, "native_patch_engine", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "native_patch_engine", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                    }
                }
