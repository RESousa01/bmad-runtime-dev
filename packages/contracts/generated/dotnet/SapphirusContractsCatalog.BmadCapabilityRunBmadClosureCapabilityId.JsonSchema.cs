...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadCapabilityRunBmadClosureCapabilityId>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityRunBmadClosureCapabilityId"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadCapabilityRunBmadClosureCapabilityId";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityRunBmadClosureCapabilityId"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    JsonSchemaEvaluation.MatchLengthLessThanOrEquals(96,stringLength, "maxLength"u8, ref context);
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^(bmm|builder):[a-z][a-z0-9._-]{2,80}$", "pattern"u8, ref context);
                }
            }
            ...
            [GeneratedRegex("^(bmm|builder):[a-z][a-z0-9._-]{2,80}$")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("^(bmm|builder):[a-z][a-z0-9._-]{2,80}$", RegexOptions.Compiled);
#endif
