    ...
    public readonly partial struct MethodSessionMethodCheckpoint
    {
        ...
        public readonly partial struct TurnOrdinalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TurnOrdinalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TurnOrdinalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TurnOrdinalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TurnOrdinalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TurnOrdinalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TurnOrdinalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TurnOrdinalEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TurnOrdinalEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TurnOrdinalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TurnOrdinalEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TurnOrdinalEntity>();
                }
                finally
                {
