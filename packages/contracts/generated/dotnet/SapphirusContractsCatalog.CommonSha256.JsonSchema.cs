...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<CommonSha256>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonSha256"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/CommonSha256";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonSha256"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^sha256:[0-9a-f]{64}$", "pattern"u8, ref context);
                }
            }
...
#else
            private static Regex CreatePattern() => new("^sha256:[0-9a-f]{64}$", RegexOptions.Compiled);
#endif
