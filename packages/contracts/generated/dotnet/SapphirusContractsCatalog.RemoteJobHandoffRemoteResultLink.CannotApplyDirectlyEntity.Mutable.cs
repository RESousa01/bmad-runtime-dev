    ...
    public readonly partial struct RemoteJobHandoffRemoteResultLink
    {
        ...
        public readonly partial struct CannotApplyDirectlyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CannotApplyDirectlyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CannotApplyDirectlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CannotApplyDirectlyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CannotApplyDirectlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CannotApplyDirectlyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CannotApplyDirectlyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CannotApplyDirectlyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CannotApplyDirectlyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CannotApplyDirectlyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CannotApplyDirectlyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CannotApplyDirectlyEntity>();
                }
                finally
                {
