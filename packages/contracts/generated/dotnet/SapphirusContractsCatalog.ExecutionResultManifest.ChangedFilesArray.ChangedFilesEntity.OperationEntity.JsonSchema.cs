            ...
            public readonly partial struct ChangedFilesEntity
            {
                    ...
                    : IJsonElement<OperationEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly OperationEntity EnumJson1 = ParsedJsonDocument<OperationEntity>.StringConstant([.."\"created\""u8]);
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly byte[] Enum2 = "modified"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly OperationEntity EnumJson2 = ParsedJsonDocument<OperationEntity>.StringConstant([.."\"modified\""u8]);
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly byte[] Enum3 = "deleted"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly OperationEntity EnumJson3 = ParsedJsonDocument<OperationEntity>.StringConstant([.."\"deleted\""u8]);
                    }
                    ...
                    public static class EnumValues
                    {
                        ...
                        /// </summary>
                        public static OperationEntity Created { get; } = Constants.EnumJson1;
                        /// <summary>
                        /// Gets the string "created"
                        ...
                        /// <summary>
                        /// Gets the string "modified"
                        /// as a <see cref="OperationEntity"/>.
                        /// </summary>
                        public static OperationEntity Modified { get; } = Constants.EnumJson2;
                        /// <summary>
                        /// Gets the string "modified"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> ModifiedUtf8 => Constants.Enum2;

                        /// <summary>
                        /// Gets the string "deleted"
                        /// as a <see cref="OperationEntity"/>.
                        /// </summary>
                        public static OperationEntity Deleted { get; } = Constants.EnumJson3;
                        /// <summary>
                        /// Gets the string "deleted"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> DeletedUtf8 => Constants.Enum3;
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ExecutionResultManifest/properties/changedFiles/items/properties/operation"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/ExecutionResultManifest/properties/changedFiles/items/properties/operation";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ExecutionResultManifest/properties/changedFiles/items/properties/operation"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                if (unescapedUtf8JsonString.Span.SequenceEqual("modified"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }

                                if (unescapedUtf8JsonString.Span.SequenceEqual("deleted"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }
                            }
