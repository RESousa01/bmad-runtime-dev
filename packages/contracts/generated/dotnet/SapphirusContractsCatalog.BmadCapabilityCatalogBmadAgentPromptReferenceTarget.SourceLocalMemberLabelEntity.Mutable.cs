    ...
    public readonly partial struct BmadCapabilityCatalogBmadAgentPromptReferenceTarget
    {
        ...
        public readonly partial struct SourceLocalMemberLabelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SourceLocalMemberLabelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SourceLocalMemberLabelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SourceLocalMemberLabelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SourceLocalMemberLabelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SourceLocalMemberLabelEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SourceLocalMemberLabelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SourceLocalMemberLabelEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SourceLocalMemberLabelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SourceLocalMemberLabelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SourceLocalMemberLabelEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SourceLocalMemberLabelEntity>();
                }
                finally
                {
