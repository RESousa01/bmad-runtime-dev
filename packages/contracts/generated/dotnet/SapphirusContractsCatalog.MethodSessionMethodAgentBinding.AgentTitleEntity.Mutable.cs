    ...
    public readonly partial struct MethodSessionMethodAgentBinding
    {
        ...
        public readonly partial struct AgentTitleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AgentTitleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AgentTitleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AgentTitleEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AgentTitleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AgentTitleEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AgentTitleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AgentTitleEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AgentTitleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AgentTitleEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AgentTitleEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AgentTitleEntity>();
                }
                finally
                {
