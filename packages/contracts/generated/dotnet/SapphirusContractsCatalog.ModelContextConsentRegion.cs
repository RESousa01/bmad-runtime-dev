...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelContextConsentRegion
#if NET8_0_OR_GREATER
        : IJsonElement<ModelContextConsentRegion>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelContextConsentRegion"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModelContextConsentRegion(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModelContextConsentRegion DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ModelContextConsentRegion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ModelContextConsentRegion left, in ModelContextConsentRegion right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModelContextConsentRegion left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ModelContextConsentRegion instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModelContextConsentRegion(JsonElement instance)
        {
            return ModelContextConsentRegion.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentRegion From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentRegion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentRegion>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentRegion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentRegion>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentRegion ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentRegion>(json, options);
        }
        ...
        /// </exception>
        public static ModelContextConsentRegion ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentRegion>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModelContextConsentRegion? result)
        {
            return JsonElementHelpers.TryParseValue<ModelContextConsentRegion>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ModelContextConsentRegion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ModelContextConsentRegion IJsonElement<ModelContextConsentRegion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModelContextConsentRegion: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ModelContextConsentRegion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ModelContextConsentRegion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ModelContextConsentRegion Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ModelContextConsentRegion>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ModelContextConsentRegion"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ModelContextConsentRegion Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModelContextConsentRegion>(_idx);
            }
