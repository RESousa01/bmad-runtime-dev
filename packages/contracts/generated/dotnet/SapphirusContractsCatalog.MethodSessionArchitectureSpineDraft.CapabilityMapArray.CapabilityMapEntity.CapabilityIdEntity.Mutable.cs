            ...
            public readonly partial struct CapabilityMapEntity
            {
                ...
                public readonly partial struct CapabilityIdEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(CapabilityIdEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="CapabilityIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator CapabilityIdEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"CapabilityIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CapabilityIdEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CapabilityIdEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<CapabilityIdEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(CapabilityIdEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<CapabilityIdEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<CapabilityIdEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<CapabilityIdEntity>();
                        }
                        finally
                        {
