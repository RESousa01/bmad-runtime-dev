        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<EntriesArray>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/entries"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/entries";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigLayer/oneOf/0/properties/entries"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            while (arrayValidation_enumerator.MoveNext())
                            {
                                ...
                                JsonSchemaContext childContext = Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.EntriesArray.EntriesEntity.JsonSchema.PushChildContext(
                                    parentDocument,
                                    arrayValidation_currentIndex,
                                    ref context,
                                    itemIndex: arrayValidation_itemCount,
                                    evaluationPath: ItemsSchemaEvaluationPath);
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigLayer.OneOf0Entity.EntriesArray.EntriesEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
