...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibilityVersionRange
#if NET8_0_OR_GREATER
        : IJsonElement<PackageCompatibilityVersionRange>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCompatibilityVersionRange"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PackageCompatibilityVersionRange(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PackageCompatibilityVersionRange DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(PackageCompatibilityVersionRange value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PackageCompatibilityVersionRange left, in PackageCompatibilityVersionRange right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PackageCompatibilityVersionRange left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PackageCompatibilityVersionRange instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PackageCompatibilityVersionRange(JsonElement instance)
        {
            return PackageCompatibilityVersionRange.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityVersionRange From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityVersionRange ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityVersionRange>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityVersionRange ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityVersionRange>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackageCompatibilityVersionRange ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityVersionRange>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static PackageCompatibilityVersionRange ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<PackageCompatibilityVersionRange>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PackageCompatibilityVersionRange? result)
        {
            return JsonElementHelpers.TryParseValue<PackageCompatibilityVersionRange>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PackageCompatibilityVersionRange(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PackageCompatibilityVersionRange IJsonElement<PackageCompatibilityVersionRange>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PackageCompatibilityVersionRange: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PackageCompatibilityVersionRange"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PackageCompatibilityVersionRange"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PackageCompatibilityVersionRange Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PackageCompatibilityVersionRange>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PackageCompatibilityVersionRange"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PackageCompatibilityVersionRange Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PackageCompatibilityVersionRange>(_idx);
            }
