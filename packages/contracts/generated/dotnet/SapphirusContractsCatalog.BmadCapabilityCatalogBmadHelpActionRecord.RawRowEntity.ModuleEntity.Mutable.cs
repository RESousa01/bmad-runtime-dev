        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct ModuleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ModuleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ModuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ModuleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ModuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModuleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModuleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ModuleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ModuleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ModuleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ModuleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ModuleEntity>();
                    }
                    finally
                    {
