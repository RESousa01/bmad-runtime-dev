    ...
    public readonly partial struct BmadCapabilityResultBmadInactiveBuilderDraft
    {
        ...
        public readonly partial struct DraftKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DraftKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DraftKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DraftKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DraftKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DraftKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DraftKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DraftKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DraftKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DraftKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DraftKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DraftKindEntity>();
                }
                finally
                {
