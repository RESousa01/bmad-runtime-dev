    ...
    public readonly partial struct BuilderAuthoringObjectBuilderModelLensResult
    {
        ...
        public readonly partial struct VerdictEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VerdictEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VerdictEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VerdictEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VerdictEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VerdictEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VerdictEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VerdictEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VerdictEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VerdictEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VerdictEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VerdictEntity>();
                }
                finally
                {
