...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<MethodSessionMethodHelpRecommendation>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodHelpRecommendation"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/MethodSessionMethodHelpRecommendation";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodHelpRecommendation"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (!context.HasCollector)
                {
                    ...
                    {
                        if (parentDocument.TryGetNamedPropertyValue(parentIndex, "recommendationKind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                        {
                            if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                            {
                                ...
                                if (discriminatorValue.Span.SequenceEqual("recommended_capability"u8))
                                {
                                    oneOfDiscriminatorBranch = 0;
                                }
                                else if (discriminatorValue.Span.SequenceEqual("no_recommendation"u8))
                                {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                ...
                JsonSchemaContext oneOfContext0 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodHelpRecommendation.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
