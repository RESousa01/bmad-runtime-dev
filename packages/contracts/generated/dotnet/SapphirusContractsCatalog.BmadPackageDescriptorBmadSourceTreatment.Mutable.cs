...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceTreatment
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadPackageDescriptorBmadSourceTreatment instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadPackageDescriptorBmadSourceTreatment"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadPackageDescriptorBmadSourceTreatment(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadPackageDescriptorBmadSourceTreatment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadSourceTreatment Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadSourceTreatment Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadPackageDescriptorBmadSourceTreatment>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadPackageDescriptorBmadSourceTreatment instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadPackageDescriptorBmadSourceTreatment, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadPackageDescriptorBmadSourceTreatment> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadPackageDescriptorBmadSourceTreatment>();
            }
            finally
            {
