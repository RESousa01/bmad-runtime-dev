...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DesktopPolicyBase64UrlSignature
#if NET8_0_OR_GREATER
        : IJsonElement<DesktopPolicyBase64UrlSignature>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DesktopPolicyBase64UrlSignature"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DesktopPolicyBase64UrlSignature(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DesktopPolicyBase64UrlSignature DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(DesktopPolicyBase64UrlSignature value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DesktopPolicyBase64UrlSignature left, in DesktopPolicyBase64UrlSignature right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DesktopPolicyBase64UrlSignature left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DesktopPolicyBase64UrlSignature instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DesktopPolicyBase64UrlSignature(JsonElement instance)
        {
            return DesktopPolicyBase64UrlSignature.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyBase64UrlSignature From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyBase64UrlSignature ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DesktopPolicyBase64UrlSignature>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyBase64UrlSignature ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DesktopPolicyBase64UrlSignature>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DesktopPolicyBase64UrlSignature ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DesktopPolicyBase64UrlSignature>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DesktopPolicyBase64UrlSignature ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DesktopPolicyBase64UrlSignature>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DesktopPolicyBase64UrlSignature? result)
        {
            return JsonElementHelpers.TryParseValue<DesktopPolicyBase64UrlSignature>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DesktopPolicyBase64UrlSignature(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DesktopPolicyBase64UrlSignature IJsonElement<DesktopPolicyBase64UrlSignature>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DesktopPolicyBase64UrlSignature: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DesktopPolicyBase64UrlSignature"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DesktopPolicyBase64UrlSignature"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DesktopPolicyBase64UrlSignature Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DesktopPolicyBase64UrlSignature>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DesktopPolicyBase64UrlSignature"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DesktopPolicyBase64UrlSignature Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DesktopPolicyBase64UrlSignature>(_idx);
            }
