    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigGraphDescriptor
    {
            ...
            : IJsonElement<GraphKindEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "method_central_toml"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly GraphKindEntity EnumJson1 = ParsedJsonDocument<GraphKindEntity>.StringConstant([.."\"method_central_toml\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "skill_customization_toml"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly GraphKindEntity EnumJson2 = ParsedJsonDocument<GraphKindEntity>.StringConstant([.."\"skill_customization_toml\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "compatibility_yaml"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly GraphKindEntity EnumJson3 = ParsedJsonDocument<GraphKindEntity>.StringConstant([.."\"compatibility_yaml\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "method_central_toml"
                /// as a <see cref="GraphKindEntity"/>.
                /// </summary>
                public static GraphKindEntity MethodCentralToml { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "method_central_toml"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> MethodCentralTomlUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "skill_customization_toml"
                /// as a <see cref="GraphKindEntity"/>.
                /// </summary>
                public static GraphKindEntity SkillCustomizationToml { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "skill_customization_toml"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SkillCustomizationTomlUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "compatibility_yaml"
                /// as a <see cref="GraphKindEntity"/>.
                /// </summary>
                public static GraphKindEntity CompatibilityYaml { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "compatibility_yaml"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> CompatibilityYamlUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/graphKind"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/graphKind";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/graphKind"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("method_central_toml"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("skill_customization_toml"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("compatibility_yaml"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
