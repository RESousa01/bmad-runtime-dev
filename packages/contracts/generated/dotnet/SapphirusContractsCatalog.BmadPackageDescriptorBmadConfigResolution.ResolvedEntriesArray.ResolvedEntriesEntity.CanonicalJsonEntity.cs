    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigResolution
    {
        ...
        public readonly partial struct ResolvedEntriesArray
        {
            ...
            public readonly partial struct ResolvedEntriesEntity
            {
                ...
                public readonly partial struct CanonicalJsonEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<CanonicalJsonEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="CanonicalJsonEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal CanonicalJsonEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static CanonicalJsonEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(CanonicalJsonEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in CanonicalJsonEntity left, in CanonicalJsonEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in CanonicalJsonEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(CanonicalJsonEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CanonicalJsonEntity(JsonElement instance)
                    {
                        return CanonicalJsonEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static CanonicalJsonEntity From<T>(in T instance)
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out CanonicalJsonEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<CanonicalJsonEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new CanonicalJsonEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static CanonicalJsonEntity IJsonElement<CanonicalJsonEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CanonicalJsonEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="CanonicalJsonEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="CanonicalJsonEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public CanonicalJsonEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<CanonicalJsonEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="CanonicalJsonEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public CanonicalJsonEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<CanonicalJsonEntity>(_idx);
                        }
