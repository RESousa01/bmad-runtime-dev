        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct ResultKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ResultKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ResultKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ResultKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ResultKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResultKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResultKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ResultKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ResultKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ResultKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ResultKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ResultKindEntity>();
                    }
                    finally
                    {
