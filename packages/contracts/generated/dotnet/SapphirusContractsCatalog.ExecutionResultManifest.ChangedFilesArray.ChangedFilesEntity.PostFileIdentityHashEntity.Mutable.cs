            ...
            public readonly partial struct ChangedFilesEntity
            {
                ...
                public readonly partial struct PostFileIdentityHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PostFileIdentityHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PostFileIdentityHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PostFileIdentityHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PostFileIdentityHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PostFileIdentityHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PostFileIdentityHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PostFileIdentityHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostFileIdentityHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostFileIdentityHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PostFileIdentityHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PostFileIdentityHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PostFileIdentityHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PostFileIdentityHashEntity>();
                        }
                        finally
                        {
