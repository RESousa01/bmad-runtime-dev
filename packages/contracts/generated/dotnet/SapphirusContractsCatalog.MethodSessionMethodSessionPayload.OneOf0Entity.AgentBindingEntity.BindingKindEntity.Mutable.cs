            ...
            public readonly partial struct AgentBindingEntity
            {
                ...
                public readonly partial struct BindingKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(BindingKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="BindingKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator BindingKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"BindingKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BindingKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BindingKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<BindingKindEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(BindingKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<BindingKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<BindingKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<BindingKindEntity>();
                        }
                        finally
                        {
