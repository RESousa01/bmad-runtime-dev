    ...
    public readonly partial struct BuilderAuthoringObjectBuilderAnalysisRun
    {
        ...
        public readonly partial struct OneOf0Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OneOf0Entity2"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OneOf0Entity2(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OneOf0Entity2 DefaultInstance { get; }
                ...
                /// </summary>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf0Entity.OneOf0Entity2.BuilderKindEntity BuilderKind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuilderKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf0Entity.OneOf0Entity2.BuilderKindEntity value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf0Entity.OneOf0Entity2.ValidationProfileEntity ValidationProfile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValidationProfileUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf0Entity.OneOf0Entity2.ValidationProfileEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in OneOf0Entity2 left, in OneOf0Entity2 right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OneOf0Entity2 left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(OneOf0Entity2 instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf0Entity2(JsonElement instance)
                {
                    return OneOf0Entity2.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf0Entity2 From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf0Entity2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf0Entity2>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf0Entity2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf0Entity2>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf0Entity2 ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf0Entity2>(json, options);
                }
                ...
                /// </exception>
                public static OneOf0Entity2 ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OneOf0Entity2>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OneOf0Entity2? result)
                {
                    return JsonElementHelpers.TryParseValue<OneOf0Entity2>(ref reader, out result);
                }
...
#if NET
                static OneOf0Entity2 IJsonElement<OneOf0Entity2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf0Entity2: ValueKind = {ValueKind} : \"{ToString()}\"";
