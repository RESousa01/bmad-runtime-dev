    ...
    public readonly partial struct ModelAccessReceiptFallbackEvent
    {
        ...
        public readonly partial struct SequenceEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SequenceEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SequenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SequenceEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SequenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SequenceEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SequenceEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SequenceEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SequenceEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SequenceEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SequenceEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SequenceEntity>();
                }
                finally
                {
