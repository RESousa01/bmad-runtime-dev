        ...
        public readonly partial struct DeclaredToolIntentsArray
        {
            ...
            public readonly partial struct DeclaredToolIntentsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DeclaredToolIntentsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeclaredToolIntentsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeclaredToolIntentsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeclaredToolIntentsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeclaredToolIntentsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeclaredToolIntentsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeclaredToolIntentsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeclaredToolIntentsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DeclaredToolIntentsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeclaredToolIntentsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeclaredToolIntentsEntity>();
                    }
                    finally
                    {
