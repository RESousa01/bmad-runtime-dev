        ...
        public readonly partial struct OpenQuestionsArray
        {
            ...
            public readonly partial struct OpenQuestionsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OpenQuestionsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OpenQuestionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OpenQuestionsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OpenQuestionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenQuestionsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenQuestionsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OpenQuestionsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OpenQuestionsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OpenQuestionsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OpenQuestionsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OpenQuestionsEntity>();
                    }
                    finally
                    {
