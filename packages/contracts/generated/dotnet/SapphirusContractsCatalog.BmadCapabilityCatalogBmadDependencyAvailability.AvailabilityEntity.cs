...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityCatalogBmadDependencyAvailability
    {
        ...
        public readonly partial struct AvailabilityEntity
#if NET8_0_OR_GREATER
            : IJsonElement<AvailabilityEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvailabilityEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvailabilityEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvailabilityEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(AvailabilityEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in AvailabilityEntity left, in AvailabilityEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvailabilityEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AvailabilityEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvailabilityEntity(JsonElement instance)
            {
                return AvailabilityEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvailabilityEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvailabilityEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AvailabilityEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvailabilityEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AvailabilityEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvailabilityEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AvailabilityEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AvailabilityEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AvailabilityEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvailabilityEntity? result)
            {
                return JsonElementHelpers.TryParseValue<AvailabilityEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AvailabilityEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AvailabilityEntity IJsonElement<AvailabilityEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvailabilityEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AvailabilityEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AvailabilityEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AvailabilityEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AvailabilityEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AvailabilityEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AvailabilityEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AvailabilityEntity>(_idx);
                }
            ...
            /// <param name="matchAvailableExternalDependency">Match 1st item.</param>
            /// <param name="matchUnavailableMissingSkill">Match 2nd item.</param>
            /// <param name="matchUnavailableMissingModule">Match 3rd item.</param>
            /// <param name="matchUnavailableProfileMismatch">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAvailableExternalDependency,
                Func<TContext, TResult> matchUnavailableMissingSkill,
                Func<TContext, TResult> matchUnavailableMissingModule,
                Func<TContext, TResult> matchUnavailableProfileMismatch,
...
#endif
            {
                ...
                {
                    return matchAvailableExternalDependency(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUnavailableMissingSkill(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchUnavailableMissingModule(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchUnavailableProfileMismatch(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchAvailableExternalDependency,
                Func<TResult> matchUnavailableMissingSkill,
                Func<TResult> matchUnavailableMissingModule,
                Func<TResult> matchUnavailableProfileMismatch,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchAvailableExternalDependency();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUnavailableMissingSkill();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchUnavailableMissingModule();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchUnavailableProfileMismatch();
                }
