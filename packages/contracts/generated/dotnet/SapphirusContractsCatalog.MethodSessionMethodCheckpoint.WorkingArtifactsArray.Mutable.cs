...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionMethodCheckpoint
    {
        ...
        public readonly partial struct WorkingArtifactsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WorkingArtifactsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WorkingArtifactsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WorkingArtifactsArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WorkingArtifactsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WorkingArtifactsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="WorkingArtifactsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WorkingArtifactsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WorkingArtifactsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WorkingArtifactsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WorkingArtifactsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WorkingArtifactsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WorkingArtifactsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodCheckpoint.WorkingArtifactsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(WorkingArtifactsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodCheckpoint.WorkingArtifactsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<WorkingArtifactsArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WorkingArtifactsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WorkingArtifactsArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WorkingArtifactsArray> Create<TContext>(
