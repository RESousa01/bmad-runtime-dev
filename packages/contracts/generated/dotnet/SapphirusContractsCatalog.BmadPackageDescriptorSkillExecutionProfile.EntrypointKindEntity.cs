...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct EntrypointKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EntrypointKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EntrypointKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EntrypointKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EntrypointKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(EntrypointKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in EntrypointKindEntity left, in EntrypointKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EntrypointKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EntrypointKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EntrypointKindEntity(JsonElement instance)
            {
                return EntrypointKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointKindEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EntrypointKindEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EntrypointKindEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EntrypointKindEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static EntrypointKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EntrypointKindEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EntrypointKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EntrypointKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EntrypointKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EntrypointKindEntity IJsonElement<EntrypointKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EntrypointKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EntrypointKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EntrypointKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EntrypointKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EntrypointKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EntrypointKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EntrypointKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EntrypointKindEntity>(_idx);
                }
            ...
            /// <param name="matchStepJit">Match 3rd item.</param>
            /// <param name="matchScriptRendered">Match 4th item.</param>
            /// <param name="matchCompatibilityShim">Match 5th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchStepJit,
                Func<TContext, TResult> matchScriptRendered,
                Func<TContext, TResult> matchCompatibilityShim,
...
#endif
            {
                ...
                {
                    return matchStepJit(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchScriptRendered(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchCompatibilityShim(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchStepJit,
                Func<TResult> matchScriptRendered,
                Func<TResult> matchCompatibilityShim,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchScriptRendered();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchCompatibilityShim();
                }
