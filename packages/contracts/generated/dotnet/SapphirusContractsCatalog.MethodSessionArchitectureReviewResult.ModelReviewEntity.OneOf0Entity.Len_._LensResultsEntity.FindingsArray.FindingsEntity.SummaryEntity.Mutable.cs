                            ...
                            public readonly partial struct FindingsEntity
                            {
                                ...
                                public readonly partial struct SummaryEntity
                                {
...
#endif
                                    {
                                        ...
                                        public static explicit operator Mutable(SummaryEntity instance)
                                        {
                                        ...
                                        /// <returns>An immutable instance of a <see cref="SummaryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator SummaryEntity(Mutable instance)
                                        {
                                        ...
                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"SummaryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public readonly SummaryEntity Clone()
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public readonly SummaryEntity Freeze()
                                        {
                                            CheckValidInstance();
                                            return _parent.FreezeElement<SummaryEntity>(_idx);
                                        }
                                    }
                                    ...
                                    public ref struct Source
                                    {
                                        ...
                                        public static implicit operator Source(SummaryEntity instance) => new(JsonElement.From(instance));
                                    ...
                                    {
                                        return workspace.CreateBuilder<SummaryEntity, Mutable>(this);
                                    }
                                    ...
                                    public static ParsedJsonDocument<SummaryEntity> Create(
                                        scoped in Source value, int initialCapacity = 1)
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            Debug.Assert(cvb.MemberCount == 1);
                                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                            return documentBuilder.ToParsedJsonDocument<SummaryEntity>();
                                        }
                                        finally
                                        {
