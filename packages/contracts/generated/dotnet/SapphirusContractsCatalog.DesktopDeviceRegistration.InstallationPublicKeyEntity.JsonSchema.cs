    ...
    public readonly partial struct DesktopDeviceRegistration
    {
            ...
            : IJsonElement<InstallationPublicKeyEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DesktopDeviceRegistration/properties/installationPublicKey"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/DesktopDeviceRegistration/properties/installationPublicKey";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DesktopDeviceRegistration/properties/installationPublicKey"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchLengthGreaterThanOrEquals(80,stringLength, "minLength"u8, ref context);
                        if (!context.HasCollector && !context.IsMatch)
                        {
                            return;
                        }
