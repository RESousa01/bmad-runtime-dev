...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct CompletionEvidenceArray
        {
            ...
            public readonly partial struct CompletionEvidenceEntity
#if NET8_0_OR_GREATER
                : IJsonElement<CompletionEvidenceEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CompletionEvidenceEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CompletionEvidenceEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CompletionEvidenceEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(CompletionEvidenceEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in CompletionEvidenceEntity left, in CompletionEvidenceEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CompletionEvidenceEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(CompletionEvidenceEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CompletionEvidenceEntity(JsonElement instance)
                {
                    return CompletionEvidenceEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CompletionEvidenceEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CompletionEvidenceEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CompletionEvidenceEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CompletionEvidenceEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CompletionEvidenceEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CompletionEvidenceEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CompletionEvidenceEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static CompletionEvidenceEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CompletionEvidenceEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CompletionEvidenceEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<CompletionEvidenceEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CompletionEvidenceEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static CompletionEvidenceEntity IJsonElement<CompletionEvidenceEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CompletionEvidenceEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CompletionEvidenceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CompletionEvidenceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public CompletionEvidenceEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CompletionEvidenceEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CompletionEvidenceEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public CompletionEvidenceEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CompletionEvidenceEntity>(_idx);
                    }
                ...
                /// <param name="matchArtifact">Match 1st item.</param>
                /// <param name="matchEvent">Match 2nd item.</param>
                /// <param name="matchStatusEvidence">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchArtifact,
                    Func<TContext, TResult> matchEvent,
                    Func<TContext, TResult> matchStatusEvidence,
...
#endif
                {
                    ...
                    {
                        return matchArtifact(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchEvent(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchStatusEvidence(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchArtifact,
                    Func<TResult> matchEvent,
                    Func<TResult> matchStatusEvidence,
