        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<CapabilityKeyEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchNormalizedAction(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
