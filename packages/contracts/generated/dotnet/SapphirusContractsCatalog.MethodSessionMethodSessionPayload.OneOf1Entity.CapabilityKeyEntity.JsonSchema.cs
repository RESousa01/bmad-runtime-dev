    ...
    public readonly partial struct MethodSessionMethodSessionPayload
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct CapabilityKeyEntity
                : IJsonElement<CapabilityKeyEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private const uint RequiredBitForModuleCode = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNormalizedActionPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("normalizedAction"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNormalizedActionNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("normalizedAction"u8, buffer, out written);

                    private const int RequiredOffsetForNormalizedAction = 0;
                    private const uint RequiredBitForNormalizedAction = 0b00000000000000000000000000000010;
                    ...
                    private const uint RequiredBitForPackageVersionId = 0b00000000000000000000000000000100;
                    ...
                    private const uint RequiredBitForSkillName = 0b00000000000000000000000000001000;

                    private const uint RequiredBitMask0 =
                        RequiredBitForModuleCode | RequiredBitForNormalizedAction | RequiredBitForPackageVersionId | RequiredBitForSkillName;
                    ...
                    private static readonly JsonSchemaPathProvider NormalizedActionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/normalizedAction"u8, buffer, out written);
                    ...
                    private static void MatchModuleCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.ModuleCodeEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.ModuleCodeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchNormalizedAction(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.NormalizedActionEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.NormalizedActionUtf8,
                                evaluationPath: NormalizedActionSchemaEvaluationPath);

                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.NormalizedActionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        requiredBitBuffer[RequiredOffsetForNormalizedAction] |= RequiredBitForNormalizedAction;
                    }
                    ...
                    private static void MatchSkillName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext3 =
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.SkillNameEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodSessionPayload.OneOf1Entity.CapabilityKeyEntity.SkillNameEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                    ...
                    private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                            ...
                            (static () => JsonPropertyNames.NormalizedActionUtf8, MatchNormalizedAction),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/capabilityKey"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/capabilityKey";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/capabilityKey"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                            {
                                if (context.HasCollector)
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyModuleCodePresent, "moduleCode"u8, "required"u8);
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyNormalizedActionPresent, "normalizedAction"u8, "required"u8);
                                    context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPackageVersionIdPresent, "packageVersionId"u8, "required"u8);
                                    context.EvaluatedKeywordForProperty(true, 3, RequiredPropertySkillNamePresent, "skillName"u8, "required"u8);
                                }
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyModuleCodeNotPresent, "moduleCode"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyModuleCodePresent, "moduleCode"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForNormalizedAction] & RequiredBitForNormalizedAction) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyNormalizedActionNotPresent, "normalizedAction"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyNormalizedActionPresent, "normalizedAction"u8, "required"u8);
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyPackageVersionIdNotPresent, "packageVersionId"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPackageVersionIdPresent, "packageVersionId"u8, "required"u8);
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 3, RequiredPropertySkillNameNotPresent, "skillName"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 3, RequiredPropertySkillNamePresent, "skillName"u8, "required"u8);
