    ...
    public readonly partial struct EvidenceEvent
    {
            ...
            : IJsonElement<RedactionLevelEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "summary"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RedactionLevelEntity EnumJson1 = ParsedJsonDocument<RedactionLevelEntity>.StringConstant([.."\"summary\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "redacted"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RedactionLevelEntity EnumJson2 = ParsedJsonDocument<RedactionLevelEntity>.StringConstant([.."\"redacted\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "privileged"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RedactionLevelEntity EnumJson3 = ParsedJsonDocument<RedactionLevelEntity>.StringConstant([.."\"privileged\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// as a <see cref="RedactionLevelEntity"/>.
                /// </summary>
                public static RedactionLevelEntity Summary { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "summary"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SummaryUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "redacted"
                /// as a <see cref="RedactionLevelEntity"/>.
                /// </summary>
                public static RedactionLevelEntity Redacted { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "redacted"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> RedactedUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "privileged"
                /// as a <see cref="RedactionLevelEntity"/>.
                /// </summary>
                public static RedactionLevelEntity Privileged { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "privileged"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> PrivilegedUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/EvidenceEvent/properties/redactionLevel"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/EvidenceEvent/properties/redactionLevel";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/EvidenceEvent/properties/redactionLevel"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("summary"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("redacted"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("privileged"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
