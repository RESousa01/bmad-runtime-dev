...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<CommonContractId>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonContractId"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/CommonContractId";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonContractId"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-z][a-z0-9_]{1,31}_[0-9A-HJKMNP-TV-Z]{16,64}$", "pattern"u8, ref context);
                }
            }
            ...
            [GeneratedRegex("^[a-z][a-z0-9_]{1,31}_[0-9A-HJKMNP-TV-Z]{16,64}$")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("^[a-z][a-z0-9_]{1,31}_[0-9A-HJKMNP-TV-Z]{16,64}$", RegexOptions.Compiled);
#endif
