...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadInstallProfile
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadPackageDescriptorBmadInstallProfile instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadPackageDescriptorBmadInstallProfile"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadPackageDescriptorBmadInstallProfile(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadPackageDescriptorBmadInstallProfile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadInstallProfile Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadPackageDescriptorBmadInstallProfile Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadPackageDescriptorBmadInstallProfile>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadPackageDescriptorBmadInstallProfile instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadPackageDescriptorBmadInstallProfile, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadPackageDescriptorBmadInstallProfile> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadPackageDescriptorBmadInstallProfile>();
            }
            finally
            {
