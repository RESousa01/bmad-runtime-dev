    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct PackageNameEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PackageNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PackageNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PackageNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PackageNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PackageNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PackageNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PackageNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PackageNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PackageNameEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PackageNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PackageNameEntity>();
                }
                finally
                {
