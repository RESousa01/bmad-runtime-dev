                ...
                public readonly partial struct GovernedByArray
                {
                    ...
                    public readonly partial struct GovernedByEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(GovernedByEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="GovernedByEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator GovernedByEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"GovernedByEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly GovernedByEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly GovernedByEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<GovernedByEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(GovernedByEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<GovernedByEntity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<GovernedByEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<GovernedByEntity>();
                            }
                            finally
                            {
