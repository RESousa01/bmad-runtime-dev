...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct CapabilityMapArray
            ...
            : IJsonElement<CapabilityMapArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CapabilityMapArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CapabilityMapArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CapabilityMapArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.CapabilityMapArray.CapabilityMapEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.CapabilityMapArray.CapabilityMapEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.CapabilityMapArray.CapabilityMapEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureSpineDraft.CapabilityMapArray.CapabilityMapEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in CapabilityMapArray left, in CapabilityMapArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CapabilityMapArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CapabilityMapArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CapabilityMapArray(JsonElement instance)
            {
                return CapabilityMapArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityMapArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityMapArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityMapArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityMapArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityMapArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CapabilityMapArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CapabilityMapArray>(json, options);
            }
            ...
            /// </exception>
            public static CapabilityMapArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CapabilityMapArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CapabilityMapArray? result)
            {
                return JsonElementHelpers.TryParseValue<CapabilityMapArray>(ref reader, out result);
            }
...
#if NET
            static CapabilityMapArray IJsonElement<CapabilityMapArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CapabilityMapArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public CapabilityMapArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public CapabilityMapArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CapabilityMapArray>(_idx);
                }
