            ...
            public readonly partial struct ChangedFilesEntity
            {
                ...
                public readonly partial struct PostContentHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PostContentHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PostContentHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PostContentHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PostContentHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PostContentHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PostContentHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PostContentHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostContentHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PostContentHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PostContentHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PostContentHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PostContentHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PostContentHashEntity>();
                        }
                        finally
                        {
