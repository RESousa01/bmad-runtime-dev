...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonDeliveryModel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonDeliveryModel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonDeliveryModel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonDeliveryModel(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonDeliveryModel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonDeliveryModel Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonDeliveryModel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonDeliveryModel>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonDeliveryModel instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonDeliveryModel, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonDeliveryModel> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonDeliveryModel>();
            }
            finally
            {
