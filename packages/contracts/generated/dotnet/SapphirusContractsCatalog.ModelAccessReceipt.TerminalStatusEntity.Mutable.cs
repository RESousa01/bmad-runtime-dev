    ...
    public readonly partial struct ModelAccessReceipt
    {
        ...
        public readonly partial struct TerminalStatusEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TerminalStatusEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TerminalStatusEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TerminalStatusEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TerminalStatusEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TerminalStatusEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TerminalStatusEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TerminalStatusEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TerminalStatusEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TerminalStatusEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TerminalStatusEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TerminalStatusEntity>();
                }
                finally
                {
