...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct PackageManifestSchemaVersionEntity
#if NET8_0_OR_GREATER
            : IJsonElement<PackageManifestSchemaVersionEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PackageManifestSchemaVersionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PackageManifestSchemaVersionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PackageManifestSchemaVersionEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PackageManifestSchemaVersionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PackageManifestSchemaVersionEntity left, in PackageManifestSchemaVersionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PackageManifestSchemaVersionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PackageManifestSchemaVersionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PackageManifestSchemaVersionEntity(JsonElement instance)
            {
                return PackageManifestSchemaVersionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageManifestSchemaVersionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageManifestSchemaVersionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageManifestSchemaVersionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageManifestSchemaVersionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageManifestSchemaVersionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PackageManifestSchemaVersionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PackageManifestSchemaVersionEntity>(json, options);
            }
            ...
            /// </exception>
            public static PackageManifestSchemaVersionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PackageManifestSchemaVersionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PackageManifestSchemaVersionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PackageManifestSchemaVersionEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PackageManifestSchemaVersionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PackageManifestSchemaVersionEntity IJsonElement<PackageManifestSchemaVersionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PackageManifestSchemaVersionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PackageManifestSchemaVersionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PackageManifestSchemaVersionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PackageManifestSchemaVersionEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PackageManifestSchemaVersionEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PackageManifestSchemaVersionEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PackageManifestSchemaVersionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PackageManifestSchemaVersionEntity>(_idx);
                }
