...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadValidationReportBmadValidationDisposition>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadValidationReportBmadValidationDisposition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadValidationReportBmadValidationDisposition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadValidationReportBmadValidationDisposition"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (!context.HasCollector)
                {
                    ...
                    {
                        if (parentDocument.TryGetNamedPropertyValue(parentIndex, "dispositionKind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                        {
                            if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                            {
                                ...
                                if (discriminatorValue.Span.SequenceEqual("conformant"u8))
                                {
                                    oneOfDiscriminatorBranch = 0;
                                }
                                else if (discriminatorValue.Span.SequenceEqual("nonconformant"u8))
                                {
                                    oneOfDiscriminatorBranch = 1;
                                }
                                else if (discriminatorValue.Span.SequenceEqual("incomplete"u8))
                                {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                        ...
                        case 2:
                        {
                            JsonSchemaContext discriminatorContext2 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                ...
                JsonSchemaContext oneOfContext0 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                ...
                JsonSchemaContext oneOfContext2 =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadValidationReportBmadValidationDisposition.OneOf2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
