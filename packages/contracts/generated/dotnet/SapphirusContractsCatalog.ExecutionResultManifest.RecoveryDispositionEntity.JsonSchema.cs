    ...
    public readonly partial struct ExecutionResultManifest
    {
            ...
            : IJsonElement<RecoveryDispositionEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "clean"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RecoveryDispositionEntity EnumJson1 = ParsedJsonDocument<RecoveryDispositionEntity>.StringConstant([.."\"clean\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "recovered"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RecoveryDispositionEntity EnumJson2 = ParsedJsonDocument<RecoveryDispositionEntity>.StringConstant([.."\"recovered\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "manual_review"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RecoveryDispositionEntity EnumJson3 = ParsedJsonDocument<RecoveryDispositionEntity>.StringConstant([.."\"manual_review\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "clean"
                /// as a <see cref="RecoveryDispositionEntity"/>.
                /// </summary>
                public static RecoveryDispositionEntity Clean { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "clean"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> CleanUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "recovered"
                /// as a <see cref="RecoveryDispositionEntity"/>.
                /// </summary>
                public static RecoveryDispositionEntity Recovered { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "recovered"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> RecoveredUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "manual_review"
                /// as a <see cref="RecoveryDispositionEntity"/>.
                /// </summary>
                public static RecoveryDispositionEntity ManualReview { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "manual_review"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ManualReviewUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ExecutionResultManifest/properties/recoveryDisposition"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ExecutionResultManifest/properties/recoveryDisposition";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ExecutionResultManifest/properties/recoveryDisposition"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("clean"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("recovered"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("manual_review"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
