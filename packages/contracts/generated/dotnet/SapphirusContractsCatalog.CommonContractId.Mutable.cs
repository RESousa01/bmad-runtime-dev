...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonContractId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonContractId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonContractId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonContractId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonContractId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonContractId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonContractId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonContractId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonContractId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonContractId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonContractId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonContractId>();
            }
            finally
            {
