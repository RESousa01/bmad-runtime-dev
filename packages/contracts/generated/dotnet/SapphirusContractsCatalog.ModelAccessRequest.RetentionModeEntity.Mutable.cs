    ...
    public readonly partial struct ModelAccessRequest
    {
        ...
        public readonly partial struct RetentionModeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RetentionModeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetentionModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetentionModeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetentionModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionModeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionModeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetentionModeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RetentionModeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RetentionModeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RetentionModeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RetentionModeEntity>();
                }
                finally
                {
