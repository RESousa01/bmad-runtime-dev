        ...
        public readonly partial struct ModelReviewEntity
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="LensResultsArray"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal LensResultsArray(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static LensResultsArray DefaultInstance { get; }
                    ...
                    public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.LensResultsArray.LensResultsEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.LensResultsArray.LensResultsEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.LensResultsArray.LensResultsEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.LensResultsArray.LensResultsEntity>(_parent, _idx);
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in LensResultsArray left, in LensResultsArray right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in LensResultsArray left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(LensResultsArray instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LensResultsArray(JsonElement instance)
                    {
                        return LensResultsArray.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LensResultsArray From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LensResultsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LensResultsArray>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LensResultsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LensResultsArray>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LensResultsArray ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LensResultsArray>(json, options);
                    }
                    ...
                    /// </exception>
                    public static LensResultsArray ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<LensResultsArray>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out LensResultsArray? result)
                    {
                        return JsonElementHelpers.TryParseValue<LensResultsArray>(ref reader, out result);
                    }
...
#if NET
                    static LensResultsArray IJsonElement<LensResultsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LensResultsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public LensResultsArray Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<LensResultsArray>(_idx);
                        }
