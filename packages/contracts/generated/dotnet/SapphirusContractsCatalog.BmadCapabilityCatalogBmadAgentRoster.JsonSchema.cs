...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<BmadCapabilityCatalogBmadAgentRoster>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAgentsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("agents"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAgentsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("agents"u8, buffer, out written);

            private const int RequiredOffsetForAgents = 0;
            private const uint RequiredBitForAgents = 0b00000000000000000000000000000001;
            ...
            private const uint RequiredBitForRosterHash = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForAgents | RequiredBitForPackageVersionId | RequiredBitForRosterHash;
            private static readonly JsonSchemaPathProvider AgentsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/agents"u8, buffer, out written);
            ...
            private static void MatchAgents(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadAgentRoster.AgentsArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AgentsUtf8,
                        evaluationPath: AgentsSchemaEvaluationPath);

                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityCatalogBmadAgentRoster.AgentsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForAgents] |= RequiredBitForAgents;
            }
            ...
            private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.AgentsUtf8, MatchAgents),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityCatalogBmadAgentRoster"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/BmadCapabilityCatalogBmadAgentRoster";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityCatalogBmadAgentRoster"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAgentsPresent, "agents"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPackageVersionIdPresent, "packageVersionId"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRosterHashPresent, "rosterHash"u8, "required"u8);
                        }
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAgents] & RequiredBitForAgents) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAgentsNotPresent, "agents"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAgentsPresent, "agents"u8, "required"u8);
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyRosterHashNotPresent, "rosterHash"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRosterHashPresent, "rosterHash"u8, "required"u8);
