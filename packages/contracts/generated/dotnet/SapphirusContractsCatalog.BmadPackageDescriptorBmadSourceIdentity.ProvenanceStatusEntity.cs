...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct ProvenanceStatusEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ProvenanceStatusEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ProvenanceStatusEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ProvenanceStatusEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ProvenanceStatusEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ProvenanceStatusEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ProvenanceStatusEntity left, in ProvenanceStatusEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ProvenanceStatusEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ProvenanceStatusEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProvenanceStatusEntity(JsonElement instance)
            {
                return ProvenanceStatusEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProvenanceStatusEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProvenanceStatusEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ProvenanceStatusEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProvenanceStatusEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ProvenanceStatusEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProvenanceStatusEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ProvenanceStatusEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ProvenanceStatusEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ProvenanceStatusEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ProvenanceStatusEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ProvenanceStatusEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ProvenanceStatusEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ProvenanceStatusEntity IJsonElement<ProvenanceStatusEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProvenanceStatusEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ProvenanceStatusEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ProvenanceStatusEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ProvenanceStatusEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ProvenanceStatusEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ProvenanceStatusEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ProvenanceStatusEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ProvenanceStatusEntity>(_idx);
                }
            ...
            /// <param name="matchImmutableIdentityVerified">Match 1st item.</param>
            /// <param name="matchReviewedSnapshotOnly">Match 2nd item.</param>
            /// <param name="matchBlockedProvenance">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchImmutableIdentityVerified,
                Func<TContext, TResult> matchReviewedSnapshotOnly,
                Func<TContext, TResult> matchBlockedProvenance,
...
#endif
            {
                ...
                {
                    return matchImmutableIdentityVerified(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReviewedSnapshotOnly(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBlockedProvenance(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchImmutableIdentityVerified,
                Func<TResult> matchReviewedSnapshotOnly,
                Func<TResult> matchBlockedProvenance,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchImmutableIdentityVerified();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReviewedSnapshotOnly();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBlockedProvenance();
                }
