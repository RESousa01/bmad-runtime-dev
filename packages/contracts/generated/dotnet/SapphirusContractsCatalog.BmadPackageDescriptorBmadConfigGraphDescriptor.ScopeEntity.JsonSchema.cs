    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigGraphDescriptor
    {
            ...
            : IJsonElement<ScopeEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForPackageVersionId = 0b00000000000000000000000000000010;
                ...
                private const uint RequiredBitForSkillName = 0b00000000000000000000000000000100;

                private const uint RequiredBitMask0 =
                    RequiredBitForModuleCode | RequiredBitForPackageVersionId | RequiredBitForSkillName;
                ...
                private static void MatchModuleCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigGraphDescriptor.ScopeEntity.ModuleCodeEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigGraphDescriptor.ScopeEntity.ModuleCodeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchSkillName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigGraphDescriptor.ScopeEntity.SkillNameEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigGraphDescriptor.ScopeEntity.SkillNameEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/scope"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/scope";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/scope"u8;
                    ...
                    else
                    {
                        ...
                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                        {
                            if (context.HasCollector)
                            {
                                ...
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPackageVersionIdPresent, "packageVersionId"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySkillNamePresent, "skillName"u8, "required"u8);
                            }
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPackageVersionIdNotPresent, "packageVersionId"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPackageVersionIdPresent, "packageVersionId"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySkillNameNotPresent, "skillName"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySkillNamePresent, "skillName"u8, "required"u8);
