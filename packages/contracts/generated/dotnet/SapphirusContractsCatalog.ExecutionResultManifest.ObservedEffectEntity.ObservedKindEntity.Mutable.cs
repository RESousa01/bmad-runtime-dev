        ...
        public readonly partial struct ObservedEffectEntity
        {
            ...
            public readonly partial struct ObservedKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ObservedKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ObservedKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ObservedKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ObservedKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObservedKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObservedKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ObservedKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ObservedKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ObservedKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ObservedKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ObservedKindEntity>();
                    }
                    finally
                    {
