        ...
        public readonly partial struct MergeSemanticsEntity
        {
                ...
                : IJsonElement<KeyedTableArrayRuleEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "merge_by_code_or_id_when_all_items_keyed"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly KeyedTableArrayRuleEntity ConstJson = ParsedJsonDocument<KeyedTableArrayRuleEntity>.StringConstant([.."\"merge_by_code_or_id_when_all_items_keyed\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/keyedTableArrayRule"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/keyedTableArrayRule";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/keyedTableArrayRule"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "merge_by_code_or_id_when_all_items_keyed"u8, "merge_by_code_or_id_when_all_items_keyed", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "merge_by_code_or_id_when_all_items_keyed", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
