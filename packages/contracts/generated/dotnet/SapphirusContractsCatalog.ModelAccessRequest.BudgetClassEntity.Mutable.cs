    ...
    public readonly partial struct ModelAccessRequest
    {
        ...
        public readonly partial struct BudgetClassEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BudgetClassEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BudgetClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BudgetClassEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BudgetClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BudgetClassEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BudgetClassEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BudgetClassEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BudgetClassEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BudgetClassEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BudgetClassEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BudgetClassEntity>();
                }
                finally
                {
