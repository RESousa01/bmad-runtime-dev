...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonSha256
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommonSha256 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommonSha256"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommonSha256(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommonSha256.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CommonSha256 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CommonSha256 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommonSha256>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommonSha256 instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommonSha256, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CommonSha256> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CommonSha256>();
            }
            finally
            {
