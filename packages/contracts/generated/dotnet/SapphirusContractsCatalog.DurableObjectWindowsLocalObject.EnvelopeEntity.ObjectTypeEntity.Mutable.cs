        ...
        public readonly partial struct EnvelopeEntity
        {
            ...
            public readonly partial struct ObjectTypeEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ObjectTypeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ObjectTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ObjectTypeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ObjectTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectTypeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectTypeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ObjectTypeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ObjectTypeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ObjectTypeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ObjectTypeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ObjectTypeEntity>();
                    }
                    finally
                    {
