    ...
    public readonly partial struct ModelAccessResult
    {
            ...
            : IJsonElement<OutputSchemaIdEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/ModelAccessResult/properties/outputSchemaId"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/ModelAccessResult/properties/outputSchemaId";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/ModelAccessResult/properties/outputSchemaId"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchLengthLessThanOrEquals(128,stringLength, "maxLength"u8, ref context);
                        if (!context.HasCollector && !context.IsMatch)
                        {
                            return;
                        }

                        JsonSchemaEvaluation.MatchLengthGreaterThanOrEquals(5,stringLength, "minLength"u8, ref context);
                        if (!context.HasCollector && !context.IsMatch)
                        {
                            return;
                        }

                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-z][a-z0-9.-]*\\.v[1-9][0-9]*$", "pattern"u8, ref context);
                    }
                }
                ...
                [GeneratedRegex("^[a-z][a-z0-9.-]*\\.v[1-9][0-9]*$")]
                private static partial Regex CreatePattern();
#else
                private static Regex CreatePattern() => new("^[a-z][a-z0-9.-]*\\.v[1-9][0-9]*$", RegexOptions.Compiled);
#endif
