            ...
            public readonly partial struct SourceSectionsEntity
            {
                ...
                public readonly partial struct LabelEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Gets a <see cref="LabelEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="LabelEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly LabelEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<LabelEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="LabelEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly LabelEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<LabelEntity>(_idx);
                        }
                    }
                    ...
                    public static ParsedJsonDocument<LabelEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<LabelEntity>();
                        }
                        finally
                        {
