    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct AltitudeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AltitudeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AltitudeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AltitudeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AltitudeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AltitudeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AltitudeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AltitudeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AltitudeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AltitudeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AltitudeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AltitudeEntity>();
                }
                finally
                {
