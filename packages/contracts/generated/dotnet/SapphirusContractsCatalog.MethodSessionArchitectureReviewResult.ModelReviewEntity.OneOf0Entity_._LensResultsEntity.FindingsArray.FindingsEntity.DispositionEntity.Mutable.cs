                            ...
                            public readonly partial struct FindingsEntity
                            {
                                ...
                                public readonly partial struct DispositionEntity
                                {
...
#endif
                                    {
                                        ...
                                        public static explicit operator Mutable(DispositionEntity instance)
                                        {
                                        ...
                                        /// <returns>An immutable instance of a <see cref="DispositionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator DispositionEntity(Mutable instance)
                                        {
                                        ...
                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"DispositionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public readonly DispositionEntity Clone()
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public readonly DispositionEntity Freeze()
                                        {
                                            CheckValidInstance();
                                            return _parent.FreezeElement<DispositionEntity>(_idx);
                                        }
                                    ...
                                    public ref struct Source
                                    {
                                        ...
                                        public static implicit operator Source(DispositionEntity instance) => new(JsonElement.From(instance));
                                    ...
                                    {
                                        return workspace.CreateBuilder<DispositionEntity, Mutable>(this);
                                    }
                                    ...
                                    public static ParsedJsonDocument<DispositionEntity> Create(
                                        scoped in Source value, int initialCapacity = 1)
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            Debug.Assert(cvb.MemberCount == 1);
                                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                            return documentBuilder.ToParsedJsonDocument<DispositionEntity>();
                                        }
                                        finally
                                        {
