        ...
        public readonly partial struct SignatureEntity
        {
            ...
            public readonly partial struct AlgorithmEntity
            {
...
#endif
                {
                    ...
                    /// <param name="matchEd25519">Match 1st item.</param>
                    /// <param name="matchEcdsaP256Sha256">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchEd25519,
                        Func<TContext, TResult> matchEcdsaP256Sha256,
...
#endif
                    {
                        ...
                        {
                            return matchEd25519(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchEcdsaP256Sha256(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchEd25519,
                        Func<TResult> matchEcdsaP256Sha256,
