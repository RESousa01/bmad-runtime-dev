    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct ValidationProfileEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ValidationProfileEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ValidationProfileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ValidationProfileEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ValidationProfileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationProfileEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ValidationProfileEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ValidationProfileEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ValidationProfileEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ValidationProfileEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ValidationProfileEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ValidationProfileEntity>();
                }
                finally
                {
