            ...
            public readonly partial struct InheritedInvariantsEntity
            {
                ...
                public readonly partial struct BindsHereEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(BindsHereEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="BindsHereEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator BindsHereEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"BindsHereEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BindsHereEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BindsHereEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<BindsHereEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(BindsHereEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<BindsHereEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<BindsHereEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<BindsHereEntity>();
                        }
                        finally
                        {
