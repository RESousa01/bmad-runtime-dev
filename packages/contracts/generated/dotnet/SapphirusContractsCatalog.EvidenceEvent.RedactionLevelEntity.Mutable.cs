    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct RedactionLevelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RedactionLevelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RedactionLevelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RedactionLevelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RedactionLevelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RedactionLevelEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RedactionLevelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RedactionLevelEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RedactionLevelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RedactionLevelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RedactionLevelEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RedactionLevelEntity>();
                }
                finally
                {
