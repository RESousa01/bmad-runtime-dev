...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct CloudPlaceholderStateEntity
#if NET8_0_OR_GREATER
            : IJsonElement<CloudPlaceholderStateEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CloudPlaceholderStateEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CloudPlaceholderStateEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CloudPlaceholderStateEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CloudPlaceholderStateEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CloudPlaceholderStateEntity left, in CloudPlaceholderStateEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CloudPlaceholderStateEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CloudPlaceholderStateEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CloudPlaceholderStateEntity(JsonElement instance)
            {
                return CloudPlaceholderStateEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudPlaceholderStateEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudPlaceholderStateEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudPlaceholderStateEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudPlaceholderStateEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudPlaceholderStateEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudPlaceholderStateEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudPlaceholderStateEntity>(json, options);
            }
            ...
            /// </exception>
            public static CloudPlaceholderStateEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CloudPlaceholderStateEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CloudPlaceholderStateEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CloudPlaceholderStateEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CloudPlaceholderStateEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CloudPlaceholderStateEntity IJsonElement<CloudPlaceholderStateEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CloudPlaceholderStateEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CloudPlaceholderStateEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CloudPlaceholderStateEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CloudPlaceholderStateEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CloudPlaceholderStateEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CloudPlaceholderStateEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CloudPlaceholderStateEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CloudPlaceholderStateEntity>(_idx);
                }
            ...
            /// <param name="matchFullyHydrated">Match 2nd item.</param>
            /// <param name="matchContainsPlaceholders">Match 3rd item.</param>
            /// <param name="matchUnknown">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNone,
                Func<TContext, TResult> matchFullyHydrated,
                Func<TContext, TResult> matchContainsPlaceholders,
...
#endif
            {
                ...
                {
                    return matchFullyHydrated(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchContainsPlaceholders(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchFullyHydrated,
                Func<TResult> matchContainsPlaceholders,
                ...
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFullyHydrated();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchContainsPlaceholders();
                }
