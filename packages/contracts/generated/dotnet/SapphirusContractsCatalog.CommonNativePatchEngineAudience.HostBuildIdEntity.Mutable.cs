    ...
    public readonly partial struct CommonNativePatchEngineAudience
    {
        ...
        public readonly partial struct HostBuildIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HostBuildIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HostBuildIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HostBuildIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HostBuildIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HostBuildIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HostBuildIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HostBuildIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HostBuildIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HostBuildIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HostBuildIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HostBuildIdEntity>();
                }
                finally
                {
