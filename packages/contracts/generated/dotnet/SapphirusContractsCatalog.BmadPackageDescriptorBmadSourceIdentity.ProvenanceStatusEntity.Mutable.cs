    ...
    public readonly partial struct BmadPackageDescriptorBmadSourceIdentity
    {
        ...
        public readonly partial struct ProvenanceStatusEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProvenanceStatusEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProvenanceStatusEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProvenanceStatusEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProvenanceStatusEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProvenanceStatusEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProvenanceStatusEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProvenanceStatusEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProvenanceStatusEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProvenanceStatusEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProvenanceStatusEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProvenanceStatusEntity>();
                }
                finally
                {
