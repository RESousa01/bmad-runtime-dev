    ...
    public readonly partial struct BmadValidationReportBmadValidationDependency
    {
        ...
        public readonly partial struct DependencyKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DependencyKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DependencyKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DependencyKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DependencyKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DependencyKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DependencyKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DependencyKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DependencyKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DependencyKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DependencyKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DependencyKindEntity>();
                }
                finally
                {
