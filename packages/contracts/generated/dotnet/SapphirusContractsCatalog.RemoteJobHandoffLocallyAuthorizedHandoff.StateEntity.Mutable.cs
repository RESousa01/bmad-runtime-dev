    ...
    public readonly partial struct RemoteJobHandoffLocallyAuthorizedHandoff
    {
        ...
        public readonly partial struct StateEntity
        {
...
#endif
            {
                ...
                /// <param name="matchLocallyApproved">Match 1st item.</param>
                /// <param name="matchUploading">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchLocallyApproved,
                    Func<TContext, TResult> matchUploading,
...
#endif
                {
                    ...
                    {
                        return matchLocallyApproved(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchUploading(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchLocallyApproved,
                    Func<TResult> matchUploading,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchLocallyApproved();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchUploading();
                    }
