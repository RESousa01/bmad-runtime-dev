...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct CompletionEvidenceArray
            ...
            : IJsonElement<CompletionEvidenceArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CompletionEvidenceArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CompletionEvidenceArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CompletionEvidenceArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorSkillExecutionProfile.CompletionEvidenceArray.CompletionEvidenceEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorSkillExecutionProfile.CompletionEvidenceArray.CompletionEvidenceEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorSkillExecutionProfile.CompletionEvidenceArray.CompletionEvidenceEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorSkillExecutionProfile.CompletionEvidenceArray.CompletionEvidenceEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in CompletionEvidenceArray left, in CompletionEvidenceArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CompletionEvidenceArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CompletionEvidenceArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CompletionEvidenceArray(JsonElement instance)
            {
                return CompletionEvidenceArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CompletionEvidenceArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceArray>(json, options);
            }
            ...
            /// </exception>
            public static CompletionEvidenceArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CompletionEvidenceArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CompletionEvidenceArray? result)
            {
                return JsonElementHelpers.TryParseValue<CompletionEvidenceArray>(ref reader, out result);
            }
...
#if NET
            static CompletionEvidenceArray IJsonElement<CompletionEvidenceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CompletionEvidenceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public CompletionEvidenceArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public CompletionEvidenceArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CompletionEvidenceArray>(_idx);
                }
