            ...
            public readonly partial struct DecisionsEntity
            {
                ...
                public readonly partial struct DecisionIdEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DecisionIdEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DecisionIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DecisionIdEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DecisionIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DecisionIdEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DecisionIdEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DecisionIdEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DecisionIdEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DecisionIdEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<DecisionIdEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DecisionIdEntity>();
                        }
                        finally
                        {
