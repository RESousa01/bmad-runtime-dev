        ...
        public readonly partial struct LimitsEntity
        {
            ...
            public readonly partial struct TimeoutSecondsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TimeoutSecondsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TimeoutSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TimeoutSecondsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TimeoutSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TimeoutSecondsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TimeoutSecondsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TimeoutSecondsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TimeoutSecondsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TimeoutSecondsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TimeoutSecondsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TimeoutSecondsEntity>();
                    }
                    finally
                    {
