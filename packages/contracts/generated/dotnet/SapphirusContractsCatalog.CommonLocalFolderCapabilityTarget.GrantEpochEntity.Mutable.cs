    ...
    public readonly partial struct CommonLocalFolderCapabilityTarget
    {
        ...
        public readonly partial struct GrantEpochEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(GrantEpochEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GrantEpochEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GrantEpochEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GrantEpochEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GrantEpochEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GrantEpochEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GrantEpochEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GrantEpochEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GrantEpochEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GrantEpochEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GrantEpochEntity>();
                }
                finally
                {
