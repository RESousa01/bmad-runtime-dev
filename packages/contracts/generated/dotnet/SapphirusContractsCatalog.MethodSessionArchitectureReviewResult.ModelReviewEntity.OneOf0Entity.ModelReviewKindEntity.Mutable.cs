            ...
            public readonly partial struct OneOf0Entity
            {
                ...
                public readonly partial struct ModelReviewKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ModelReviewKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ModelReviewKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ModelReviewKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ModelReviewKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ModelReviewKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ModelReviewKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ModelReviewKindEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ModelReviewKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ModelReviewKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ModelReviewKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ModelReviewKindEntity>();
                        }
                        finally
                        {
