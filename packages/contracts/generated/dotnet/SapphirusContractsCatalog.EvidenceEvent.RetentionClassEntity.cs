...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct RetentionClassEntity
#if NET8_0_OR_GREATER
            : IJsonElement<RetentionClassEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RetentionClassEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RetentionClassEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RetentionClassEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RetentionClassEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RetentionClassEntity left, in RetentionClassEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RetentionClassEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RetentionClassEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RetentionClassEntity(JsonElement instance)
            {
                return RetentionClassEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionClassEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionClassEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionClassEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionClassEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionClassEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionClassEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionClassEntity>(json, options);
            }
            ...
            /// </exception>
            public static RetentionClassEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RetentionClassEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RetentionClassEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RetentionClassEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RetentionClassEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RetentionClassEntity IJsonElement<RetentionClassEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RetentionClassEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RetentionClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RetentionClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RetentionClassEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RetentionClassEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RetentionClassEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RetentionClassEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RetentionClassEntity>(_idx);
                }
            ...
            /// <param name="matchOperational">Match 1st item.</param>
            /// <param name="matchEvidence">Match 2nd item.</param>
            /// <param name="matchDebug">Match 3rd item.</param>
            /// <param name="matchPrivileged">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchOperational,
                Func<TContext, TResult> matchEvidence,
                Func<TContext, TResult> matchDebug,
                Func<TContext, TResult> matchPrivileged,
...
#endif
            {
                ...
                {
                    return matchOperational(context);
                }
                ...
                {
                    return matchPrivileged(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchOperational,
                Func<TResult> matchEvidence,
                Func<TResult> matchDebug,
                Func<TResult> matchPrivileged,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchOperational();
                }
