...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelContextConsentCanonicalSchemaId
#if NET8_0_OR_GREATER
        : IJsonElement<ModelContextConsentCanonicalSchemaId>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelContextConsentCanonicalSchemaId"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModelContextConsentCanonicalSchemaId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModelContextConsentCanonicalSchemaId DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ModelContextConsentCanonicalSchemaId value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ModelContextConsentCanonicalSchemaId left, in ModelContextConsentCanonicalSchemaId right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModelContextConsentCanonicalSchemaId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ModelContextConsentCanonicalSchemaId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModelContextConsentCanonicalSchemaId(JsonElement instance)
        {
            return ModelContextConsentCanonicalSchemaId.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentCanonicalSchemaId From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentCanonicalSchemaId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentCanonicalSchemaId>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentCanonicalSchemaId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentCanonicalSchemaId>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelContextConsentCanonicalSchemaId ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentCanonicalSchemaId>(json, options);
        }
        ...
        /// </exception>
        public static ModelContextConsentCanonicalSchemaId ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ModelContextConsentCanonicalSchemaId>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModelContextConsentCanonicalSchemaId? result)
        {
            return JsonElementHelpers.TryParseValue<ModelContextConsentCanonicalSchemaId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ModelContextConsentCanonicalSchemaId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ModelContextConsentCanonicalSchemaId IJsonElement<ModelContextConsentCanonicalSchemaId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModelContextConsentCanonicalSchemaId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ModelContextConsentCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ModelContextConsentCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ModelContextConsentCanonicalSchemaId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ModelContextConsentCanonicalSchemaId>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ModelContextConsentCanonicalSchemaId"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ModelContextConsentCanonicalSchemaId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModelContextConsentCanonicalSchemaId>(_idx);
            }
