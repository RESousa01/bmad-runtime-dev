        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct SkillEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SkillEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SkillEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SkillEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SkillEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SkillEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SkillEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SkillEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SkillEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SkillEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SkillEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SkillEntity>();
                    }
                    finally
                    {
