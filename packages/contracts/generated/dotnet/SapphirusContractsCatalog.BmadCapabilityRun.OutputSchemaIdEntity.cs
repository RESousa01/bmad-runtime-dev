...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityRun
    {
        ...
        public readonly partial struct OutputSchemaIdEntity
#if NET8_0_OR_GREATER
            : IJsonElement<OutputSchemaIdEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputSchemaIdEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputSchemaIdEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputSchemaIdEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(OutputSchemaIdEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in OutputSchemaIdEntity left, in OutputSchemaIdEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputSchemaIdEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputSchemaIdEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputSchemaIdEntity(JsonElement instance)
            {
                return OutputSchemaIdEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputSchemaIdEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputSchemaIdEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<OutputSchemaIdEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputSchemaIdEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<OutputSchemaIdEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputSchemaIdEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<OutputSchemaIdEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static OutputSchemaIdEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<OutputSchemaIdEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputSchemaIdEntity? result)
            {
                return JsonElementHelpers.TryParseValue<OutputSchemaIdEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OutputSchemaIdEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OutputSchemaIdEntity IJsonElement<OutputSchemaIdEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputSchemaIdEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OutputSchemaIdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OutputSchemaIdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OutputSchemaIdEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OutputSchemaIdEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OutputSchemaIdEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OutputSchemaIdEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputSchemaIdEntity>(_idx);
                }
            ...
            /// <param name="matchSapphirusBmadDocumentArtifactV1">Match 1st item.</param>
            /// <param name="matchSapphirusBmadGovernedChangeSetV1">Match 2nd item.</param>
            /// <param name="matchSapphirusBmadInactiveBuilderDraftV1">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSapphirusBmadDocumentArtifactV1,
                Func<TContext, TResult> matchSapphirusBmadGovernedChangeSetV1,
                Func<TContext, TResult> matchSapphirusBmadInactiveBuilderDraftV1,
...
#endif
            {
                ...
                {
                    return matchSapphirusBmadDocumentArtifactV1(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSapphirusBmadGovernedChangeSetV1(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchSapphirusBmadInactiveBuilderDraftV1(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSapphirusBmadDocumentArtifactV1,
                Func<TResult> matchSapphirusBmadGovernedChangeSetV1,
                Func<TResult> matchSapphirusBmadInactiveBuilderDraftV1,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSapphirusBmadDocumentArtifactV1();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSapphirusBmadGovernedChangeSetV1();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchSapphirusBmadInactiveBuilderDraftV1();
                }
