    ...
    public readonly partial struct ModelAccessReceipt
    {
        ...
        public readonly partial struct RetryCountEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RetryCountEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetryCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetryCountEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetryCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RetryCountEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RetryCountEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetryCountEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RetryCountEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RetryCountEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RetryCountEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RetryCountEntity>();
                }
                finally
                {
