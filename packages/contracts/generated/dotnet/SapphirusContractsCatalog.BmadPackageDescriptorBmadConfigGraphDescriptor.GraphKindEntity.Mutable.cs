    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigGraphDescriptor
    {
        ...
        public readonly partial struct GraphKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(GraphKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GraphKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GraphKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GraphKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GraphKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GraphKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GraphKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GraphKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GraphKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GraphKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GraphKindEntity>();
                }
                finally
                {
