            ...
            public readonly partial struct ChangedFilesEntity
            {
                ...
                public readonly partial struct PreContentHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PreContentHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PreContentHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PreContentHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PreContentHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreContentHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PreContentHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PreContentHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PreContentHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.ExecutionResultManifest.ChangedFilesArray.ChangedFilesEntity.PreContentHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PreContentHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PreContentHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PreContentHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PreContentHashEntity>();
                        }
                        finally
                        {
