    ...
    public readonly partial struct DesktopDeviceRegistration
    {
            ...
            : IJsonElement<ArchitectureEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "x64"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ArchitectureEntity EnumJson1 = ParsedJsonDocument<ArchitectureEntity>.StringConstant([.."\"x64\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "arm64"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly ArchitectureEntity EnumJson2 = ParsedJsonDocument<ArchitectureEntity>.StringConstant([.."\"arm64\""u8]);
            }
            ...
            public static class EnumValues
            {
                /// <summary>
                /// Gets the string "x64"
                /// as a <see cref="ArchitectureEntity"/>.
                /// </summary>
                public static ArchitectureEntity X64 { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "x64"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> X64Utf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "arm64"
                /// as a <see cref="ArchitectureEntity"/>.
                /// </summary>
                public static ArchitectureEntity Arm64 { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "arm64"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> Arm64Utf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DesktopDeviceRegistration/properties/architecture"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/DesktopDeviceRegistration/properties/architecture";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DesktopDeviceRegistration/properties/architecture"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("x64"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("arm64"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
