...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptor
    {
        ...
        public readonly partial struct UpstreamManifestObservationHashesArray
            ...
            : IJsonElement<UpstreamManifestObservationHashesArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UpstreamManifestObservationHashesArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UpstreamManifestObservationHashesArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UpstreamManifestObservationHashesArray DefaultInstance { get; }
            ...
            public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256 this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in UpstreamManifestObservationHashesArray left, in UpstreamManifestObservationHashesArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UpstreamManifestObservationHashesArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(UpstreamManifestObservationHashesArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UpstreamManifestObservationHashesArray(JsonElement instance)
            {
                return UpstreamManifestObservationHashesArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UpstreamManifestObservationHashesArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UpstreamManifestObservationHashesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UpstreamManifestObservationHashesArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UpstreamManifestObservationHashesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UpstreamManifestObservationHashesArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UpstreamManifestObservationHashesArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UpstreamManifestObservationHashesArray>(json, options);
            }
            ...
            /// </exception>
            public static UpstreamManifestObservationHashesArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UpstreamManifestObservationHashesArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UpstreamManifestObservationHashesArray? result)
            {
                return JsonElementHelpers.TryParseValue<UpstreamManifestObservationHashesArray>(ref reader, out result);
            }
...
#if NET
            static UpstreamManifestObservationHashesArray IJsonElement<UpstreamManifestObservationHashesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UpstreamManifestObservationHashesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public UpstreamManifestObservationHashesArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public UpstreamManifestObservationHashesArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<UpstreamManifestObservationHashesArray>(_idx);
                }
