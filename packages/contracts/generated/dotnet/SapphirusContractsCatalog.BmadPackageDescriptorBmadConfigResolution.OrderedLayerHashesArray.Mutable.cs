...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigResolution
    {
        ...
        public readonly partial struct OrderedLayerHashesArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OrderedLayerHashesArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OrderedLayerHashesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OrderedLayerHashesArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OrderedLayerHashesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OrderedLayerHashesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="OrderedLayerHashesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OrderedLayerHashesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OrderedLayerHashesArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OrderedLayerHashesArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OrderedLayerHashesArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OrderedLayerHashesArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OrderedLayerHashesArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigResolution.OrderedLayerHashesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OrderedLayerHashesArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptorBmadConfigResolution.OrderedLayerHashesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OrderedLayerHashesArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OrderedLayerHashesArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OrderedLayerHashesArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OrderedLayerHashesArray> Create<TContext>(
