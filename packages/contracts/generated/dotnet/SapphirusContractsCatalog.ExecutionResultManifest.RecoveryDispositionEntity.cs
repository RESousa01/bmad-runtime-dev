...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct RecoveryDispositionEntity
#if NET8_0_OR_GREATER
            : IJsonElement<RecoveryDispositionEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RecoveryDispositionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RecoveryDispositionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RecoveryDispositionEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RecoveryDispositionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RecoveryDispositionEntity left, in RecoveryDispositionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RecoveryDispositionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RecoveryDispositionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RecoveryDispositionEntity(JsonElement instance)
            {
                return RecoveryDispositionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RecoveryDispositionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RecoveryDispositionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RecoveryDispositionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RecoveryDispositionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RecoveryDispositionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RecoveryDispositionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RecoveryDispositionEntity>(json, options);
            }
            ...
            /// </exception>
            public static RecoveryDispositionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RecoveryDispositionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RecoveryDispositionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RecoveryDispositionEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RecoveryDispositionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RecoveryDispositionEntity IJsonElement<RecoveryDispositionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RecoveryDispositionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RecoveryDispositionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RecoveryDispositionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RecoveryDispositionEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RecoveryDispositionEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RecoveryDispositionEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RecoveryDispositionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RecoveryDispositionEntity>(_idx);
                }
            ...
            /// <param name="matchClean">Match 1st item.</param>
            /// <param name="matchRecovered">Match 2nd item.</param>
            /// <param name="matchManualReview">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchClean,
                Func<TContext, TResult> matchRecovered,
                Func<TContext, TResult> matchManualReview,
...
#endif
            {
                ...
                {
                    return matchClean(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchRecovered(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchManualReview(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchClean,
                Func<TResult> matchRecovered,
                Func<TResult> matchManualReview,
