    ...
    public readonly partial struct MethodSessionMethodCheckpoint
    {
        ...
        public readonly partial struct CurrentStepKeyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CurrentStepKeyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CurrentStepKeyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CurrentStepKeyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CurrentStepKeyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CurrentStepKeyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CurrentStepKeyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CurrentStepKeyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CurrentStepKeyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CurrentStepKeyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CurrentStepKeyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CurrentStepKeyEntity>();
                }
                finally
                {
