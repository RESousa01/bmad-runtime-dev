    ...
    public readonly partial struct BmadValidationReportBmadValidationEvidenceRef
    {
        ...
        public readonly partial struct EvidenceKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EvidenceKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EvidenceKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EvidenceKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EvidenceKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EvidenceKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EvidenceKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EvidenceKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EvidenceKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EvidenceKindEntity>();
                }
                finally
                {
