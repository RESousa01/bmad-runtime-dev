...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResultBmadBoundedProse
#if NET8_0_OR_GREATER
        : IJsonElement<BmadCapabilityResultBmadBoundedProse>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BmadCapabilityResultBmadBoundedProse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BmadCapabilityResultBmadBoundedProse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BmadCapabilityResultBmadBoundedProse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BmadCapabilityResultBmadBoundedProse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BmadCapabilityResultBmadBoundedProse left, in BmadCapabilityResultBmadBoundedProse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BmadCapabilityResultBmadBoundedProse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BmadCapabilityResultBmadBoundedProse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BmadCapabilityResultBmadBoundedProse(JsonElement instance)
        {
            return BmadCapabilityResultBmadBoundedProse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedProse From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedProse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedProse>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedProse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedProse>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BmadCapabilityResultBmadBoundedProse ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedProse>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BmadCapabilityResultBmadBoundedProse ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BmadCapabilityResultBmadBoundedProse>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BmadCapabilityResultBmadBoundedProse? result)
        {
            return JsonElementHelpers.TryParseValue<BmadCapabilityResultBmadBoundedProse>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BmadCapabilityResultBmadBoundedProse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BmadCapabilityResultBmadBoundedProse IJsonElement<BmadCapabilityResultBmadBoundedProse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BmadCapabilityResultBmadBoundedProse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BmadCapabilityResultBmadBoundedProse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BmadCapabilityResultBmadBoundedProse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityResultBmadBoundedProse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BmadCapabilityResultBmadBoundedProse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BmadCapabilityResultBmadBoundedProse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BmadCapabilityResultBmadBoundedProse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BmadCapabilityResultBmadBoundedProse>(_idx);
            }
