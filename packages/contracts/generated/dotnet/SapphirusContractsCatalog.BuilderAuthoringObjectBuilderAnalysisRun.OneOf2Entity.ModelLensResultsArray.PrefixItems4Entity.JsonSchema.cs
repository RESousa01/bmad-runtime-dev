        ...
        public readonly partial struct OneOf2Entity
        {
            ...
            public readonly partial struct ModelLensResultsArray
            {
                    ...
                    : IJsonElement<PrefixItems4Entity>
                {
                    ...
                    {
                        private static readonly JsonSchemaPathProvider HoistedAllOf1BuilderKindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/builderKind"u8, buffer, out written);

                        private static readonly JsonSchemaPathProvider HoistedAllOf1LensSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/lens"u8, buffer, out written);

                        /// <summary>
                        /// Gets a provider for the schema location from which this type was generated.
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/4"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/4";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderAnalysisRun/oneOf/2/properties/modelLensResults/prefixItems/4"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            JsonSchemaContext allOfContext0 =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderModelLensResult.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf0SchemaEvaluationPath);
                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderModelLensResult.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext0);
                            ...
                            JsonSchemaContext hoistedAllOf1_context =
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf2Entity.ModelLensResultsArray.PrefixItems4Entity.AllOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
                            if (parentDocument.GetJsonTokenType(parentIndex) == JsonTokenType.StartObject)
                            {
                                ...
                                while (objectValidation_enumerator.MoveNext())
                                {
                                    ...
                                    if (objectValidation_unescapedPropertyName.Span.SequenceEqual("builderKind"u8))
                                    {
                                        ...
                                        JsonSchemaContext hoistedChildContext =
                                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf2Entity.ModelLensResultsArray.PrefixItems4Entity.AllOf1Entity.BuilderKindEntity.JsonSchema.PushChildContextUnescaped(
                                                parentDocument,
                                                objectValidation_currentIndex,
                                                ref hoistedAllOf1_context,
                                                "builderKind"u8,
                                                evaluationPath: HoistedAllOf1BuilderKindSchemaEvaluationPath);
                                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf2Entity.ModelLensResultsArray.PrefixItems4Entity.AllOf1Entity.BuilderKindEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref hoistedChildContext);
                                        hoistedAllOf1_context.CommitChildContext(hoistedChildContext.IsMatch, ref hoistedChildContext);
                                    }
                                    else if (objectValidation_unescapedPropertyName.Span.SequenceEqual("lens"u8))
                                    {
                                        hoistedAllOf1_context.AddLocalEvaluatedProperty(objectValidation_propertyCount);
                                        context.AddAppliedEvaluatedProperty(objectValidation_propertyCount);
                                        JsonSchemaContext hoistedChildContext1 =
                                            Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf2Entity.ModelLensResultsArray.PrefixItems4Entity.AllOf1Entity.LensEntity.JsonSchema.PushChildContextUnescaped(
                                                parentDocument,
                                                objectValidation_currentIndex,
                                                ref hoistedAllOf1_context,
                                                "lens"u8,
                                                evaluationPath: HoistedAllOf1LensSchemaEvaluationPath);
                                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BuilderAuthoringObjectBuilderAnalysisRun.OneOf2Entity.ModelLensResultsArray.PrefixItems4Entity.AllOf1Entity.LensEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref hoistedChildContext1);
