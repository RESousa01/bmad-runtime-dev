        ...
        public readonly partial struct OneOf0Entity
        {
                ...
                : IJsonElement<ResultKindEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "document_artifact"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ResultKindEntity ConstJson = ParsedJsonDocument<ResultKindEntity>.StringConstant([.."\"document_artifact\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResult/oneOf/0/properties/resultKind"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadCapabilityResult/oneOf/0/properties/resultKind";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResult/oneOf/0/properties/resultKind"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "document_artifact"u8, "document_artifact", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "document_artifact", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
