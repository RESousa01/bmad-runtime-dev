            ...
            public readonly partial struct ModulesEntity
            {
                ...
                public readonly partial struct HelpCatalogSourceHashEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(HelpCatalogSourceHashEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="HelpCatalogSourceHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator HelpCatalogSourceHashEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"HelpCatalogSourceHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HelpCatalogSourceHashEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HelpCatalogSourceHashEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<HelpCatalogSourceHashEntity>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ModulesArray.ModulesEntity.HelpCatalogSourceHashEntity.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadPackageDescriptor.ModulesArray.ModulesEntity.HelpCatalogSourceHashEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(HelpCatalogSourceHashEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<HelpCatalogSourceHashEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<HelpCatalogSourceHashEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<HelpCatalogSourceHashEntity>();
                        }
                        finally
                        {
