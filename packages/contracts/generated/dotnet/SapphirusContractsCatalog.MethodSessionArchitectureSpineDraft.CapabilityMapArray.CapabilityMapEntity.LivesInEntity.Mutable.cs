            ...
            public readonly partial struct CapabilityMapEntity
            {
                ...
                public readonly partial struct LivesInEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(LivesInEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="LivesInEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator LivesInEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"LivesInEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly LivesInEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly LivesInEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<LivesInEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(LivesInEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<LivesInEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<LivesInEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<LivesInEntity>();
                        }
                        finally
                        {
