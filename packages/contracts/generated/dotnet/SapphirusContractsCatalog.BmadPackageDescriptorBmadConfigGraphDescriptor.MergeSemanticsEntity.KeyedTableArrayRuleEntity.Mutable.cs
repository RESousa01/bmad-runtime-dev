        ...
        public readonly partial struct MergeSemanticsEntity
        {
            ...
            public readonly partial struct KeyedTableArrayRuleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(KeyedTableArrayRuleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="KeyedTableArrayRuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator KeyedTableArrayRuleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"KeyedTableArrayRuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyedTableArrayRuleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyedTableArrayRuleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<KeyedTableArrayRuleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(KeyedTableArrayRuleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<KeyedTableArrayRuleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<KeyedTableArrayRuleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<KeyedTableArrayRuleEntity>();
                    }
                    finally
                    {
