        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct ServiceIdEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ServiceIdEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ServiceIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ServiceIdEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ServiceIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ServiceIdEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ServiceIdEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ServiceIdEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ServiceIdEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ServiceIdEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ServiceIdEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ServiceIdEntity>();
                    }
                    finally
                    {
