    ...
    public readonly partial struct BuilderAuthoringObjectBuilderModelLensResult
    {
        ...
        public readonly partial struct EvaluationClaimEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EvaluationClaimEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EvaluationClaimEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EvaluationClaimEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EvaluationClaimEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EvaluationClaimEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EvaluationClaimEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EvaluationClaimEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EvaluationClaimEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EvaluationClaimEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EvaluationClaimEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EvaluationClaimEntity>();
                }
                finally
                {
