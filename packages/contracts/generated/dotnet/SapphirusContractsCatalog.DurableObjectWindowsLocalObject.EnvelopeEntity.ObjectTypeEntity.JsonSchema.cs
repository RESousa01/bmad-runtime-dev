        ...
        public readonly partial struct EnvelopeEntity
        {
                ...
                : IJsonElement<ObjectTypeEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "execution_spec_candidate"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ObjectTypeEntity ConstJson = ParsedJsonDocument<ObjectTypeEntity>.StringConstant([.."\"execution_spec_candidate\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DurableObjectWindowsLocalObject/properties/envelope/properties/objectType"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/DurableObjectWindowsLocalObject/properties/envelope/properties/objectType";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DurableObjectWindowsLocalObject/properties/envelope/properties/objectType"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "execution_spec_candidate"u8, "execution_spec_candidate", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "execution_spec_candidate", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
