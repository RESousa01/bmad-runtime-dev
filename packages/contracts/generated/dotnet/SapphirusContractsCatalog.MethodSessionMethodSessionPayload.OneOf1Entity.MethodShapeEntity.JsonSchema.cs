        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<MethodShapeEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "architect_iterative"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly MethodShapeEntity ConstJson = ParsedJsonDocument<MethodShapeEntity>.StringConstant([.."\"architect_iterative\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/methodShape"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/methodShape";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionMethodSessionPayload/oneOf/1/properties/methodShape"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "architect_iterative"u8, "architect_iterative", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "architect_iterative", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
