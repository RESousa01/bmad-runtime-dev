    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct CompletionEvidenceClassEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CompletionEvidenceClassEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CompletionEvidenceClassEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CompletionEvidenceClassEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CompletionEvidenceClassEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CompletionEvidenceClassEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CompletionEvidenceClassEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CompletionEvidenceClassEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CompletionEvidenceClassEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CompletionEvidenceClassEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CompletionEvidenceClassEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CompletionEvidenceClassEntity>();
                }
                finally
                {
