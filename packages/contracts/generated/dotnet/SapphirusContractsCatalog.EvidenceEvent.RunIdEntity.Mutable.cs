    ...
    public readonly partial struct EvidenceEvent
    {
        ...
        public readonly partial struct RunIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RunIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RunIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RunIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RunIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RunIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RunIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RunIdEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.RunIdEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.EvidenceEvent.RunIdEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonContractId.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RunIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RunIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RunIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RunIdEntity>();
                }
                finally
                {
