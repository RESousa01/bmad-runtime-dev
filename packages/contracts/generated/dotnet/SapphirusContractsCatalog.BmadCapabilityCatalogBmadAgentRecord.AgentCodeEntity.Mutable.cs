    ...
    public readonly partial struct BmadCapabilityCatalogBmadAgentRecord
    {
        ...
        public readonly partial struct AgentCodeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AgentCodeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AgentCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AgentCodeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AgentCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AgentCodeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AgentCodeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AgentCodeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AgentCodeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AgentCodeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AgentCodeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AgentCodeEntity>();
                }
                finally
                {
