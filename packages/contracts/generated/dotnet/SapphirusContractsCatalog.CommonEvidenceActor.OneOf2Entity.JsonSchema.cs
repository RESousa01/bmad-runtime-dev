...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonEvidenceActor
    {
            ...
            : IJsonElement<OneOf2Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyActorKindPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("actorKind"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyActorKindNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("actorKind"u8, buffer, out written);

                private const int RequiredOffsetForActorKind = 0;
                private const uint RequiredBitForActorKind = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitForInstallationId = 0b00000000000000000000000000000100;

                private const uint RequiredBitMask0 =
                    RequiredBitForActorKind | RequiredBitForHostBinarySha256 | RequiredBitForInstallationId;
                private static readonly JsonSchemaPathProvider ActorKindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/actorKind"u8, buffer, out written);
                ...
                private static void MatchActorKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf2Entity.ActorKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ActorKindUtf8,
                            evaluationPath: ActorKindSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf2Entity.ActorKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForActorKind] |= RequiredBitForActorKind;
                }
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.ActorKindUtf8, MatchActorKind),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/CommonEvidenceActor/oneOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/CommonEvidenceActor/oneOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/CommonEvidenceActor/oneOf/2"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                        {
                            if (context.HasCollector)
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyActorKindPresent, "actorKind"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyHostBinarySha256Present, "hostBinarySha256"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyInstallationIdPresent, "installationId"u8, "required"u8);
                            }
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForActorKind] & RequiredBitForActorKind) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyActorKindNotPresent, "actorKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyActorKindPresent, "actorKind"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyInstallationIdNotPresent, "installationId"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyInstallationIdPresent, "installationId"u8, "required"u8);
