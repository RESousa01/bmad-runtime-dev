        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct OrdinalEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OrdinalEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OrdinalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OrdinalEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OrdinalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OrdinalEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OrdinalEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OrdinalEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OrdinalEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OrdinalEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OrdinalEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OrdinalEntity>();
                    }
                    finally
                    {
