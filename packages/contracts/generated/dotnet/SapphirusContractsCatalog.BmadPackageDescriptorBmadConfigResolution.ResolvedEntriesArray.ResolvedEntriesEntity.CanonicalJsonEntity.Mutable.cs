            ...
            public readonly partial struct ResolvedEntriesEntity
            {
                ...
                public readonly partial struct CanonicalJsonEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(CanonicalJsonEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="CanonicalJsonEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator CanonicalJsonEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"CanonicalJsonEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CanonicalJsonEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CanonicalJsonEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<CanonicalJsonEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(CanonicalJsonEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<CanonicalJsonEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<CanonicalJsonEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<CanonicalJsonEntity>();
                        }
                        finally
                        {
