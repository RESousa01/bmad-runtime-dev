        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct RecommendationKindEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RecommendationKindEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RecommendationKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RecommendationKindEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RecommendationKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RecommendationKindEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RecommendationKindEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RecommendationKindEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RecommendationKindEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RecommendationKindEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RecommendationKindEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RecommendationKindEntity>();
                    }
                    finally
                    {
