                    ...
                    public readonly partial struct LensResultsEntity
                    {
                        ...
                        public readonly partial struct FindingsArray
                        {
                            ...
                            public readonly partial struct FindingsEntity
                            {
                                ...
                                public readonly partial struct SummaryEntity
#if NET8_0_OR_GREATER
                                    : IJsonElement<SummaryEntity>,
                                      IFormattable,
                                      ISpanFormattable,
...
#endif
                                {
                                    ...
                                    /// <summary>
                                    /// Initializes a new instance of the <see cref="SummaryEntity"/> struct.
                                    /// </summary>
                                    /// <param name="value">The value from which to construct the instance.</param>
                                    internal SummaryEntity(IJsonDocument parent, int idx)
                                    {
                                        Debug.Assert(idx >= 0);
                                        _parent = parent;
                                        _idx = idx;
                                    ...
                                    /// </summary>
                                    public static SummaryEntity DefaultInstance { get; }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static explicit operator string(SummaryEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                    ...
                                    /// </returns>
                                    public static bool operator ==(in SummaryEntity left, in SummaryEntity right)
                                    {
                                    ...
                                    /// <c>True</c> if the values are equal.
                                    /// </returns>
                                    public static bool operator ==(in SummaryEntity left, in JsonElement right)
                                    {
                                        return left.Equals(right);
                                    }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator JsonElement(SummaryEntity instance)
                                    {
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator SummaryEntity(JsonElement instance)
                                    {
                                        return SummaryEntity.From(instance);
                                    }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static SummaryEntity From<T>(in T instance)
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static SummaryEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<SummaryEntity>(utf8Json, options);
                                    }
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static SummaryEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<SummaryEntity>(json, options);
                                    }
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static SummaryEntity ParseValue(string json, JsonDocumentOptions options = default)
                                    {
                                        return JsonElementHelpers.ParseValue<SummaryEntity>(json, options);
                                    }
                                    ...
                                    /// </exception>
                                    public static SummaryEntity ParseValue(ref Utf8JsonReader reader)
                                    {
                                        return JsonElementHelpers.ParseValue<SummaryEntity>(ref reader);
                                    }
                                    ...
                                    ///   A value could not be read from the reader.
                                    /// </exception>
                                    public static bool TryParseValue(ref Utf8JsonReader reader, out SummaryEntity? result)
                                    {
                                        return JsonElementHelpers.TryParseValue<SummaryEntity>(ref reader, out result);
                                    }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new SummaryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                    static SummaryEntity IJsonElement<SummaryEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"SummaryEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// <summary>
                                    /// Gets a <see cref="SummaryEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </summary>
                                    /// <returns>
                                    /// A <see cref="SummaryEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </returns>
                                    /// <remarks>
                                    /// <para>
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public SummaryEntity Clone()
                                    {
                                        CheckValidInstance();
                                        return _parent.CloneElement<SummaryEntity>(_idx);
                                    }
                                    ...
                                    /// </summary>
                                    /// <returns>
                                    /// An immutable <see cref="SummaryEntity"/> that lives for the lifetime of its
