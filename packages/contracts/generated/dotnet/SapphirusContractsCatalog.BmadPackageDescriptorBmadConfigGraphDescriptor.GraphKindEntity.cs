...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadConfigGraphDescriptor
    {
        ...
        public readonly partial struct GraphKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<GraphKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GraphKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal GraphKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static GraphKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(GraphKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in GraphKindEntity left, in GraphKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in GraphKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(GraphKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GraphKindEntity(JsonElement instance)
            {
                return GraphKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GraphKindEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GraphKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GraphKindEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GraphKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GraphKindEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GraphKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GraphKindEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static GraphKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GraphKindEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out GraphKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<GraphKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GraphKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static GraphKindEntity IJsonElement<GraphKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GraphKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GraphKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GraphKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public GraphKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GraphKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GraphKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public GraphKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<GraphKindEntity>(_idx);
                }
            ...
            /// <param name="matchMethodCentralToml">Match 1st item.</param>
            /// <param name="matchSkillCustomizationToml">Match 2nd item.</param>
            /// <param name="matchCompatibilityYaml">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchMethodCentralToml,
                Func<TContext, TResult> matchSkillCustomizationToml,
                Func<TContext, TResult> matchCompatibilityYaml,
...
#endif
            {
                ...
                {
                    return matchMethodCentralToml(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSkillCustomizationToml(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchCompatibilityYaml(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchMethodCentralToml,
                Func<TResult> matchSkillCustomizationToml,
                Func<TResult> matchCompatibilityYaml,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchMethodCentralToml();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSkillCustomizationToml();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchCompatibilityYaml();
                }
