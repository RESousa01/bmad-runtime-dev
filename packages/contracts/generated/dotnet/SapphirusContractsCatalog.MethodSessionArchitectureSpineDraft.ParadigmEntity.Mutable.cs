    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct ParadigmEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ParadigmEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ParadigmEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ParadigmEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ParadigmEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ParadigmEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ParadigmEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ParadigmEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ParadigmEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ParadigmEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ParadigmEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ParadigmEntity>();
                }
                finally
                {
