    ...
    public readonly partial struct ExecutionResultManifest
    {
        ...
        public readonly partial struct ManifestKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ManifestKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ManifestKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ManifestKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ManifestKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ManifestKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ManifestKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ManifestKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ManifestKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ManifestKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ManifestKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ManifestKindEntity>();
                }
                finally
                {
