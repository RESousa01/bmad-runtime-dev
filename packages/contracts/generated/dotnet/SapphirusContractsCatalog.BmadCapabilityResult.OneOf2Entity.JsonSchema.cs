...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResult
    {
            ...
            : IJsonElement<OneOf2Entity>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInactiveBuilderDraftPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("inactiveBuilderDraft"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInactiveBuilderDraftNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("inactiveBuilderDraft"u8, buffer, out written);

                private const int RequiredOffsetForInactiveBuilderDraft = 0;
                private const uint RequiredBitForInactiveBuilderDraft = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitForResultKind = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForInactiveBuilderDraft | RequiredBitForResultKind;
                private static readonly JsonSchemaPathProvider InactiveBuilderDraftSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/inactiveBuilderDraft/$ref"u8, buffer, out written);
                ...
                private static void MatchInactiveBuilderDraft(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadInactiveBuilderDraft.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.InactiveBuilderDraftUtf8,
                            evaluationPath: InactiveBuilderDraftSchemaEvaluationPath);

                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadInactiveBuilderDraft.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForInactiveBuilderDraft] |= RequiredBitForInactiveBuilderDraft;
                }
                ...
                private static void MatchResultKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf2Entity.ResultKindEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResult.OneOf2Entity.ResultKindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Sapphirus.Contracts.Generated.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.InactiveBuilderDraftUtf8, MatchInactiveBuilderDraft),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadCapabilityResult/oneOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BmadCapabilityResult/oneOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadCapabilityResult/oneOf/2"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyInactiveBuilderDraftPresent, "inactiveBuilderDraft"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyResultKindPresent, "resultKind"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForInactiveBuilderDraft] & RequiredBitForInactiveBuilderDraft) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyInactiveBuilderDraftNotPresent, "inactiveBuilderDraft"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyInactiveBuilderDraftPresent, "inactiveBuilderDraft"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyResultKindNotPresent, "resultKind"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyResultKindPresent, "resultKind"u8, "required"u8);
