            ...
            public readonly partial struct OpenItemsEntity
            {
                ...
                public readonly partial struct ItemKindEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ItemKindEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ItemKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ItemKindEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ItemKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ItemKindEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ItemKindEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ItemKindEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ItemKindEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ItemKindEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ItemKindEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ItemKindEntity>();
                        }
                        finally
                        {
