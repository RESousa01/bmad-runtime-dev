            ...
            public readonly partial struct DecisionsEntity
            {
                ...
                public readonly partial struct RuleEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RuleEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RuleEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuleEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RuleEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RuleEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RuleEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RuleEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RuleEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RuleEntity>();
                        }
                        finally
                        {
