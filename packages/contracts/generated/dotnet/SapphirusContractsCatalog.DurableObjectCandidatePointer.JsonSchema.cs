...
public readonly partial struct SapphirusContractsCatalog
{
        ...
        : IJsonElement<DurableObjectCandidatePointer>
    {
        public static partial class JsonSchema
        {
            ...
            private const uint RequiredBitForCandidateId = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForCandidateId;
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.CandidateIdUtf8))
                {
                    matcher = MatchCandidateId;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DurableObjectCandidatePointer"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/DurableObjectCandidatePointer";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DurableObjectCandidatePointer"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCandidateIdPresent, "candidateId"u8, "required"u8);
                    }
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCandidateIdNotPresent, "candidateId"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCandidateIdPresent, "candidateId"u8, "required"u8);
