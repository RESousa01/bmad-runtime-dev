            ...
            public readonly partial struct OneOf1Entity
            {
                ...
                public readonly partial struct ReasonCodeEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ReasonCodeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ReasonCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ReasonCodeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ReasonCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ReasonCodeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ReasonCodeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ReasonCodeEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ReasonCodeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ReasonCodeEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ReasonCodeEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ReasonCodeEntity>();
                        }
                        finally
                        {
