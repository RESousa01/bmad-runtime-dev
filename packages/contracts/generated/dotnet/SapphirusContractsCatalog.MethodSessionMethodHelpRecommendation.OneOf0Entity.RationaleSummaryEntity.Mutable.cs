        ...
        public readonly partial struct OneOf0Entity
        {
            ...
            public readonly partial struct RationaleSummaryEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RationaleSummaryEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RationaleSummaryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RationaleSummaryEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RationaleSummaryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RationaleSummaryEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RationaleSummaryEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RationaleSummaryEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RationaleSummaryEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RationaleSummaryEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RationaleSummaryEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RationaleSummaryEntity>();
                    }
                    finally
                    {
