...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessRequestCanonicalSchemaId
#if NET8_0_OR_GREATER
        : IJsonElement<ModelAccessRequestCanonicalSchemaId>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelAccessRequestCanonicalSchemaId"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModelAccessRequestCanonicalSchemaId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModelAccessRequestCanonicalSchemaId DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ModelAccessRequestCanonicalSchemaId value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ModelAccessRequestCanonicalSchemaId left, in ModelAccessRequestCanonicalSchemaId right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModelAccessRequestCanonicalSchemaId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ModelAccessRequestCanonicalSchemaId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModelAccessRequestCanonicalSchemaId(JsonElement instance)
        {
            return ModelAccessRequestCanonicalSchemaId.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessRequestCanonicalSchemaId From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessRequestCanonicalSchemaId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ModelAccessRequestCanonicalSchemaId>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessRequestCanonicalSchemaId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ModelAccessRequestCanonicalSchemaId>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModelAccessRequestCanonicalSchemaId ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ModelAccessRequestCanonicalSchemaId>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ModelAccessRequestCanonicalSchemaId ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ModelAccessRequestCanonicalSchemaId>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModelAccessRequestCanonicalSchemaId? result)
        {
            return JsonElementHelpers.TryParseValue<ModelAccessRequestCanonicalSchemaId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ModelAccessRequestCanonicalSchemaId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ModelAccessRequestCanonicalSchemaId IJsonElement<ModelAccessRequestCanonicalSchemaId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModelAccessRequestCanonicalSchemaId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ModelAccessRequestCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ModelAccessRequestCanonicalSchemaId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ModelAccessRequestCanonicalSchemaId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ModelAccessRequestCanonicalSchemaId>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ModelAccessRequestCanonicalSchemaId"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ModelAccessRequestCanonicalSchemaId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModelAccessRequestCanonicalSchemaId>(_idx);
            }
