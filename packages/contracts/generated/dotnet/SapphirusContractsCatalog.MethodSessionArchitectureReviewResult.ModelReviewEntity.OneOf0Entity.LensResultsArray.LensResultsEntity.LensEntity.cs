                ...
                public readonly partial struct LensResultsArray
                {
                    ...
                    public readonly partial struct LensResultsEntity
                    {
...
#endif
                        {
                            ...
                            /// <param name="matchGoodSpine">Match 1st item.</param>
                            /// <param name="matchCurrentTechnologyEvidence">Match 2nd item.</param>
                            /// <param name="matchCrossUnitDivergence">Match 3rd item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchGoodSpine,
                                Func<TContext, TResult> matchCurrentTechnologyEvidence,
                                Func<TContext, TResult> matchCrossUnitDivergence,
...
#endif
                            {
                                ...
                                {
                                    return matchGoodSpine(context);
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchCurrentTechnologyEvidence(context);
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchCrossUnitDivergence(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchGoodSpine,
                                Func<TResult> matchCurrentTechnologyEvidence,
                                Func<TResult> matchCrossUnitDivergence,
                                Func<TResult> defaultMatch)
                            {
                                if (this.ValueEquals(Constants.Enum1))
                                {
                                    return matchGoodSpine();
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchCurrentTechnologyEvidence();
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchCrossUnitDivergence();
                                }
