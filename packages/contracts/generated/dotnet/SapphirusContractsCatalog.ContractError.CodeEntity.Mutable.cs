    ...
    public readonly partial struct ContractError
    {
        ...
        public readonly partial struct CodeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CodeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CodeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CodeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CodeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CodeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CodeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CodeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CodeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CodeEntity>();
                }
                finally
                {
