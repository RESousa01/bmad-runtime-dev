    ...
    public readonly partial struct RemoteJobHandoffImportedProposalHandoff
    {
        ...
        public readonly partial struct StateEntity
        {
...
#endif
            {
                ...
                /// <param name="matchImportedAsLocalProposal">Match 1st item.</param>
                /// <param name="matchClosed">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchImportedAsLocalProposal,
                    Func<TContext, TResult> matchClosed,
...
#endif
                {
                    ...
                    {
                        return matchImportedAsLocalProposal(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchClosed(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchImportedAsLocalProposal,
                    Func<TResult> matchClosed,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchImportedAsLocalProposal();
                    }
