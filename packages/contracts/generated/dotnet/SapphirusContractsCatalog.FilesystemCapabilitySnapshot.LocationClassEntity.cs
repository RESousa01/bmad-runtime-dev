...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct FilesystemCapabilitySnapshot
    {
        ...
        public readonly partial struct LocationClassEntity
#if NET8_0_OR_GREATER
            : IJsonElement<LocationClassEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LocationClassEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LocationClassEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LocationClassEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LocationClassEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LocationClassEntity left, in LocationClassEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LocationClassEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LocationClassEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LocationClassEntity(JsonElement instance)
            {
                return LocationClassEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationClassEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationClassEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationClassEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationClassEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationClassEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationClassEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationClassEntity>(json, options);
            }
            ...
            /// </exception>
            public static LocationClassEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LocationClassEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LocationClassEntity? result)
            {
                return JsonElementHelpers.TryParseValue<LocationClassEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LocationClassEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LocationClassEntity IJsonElement<LocationClassEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LocationClassEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LocationClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LocationClassEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LocationClassEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LocationClassEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LocationClassEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LocationClassEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LocationClassEntity>(_idx);
                }
            ...
            /// <param name="matchFixedLocal">Match 1st item.</param>
            /// <param name="matchRemovable">Match 2nd item.</param>
            /// <param name="matchUnc">Match 3rd item.</param>
            /// <param name="matchVirtual">Match 4th item.</param>
            /// <param name="matchCloudBacked">Match 5th item.</param>
            /// <param name="matchUnknown">Match 6th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchFixedLocal,
                Func<TContext, TResult> matchRemovable,
                Func<TContext, TResult> matchUnc,
                Func<TContext, TResult> matchVirtual,
                Func<TContext, TResult> matchCloudBacked,
...
#endif
            {
                ...
                {
                    return matchFixedLocal(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchRemovable(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchUnc(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchVirtual(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchCloudBacked(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchFixedLocal,
                Func<TResult> matchRemovable,
                Func<TResult> matchUnc,
                Func<TResult> matchVirtual,
                Func<TResult> matchCloudBacked,
                Func<TResult> matchUnknown,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchFixedLocal();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchRemovable();
                }
