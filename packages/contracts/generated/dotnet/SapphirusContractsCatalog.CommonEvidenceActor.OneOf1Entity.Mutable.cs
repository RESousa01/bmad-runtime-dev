    ...
    public readonly partial struct CommonEvidenceActor
    {
        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.Mutable ActorKind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActorKindUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the <c>serviceId</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Mutable ServiceId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceIdUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetActorKind(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Set the <c>serviceId</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetServiceId(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("serviceId");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ServiceId, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source _createArg1;
                ...
                internal Source(Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source serviceId)
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.ActorKind, Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ActorKindEntity.ConstInstance);
                    serviceId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ServiceId, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="OneOf1Entity"/>.
                /// </summary>
                public void Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source serviceId)
                {
                    Create(ref _builder, serviceId);
                }
                ...
                internal static void BuildCreateValue(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// </summary>
            /// <param name="serviceId">The value of the <c>"serviceId"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source serviceId)
            {
                return new Source(serviceId);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="serviceId">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source serviceId, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(serviceId);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<OneOf1Entity> Create(in Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonEvidenceActor.OneOf1Entity.ServiceIdEntity.Source serviceId, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
