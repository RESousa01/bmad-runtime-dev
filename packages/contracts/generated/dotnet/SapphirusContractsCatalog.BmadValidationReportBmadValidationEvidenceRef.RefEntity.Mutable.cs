    ...
    public readonly partial struct BmadValidationReportBmadValidationEvidenceRef
    {
        ...
        public readonly partial struct RefEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RefEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RefEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RefEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RefEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RefEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RefEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RefEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RefEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RefEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RefEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RefEntity>();
                }
                finally
                {
