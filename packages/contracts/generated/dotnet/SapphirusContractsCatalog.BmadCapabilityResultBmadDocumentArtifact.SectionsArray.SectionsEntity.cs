    ...
    public readonly partial struct BmadCapabilityResultBmadDocumentArtifact
    {
        ...
        public readonly partial struct SectionsArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SectionsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SectionsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SectionsEntity DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedProse Body
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedProse value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedTitle Heading
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadingUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.BmadCapabilityResultBmadBoundedTitle value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in SectionsEntity left, in SectionsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SectionsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(SectionsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SectionsEntity(JsonElement instance)
                {
                    return SectionsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SectionsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SectionsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SectionsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SectionsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SectionsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SectionsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SectionsEntity>(json, options);
                }
                ...
                /// </exception>
                public static SectionsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SectionsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SectionsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SectionsEntity>(ref reader, out result);
                }
...
#if NET
                static SectionsEntity IJsonElement<SectionsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SectionsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SectionsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SectionsEntity>(_idx);
                    }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Heading"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Heading"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> HeadingUtf8 => "heading"u8;
                }
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Heading"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Heading => "heading"u8;
                }
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Heading"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Heading => [0x95, 0x00, 0x00, 0x00, 0x22, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6E, 0x67, 0x22];
                }
            }
        }
    }
