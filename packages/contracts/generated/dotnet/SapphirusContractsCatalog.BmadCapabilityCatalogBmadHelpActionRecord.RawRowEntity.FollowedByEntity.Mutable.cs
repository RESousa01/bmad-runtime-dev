        ...
        public readonly partial struct RawRowEntity
        {
            ...
            public readonly partial struct FollowedByEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FollowedByEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FollowedByEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FollowedByEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FollowedByEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FollowedByEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FollowedByEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FollowedByEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FollowedByEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FollowedByEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FollowedByEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FollowedByEntity>();
                    }
                    finally
                    {
