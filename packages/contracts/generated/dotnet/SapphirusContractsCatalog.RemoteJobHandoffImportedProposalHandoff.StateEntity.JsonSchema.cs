    ...
    public readonly partial struct RemoteJobHandoffImportedProposalHandoff
    {
            ...
            : IJsonElement<StateEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "imported_as_local_proposal"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson1 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"imported_as_local_proposal\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "closed"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly StateEntity EnumJson2 = ParsedJsonDocument<StateEntity>.StringConstant([.."\"closed\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "imported_as_local_proposal"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity ImportedAsLocalProposal { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "imported_as_local_proposal"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ImportedAsLocalProposalUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "closed"
                /// as a <see cref="StateEntity"/>.
                /// </summary>
                public static StateEntity Closed { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "closed"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ClosedUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/RemoteJobHandoffImportedProposalHandoff/properties/state"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/RemoteJobHandoffImportedProposalHandoff/properties/state";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/RemoteJobHandoffImportedProposalHandoff/properties/state"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("imported_as_local_proposal"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("closed"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
