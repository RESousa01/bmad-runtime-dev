    ...
    public readonly partial struct BmadCapabilityCatalogInstalledSkillRecord
    {
        ...
        public readonly partial struct ActionCardinalityEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ActionCardinalityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ActionCardinalityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ActionCardinalityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ActionCardinalityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ActionCardinalityEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ActionCardinalityEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ActionCardinalityEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ActionCardinalityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ActionCardinalityEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ActionCardinalityEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ActionCardinalityEntity>();
                }
                finally
                {
