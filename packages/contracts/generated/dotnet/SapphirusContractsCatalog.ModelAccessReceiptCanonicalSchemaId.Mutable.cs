...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelAccessReceiptCanonicalSchemaId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelAccessReceiptCanonicalSchemaId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelAccessReceiptCanonicalSchemaId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelAccessReceiptCanonicalSchemaId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelAccessReceiptCanonicalSchemaId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptCanonicalSchemaId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelAccessReceiptCanonicalSchemaId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelAccessReceiptCanonicalSchemaId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelAccessReceiptCanonicalSchemaId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelAccessReceiptCanonicalSchemaId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelAccessReceiptCanonicalSchemaId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelAccessReceiptCanonicalSchemaId>();
            }
            finally
            {
