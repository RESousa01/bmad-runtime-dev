    ...
    public readonly partial struct CommonDeclaredWrite
    {
        ...
        public readonly partial struct PreimageHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PreimageHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PreimageHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PreimageHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PreimageHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PreimageHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PreimageHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PreimageHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeclaredWrite.PreimageHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonDeclaredWrite.PreimageHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PreimageHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PreimageHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PreimageHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PreimageHashEntity>();
                }
                finally
                {
