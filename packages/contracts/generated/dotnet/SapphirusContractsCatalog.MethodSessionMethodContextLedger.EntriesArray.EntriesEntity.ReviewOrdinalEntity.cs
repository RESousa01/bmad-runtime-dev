    ...
    public readonly partial struct MethodSessionMethodContextLedger
    {
        ...
        public readonly partial struct EntriesArray
        {
            ...
            public readonly partial struct EntriesEntity
            {
                ...
                public readonly partial struct ReviewOrdinalEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<ReviewOrdinalEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="ReviewOrdinalEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal ReviewOrdinalEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static ReviewOrdinalEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator System.Numerics.BigInteger(ReviewOrdinalEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator decimal(ReviewOrdinalEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in ReviewOrdinalEntity left, in ReviewOrdinalEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in ReviewOrdinalEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(ReviewOrdinalEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReviewOrdinalEntity(JsonElement instance)
                    {
                        return ReviewOrdinalEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ReviewOrdinalEntity From<T>(in T instance)
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out ReviewOrdinalEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<ReviewOrdinalEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReviewOrdinalEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static ReviewOrdinalEntity IJsonElement<ReviewOrdinalEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReviewOrdinalEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReviewOrdinalEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReviewOrdinalEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public ReviewOrdinalEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReviewOrdinalEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReviewOrdinalEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public ReviewOrdinalEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<ReviewOrdinalEntity>(_idx);
                        }
