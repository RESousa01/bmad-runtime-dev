...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorBmadResourceInventoryEntry
    {
        ...
        public readonly partial struct LocationKindEntity
#if NET8_0_OR_GREATER
            : IJsonElement<LocationKindEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LocationKindEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LocationKindEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LocationKindEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LocationKindEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LocationKindEntity left, in LocationKindEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LocationKindEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LocationKindEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LocationKindEntity(JsonElement instance)
            {
                return LocationKindEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationKindEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationKindEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationKindEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationKindEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationKindEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationKindEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationKindEntity>(json, options);
            }
            ...
            /// </exception>
            public static LocationKindEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LocationKindEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LocationKindEntity? result)
            {
                return JsonElementHelpers.TryParseValue<LocationKindEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LocationKindEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LocationKindEntity IJsonElement<LocationKindEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LocationKindEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LocationKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LocationKindEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LocationKindEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LocationKindEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LocationKindEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LocationKindEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LocationKindEntity>(_idx);
                }
            ...
            /// <param name="matchSourceTree">Match 1st item.</param>
            /// <param name="matchFinalInstall">Match 2nd item.</param>
            /// <param name="matchManagedProjection">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSourceTree,
                Func<TContext, TResult> matchFinalInstall,
                Func<TContext, TResult> matchManagedProjection,
...
#endif
            {
                ...
                {
                    return matchSourceTree(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFinalInstall(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchManagedProjection(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSourceTree,
                Func<TResult> matchFinalInstall,
                Func<TResult> matchManagedProjection,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSourceTree();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFinalInstall();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchManagedProjection();
                }
