    ...
    public readonly partial struct MethodSessionArchitectureSpineDraft
    {
        ...
        public readonly partial struct PurposeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PurposeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PurposeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PurposeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PurposeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PurposeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PurposeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PurposeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PurposeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PurposeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PurposeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PurposeEntity>();
                }
                finally
                {
