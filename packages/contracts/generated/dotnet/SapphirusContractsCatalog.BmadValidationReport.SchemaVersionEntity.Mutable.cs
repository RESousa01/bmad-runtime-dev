    ...
    public readonly partial struct BmadValidationReport
    {
        ...
        public readonly partial struct SchemaVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SchemaVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SchemaVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SchemaVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SchemaVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SchemaVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SchemaVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SchemaVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SchemaVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SchemaVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SchemaVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SchemaVersionEntity>();
                }
                finally
                {
