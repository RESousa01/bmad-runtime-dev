        ...
        public readonly partial struct MergeSemanticsEntity
        {
                ...
                : IJsonElement<DeletionOperatorEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "none"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly DeletionOperatorEntity ConstJson = ParsedJsonDocument<DeletionOperatorEntity>.StringConstant([.."\"none\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/deletionOperator"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/deletionOperator";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorBmadConfigGraphDescriptor/properties/mergeSemantics/properties/deletionOperator"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "none"u8, "none", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "none", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
