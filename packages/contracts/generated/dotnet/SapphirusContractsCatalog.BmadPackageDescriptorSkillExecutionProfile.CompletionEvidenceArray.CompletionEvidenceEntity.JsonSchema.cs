        ...
        public readonly partial struct CompletionEvidenceArray
        {
                ...
                : IJsonElement<CompletionEvidenceEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "artifact"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly CompletionEvidenceEntity EnumJson1 = ParsedJsonDocument<CompletionEvidenceEntity>.StringConstant([.."\"artifact\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "event"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly CompletionEvidenceEntity EnumJson2 = ParsedJsonDocument<CompletionEvidenceEntity>.StringConstant([.."\"event\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "status_evidence"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly CompletionEvidenceEntity EnumJson3 = ParsedJsonDocument<CompletionEvidenceEntity>.StringConstant([.."\"status_evidence\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "artifact"
                    /// as a <see cref="CompletionEvidenceEntity"/>.
                    /// </summary>
                    public static CompletionEvidenceEntity Artifact { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "artifact"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ArtifactUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "event"
                    /// as a <see cref="CompletionEvidenceEntity"/>.
                    /// </summary>
                    public static CompletionEvidenceEntity Event { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "event"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> EventUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "status_evidence"
                    /// as a <see cref="CompletionEvidenceEntity"/>.
                    /// </summary>
                    public static CompletionEvidenceEntity StatusEvidence { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "status_evidence"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> StatusEvidenceUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BmadPackageDescriptorSkillExecutionProfile/properties/completionEvidence/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/$defs/BmadPackageDescriptorSkillExecutionProfile/properties/completionEvidence/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BmadPackageDescriptorSkillExecutionProfile/properties/completionEvidence/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("artifact"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("event"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("status_evidence"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
