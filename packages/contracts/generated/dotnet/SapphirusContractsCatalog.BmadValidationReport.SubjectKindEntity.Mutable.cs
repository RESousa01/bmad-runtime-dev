    ...
    public readonly partial struct BmadValidationReport
    {
        ...
        public readonly partial struct SubjectKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SubjectKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SubjectKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SubjectKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SubjectKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SubjectKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SubjectKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SubjectKindEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SubjectKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SubjectKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SubjectKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SubjectKindEntity>();
                }
                finally
                {
