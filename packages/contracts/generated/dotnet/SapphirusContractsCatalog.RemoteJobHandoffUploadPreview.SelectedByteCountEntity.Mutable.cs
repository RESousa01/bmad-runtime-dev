    ...
    public readonly partial struct RemoteJobHandoffUploadPreview
    {
        ...
        public readonly partial struct SelectedByteCountEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SelectedByteCountEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SelectedByteCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SelectedByteCountEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SelectedByteCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SelectedByteCountEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SelectedByteCountEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SelectedByteCountEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SelectedByteCountEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SelectedByteCountEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SelectedByteCountEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SelectedByteCountEntity>();
                }
                finally
                {
