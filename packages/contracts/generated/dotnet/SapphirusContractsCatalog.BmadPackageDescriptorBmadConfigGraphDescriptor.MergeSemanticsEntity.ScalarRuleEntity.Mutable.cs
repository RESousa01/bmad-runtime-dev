        ...
        public readonly partial struct MergeSemanticsEntity
        {
            ...
            public readonly partial struct ScalarRuleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ScalarRuleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ScalarRuleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ScalarRuleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ScalarRuleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ScalarRuleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ScalarRuleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ScalarRuleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ScalarRuleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ScalarRuleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ScalarRuleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ScalarRuleEntity>();
                    }
                    finally
                    {
