    ...
    public readonly partial struct CommonLocalPathPreimage
    {
        ...
        public readonly partial struct FileIdentityHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FileIdentityHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FileIdentityHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FileIdentityHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FileIdentityHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FileIdentityHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FileIdentityHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FileIdentityHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.FileIdentityHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonLocalPathPreimage.FileIdentityHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FileIdentityHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FileIdentityHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FileIdentityHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FileIdentityHashEntity>();
                }
                finally
                {
