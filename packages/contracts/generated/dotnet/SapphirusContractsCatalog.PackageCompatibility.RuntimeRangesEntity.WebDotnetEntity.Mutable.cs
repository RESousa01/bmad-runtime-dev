        ...
        public readonly partial struct RuntimeRangesEntity
        {
            ...
            public readonly partial struct WebDotnetEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WebDotnetEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WebDotnetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WebDotnetEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WebDotnetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WebDotnetEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WebDotnetEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WebDotnetEntity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.RuntimeRangesEntity.WebDotnetEntity.Mutable, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibility.RuntimeRangesEntity.WebDotnetEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.PackageCompatibilityVersionRange.JsonSchema.Evaluate(_parent, _idx))
                        {
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WebDotnetEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<WebDotnetEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WebDotnetEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WebDotnetEntity>();
                    }
                    finally
                    {
