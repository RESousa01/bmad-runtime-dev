...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct CommonRelativeWorkspacePath
#if NET8_0_OR_GREATER
        : IJsonElement<CommonRelativeWorkspacePath>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonRelativeWorkspacePath"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CommonRelativeWorkspacePath(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CommonRelativeWorkspacePath DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CommonRelativeWorkspacePath value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CommonRelativeWorkspacePath left, in CommonRelativeWorkspacePath right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CommonRelativeWorkspacePath left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CommonRelativeWorkspacePath instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CommonRelativeWorkspacePath(JsonElement instance)
        {
            return CommonRelativeWorkspacePath.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonRelativeWorkspacePath From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonRelativeWorkspacePath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonRelativeWorkspacePath>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonRelativeWorkspacePath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonRelativeWorkspacePath>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CommonRelativeWorkspacePath ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonRelativeWorkspacePath>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static CommonRelativeWorkspacePath ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CommonRelativeWorkspacePath>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CommonRelativeWorkspacePath? result)
        {
            return JsonElementHelpers.TryParseValue<CommonRelativeWorkspacePath>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CommonRelativeWorkspacePath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static CommonRelativeWorkspacePath IJsonElement<CommonRelativeWorkspacePath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CommonRelativeWorkspacePath: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CommonRelativeWorkspacePath"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CommonRelativeWorkspacePath"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CommonRelativeWorkspacePath Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CommonRelativeWorkspacePath>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CommonRelativeWorkspacePath"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public CommonRelativeWorkspacePath Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CommonRelativeWorkspacePath>(_idx);
            }
