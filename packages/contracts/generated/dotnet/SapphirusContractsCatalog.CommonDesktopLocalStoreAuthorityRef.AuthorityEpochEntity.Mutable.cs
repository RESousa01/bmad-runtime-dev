    ...
    public readonly partial struct CommonDesktopLocalStoreAuthorityRef
    {
        ...
        public readonly partial struct AuthorityEpochEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AuthorityEpochEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AuthorityEpochEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AuthorityEpochEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AuthorityEpochEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorityEpochEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorityEpochEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AuthorityEpochEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AuthorityEpochEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AuthorityEpochEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AuthorityEpochEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AuthorityEpochEntity>();
                }
                finally
                {
