    ...
    public readonly partial struct RemoteJobHandoffFailedHandoff
    {
        ...
        public readonly partial struct FailureCodeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FailureCodeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FailureCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FailureCodeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FailureCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FailureCodeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FailureCodeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FailureCodeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FailureCodeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FailureCodeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FailureCodeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FailureCodeEntity>();
                }
                finally
                {
