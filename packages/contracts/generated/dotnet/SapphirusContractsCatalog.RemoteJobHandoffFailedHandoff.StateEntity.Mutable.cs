    ...
    public readonly partial struct RemoteJobHandoffFailedHandoff
    {
        ...
        public readonly partial struct StateEntity
        {
...
#endif
            {
                ...
                /// <param name="matchCancelled">Match 1st item.</param>
                /// <param name="matchExpired">Match 2nd item.</param>
                /// <param name="matchUploadFailed">Match 3rd item.</param>
                /// <param name="matchRemoteFailed">Match 4th item.</param>
                /// <param name="matchResultRejected">Match 5th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchUploadFailed,
                    Func<TContext, TResult> matchRemoteFailed,
                    Func<TContext, TResult> matchResultRejected,
...
#endif
                {
                    ...
                    {
                        return matchUploadFailed(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchRemoteFailed(context);
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchResultRejected(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchUploadFailed,
                    Func<TResult> matchRemoteFailed,
                    Func<TResult> matchResultRejected,
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchUploadFailed();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchRemoteFailed();
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchResultRejected();
                    }
