...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct ModelContextConsentRegion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModelContextConsentRegion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModelContextConsentRegion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModelContextConsentRegion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModelContextConsentRegion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModelContextConsentRegion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModelContextConsentRegion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModelContextConsentRegion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModelContextConsentRegion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModelContextConsentRegion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ModelContextConsentRegion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ModelContextConsentRegion>();
            }
            finally
            {
