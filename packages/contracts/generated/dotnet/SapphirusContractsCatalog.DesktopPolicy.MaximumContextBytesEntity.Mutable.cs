    ...
    public readonly partial struct DesktopPolicy
    {
        ...
        public readonly partial struct MaximumContextBytesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumContextBytesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumContextBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumContextBytesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumContextBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumContextBytesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumContextBytesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumContextBytesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumContextBytesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumContextBytesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaximumContextBytesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumContextBytesEntity>();
                }
                finally
                {
