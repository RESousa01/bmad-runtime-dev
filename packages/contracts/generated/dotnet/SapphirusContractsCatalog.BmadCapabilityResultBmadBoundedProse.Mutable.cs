...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadCapabilityResultBmadBoundedProse
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BmadCapabilityResultBmadBoundedProse instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BmadCapabilityResultBmadBoundedProse"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BmadCapabilityResultBmadBoundedProse(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BmadCapabilityResultBmadBoundedProse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityResultBmadBoundedProse Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BmadCapabilityResultBmadBoundedProse Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BmadCapabilityResultBmadBoundedProse>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BmadCapabilityResultBmadBoundedProse instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BmadCapabilityResultBmadBoundedProse, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BmadCapabilityResultBmadBoundedProse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BmadCapabilityResultBmadBoundedProse>();
            }
            finally
            {
