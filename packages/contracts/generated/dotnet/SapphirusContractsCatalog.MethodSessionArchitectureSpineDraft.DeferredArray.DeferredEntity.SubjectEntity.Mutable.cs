            ...
            public readonly partial struct DeferredEntity
            {
                ...
                public readonly partial struct SubjectEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(SubjectEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SubjectEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SubjectEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SubjectEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SubjectEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SubjectEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SubjectEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SubjectEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SubjectEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<SubjectEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<SubjectEntity>();
                        }
                        finally
                        {
