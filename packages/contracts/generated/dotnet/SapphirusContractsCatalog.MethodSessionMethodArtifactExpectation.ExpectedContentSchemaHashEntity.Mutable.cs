    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct ExpectedContentSchemaHashEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpectedContentSchemaHashEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpectedContentSchemaHashEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpectedContentSchemaHashEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpectedContentSchemaHashEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectedContentSchemaHashEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectedContentSchemaHashEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpectedContentSchemaHashEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodArtifactExpectation.ExpectedContentSchemaHashEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionMethodArtifactExpectation.ExpectedContentSchemaHashEntity.Mutable, TResult> defaultMatch)
                {
                    if (Sapphirus.Contracts.Generated.SapphirusContractsCatalog.CommonSha256.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpectedContentSchemaHashEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpectedContentSchemaHashEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpectedContentSchemaHashEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpectedContentSchemaHashEntity>();
                }
                finally
                {
