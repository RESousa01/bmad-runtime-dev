    ...
    public readonly partial struct MethodSessionArchitectureReviewResult
    {
            ...
            : IJsonElement<ModelReviewEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/MethodSessionArchitectureReviewResult/properties/modelReview"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/MethodSessionArchitectureReviewResult/properties/modelReview"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (!context.HasCollector)
                    {
                        ...
                        {
                            if (parentDocument.TryGetNamedPropertyValue(parentIndex, "modelReviewKind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                            {
                                if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                                {
                                    ...
                                    if (discriminatorValue.Span.SequenceEqual("source_grounded"u8))
                                    {
                                        oneOfDiscriminatorBranch = 0;
                                    }
                                    else if (discriminatorValue.Span.SequenceEqual("unavailable"u8))
                                    {
                        ...
                        switch (oneOfDiscriminatorBranch)
                        {
                            case 0:
                            {
                                JsonSchemaContext discriminatorContext0 =
                                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                            ...
                            case 1:
                            {
                                JsonSchemaContext discriminatorContext1 =
                                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                    ...
                    JsonSchemaContext oneOfContext1 =
                        Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                    Sapphirus.Contracts.Generated.SapphirusContractsCatalog.MethodSessionArchitectureReviewResult.ModelReviewEntity.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
