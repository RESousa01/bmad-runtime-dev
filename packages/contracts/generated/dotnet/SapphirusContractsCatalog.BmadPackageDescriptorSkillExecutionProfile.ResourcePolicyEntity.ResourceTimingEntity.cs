...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct BmadPackageDescriptorSkillExecutionProfile
    {
        ...
        public readonly partial struct ResourcePolicyEntity
        {
            ...
            public readonly partial struct ResourceTimingEntity
#if NET8_0_OR_GREATER
                : IJsonElement<ResourceTimingEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ResourceTimingEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ResourceTimingEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ResourceTimingEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ResourceTimingEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ResourceTimingEntity left, in ResourceTimingEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ResourceTimingEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ResourceTimingEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ResourceTimingEntity(JsonElement instance)
                {
                    return ResourceTimingEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ResourceTimingEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ResourceTimingEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ResourceTimingEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ResourceTimingEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ResourceTimingEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ResourceTimingEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ResourceTimingEntity>(json, options);
                }
                ...
                /// </exception>
                public static ResourceTimingEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ResourceTimingEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ResourceTimingEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ResourceTimingEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ResourceTimingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ResourceTimingEntity IJsonElement<ResourceTimingEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ResourceTimingEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ResourceTimingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ResourceTimingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ResourceTimingEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ResourceTimingEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ResourceTimingEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ResourceTimingEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ResourceTimingEntity>(_idx);
                    }
                ...
                /// <param name="matchAllDeclaredAtStart">Match 1st item.</param>
                /// <param name="matchCurrentStepOnly">Match 2nd item.</param>
                /// <param name="matchRenderInputsOnly">Match 3rd item.</param>
                /// <param name="matchForwardTargetOnly">Match 4th item.</param>
                /// <param name="matchOnDemandDeclared">Match 5th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchAllDeclaredAtStart,
                    Func<TContext, TResult> matchCurrentStepOnly,
                    Func<TContext, TResult> matchRenderInputsOnly,
                    Func<TContext, TResult> matchForwardTargetOnly,
                    Func<TContext, TResult> matchOnDemandDeclared,
...
#endif
                {
                    ...
                    {
                        return matchAllDeclaredAtStart(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchCurrentStepOnly(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchRenderInputsOnly(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchForwardTargetOnly(context);
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchOnDemandDeclared(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchAllDeclaredAtStart,
                    Func<TResult> matchCurrentStepOnly,
                    Func<TResult> matchRenderInputsOnly,
                    Func<TResult> matchForwardTargetOnly,
                    Func<TResult> matchOnDemandDeclared,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchAllDeclaredAtStart();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchCurrentStepOnly();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchRenderInputsOnly();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchForwardTargetOnly();
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchOnDemandDeclared();
                    }
