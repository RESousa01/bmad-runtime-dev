    ...
    public readonly partial struct RemoteJobHandoffUploadPreview
    {
        ...
        public readonly partial struct SelectedEntryCountEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SelectedEntryCountEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SelectedEntryCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SelectedEntryCountEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SelectedEntryCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SelectedEntryCountEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SelectedEntryCountEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SelectedEntryCountEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SelectedEntryCountEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SelectedEntryCountEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SelectedEntryCountEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SelectedEntryCountEntity>();
                }
                finally
                {
