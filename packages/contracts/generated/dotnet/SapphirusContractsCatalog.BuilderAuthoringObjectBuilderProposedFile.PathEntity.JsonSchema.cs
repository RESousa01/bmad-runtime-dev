    ...
    public readonly partial struct BuilderAuthoringObjectBuilderProposedFile
    {
            ...
            : IJsonElement<PathEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/BuilderAuthoringObjectBuilderProposedFile/properties/path"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/BuilderAuthoringObjectBuilderProposedFile/properties/path";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/BuilderAuthoringObjectBuilderProposedFile/properties/path"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchLengthLessThanOrEquals(240,stringLength, "maxLength"u8, ref context);
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^(?!/)(?!(?:.*\\/)?\\.{1,2}(?:\\/|$))(?!.*[\\\\:\\u0000-\\u001f\\u007f])(?=.{1,240}$)(?=[^/]{1,120}(?:/[^/]{1,120}){0,15}$)[^/]+(?:/[^/]+)*$", "pattern"u8, ref context);
                    }
                }
