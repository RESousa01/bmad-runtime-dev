    ...
    public readonly partial struct PackageCompatibility
    {
        ...
        public readonly partial struct RevocationPolicyIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RevocationPolicyIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RevocationPolicyIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RevocationPolicyIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RevocationPolicyIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RevocationPolicyIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RevocationPolicyIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RevocationPolicyIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RevocationPolicyIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RevocationPolicyIdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RevocationPolicyIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RevocationPolicyIdEntity>();
                }
                finally
                {
