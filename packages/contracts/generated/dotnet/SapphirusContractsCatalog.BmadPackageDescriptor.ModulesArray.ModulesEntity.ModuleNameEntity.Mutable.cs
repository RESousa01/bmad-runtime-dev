            ...
            public readonly partial struct ModulesEntity
            {
                ...
                public readonly partial struct ModuleNameEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ModuleNameEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ModuleNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ModuleNameEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ModuleNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ModuleNameEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ModuleNameEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ModuleNameEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ModuleNameEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ModuleNameEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ModuleNameEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ModuleNameEntity>();
                        }
                        finally
                        {
