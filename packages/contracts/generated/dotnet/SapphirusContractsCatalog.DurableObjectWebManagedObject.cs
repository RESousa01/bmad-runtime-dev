...
public readonly partial struct SapphirusContractsCatalog
{
    ...
    public readonly partial struct DurableObjectWebManagedObject
        ...
        : IJsonElement<DurableObjectWebManagedObject>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DurableObjectWebManagedObject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DurableObjectWebManagedObject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DurableObjectWebManagedObject DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectWebManagedObject.EnvelopeEntity Envelope
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvelopeUtf8, out Sapphirus.Contracts.Generated.SapphirusContractsCatalog.DurableObjectWebManagedObject.EnvelopeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DurableObjectWebManagedObject left, in DurableObjectWebManagedObject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DurableObjectWebManagedObject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DurableObjectWebManagedObject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DurableObjectWebManagedObject(JsonElement instance)
        {
            return DurableObjectWebManagedObject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWebManagedObject From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWebManagedObject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWebManagedObject>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWebManagedObject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWebManagedObject>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DurableObjectWebManagedObject ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWebManagedObject>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DurableObjectWebManagedObject ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DurableObjectWebManagedObject>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DurableObjectWebManagedObject? result)
        {
            return JsonElementHelpers.TryParseValue<DurableObjectWebManagedObject>(ref reader, out result);
        }
...
#if NET
        static DurableObjectWebManagedObject IJsonElement<DurableObjectWebManagedObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DurableObjectWebManagedObject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DurableObjectWebManagedObject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DurableObjectWebManagedObject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DurableObjectWebManagedObject>(_idx);
            }
