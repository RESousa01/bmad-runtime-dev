    ...
    public readonly partial struct MethodSessionMethodArtifactExpectation
    {
        ...
        public readonly partial struct ExpectationKindEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpectationKindEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpectationKindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpectationKindEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpectationKindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectationKindEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectationKindEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpectationKindEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpectationKindEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpectationKindEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpectationKindEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpectationKindEntity>();
                }
                finally
                {
