...
/**
 * Computes lowercase SHA-256 without Node-only APIs so generated validators
 * remain synchronous and browser-safe.
 */
export function sha256Hex(value) {
  if (typeof value !== "string") {
    throw new TypeError("SHA-256 input must be a string.");
  }
  const message = paddedMessage(encoder.encode(value));
